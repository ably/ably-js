(function() {
  ...
  this.Base64 = function() {
    ...
    var e = {codex:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode:function(b) {
      ...
      for(b = new c(b);b.moveNext();) {
        ...
        var p = b.current;
        b.moveNext();
        var r = b.current, P = l >> 2, l = (l & 3) << 4 | p >> 4, h = (p & 15) << 2 | r >> 6, v = r & 63;
        isNaN(p) ? h = v = 64 : isNaN(r) && (v = 64);
        f.append(d.charAt(P) + d.charAt(l) + d.charAt(h) + d.charAt(v))
      }
      return f.toString()
    }, decode:function(c) {
      var f = new a;
  ...
  var C = Ably.Crypto = window.CryptoJS && function() {
    ...
    return{registerObject:function(a, b, c, e) {
      ...
      q.w3 && !(q.wk && 312 > q.wk) && a && b && e && f && g ? (m(b, !1), c(function() {
        ...
        if(V(g)) {
          W = h(c, q, b), c.id == b && m(b, !0), n.success = !0, n.ref = W
        }else {
          if(p && d()) {
            c.data = p;
            l(c, q, b, Q);
      ...
      if(I) {
        var a = v(z);
        a && E && (a.parentNode.replaceChild(E, a), H && (m(H, !0), q.ie && q.win && (E.style.display = "block")), J && J(L));
        I = !1
      }
    }}
  }(), aa = function() {
    ...
    }, l = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:u.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:u.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, e = a.TMessage = {}, d = a.TPresence = {}, f = a.TProtocolMessage = {}, h = a.TMessageArray = {}, l = a.TMessageBundle = {}, p = c.TType.BUFFER;
  ...
  var X = function() {
    ...
    b.prototype.requestToken = function(b, e, d) {
      ...
      var m = e.id || b.keyId, g = this.rest, u = function(a) {
        return g.baseUri(a) + "/keys/" + m + "/requestToken"
      }, w = function(a, c) {
        var e;
    ...
    a.prototype.time = function(a, c) {
      ...
      Http.get(this, function(a) {
        ...
        if(a) {
          ...
          var e = b[0];
          e ? (h.serverTimeOffset = e - Date.now(), c(null, e)) : (a = Error("Internal error (unexpected result type from GET /time)"), a.statusCode = 500, c(a))
        }
      })
    };
        ...
        if(a) {
          ...
          try {
            for(var d = Serialize.TMessageArray.decode(b, f), g = 0;g < d.length;g++) {
              l && U.decrypt(d[g], l), d[g].data = Data.fromTData(d[g].data)
            }
            c(null, d)
          }catch(h) {
            c(h)
    ...
    a.prototype.setPresence = function(a, c) {
      ...
      for(var k = 0;k < a.length;k++) {
        var l = a[k], p = l.clientId + ":" + l.memberId, r = new ia(l.clientId, Data.fromTData(l.clientData), l.memberId);
        switch(l.state) {
          case b.LEAVE:
  ...
  (function() {
    ...
    a.checkConnectivity = function(b) {
      (new a.Request).send("http://live.cdn.ably-realtime.com/is-the-internet-up.txt", null, null, null, !1, !1, function(a, c) {
        b(null, !a && "yes" == c)
      })
    };
    ...
    a.Request.prototype.send = function(a, d, g, f, h, l, m) {
      ...
      var v = this.xhr = c();
      l && (v.responseType = "arraybuffer", f && (f = f.view));
      ...
      v.onreadystatechange = function() {
        if(4 == v.readyState) {
          if(clearTimeout(z), t) {
            ...
            if(v.status == n) {
              var a = null;
              l ? v.response && (a = new w, a.buf = v.response, a.view = new DataView(a.buf)) : a = v.responseText;
              ...
              0 != v.status && (t = Error("Unexpected response: statusCode \x3d " + v.status), t.statusCode = v.status, t.code = 8E4, t.statusText = v.statusText, m(t))
            }
          }
        }
      };
