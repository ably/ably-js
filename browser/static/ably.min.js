...
2)c[e>>>3]|=parseInt(a.substr(e,2),16)<<24-e%8*4;return new n.init(c,g/2)}},t=e.Latin1={stringify:function(a){var g=a.words;a=a.sigBytes;for(var c=[],e=0;e<a;e++)c.push(String.fromCharCode(g[e>>>2]>>>24-e%4*8&255));return c.join("")},parse:function(a){for(var g=a.length,c=[],e=0;e<g;e++)c[e>>>2]|=(a.charCodeAt(e)&255)<<24-e%4*8;return new n.init(c,g)}},k=e.Utf8={stringify:function(a){try{return decodeURIComponent(escape(t.stringify(a)))}catch(v){throw Error("Malformed UTF-8 data");}},parse:function(a){return t.parse(unescape(encodeURIComponent(a)))}},
...
g[1],b=g[2],d=g[3],n=g[4],t=g[5],l=g[6],h=g[7],J=0;64>J;J++){if(16>J)m[J]=a[c+J]|0;else{var E=m[J-15],q=m[J-2];m[J]=((E<<25|E>>>7)^(E<<14|E>>>18)^E>>>3)+m[J-7]+((q<<15|q>>>17)^(q<<13|q>>>19)^q>>>10)+m[J-16]}E=h+((n<<26|n>>>6)^(n<<21|n>>>11)^(n<<7|n>>>25))+(n&t^~n&l)+e[J]+m[J];q=((k<<30|k>>>2)^(k<<19|k>>>13)^(k<<10|k>>>22))+(k&f^k&b^f&b);h=l;l=t;t=n;n=d+E|0;d=b;b=f;f=k;k=E+q|0}g[0]=g[0]+k|0;g[1]=g[1]+f|0;g[2]=g[2]+b|0;g[3]=g[3]+d|0;g[4]=g[4]+n|0;g[5]=g[5]+t|0;g[6]=g[6]+l|0;g[7]=g[7]+h|0},_doFinalize:function(){var a=
...
6-m%4*2;b[e>>>2]|=(t|k)<<24-e%4*8;e++}return d.create(b,e)},_map:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="}})();C.lib.Cipher||function(b){var d=C,f=d.lib,a=f.Base,c=f.WordArray,n=f.BufferedBlockAlgorithm,e=d.enc.Base64,m=d.algo.EvpKDF,t=f.Cipher=n.extend({cfg:a.extend(),createEncryptor:function(a,g){return this.create(this._ENC_XFORM_MODE,a,g)},createDecryptor:function(a,g){return this.create(this._DEC_XFORM_MODE,a,g)},init:function(a,g,c){this.cfg=this.cfg.extend(c);this._xformMode=
...
c=[],n=[],e=[],m=[],t=[],k=[],g=[],p=[],x=[];(function(){for(var f=[],b=0;256>b;b++)f[b]=128>b?b<<1:b<<1^283;var d=0,v=0;for(b=0;256>b;b++){var l=v^v<<1^v<<2^v<<3^v<<4;l=l>>>8^l&255^99;a[d]=l;c[l]=d;var h=f[d],q=f[h],r=f[q],H=257*f[l]^16843008*l;n[d]=H<<24|H>>>8;e[d]=H<<16|H>>>16;m[d]=H<<8|H>>>24;t[d]=H;H=16843009*r^65537*q^257*h^16843008*d;k[l]=H<<24|H>>>8;g[l]=H<<16|H>>>16;p[l]=H<<8|H>>>24;x[l]=H;d?(d=h^f[f[f[r^h]]],v^=f[f[v]]):d=v=1}})();var v=[0,1,2,4,8,16,32,64,128,27,54];f=f.AES=d.extend({_doReset:function(){var c=
...
c,this._keySchedule,n,e,m,t,a)},decryptBlock:function(a,e){var f=a[e+1];a[e+1]=a[e+3];a[e+3]=f;this._doCryptBlock(a,e,this._invKeySchedule,k,g,p,x,c);f=a[e+1];a[e+1]=a[e+3];a[e+3]=f},_doCryptBlock:function(a,g,c,e,k,f,p,b){for(var d=this._nRounds,m=a[g]^c[0],n=a[g+1]^c[1],t=a[g+2]^c[2],v=a[g+3]^c[3],l=4,x=1;x<d;x++){var h=e[m>>>24]^k[n>>>16&255]^f[t>>>8&255]^p[v&255]^c[l++],aa=e[n>>>24]^k[t>>>16&255]^f[v>>>8&255]^p[m&255]^c[l++],S=e[t>>>24]^k[v>>>16&255]^f[m>>>8&255]^p[n&255]^c[l++];v=e[v>>>24]^k[m>>>
16&255]^f[n>>>8&255]^p[t&255]^c[l++];m=h;n=aa;t=S}h=(b[m>>>24]<<24|b[n>>>16&255]<<16|b[t>>>8&255]<<8|b[v&255])^c[l++];aa=(b[n>>>24]<<24|b[t>>>16&255]<<16|b[v>>>8&255]<<8|b[m&255])^c[l++];S=(b[t>>>24]<<24|b[v>>>16&255]<<16|b[m>>>8&255]<<8|b[n&255])^c[l++];v=(b[v>>>24]<<24|b[m>>>16&255]<<16|b[n>>>8&255]<<8|b[t&255])^c[l++];a[g]=h;a[g+1]=aa;a[g+2]=S;a[g+3]=v},keySize:8});b.AES=d._createHelper(f)})();(function(){if("undefined"!==typeof ArrayBuffer){var b=C.lib.WordArray,d=b.init;(b.init=function(f){if(f instanceof
...
typeof Uint8Array?function(a){a=new Uint8Array(a);w.getRandomValues(a);return z.base64Encode(a.buffer)}:function(a){var c=z.base64CharSet;a=Math.round(4*a/3);for(var b="",e=0;e<a;e++)b+=c[Math.floor(Math.random()*c.length)];return b};b.arrChooseN=function(a,c){for(var f=Math.min(c,a.length),e=a.slice(),d=[],t=0;t<f;t++)d.push(b.arrPopRandomElement(e));return d};b.trim=String.prototype.trim?function(a){return a.trim()}:function(a){return a.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")};b.promisify=
...
suspendedRetryTimeout:3E4,httpRequestTimeout:15E3,channelRetryTimeout:15E3,fallbackRetryTimeout:6E5,connectionStateTtl:12E4,realtimeRequestTimeout:1E4,recvTimeout:9E4,preferenceConnectTimeout:6E3,parallelUpgradeDelay:6E3};r.httpMaxRetryCount=3;r.maxMessageSize=65536;r.version="1.1.17";r.libstring=w.libver+r.version;r.apiVersion="1.1";r.getHost=function(b,d,f){return d=f?d==b.restHost&&b.realtimeHost||d||b.realtimeHost:d||b.restHost};r.getPort=function(b,d){return d||b.tls?b.tlsPort:b.port};r.getHttpScheme=
...
function(){return this.messageQueue.clear()};b.prototype.finish=function(){var b=this.transport;this.onceIdle(function(){b.disconnect()})};b.PendingMessage=function(b,a){this.message=b;this.callback=a;this.merged=!1;var c=b.action;this.sendAttempted=!1;this.ackRequired=c==l.MESSAGE||c==l.PRESENCE};return b}(),P=function(){function b(){}function l(a,c){return h.arrIndexOf(t,a.shortName)>h.arrIndexOf(t,c.shortName)}function f(a,c,b,e){this.options=a;this.host=c;this.mode=b;this.connectionKey=e;this.format=
...
function(a){b.prototype[a]=function(b,d){var c=this;K[a](c.rest,c.path,c.headers,b,c.envelope,function(a,b,e,g,f){c.handlePage(a,b,e,g,f,d)})}});h.arrForEach(y.methodsWithBody,function(a){b.prototype[a]=function(b,d,e){var c=this;K[a](c.rest,c.path,d,c.headers,b,c.envelope,function(a,b,d,f,m){e&&c.handlePage(a,b,d,f,m,e)})}});b.prototype.handlePage=function(a,b,n,e,m,t){if(!a||this.useHttpPaginatedResponse&&(b||"number"===typeof a.code)){var c,g;try{var p=this.bodyHandler(b,n,e)}catch(v){t(a||v);
return}if(n&&(c=n.Link||n.link)){b=c;"string"==typeof b&&(b=b.split(","));e={};for(c=0;c<b.length;c++)if(g=b[c].match(/^\s*<(.+)>;\s*rel="(\w+)"$/)){var x;(x=(x=g[1].match(/^\.\/(\w+)\?(.*)$/))&&h.parseQueryString(x[2]))&&(e[g[2]]=x)}g=e}this.useHttpPaginatedResponse?t(null,new f(this,p,n,m,g,a)):t(null,new l(this,p,g))}else d.logAction(d.LOG_ERROR,"PaginatedResource.handlePage()","Unexpected error getting resource: err = "+h.inspectError(a)),t(a)};l.prototype.get=function(a,b){var c=this.resource;
...
"application/x-www-form-urlencoded",f=h.toQueryString(m).slice(1),y.postUri(k,c.authUrl,g,f,{},e)):y.getUri(k,c.authUrl,g||{},m,e)};else if(c.key){var t=this;d.logAction(d.LOG_MINOR,"Auth.requestToken()","using token auth with client-side signing");m=function(a,b){t.createTokenRequest(a,c,b)}}else{d.logAction(d.LOG_ERROR,"Auth()","library initialized with a token literal without any way to renew the token when it expires (no authUrl, authCallback, or key). See https://help.ably.io/error/40171 for help");
...
else this.once("nopending",b)};l.prototype.hasNopending=function(){return h.arrEvery(h.valuesArray(this.inProgress,!0),function(b){return!h.containsValue(b,!0)})};return b}();G.Promise=function(b){b=r.objectifyOptions(b);b.promises=!0;return new G(b)};G.Callbacks=G;var V=function(){return function(b,d,f,a){this.previous=b;this.current=d;f&&(this.retryIn=f);a&&(this.reason=a)}}(),da=function(){return function(b,d,f,a){this.previous=b;this.current=d;"attached"===d&&(this.resumed=f);a&&(this.reason=
...
l);p.timestamp||(p.timestamp=a);p.id||(p.id=h+":"+g)}this.presence.setPresence(m,b,e);break;case f.MESSAGE:e=a.messages;h=a.id;l=a.connectionId;a=a.timestamp;k=this.channelOptions;for(g=0;g<e.length;g++){try{m=e[g],D.decode(m,k)}catch(x){d.logAction(d.LOG_ERROR,"RealtimeChannel.onMessage()",x.toString())}m.connectionId||(m.connectionId=l);m.timestamp||(m.timestamp=a);m.id||(m.id=h+":"+g)}this.onEvent(e);break;case f.ERROR:(h=a.error)&&80016==h.code?this.checkPendingState():this.notifyState("failed",
...
b)};l.prototype.history=function(a,c){d.logAction(d.LOG_MICRO,"RealtimeChannel.history()","channel = "+this.name);void 0===c&&("function"==typeof a?(c=a,a=null):c=b);if(a&&a.untilAttach){if("attached"!==this.state){c(new q("option untilAttach requires the channel to be attached",4E4,400));return}if(!this.properties.attachSerial){c(new q("untilAttach was specified and channel is attached, but attachSerial is not defined",4E4,400));return}delete a.untilAttach;a.from_serial=this.properties.attachSerial}Y.prototype._history.call(this,
a,c)};l.prototype.whenState=function(a,b){B.prototype.whenState.call(this,a,this.state,b)};return l}(),sa=function(){function b(){}function l(a){a=a.channel.realtime;var b=a.auth.clientId;return(!b||"*"===b)&&"connected"===a.connection.state}function f(a,b,c){switch(a.state){case "attached":case "suspended":c();break;case "initialized":case "detached":case "detaching":case "attaching":a.attach(function(a){a?b(a):c()});break;default:b(q.fromValues(U.invalidStateError(a.state)))}}function a(a){X.call(this,
a);this.syncComplete=!1;this.members=new c(this);this._myMembers=new c(this);this.subscriptions=new B;this.pendingPresence=[]}function c(a){B.call(this);this.presence=a;this.map={};this.syncInProgress=!1;this.residualMembers=null}function n(a,b){if(a.isSynthesized()||b.isSynthesized())return a.timestamp>b.timestamp;var c=a.parseId(),d=b.parseId();return c.msgSerial===d.msgSerial?c.index>d.index:c.msgSerial>d.msgSerial}h.inherits(a,X);a.prototype.enter=function(a,b){if(l(this))throw new q("clientId must be specified to enter a presence channel",
...
this.channel.state,4E4,400)));X.prototype._history.call(this,a,c)};a.prototype.setPresence=function(a,b,c){d.logAction(d.LOG_MICRO,"RealtimePresence.setPresence()","received presence for "+a.length+" participants; syncChannelSerial = "+c);var e,f,h=this.members,m=this._myMembers,l=[],n=this.channel.connectionManager.connectionId;b&&(this.members.startSync(),c&&(f=c.match(/^[\w\-]+:(.*)$/))&&(e=f[1]));for(c=0;c<a.length;c++)switch(f=I.fromValues(a[c]),f.action){case "leave":h.remove(f)&&l.push(f);
f.connectionId!==n||f.isSynthesized()||m.remove(f);break;case "enter":case "present":case "update":h.put(f)&&l.push(f),f.connectionId===n&&m.put(f)}b&&!e&&(h.endSync(),this._ensureMyMembersPresent(),this.channel.setInProgress(U.progressOps.sync,!1),this.channel.syncChannelSerial=null);for(c=0;c<l.length;c++)f=l[c],this.subscriptions.emit(f.action,f)};a.prototype.onAttached=function(a){d.logAction(d.LOG_MINOR,"RealtimePresence.onAttached()","channel = "+this.channel.name+", hasPresence = "+a);a?this.members.startSync():
(this._synthesizeLeaves(this.members.values()),this.members.clear(),this._ensureMyMembersPresent());a=this.pendingPresence;var b=a.length;if(b){this.pendingPresence=[];var c=[],e=ba();d.logAction(d.LOG_MICRO,"RealtimePresence.onAttached","sending "+b+" queued presence messages");for(var f=0;f<b;f++){var h=a[f];c.push(h.presence);e.push(h.callback)}this.channel.sendPresence(c,e)}};a.prototype.actOnChannelState=function(a,b,c){switch(a){case "attached":this.onAttached(b);break;case "detached":case "failed":this._clearMyMembers(),
...
typeof P&&b.isAvailable()&&(P.supportedTransports.xhr_polling=b);return b})();(function(){function b(){}function l(a,b,c){c.stream=!1;N.call(this,a,b,c);this.shortName="jsonp"}function f(a,b,d,e,f,l,m,n){B.call(this);void 0===a&&(a=c++);this.id=a;this.uri=b;this.params=e||{};this.params.rnd=h.cheapRandStr();d&&(d["X-Ably-Version"]&&(this.params.v=d["X-Ably-Version"]),d["X-Ably-Lib"]&&(this.params.lib=d["X-Ably-Lib"]));this.body=f;this.method=n;this.requestMode=l;this.timeouts=m;this.requestComplete=
!1}var a=u._ablyjs_jsonp={};a._=function(c){return a["_"+c]||b};var c=1,n=null;h.inherits(l,N);l.isAvailable=function(){return w.jsonpSupported&&w.allowComet};l.isAvailable()&&(P.supportedTransports.jsonp=l);w.jsonpSupported&&(n=document.getElementsByTagName("head")[0]);var e=null;u.JSONPTransport=l;l.tryConnect=function(a,b,c,e){function f(a){e({event:this.event,error:a})}var g=new l(a,b,c);g.on(["failed","disconnected"],f);g.on("preconnect",function(){d.logAction(d.LOG_MINOR,"JSONPTransport.tryConnect()",
...
this.emit("disposed")};w.jsonpSupported&&!y.Request&&(y.Request=function(a,b,c,d,e,f,l){var g=m(c,d,e,f,N.REQ_SEND,b&&b.options.timeouts,a);g.once("complete",l);h.nextTick(function(){g.exec()});return g},y.checkConnectivity=function(a){var b=r.jsonpInternetUpUrl;if(e)e.push(a);else{e=[a];d.logAction(d.LOG_MICRO,"(JSONP)Http.checkConnectivity()","Sending; "+b);var c=new f("isTheInternetUp",b,null,null,null,N.REQ_SEND,r.TIMEOUTS);c.once("complete",function(a,b){var c=!a&&b;d.logAction(d.LOG_MICRO,"(JSONP)Http.checkConnectivity()",
"Result: "+c);for(var f=0;f<e.length;f++)e[f](null,c);e=null});h.nextTick(function(){c.exec()})}});return l})();"undefined"!==typeof G&&(Z.msgpack=ha,Z.Rest=F,Z.Realtime=G,G.ConnectionManager=P,G.BufferUtils=F.BufferUtils=z,"undefined"!==typeof T&&(G.Crypto=F.Crypto=T),G.Defaults=F.Defaults=r,G.Http=F.Http=y,G.Utils=F.Utils=h,G.Http=F.Http=y,G.Message=F.Message=D,G.PresenceMessage=F.PresenceMessage=I,G.ProtocolMessage=F.ProtocolMessage=A);if("object"===typeof u.exports){for(var ea in u.Ably)u.Ably.hasOwnProperty(ea)&&
