(function() {
  for(var kb = ["web_socket", "flash_socket", "xhr", "jsonp"], la = {disconnected:{statusCode:408, code:80003, reason:"Connection to server temporarily unavailable"}, suspended:{statusCode:408, code:80002, reason:"Connection to server unavailable"}, failed:{statusCode:408, code:8E4, reason:"Connection failed or disconnected by server"}}, Aa = function(a, b, c) {
    function f() {
    }
  ...
  C.prototype = {getArray:function() {
    ...
    return Ba.decode(this.view, a, b)
    ...
    return Ba.encode(b, this.view, a)
  }, inspect:function() {
  ...
  var y = d.Type, Ca = function(a, b) {
    Error.call(this, b);
    this.name = "TProtocolException";
    this.type = a
  };
  Aa(Ca, Error);
  var k = d.TBinaryProtocol = function(a, b, c) {
    this.trans = a;
  ...
  k.prototype.writeMessageBegin = function(a, b, c) {
  ...
  k.prototype.writeStructBegin = function() {
  };
  k.prototype.writeStructEnd = function() {
  };
  k.prototype.writeFieldBegin = function(a, b, c) {
    this.writeByte(b);
    this.writeI16(c)
  };
  ...
  k.prototype.writeMapBegin = function(a, b, c) {
    this.writeByte(a);
    this.writeByte(b);
    this.writeI32(c)
  };
  ...
  k.prototype.writeListBegin = function(a, b) {
    this.writeByte(a);
    this.writeI32(b)
  };
  k.prototype.writeListEnd = function() {
  };
  k.prototype.writeSetBegin = function(a, b) {
    this.writeByte(a);
    this.writeI32(b)
  };
  ...
  k.prototype.readMessageBegin = function() {
    ...
    if(0 > a) {
      b = a & -65536;
      if(-2147418112 != b) {
        throw console.log("BAD: " + b), Ca(4, "Bad version in readMessageBegin: " + a);
      }
      a &= 255;
      b = this.readString()
    }else {
      if(this.strictRead) {
        throw Ca(4, "No protocol version header");
      }
      b = this.trans.read(a);
      a = this.readByte()
    }
  ...
  var mb = new C(0), X = d.TTransport = function(a, b) {
    this.buf = a || mb;
    this.onFlush = b;
    this.reset()
  };
  ...
  var Da = d.TFramedTransport = function(a, b) {
    X.call(this, a, b)
  };
  Da.receiver = function(a) {
    ...
    return function(d) {
      ...
      for(;d.length;) {
        ...
        d.length >= b ? (d.copy(f, c, 0, b), d = d.slice(b, d.length), b = 0, a(new Da(f))) : d.length && (d.copy(f, c, 0, d.length), b -= d.length, c += d.length, d = d.slice(d.length, d.length))
      }
    }
  };
  Aa(Da, X, {flush:function() {
    var a = this;
  ...
  var G = {TAction:TAction, TType:TType, TData:S, TPresence:Y, TMessage:Z, TChannelMessage:$, TMessageSet:ea}, T, aa = function() {
    ...
    if(0 < a) {
      for(var b = 0;b < a;b++) {
        ...
        if(0 < g.pv[0]) {
          var e = H(c);
          if(e) {
            if(na(M[b].swfVersion) && !(g.wk && 312 > g.wk)) {
              V(c, !0), f && (d.success = !0, d.ref = Ea(c), f(d))
            }else {
              if(M[b].expressInstall && Fa()) {
                d = {};
                ...
                for(var p = {}, e = e.getElementsByTagName("param"), q = e.length, n = 0;n < q;n++) {
                  "movie" != e[n].getAttribute("name").toLowerCase() && (p[e[n].getAttribute("name")] = e[n].getAttribute("value"))
                }
                Ga(d, p, c, f)
              }else {
                nb(e), f && f(d)
          ...
          if(V(c, !0), f) {
            if((c = Ea(c)) && typeof c.SetVariable != r) {
              d.success = !0, d.ref = c
            }
            f(d)
          }
    ...
    return!oa && na("6.0.65") && (g.win || g.mac) && !(g.wk && 312 > g.wk)
  }, Ga = function(a, b, c, f) {
    oa = !0;
    Ia = f || null;
    Va = {success:!1, id:c};
    var d = H(c);
    if(d) {
      "OBJECT" == d.nodeName ? (fa = Ja(d), pa = null) : (fa = d, pa = c);
      a.id = Wa;
    ...
    if(g.ie && g.win && 4 != a.readyState) {
      ...
      b.parentNode.replaceChild(Ja(a), b);
      a.style.display = "none";
      (function() {
        4 == a.readyState ? a.parentNode.removeChild(a) : setTimeout(arguments.callee, 10)
      })()
    }else {
      a.parentNode.replaceChild(Ja(a), a)
    }
  }, Ja = function(a) {
    var b = l.createElement("div");
    if(g.win && g.ie) {
    ...
    if(d) {
      if(typeof a.id == r && (a.id = c), g.ie && g.win) {
        var e = "", p;
        for(p in a) {
          a[p] != Object.prototype[p] && ("data" == p.toLowerCase() ? b.movie = a[p] : "styleclass" == p.toLowerCase() ? e += ' class="' + a[p] + '"' : "classid" != p.toLowerCase() && (e += " " + p + '="' + a[p] + '"'))
        }
        p = "";
        for(var q in b) {
          b[q] != Object.prototype[q] && (p += '<param name="' + q + '" value="' + b[q] + '" />')
        }
        d.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + e + ">" + p + "</object>";
        qa[qa.length] = a.id;
        f = H(a.id)
      }else {
        q = l.createElement(J);
        q.setAttribute("type", ra);
        for(var n in a) {
          a[n] != Object.prototype[n] && ("styleclass" == n.toLowerCase() ? q.setAttribute("class", a[n]) : "classid" != n.toLowerCase() && q.setAttribute(n, a[n]))
        }
        for(e in b) {
          b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = q, p = e, n = b[e], c = l.createElement("param"), c.setAttribute("name", p), c.setAttribute("value", n), a.appendChild(c))
        }
    ...
    if(!g.ie || !g.mac) {
      ...
      if(d) {
        ...
        f && (La = K = null);
        if(!K || La != c) {
          f = l.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), K = d.appendChild(f), g.ie && (g.win && typeof l.styleSheets != r && 0 < l.styleSheets.length) && (K = l.styleSheets[l.styleSheets.length - 1]), La = c
        }
    ...
    if(Za) {
      ...
      U && H(a) ? H(a).style.visibility = c : Ya("#" + a, "visibility:" + c)
    }
  }, $a = function(a) {
    return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != r ? encodeURIComponent(a) : a
  }, r = "undefined", J = "object", ra = "application/x-shockwave-flash", Wa = "SWFObjectExprInst", D = window, l = document, N = navigator, ab = !1, ma = [function() {
    if(ab) {
      var a = l.getElementsByTagName("body")[0], b = l.createElement(J);
      b.setAttribute("type", ra);
  ...
  }], M = [], qa = [], ba = [], fa, pa, Ia, Va, U = !1, oa = !1, K, La, Za = !0, g, ob = typeof l.getElementById != r && typeof l.getElementsByTagName != r && typeof l.createElement != r, sa = N.userAgent.toLowerCase(), ta = N.platform.toLowerCase(), pb = ta ? /win/.test(ta) : /win/.test(sa), qb = ta ? /mac/.test(ta) : /mac/.test(sa), rb = /webkit/.test(sa) ? parseFloat(sa.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Ma = !+"\v1", ga = [0, 0, 0], A = null;
  if(typeof N.plugins != r && typeof N.plugins["Shockwave Flash"] == J) {
    if((A = N.plugins["Shockwave Flash"].description) && !(typeof N.mimeTypes != r && N.mimeTypes[ra] && !N.mimeTypes[ra].enabledPlugin)) {
      ab = !0, Ma = !1, A = A.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), ga[0] = parseInt(A.replace(/^(.*)\..*$/, "$1"), 10), ga[1] = parseInt(A.replace(/^.*\.(.*)\s.*$/, "$1"), 10), ga[2] = /[a-zA-Z]/.test(A) ? parseInt(A.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    }
  }else {
    if(typeof D.ActiveXObject != r) {
      try {
        var bb = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
        if(bb && (A = bb.GetVariable("$version"))) {
          Ma = !0, A = A.split(" ")[1].split(","), ga = [parseInt(A[0], 10), parseInt(A[1], 10), parseInt(A[2], 10)]
        }
      }catch(Gb) {
      }
    }
  }
  g = {w3:ob, pv:ga, wk:rb, ie:Ma, win:pb, mac:qb};
  ...
  T = {registerObject:function(a, b, c, f) {
  ...
  }, embedSWF:function(a, b, c, f, d, e, p, q, n, i) {
    var k = {success:!1, id:b};
    g.w3 && !(g.wk && 312 > g.wk) && a && b && c && f && d ? (V(b, !1), Ta(function() {
      c += "";
      f += "";
      var g = {};
      if(n && typeof n === J) {
      ...
      if(p && typeof p === J) {
        for(var m in p) {
          j.flashvars = typeof j.flashvars != r ? j.flashvars + ("&" + m + "=" + p[m]) : m + "=" + p[m]
        }
      }
      if(na(d)) {
        l = Ka(g, j, b), g.id == b && V(b, !0), k.success = !0, k.ref = l
      }else {
        if(e && Fa()) {
          g.data = e;
          Ga(g, j, b, i);
  ...
  }, hasFlashPlayerVersion:na, createSWF:function(a, b, c) {
    if(g.w3) {
      return Ka(a, b, c)
    }
    ...
    g.w3 && Ya(a, b, c, f)
  }, addDomLoadEvent:Ta, addLoadEvent:Ua, getQueryParamValue:function(a) {
    ...
    if(b) {
      ...
      for(var b = b.split("&"), c = 0;c < b.length;c++) {
        if(b[c].substring(0, b[c].indexOf("=")) == a) {
          return $a(b[c].substring(b[c].indexOf("=") + 1))
        }
      }
    }
    return""
    ...
    if(oa) {
      var a = H(Wa);
      a && fa && (a.parentNode.replaceChild(fa, a), pa && (V(pa, !0), g.ie && g.win && (fa.style.display = "block")), Ia && Ia(Va));
      oa = !1
    }
  }};
  var ua;
  ...
  i.__initialize = function() {
    if(!i.__initialized) {
      ...
      T.embedSWF("swf/WebSocketMainInsecure-0.9.swf", "webSocketFlash", "1", "1", "10.0.0", null, null, {hasPriority:!0, swliveconnect:!0, allowScriptAccess:"always"}, null, function(a) {
  ...
  e.setLog = function(a, b) {
    cb = a || 3;
    db = b || console.log.bind(console)
  };
  var j = function() {
  }, sb = "object" == typeof window;
  j.addProperties = j.mixin = function(a, b) {
    for(var c in b) {
      a[c] = b[c]
    }
    return a
  ...
  j.prototypicalClone = function(a, b) {
    function c() {
    }
    c.prototype = a;
    var f = new c;
  ...
  }, E = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:15E3, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:3E4}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, retryDelay:12E4}, closed:{state:"closed", 
  ...
  s.prototype.notifyState = function(a) {
    if(!(this.state.terminal || a.state == this.state.state)) {
      ...
      a = new va(this.state.state, b.state, b.retryDelay, a.error || la[b.state]);
  ...
  s.prototype.requestState = function(a) {
    ...
    if(a.state != this.state.state) {
      ...
      var b = E[a.state], a = new va(this.state.state, b.state, b.retryIn, a.error || la[b.state]);
      this.enactStateChange(a)
    }
  };
  s.prototype.connectImpl = function() {
    ...
    var a = this, b = this.realtime.auth, c = function(f) {
      ...
      a.notifyState({state:E.connecting.failState, error:f})
    }, f = function() {
  ...
  s.prototype.send = function(a, b, c) {
    c = c || ub;
    this.state.queueEvents && (b ? (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "queueing event"), (b = this.pendingMessages[this.pendingMessages.length - 1]) && Na.mergeTo(b.msg, a) ? (b.isMerged || (b.callback = new ha([b.callback]), b.isMerged = !0), b.listener.push(c)) : this.pendingMessages.push({msg:a, callback:c})) : (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), c(this.error)));
  ...
  var t = function(a, b, c) {
    ...
    this.auth = b;
    this.options = c;
    c.useTextProtocol ? (this.thriftTransport = ia.TStringTransport, this.thriftProtocol = ia.TJSONProtocol) : (this.thriftTransport = ia.TTransport, this.thriftProtocol = ia.TBinaryProtocol, this.protocolBuffer = new ia.CheckedBuffer(vb));
    this.isConnected = !1
  }, ia = "object" == typeof window ? d : require("thrift"), vb = 1024;
  j.inherits(t, w);
  t.prototype.connect = function() {
  };
  t.prototype.close = function() {
    this.isConnected = !1;
    this.emit("closed", la.closed)
  };
  ...
  var u = function(a, b, c) {
    ...
    t.call(this, a, b, c)
  }, Oa = "object" == typeof window, eb = Oa ? window.WebSocket || window.MozWebSocket : require("ws"), wb = Oa ? !1 : C, xb = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), wa = Oa ? d : require("thrift");
  j.inherits(u, t);
  ...
  u.prototype.onWsData = function(a, b) {
    var c = b ? new wa.TBinaryProtocol(new wa.TTransport(a)) : new wa.TJSONProtocol(new wa.TStringTransport(a)), f = new xb.TChannelMessage;
    try {
  ...
  }, Pa = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types");
  (j || require("util")).inherits(v, t);
  ...
  v.prototype.send = function(a, b) {
    if(this.sendRequest) {
      this.pendingMessage = this.pendingMessage || new Pa.TMessageSet({items:[]}), this.pendingMessage.items.push(a), this.pendingCallback = this.pendingCallback || new ha, this.pendingCallback.push(b)
    }else {
      var c = this.pendingMessage || new Pa.TMessageSet({items:[]});
      c.items.push(a);
  ...
  v.prototype.onResponseData = function(a) {
    var a = new this.thriftProtocol(new this.thriftTransport(a)), b = new Pa.TMessageSet;
    try {
      b.read(a);
      var c = b.items;
      if(c && c.length) {
  ...
  B.Request = function(a, b, c, d, e, g) {
    ...
    var j = this.xhr = fb();
    e && (j.responseType = "arraybuffer");
    var k = setTimeout(d ? 9E4 : 1E4, function() {
      j.abort()
    });
    j.open(b, a, !0);
    j.setRequestHeader("Accept", e ? "application/x-thrift" : "application/json");
    j.onreadystatechange = function() {
      if(4 == j.readyState) {
        clearTimeout(k);
        var a = null;
        j.status != i ? (a = Error("Unexpected response: statusCode = " + j.status), a.statusCode = j.status, a.statusText = j.statusText, g(a)) : (a = null, e ? j.response && (a = new C, a.buf = j.response, a.view = new DataView(a.buf)) : a = j.responseText, g(null, a))
      }
    };
    j.send(c)
  };
  ...
  O.isAvailable = function() {
    return zb && T && 10 <= T.getFlashPlayerVersion().major && ua
  };
  ...
  O.prototype.createWebSocket = function(a, b) {
    ...
    this.uri = a;
    return new ua(a, [], this.options.proxyHost, this.options.proxyPort)
  };
  ...
  P.get = function(a, b, c, d) {
    4 > arguments.length && ("function" == typeof c ? (d = c, c = null) : d = gb);
    a.auth.getAuthHeaders(function(e, g) {
      e ? d(e) : Http.get(a.baseUri + b, j.mixin(g, a.headers), c, d)
    })
  };
  P.post = function(a, b, c, d, e) {
    5 > arguments.length && ("function" == typeof d ? (e = d, d = null) : e = gb);
    a.auth.getAuthHeaders(function(g, i) {
      g ? e(g) : Http.post(a.baseUri + b, j.mixin(i, a.headers), c, d, e)
    })
  };
  var Ab = function() {
  }, Bb = function(a) {
  ...
  }, Qa = "object" == typeof window, Cb = Qa ? null : require("crypto"), xa = void 0;
  Qa && (window.CryptoJS && CryptoJS.HmacSHA1 && CryptoJS.enc.Base64) && (xa = function(a, b) {
    return CryptoJS.HmacSHA1(a, b).toString(CryptoJS.enc.Base64)
  });
  Qa || (xa = function(a, b) {
    var c = Cb.createHmac("SHA1", b);
    c.update(a);
  ...
  ca.prototype.requestToken = function(a, b) {
    ...
    var a = a || {}, b = b || Ab, a = j.mixin(j.copy(this.tokenOptions), a), c;
    if(a.authCallback) {
      ...
      if(a.authUrl) {
        e.logAction(e.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), c = function(b, c) {
          Http.get(a.authUrl, a.authHeaders || {}, j.mixin(b, a.authParams), c)
        }
      }else {
        if(a.keyValue) {
          var d = this;
          ...
          c = function(b, c) {
            d.createTokenRequest(j.mixin(j.copy(a), b), c)
          }
        }else {
    ...
    "capability" in a && (h.capability = Bb(a.capability));
    d = this;
    c(h, function(a, c) {
      if(a) {
  ...
  var ja = function(a) {
    ...
    b = j.defaultHeaders["json" == a.format];
    a.headers && (b = j.mixin(j.copy(a.headers), this.headers));
    this.headers = b;
  ...
  ib.prototype.get = function(a, b) {
    ...
    c || (this.attached[a] = c = new Na(this.realtime, a, b || {}));
    return c
  };
  this.Realtime = ja;
  var va;
  ...
  var Na, m = function(a, b, c) {
    ...
    this.options = j.prototypicalClone(Db, c);
  ...
  j.inherits(m, Q);
  m.prototype.publish = function(a, b, c) {
  ...
  m.prototype.attachImpl = function(a) {
  ...
  m.prototype.detachImpl = function(a) {
  ...
  m.prototype.subscribeAttached = function(a, b, c) {
  ...
  m.prototype.subscribeForEvent = function(a, b, c) {
  ...
  m.prototype.unsubscribeAttached = function(a, b, c) {
    if(null === a || a.__proto__ !== Array.prototype) {
  ...
  m.prototype.unsubscribeForEvent = function(a, b, c) {
  ...
  m.prototype.sendPresence = function(a, b) {
    var c = new z.TChannelMessage({action:z.TAction.PRESENCE, name:name});
    this.sendMessage(c, b)
  };
  m.prototype.onMessage = function(a) {
    switch(a.action) {
      case 5:
        this.setAttached(a);
        break;
  ...
  m.prototype.setAttached = function(a) {
  ...
  m.prototype.setSubscribed = function(a) {
  ...
  m.prototype.setDetached = function(a) {
  ...
  m.prototype.setUnsubscribed = function(a) {
  ...
  var jb, I = function(a, b) {
    ...
    this.clients = {}
  }, za = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types");
  j.inherits(I, w);
  ...
  I.prototype.enterClient = function(a, b, c) {
    ...
    this.clients[a] = b;
    a = new za.TPresence({state:za.TPresenceState.ENTER, clientId:this.clientId});
  ...
  I.prototype.leaveClient = function(a, b) {
    ...
    var c = new za.TPresence({state:za.TPresenceState.LEAVE, clientId:this.channel.ably.options.clientId});
