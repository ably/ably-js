...
2)c[e>>>3]|=parseInt(g.substr(e,2),16)<<24-e%8*4;return new n.init(c,a/2)}},t=e.Latin1={stringify:function(g){var a=g.words;g=g.sigBytes;for(var c=[],e=0;e<g;e++)c.push(String.fromCharCode(a[e>>>2]>>>24-e%4*8&255));return c.join("")},parse:function(g){for(var a=g.length,c=[],e=0;e<a;e++)c[e>>>2]|=(g.charCodeAt(e)&255)<<24-e%4*8;return new n.init(c,a)}},k=e.Utf8={stringify:function(g){try{return decodeURIComponent(escape(t.stringify(g)))}catch(D){throw Error("Malformed UTF-8 data");}},parse:function(g){return t.parse(unescape(encodeURIComponent(g)))}},
...
c)).finalize(a)}}});var p=f.algo={};return f}(Math);(function(b){var d=B,f=d.lib,a=f.WordArray,c=f.Hasher;f=d.algo;var n=[],e=[];(function(){function a(g){for(var a=b.sqrt(g),c=2;c<=a;c++)if(!(g%c))return!1;return!0}function c(g){return 4294967296*(g-(g|0))|0}for(var g=2,p=0;64>p;)a(g)&&(8>p&&(n[p]=c(b.pow(g,.5))),e[p]=c(b.pow(g,1/3)),p++),g++})();var m=[];f=f.SHA256=c.extend({_doReset:function(){this._hash=new a.init(n.slice(0))},_doProcessBlock:function(a,c){for(var g=this._hash.words,k=g[0],f=
g[1],b=g[2],d=g[3],n=g[4],t=g[5],l=g[6],h=g[7],K=0;64>K;K++){if(16>K)m[K]=a[c+K]|0;else{var E=m[K-15],q=m[K-2];m[K]=((E<<25|E>>>7)^(E<<14|E>>>18)^E>>>3)+m[K-7]+((q<<15|q>>>17)^(q<<13|q>>>19)^q>>>10)+m[K-16]}E=h+((n<<26|n>>>6)^(n<<21|n>>>11)^(n<<7|n>>>25))+(n&t^~n&l)+e[K]+m[K];q=((k<<30|k>>>2)^(k<<19|k>>>13)^(k<<10|k>>>22))+(k&f^k&b^f&b);h=l;l=t;t=n;n=d+E|0;d=b;b=f;f=k;k=E+q|0}g[0]=g[0]+k|0;g[1]=g[1]+f|0;g[2]=g[2]+b|0;g[3]=g[3]+d|0;g[4]=g[4]+n|0;g[5]=g[5]+t|0;g[6]=g[6]+l|0;g[7]=g[7]+h|0},_doFinalize:function(){var a=
...
g.slice(c,c+k)}});c.Decryptor=c.extend({processBlock:function(g,c){var e=this._cipher,k=e.blockSize,p=g.slice(c,c+k);e.decryptBlock(g,c);a.call(this,g,c,k);this._prevBlock=p}});return c}();var p=(d.pad={}).Pkcs7={pad:function(g,a){var e=4*a;e-=g.sigBytes%e;for(var k=e<<24|e<<16|e<<8|e,p=[],f=0;f<e;f+=4)p.push(k);e=c.create(p,e);g.concat(e)},unpad:function(g){g.sigBytes-=g.words[g.sigBytes-1>>>2]&255}};f.BlockCipher=t.extend({cfg:t.cfg.extend({mode:k,padding:p}),reset:function(){t.reset.call(this);
...
c=[],n=[],e=[],m=[],t=[],k=[],g=[],p=[],w=[];(function(){for(var f=[],b=0;256>b;b++)f[b]=128>b?b<<1:b<<1^283;var d=0,l=0;for(b=0;256>b;b++){var h=l^l<<1^l<<2^l<<3^l<<4;h=h>>>8^h&255^99;a[d]=h;c[h]=d;var D=f[d],q=f[D],r=f[q],I=257*f[h]^16843008*h;n[d]=I<<24|I>>>8;e[d]=I<<16|I>>>16;m[d]=I<<8|I>>>24;t[d]=I;I=16843009*r^65537*q^257*D^16843008*d;k[h]=I<<24|I>>>8;g[h]=I<<16|I>>>16;p[h]=I<<8|I>>>24;w[h]=I;d?(d=D^f[f[f[r^D]]],l^=f[f[l]]):d=l=1}})();var h=[0,1,2,4,8,16,32,64,128,27,54];f=f.AES=d.extend({_doReset:function(){var c=
this._key,e=c.words,f=c.sigBytes/4;c=4*((this._nRounds=f+6)+1);for(var b=this._keySchedule=[],d=0;d<c;d++)if(d<f)b[d]=e[d];else{var m=b[d-1];d%f?6<f&&4==d%f&&(m=a[m>>>24]<<24|a[m>>>16&255]<<16|a[m>>>8&255]<<8|a[m&255]):(m=m<<8|m>>>24,m=a[m>>>24]<<24|a[m>>>16&255]<<16|a[m>>>8&255]<<8|a[m&255],m^=h[d/f|0]<<24);b[d]=b[d-f]^m}e=this._invKeySchedule=[];for(f=0;f<c;f++)d=c-f,m=f%4?b[d]:b[d-4],e[f]=4>f||4>=d?m:k[a[m>>>24]]^g[a[m>>>16&255]]^p[a[m>>>8&255]]^w[a[m&255]]},encryptBlock:function(g,c){this._doCryptBlock(g,
c,this._keySchedule,n,e,m,t,a)},decryptBlock:function(a,e){var f=a[e+1];a[e+1]=a[e+3];a[e+3]=f;this._doCryptBlock(a,e,this._invKeySchedule,k,g,p,w,c);f=a[e+1];a[e+1]=a[e+3];a[e+3]=f},_doCryptBlock:function(g,a,c,e,k,f,p,b){for(var d=this._nRounds,m=g[a]^c[0],n=g[a+1]^c[1],t=g[a+2]^c[2],l=g[a+3]^c[3],w=4,h=1;h<d;h++){var D=e[m>>>24]^k[n>>>16&255]^f[t>>>8&255]^p[l&255]^c[w++],G=e[n>>>24]^k[t>>>16&255]^f[l>>>8&255]^p[m&255]^c[w++],T=e[t>>>24]^k[l>>>16&255]^f[m>>>8&255]^p[n&255]^c[w++];l=e[l>>>24]^k[m>>>
16&255]^f[n>>>8&255]^p[t&255]^c[w++];m=D;n=G;t=T}D=(b[m>>>24]<<24|b[n>>>16&255]<<16|b[t>>>8&255]<<8|b[l&255])^c[w++];G=(b[n>>>24]<<24|b[t>>>16&255]<<16|b[l>>>8&255]<<8|b[m&255])^c[w++];T=(b[t>>>24]<<24|b[l>>>16&255]<<16|b[m>>>8&255]<<8|b[n&255])^c[w++];l=(b[l>>>24]<<24|b[m>>>16&255]<<16|b[n>>>8&255]<<8|b[t&255])^c[w++];g[a]=D;g[a+1]=G;g[a+2]=T;g[a+3]=l},keySize:8});b.AES=d._createHelper(f)})();(function(){if("undefined"!==typeof ArrayBuffer){var b=B.lib.WordArray,d=b.init;(b.init=function(f){if(f instanceof
...
198),g.setUint32(e+1,m),(new Uint8Array(g.buffer)).set(new Uint8Array(a),e+5),5+m}if("number"===k){if(Math.floor(a)!==a)return g.setUint8(e,203),g.setFloat64(e+1,a),9;if(0<=a){if(128>a)return g.setUint8(e,a),1;if(256>a)return g.setUint8(e,204),g.setUint8(e+1,a),2;if(65536>a)return g.setUint8(e,205),g.setUint16(e+1,a),3;if(4294967296>a)return g.setUint8(e,206),g.setUint32(e+1,a),5;if(1.8446744073709552E19>a)return g.setUint8(e,207),e+=1,1.8446744073709552E19>a?(g.setUint32(e,Math.floor(a*t)),g.setInt32(e+
...
g.offset+" trailing bytes");return c};var t=1/4294967296;a.prototype.map=function(a){for(var g={},e=0;e<a;e++){var c=this.parse();g[c]=this.parse()}return g};a.prototype.bin=a.prototype.buf=function(a){var g=new ArrayBuffer(a);(new Uint8Array(g)).set(new Uint8Array(this.view.buffer,this.offset,a),0);this.offset+=a;return g};a.prototype.str=function(a){var g=d(this.view,this.offset,a);this.offset+=a;return g};a.prototype.array=function(a){for(var g=Array(a),e=0;e<a;e++)g[e]=this.parse();return g};
...
r={internetUpUrl:"https://internet-up.ably-realtime.com/is-the-internet-up.txt",jsonpInternetUpUrl:"https://internet-up.ably-realtime.com/is-the-internet-up-0-9.js",defaultTransports:["xhr_polling","xhr_streaming","jsonp","web_socket"],baseTransportOrder:["xhr_polling","xhr_streaming","jsonp","web_socket"],transportPreferenceOrder:["jsonp","xhr_polling","xhr_streaming","web_socket"],upgradeTransports:["xhr_streaming","web_socket"]};u.noUpgrade&&(r.upgradeTransports=[]);var y=function(){function b(a){return null!==
...
typeof Uint8Array?function(a){a=new Uint8Array(a);u.getRandomValues(a);return y.base64Encode(a.buffer)}:function(a){var c=y.base64CharSet;a=Math.round(4*a/3);for(var b="",e=0;e<a;e++)b+=c[Math.floor(Math.random()*c.length)];return b};b.arrChooseN=function(a,c){for(var f=Math.min(c,a.length),e=a.slice(),d=[],t=0;t<f;t++)d.push(b.arrPopRandomElement(e));return d};b.trim=String.prototype.trim?function(a){return a.trim()}:function(a){return a.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")};b.promisify=
...
suspendedRetryTimeout:3E4,httpRequestTimeout:15E3,channelRetryTimeout:15E3,fallbackRetryTimeout:6E5,connectionStateTtl:12E4,realtimeRequestTimeout:1E4,recvTimeout:9E4,preferenceConnectTimeout:6E3,parallelUpgradeDelay:6E3};r.httpMaxRetryCount=3;r.maxMessageSize=65536;r.version="1.1.15";r.libstring=u.libver+r.version;r.apiVersion="1.1";r.getHost=function(b,d,f){return d=f?d==b.restHost&&b.realtimeHost||d||b.realtimeHost:d||b.restHost};r.getPort=function(b,d){return d||b.tls?b.tlsPort:b.port};r.getHttpScheme=
function(b){return b.tls?"https://":"http://"};r.getFallbackHosts=function(b){var d=b.fallbackHosts;b="undefined"!==typeof b.httpMaxRetryCount?b.httpMaxRetryCount:r.httpMaxRetryCount;return d?h.arrChooseN(d,b):[]};r.getHosts=function(b){return[b.restHost].concat(r.getFallbackHosts(b))};r.objectifyOptions=function(b){return"string"==typeof b?-1==b.indexOf(":")?{token:b}:{key:b}:b};r.normaliseOptions=function(b){b.host&&(d.deprecated("host","restHost"),b.restHost=b.host);b.wsHost&&(d.deprecated("wsHost",
...
b.realtimeHost=l?r.REALTIME_HOST:f+"-"+r.REALTIME_HOST}b.fallbackHosts=l||b.fallbackHostsUseDefault?r.FALLBACK_HOSTS:b.fallbackHosts;h.arrForEach((b.fallbackHosts||[]).concat(b.restHost,b.realtimeHost),ka);b.port=b.port||r.PORT;b.tlsPort=b.tlsPort||r.TLS_PORT;b.maxMessageSize=b.maxMessageSize||r.maxMessageSize;"tls"in b||(b.tls=!0);b.timeouts={};for(var a in r.TIMEOUTS)b.timeouts[a]=b[a]||r.TIMEOUTS[a];b.useBinaryProtocol="useBinaryProtocol"in b?u.supportsBinary&&b.useBinaryProtocol:u.preferBinary;
...
a&&a.succeeded||0;this.failed=a&&a.failed||0;this.refused=a&&a.refused||0}function a(a){this.plain=new d(a&&a.plain);this.tls=new d(a&&a.tls);this.all=new d(a&&a.all)}function c(a){this.messages=new b(a&&a.messages);this.presence=new b(a&&a.presence);this.all=new b(a&&a.all)}function h(a){this.realtime=new c(a&&a.realtime);this.rest=new c(a&&a.rest);this.webhook=new c(a&&a.webhook);this.sharedQueue=new c(a&&a.sharedQueue);this.externalQueue=new c(a&&a.externalQueue);this.httpEvent=new c(a&&a.httpEvent);
this.push=new c(a&&a.push);this.all=new c(a&&a.all)}function e(a){this.all=new c(a&&a.all);this.inbound=new h(a&&a.inbound);this.outbound=new h(a&&a.outbound)}function m(a){this.all=new c(a&&a.all);this.producerPaid=new e(a&&a.producerPaid);this.consumerPaid=new e(a&&a.consumerPaid)}function t(a){this.messages=a&&a.messages||0;var g=a&&a.notifications;this.notifications={invalid:g&&g.invalid||0,attempted:g&&g.attempted||0,successful:g&&g.successful||0,failed:g&&g.failed||0};this.directPublishes=a&&
a.directPublishes||0}function k(g){e.call(this,g);this.persisted=new c(g&&g.persisted);this.connections=new a(g&&g.connections);this.channels=new d(g&&g.channels);this.apiRequests=new f(g&&g.apiRequests);this.tokenRequests=new f(g&&g.tokenRequests);this.xchgProducer=new m(g&&g.xchgProducer);this.xchgConsumer=new m(g&&g.xchgConsumer);this.push=new t(g&&g.pushStats);this.inProgress=g&&g.inProgress||void 0;this.unit=g&&g.unit||void 0;this.intervalId=g&&g.intervalId||void 0}k.fromValues=function(a){return new k(a)};
...
b.fromValues=function(d){return h.mixin(new b,d)};b.fromValuesArray=function(d){for(var f=d.length,a=Array(f),c=0;c<f;c++)a[c]=b.fromValues(d[c]);return a};return b}(),N={disconnected:q.fromValues({statusCode:400,code:80003,message:"Connection to server temporarily unavailable"}),suspended:q.fromValues({statusCode:400,code:80002,message:"Connection to server unavailable"}),failed:q.fromValues({statusCode:400,code:8E4,message:"Connection failed or disconnected by server"}),closing:q.fromValues({statusCode:400,
code:80017,message:"Connection closing"}),closed:q.fromValues({statusCode:400,code:80017,message:"Connection closed"}),unknownConnectionErr:q.fromValues({statusCode:500,code:50002,message:"Internal connection error"}),unknownChannelErr:q.fromValues({statusCode:500,code:50001,message:"Internal channel error"})},ha=function(){function b(){A.call(this);this.messages=[]}h.inherits(b,A);b.prototype.count=function(){return this.messages.length};b.prototype.push=function(b){this.messages.push(b)};b.prototype.shift=
function(){return this.messages.shift()};b.prototype.last=function(){return this.messages[this.messages.length-1]};b.prototype.copyAll=function(){return this.messages.slice()};b.prototype.append=function(b){this.messages.push.apply(this.messages,b)};b.prototype.prepend=function(b){this.messages.unshift.apply(this.messages,b)};b.prototype.completeMessages=function(b,f,a){d.logAction(d.LOG_MICRO,"MessageQueue.completeMessages()","serial = "+b+"; count = "+f);a=a||null;var c=this.messages,h=c[0];if(h){h=
h.message.msgSerial;b+=f;if(b>h)for(b=c.splice(0,b-h),f=0;f<b.length;f++)b[f].callback(a);0==c.length&&this.emit("idle")}};b.prototype.completeAllMessages=function(b){this.completeMessages(0,Number.MAX_SAFE_INTEGER||Number.MAX_VALUE,b)};b.prototype.clear=function(){d.logAction(d.LOG_MICRO,"MessageQueue.clear()","clearing "+this.messages.length+" messages");this.messages=[];this.emit("idle")};return b}(),ia=function(){function b(b){A.call(this);this.transport=b;this.messageQueue=new ha;var a=this;
...
function(){return this.messageQueue.clear()};b.prototype.finish=function(){var b=this.transport;this.onceIdle(function(){b.disconnect()})};b.PendingMessage=function(b,a){this.message=b;this.callback=a;this.merged=!1;var c=b.action;this.sendAttempted=!1;this.ackRequired=c==l.MESSAGE||c==l.PRESENCE};return b}(),Q=function(){function b(){}function l(a,c){return h.arrIndexOf(t,a.shortName)>h.arrIndexOf(t,c.shortName)}function f(a,c,b,e){this.options=a;this.host=c;this.mode=b;this.connectionKey=e;this.format=
...
function(a,c){var g=c.mode;d.logAction(d.LOG_MINOR,"ConnectionManager.setTransportPending()","transport = "+a+"; mode = "+g);h.arrDeleteValue(this.proposedTransports,a);this.pendingTransports.push(a);var b=this;a.once("connected",function(e,d,f,p){"upgrade"==g&&b.activeProtocol?a.shortName!==k&&h.arrIn(b.getUpgradePossibilities(),k)?setTimeout(function(){b.scheduleTransportActivation(e,a,d,f,p)},b.options.timeouts.parallelUpgradeDelay):b.scheduleTransportActivation(e,a,d,f,p):(b.activateTransport(e,
a,d,f,p),h.nextTick(function(){b.connectImpl(c)}));"recover"===g&&b.options.recover&&(b.options.recover=null,b.unpersistConnection())});a.on(["disconnected","closed","failed"],function(c){b.deactivateTransport(a,this.event,c)});this.emit("transport.pending",a)};a.prototype.scheduleTransportActivation=function(a,c,b,e,f){function g(){c.disconnect();h.arrDeleteValue(k.pendingTransports,c)}var k=this,p=this.activeProtocol&&this.activeProtocol.getTransport();this.state!==this.states.connected&&this.state!==
...
k.state=k.states.synchronizing;var m=k.activeProtocol}else if(k.state!==k.states.connecting){d.logAction(d.LOG_MINOR,"ConnectionManager.scheduleTransportActivation()","Current connection state ("+k.state.state+(k.state===k.states.synchronizing?", but with an upgrade already in progress":"")+") is not valid to upgrade in; abandoning upgrade to "+c.shortName);g();return}var h=(p=b!==k.connectionId)?f:k;p&&d.logAction(d.LOG_ERROR,"ConnectionManager.scheduleTransportActivation()","Upgrade resulted in new connectionId; resetting library connection position from "+
...
"disconnected"===c&&b&&500<b.statusCode&&1<this.httpHosts.length?(this.unpersistTransportPreference(),this.forceFallbackHost=!0,this.notifyState({state:c,error:b,retryImmediately:!0})):(a="failed"===c&&P.isTokenErr(b)?"disconnected":c,this.notifyState({state:a,error:b})):e&&"disconnected"===c&&this.state!==this.states.synchronizing&&(d.logAction(d.LOG_MICRO,"ConnectionManager.deactivateTransport()","wasActive but another transport is connected and scheduled for activation, so going into the connecting state until it activates"),
...
new W(this.state.state,g.state,null,a.error||N[g.state]);this.enactStateChange(a);"connecting"==c&&h.nextTick(function(){b.startConnect()});"closing"==c&&this.closeImpl()}};a.prototype.startConnect=function(){if(this.state!==this.states.connecting)d.logAction(d.LOG_MINOR,"ConnectionManager.startConnect()","Must be in connecting state to connect, but was "+this.state.state);else{var a=this.realtime.auth,c=this,b=++this.connectCounter,e=function(){c.checkConnectionStateFreshness();c.getTransportParams(function(a){b===
c.connectCounter&&c.connectImpl(a,b)})};d.logAction(d.LOG_MINOR,"ConnectionManager.startConnect()","starting connection");this.startSuspendTimer();this.startTransitionTimer(this.states.connecting);if("basic"===a.method)e();else{var f=function(a){b===c.connectCounter&&(a?c.actOnErrorFromAuthorize(a):e())};this.errorReason&&P.isTokenErr(this.errorReason)?a._forceNewToken(null,null,f):a._ensureValidAuthCredentials(!1,f)}}};a.prototype.connectImpl=function(a,c){var b=this.state.state;b!==this.states.connecting.state&&
...
x.checkConnectivity(function(e,d){c===f.connectCounter&&(e?g(e):d?(a.host=h.arrPopRandomElement(k),f.tryATransport(a,f.baseTransport,b)):g(new q("Unable to connect (network unreachable)",8E4,404)))}):g(new q("Unable to connect (and no more fallback hosts to try)",8E4,404))}var f=this,k=this.httpHosts.slice();d.logAction(d.LOG_MINOR,"ConnectionManager.connectBase()","Trying to connect with base transport "+this.baseTransport);var m=k.shift();m?(a.host=m,this.forceFallbackHost&&k.length?(this.forceFallbackHost=
...
function(a){this.proposedTransports.push(a)};a.prototype.getTransportPreference=function(){return this.transportPreference||c&&M.get("ably-transport-preference")};a.prototype.persistTransportPreference=function(a){h.arrIn(r.upgradeTransports,a.shortName)&&(this.transportPreference=a.shortName,c&&M.set("ably-transport-preference",a.shortName))};a.prototype.unpersistTransportPreference=function(){this.transportPreference=null;c&&M.remove("ably-transport-preference")};a.prototype.actOnErrorFromAuthorize=
...
return b}();(function(){function b(b,a,c){this.shortName="web_socket";c.heartbeats=u.useProtocolHeartbeats;S.call(this,b,a,c);this.wsHost=r.getHost(c.options,c.host,!0)}var l=u.WebSocket;h.inherits(b,S);b.isAvailable=function(){return!!l};b.isAvailable()&&(Q.supportedTransports.web_socket=b);b.tryConnect=function(f,a,c,h){function e(a){h({event:this.event,error:a})}var m=new b(f,a,c);m.on(["failed","disconnected"],e);m.on("wsopen",function(){d.logAction(d.LOG_MINOR,"WebSocketTransport.tryConnect()",
...
function(a){b.onWsError(a)};if(g.on)g.on("ping",function(){b.onActivity()})}catch(p){d.logAction(d.LOG_ERROR,"WebSocketTransport.connect()","Unexpected exception creating websocket: err = "+(p.stack||p.message)),b.disconnect(p)}}}})};b.prototype.send=function(b){var a=this.wsConnection;if(a)try{a.send(z.serialize(b,this.params.format))}catch(c){b="Exception from ws connection when trying to send: "+h.inspectError(c),d.logAction(d.LOG_ERROR,"WebSocketTransport.send()",b),this.finish("disconnected",
...
function(){d.logAction(d.LOG_MINOR,"CometTransport.dispose()","");if(!this.isDisposed){this.isDisposed=!0;this.recvRequest&&(d.logAction(d.LOG_MINOR,"CometTransport.dispose()","aborting recv request"),this.recvRequest.abort(),this.recvRequest=null);this.finish("disconnected",N.disconnected);var b=this;h.nextTick(function(){b.emit("disposed")})}};l.prototype.onConnect=function(b){if(!this.isDisposed){var a=b.connectionKey;S.prototype.onConnect.call(this,b);a=this.baseUri+a;d.logAction(d.LOG_MICRO,
...
function(a){b.prototype[a]=function(b,d){var c=this;L[a](c.rest,c.path,c.headers,b,c.envelope,function(a,b,e,g,f){c.handlePage(a,b,e,g,f,d)})}});h.arrForEach(x.methodsWithBody,function(a){b.prototype[a]=function(b,d,e){var c=this;L[a](c.rest,c.path,d,c.headers,b,c.envelope,function(a,b,g,d,f){e&&c.handlePage(a,b,g,d,f,e)})}});b.prototype.handlePage=function(a,b,n,e,m,t){if(!a||this.useHttpPaginatedResponse&&(b||"number"===typeof a.code)){var c,g;try{var p=this.bodyHandler(b,n,e)}catch(D){t(a||D);
return}if(n&&(c=n.Link||n.link)){b=c;"string"==typeof b&&(b=b.split(","));e={};for(c=0;c<b.length;c++)if(g=b[c].match(/^\s*<(.+)>;\s*rel="(\w+)"$/)){var w;(w=(w=g[1].match(/^\.\/(\w+)\?(.*)$/))&&h.parseQueryString(w[2]))&&(e[g[2]]=w)}g=e}this.useHttpPaginatedResponse?t(null,new f(this,p,n,m,g,a)):t(null,new l(this,p,g))}else d.logAction(d.LOG_ERROR,"PaginatedResource.handlePage()","Unexpected error getting resource: err = "+h.inspectError(a)),t(a)};l.prototype.get=function(a,b){var c=this.resource;
L.get(c.rest,c.path,c.headers,a,c.envelope,function(a,d,f,k,g){c.handlePage(a,d,f,k,g,b)})};h.inherits(f,l);return b}(),P=function(){function b(){}function l(a){if(!h.isErrorInfo(a))return new q(h.inspectError(a),a.code||40170,a.statusCode||401);a.code||(403===a.statusCode?a.code=40300:(a.code=40170,a.statusCode=401));return a}function f(a){if(!a)return"";"string"==typeof a&&(a=JSON.parse(a));var b={},c=h.keysArray(a,!0);if(!c)return"";c.sort();for(var e=0;e<c.length;e++)b[c[e]]=a[c[e]].sort();return JSON.stringify(b)}
...
"application/x-www-form-urlencoded",f=h.toQueryString(m).slice(1),x.postUri(k,c.authUrl,g,f,{},e)):x.getUri(k,c.authUrl,g||{},m,e)};else if(c.key){var t=this;d.logAction(d.LOG_MINOR,"Auth.requestToken()","using token auth with client-side signing");m=function(a,b){t.createTokenRequest(a,c,b)}}else{d.logAction(d.LOG_ERROR,"Auth()","library initialized with a token literal without any way to renew the token when it expires (no authUrl, authCallback, or key). See https://help.ably.io/error/40171 for help");
e(new q("Need a new token, but authOptions does not include any way to request one (no authUrl, authCallback, or key)",40171,403));return}"capability"in a&&(a.capability=f(a.capability));var p=!1,r=this.client.options.timeouts.realtimeRequestTimeout,u=setTimeout(function(){p=!0;var a="Token request callback timed out after "+r/1E3+" seconds";d.logAction(d.LOG_ERROR,"Auth.requestToken()",a);e(new q(a,40170,401))},r);m(a,function(a,b,f){p||(clearTimeout(u),a?(d.logAction(d.LOG_ERROR,"Auth.requestToken()",
...
a.statusCode=500,d(a)))})};l.prototype.request=function(c,d,e,f,t,k){var g=this.options.useBinaryProtocol,m=g?a.encode:JSON.stringify,n=g?a.decode:JSON.parse,l=g?"msgpack":"json";g=x.supportsLinkHeaders?void 0:l;e=e||{};c=c.toLowerCase();l="get"==c?h.defaultGetHeaders(l):h.defaultPostHeaders(l);if(void 0===k){if(this.options.promises)return h.promisify(this,"request",arguments);k=b}"string"!==typeof f&&(f=m(f));this.options.headers&&h.mixin(l,this.options.headers);t&&h.mixin(l,t);m=new R(this,d,l,
g,function(a,b,c){return h.ensureArray(c?a:n(a))},!0);if(!h.arrIn(x.methods,c))throw new q("Unsupported method "+c,40500,405);if(h.arrIn(x.methodsWithBody,c))m[c](e,f,k);else m[c](e,k)};l.prototype.setLog=function(a){d.setLog(a.level,a.handler)};f.prototype.get=function(a,b){a=String(a);var c=this.attached[a];c?b&&c.setOptions(b):this.attached[a]=c=new Z(this.rest,a,b);return c};f.prototype.release=function(a){delete this.attached[String(a)]};return l}();F.Promise=function(b){b=r.objectifyOptions(b);
...
b)};l.prototype.history=function(a,c){d.logAction(d.LOG_MICRO,"RealtimeChannel.history()","channel = "+this.name);void 0===c&&("function"==typeof a?(c=a,a=null):c=b);if(a&&a.untilAttach){if("attached"!==this.state){c(new q("option untilAttach requires the channel to be attached",4E4,400));return}if(!this.properties.attachSerial){c(new q("untilAttach was specified and channel is attached, but attachSerial is not defined",4E4,400));return}delete a.untilAttach;a.from_serial=this.properties.attachSerial}Z.prototype._history.call(this,
a,c)};l.prototype.whenState=function(a,b){A.prototype.whenState.call(this,a,this.state,b)};return l}(),ra=function(){function b(){}function l(a){a=a.channel.realtime;var b=a.auth.clientId;return(!b||"*"===b)&&"connected"===a.connection.state}function f(a,b,c){switch(a.state){case "attached":case "suspended":c();break;case "initialized":case "detached":case "detaching":case "attaching":a.attach(function(a){a?b(a):c()});break;default:b(q.fromValues(V.invalidStateError(a.state)))}}function a(a){Y.call(this,
a);this.syncComplete=!1;this.members=new c(this);this._myMembers=new c(this);this.subscriptions=new A;this.pendingPresence=[]}function c(a){A.call(this);this.presence=a;this.map={};this.syncInProgress=!1;this.residualMembers=null}function n(a,b){if(a.isSynthesized()||b.isSynthesized())return a.timestamp>b.timestamp;var c=a.parseId(),d=b.parseId();return c.msgSerial===d.msgSerial?c.index>d.index:c.msgSerial>d.msgSerial}h.inherits(a,Y);a.prototype.enter=function(a,b){if(l(this))throw new q("clientId must be specified to enter a presence channel",
...
"Request.on"+a.type+"()",b);e.complete(new q(b,c,g))}function b(){B=u.responseText;for(var a=B.length-1,b,c;F<a&&-1<(b=B.indexOf("\n",F));){c=B.slice(F,b);F=b+1;a:{try{c=JSON.parse(c)}catch(la){e.complete(new q("Malformed response body from server: "+la.message,null,400));break a}e.emit("data",c)}}}function c(){b();e.streamComplete=!0;h.nextTick(function(){e.complete()})}var e=this,f=this.timer=setTimeout(function(){e.timedOut=!0;u.abort()},0==this.requestMode?this.timeouts.httpRequestTimeout:this.timeouts.recvTimeout),
l=this.body,n=this.method,r=this.headers,u=this.xhr=new XMLHttpRequest,v=r.accept,x="text";v?0===v.indexOf("application/x-msgpack")&&(x="arraybuffer"):r.accept="application/json";l&&-1<(r["content-type"]||(r["content-type"]="application/json")).indexOf("application/json")&&"string"!=typeof l&&(l=JSON.stringify(l));u.open(n,this.uri,!0);u.responseType=x;"authorization"in r&&(u.withCredentials=!0);for(var z in r)u.setRequestHeader(z,r[z]);u.onerror=function(b){a(b,"XHR error occurred",null,400)};u.onabort=
