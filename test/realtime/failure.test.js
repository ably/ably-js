...
define(['ably', 'shared_helper', 'async', 'chai'], function (Ably, helper, async, chai) {
  ...
  describe('realtime/failure', function () {
    ...
    it('failed_channel', function (done) {
      ...
      var tests = [
        function (callback) {
          ptcb(failChan.publish('event', 'data'), function (err) {
            try {
        ...
        function (callback) {
          ptcb(failChan.presence.enterClient('clientId'), function (err) {
            try {
        ...
        function (callback) {
          ptcb(failChan.presence.leaveClient('clientId'), function (err) {
            try {
        ...
        function (callback) {
          ptcb(failChan.presence.get(), function (err) {
            try {
      ...
      try {
        realtime.connection.once('connected', function () {
          ...
          ptcb(failChan.attach(), function (err) {
            try {
