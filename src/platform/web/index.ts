...
import { makeFromDeserializedWithDependencies } from '../../common/lib/types/protocolmessage';
...
export { DefaultRest as Rest, DefaultRealtime as Realtime, msgpack, makeFromDeserializedWithDependencies, ErrorInfo };
