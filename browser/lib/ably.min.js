(function() {
  ...
  V.prototype = {_2scomp:function() {
    ...
    for(var b = this.buffer, c = this.offset, f = b[0] & 128, h = 0, d = 1, e = 7, m = 1;0 <= e;e--, m *= 256) {
      var p = b[c + e];
      f && (p = (p ^ 255) + d, d = p >> 8, p &= 255);
      h += p * m
    }
    return!a && h >= V.MAX_INT ? f ? -Infinity : Infinity : f ? -h : h
  }, valueOf:function() {
  ...
  var za = {encode:function(a, b, c) {
    ...
    for(var f = "", h = b, c = c + b, b = c1 = c2 = 0;h < c;) {
      b = a.getInt8(h++), 128 > b ? f += String.fromCharCode(b) : 191 < b && 224 > b ? (c2 = a.getInt8(h++), f += String.fromCharCode((b & 31) << 6 | c2 & 63)) : (c2 = a.getInt8(h++), c3 = a.getInt8(h++), f += String.fromCharCode((b & 15) << 12 | (c2 & 63) << 6 | c3 & 63))
    }
    return f
  }}, C = function(a) {
    this.offset = 0;
  ...
  C.prototype = {getArray:function() {
    ...
    var a = a || 0, b = b || this.length, c = new C, f = c.length = b - a, h = c.offset = this.offset + a, d = c.buf = this.buf;
    c.view = new DataView(d, h, f);
    return c
  }, getInt8:function(a) {
  ...
  Ba.receiver = function(a) {
    var b = 0, c = 0, f = null, h = null;
    return function(d) {
      if(h) {
        var e = new C(d.length + h.length);
        h.copy(e, 0, 0);
        d.copy(e, h.length, 0);
        h = null
      }
  ...
  var G = {TAction:TAction, TType:TType, TData:R, TPresence:X, TMessage:Y, TChannelMessage:Z, TMessageSet:da}, S, $ = function() {
    ...
    if(typeof D.addEventListener != r) {
      D.addEventListener("load", a, !1)
    }else {
      if(typeof l.addEventListener != r) {
        l.addEventListener("load", a, !1)
      }else {
        if(typeof D.attachEvent != r) {
          var b = D;
    ...
    if(0 < a) {
      for(var b = 0;b < a;b++) {
        ...
        if(0 < g.pv[0]) {
          var e = H(c);
          if(e) {
            if(la(M[b].swfVersion) && !(g.wk && 312 > g.wk)) {
              ...
              if(M[b].expressInstall && Da()) {
                ...
                for(var q = {}, e = e.getElementsByTagName("param"), m = e.length, p = 0;p < m;p++) {
                  "movie" != e[p].getAttribute("name").toLowerCase() && (q[e[p].getAttribute("name")] = e[p].getAttribute("value"))
                }
                Ea(d, q, c, f)
              }else {
                lb(e), f && f(d)
          ...
          if(U(c, !0), f) {
            if((c = Ca(c)) && typeof c.SetVariable != r) {
              d.success = !0, d.ref = c
            }
            f(d)
          }
    ...
    if((a = H(a)) && "OBJECT" == a.nodeName) {
      typeof a.SetVariable != r ? b = a : (a = a.getElementsByTagName(J)[0]) && (b = a)
    }
    return b
  }, Da = function() {
    return!ma && la("6.0.65") && (g.win || g.mac) && !(g.wk && 312 > g.wk)
  }, Ea = function(a, b, c, f) {
    ma = !0;
    Ga = f || null;
    Ua = {success:!1, id:c};
    ...
    if(d) {
      if(typeof a.id == r && (a.id = c), g.ie && g.win) {
        ...
        q = "";
        for(var m in b) {
          b[m] != Object.prototype[m] && (q += '<param name="' + m + '" value="' + b[m] + '" />')
        }
        ...
        m = l.createElement(J);
        m.setAttribute("type", pa);
        for(var p in a) {
          a[p] != Object.prototype[p] && ("styleclass" == p.toLowerCase() ? m.setAttribute("class", a[p]) : "classid" != p.toLowerCase() && m.setAttribute(p, a[p]))
        }
        for(e in b) {
          b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = m, q = e, p = b[e], c = l.createElement("param"), c.setAttribute("name", q), c.setAttribute("value", p), a.appendChild(c))
        }
    ...
    if(!g.ie || !g.mac) {
      ...
      if(d) {
        ...
        f && (Ja = K = null);
        if(!K || Ja != c) {
          f = l.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), K = d.appendChild(f), g.ie && (g.win && typeof l.styleSheets != r && 0 < l.styleSheets.length) && (K = l.styleSheets[l.styleSheets.length - 1]), Ja = c
        }
        g.ie && g.win ? K && typeof K.addRule == J && K.addRule(a, b) : K && typeof l.createTextNode != r && K.appendChild(l.createTextNode(a + " {" + b + "}"))
      }
    }
  }, U = function(a, b) {
    if(Ya) {
  ...
  }, r = "undefined", J = "object", pa = "application/x-shockwave-flash", Va = "SWFObjectExprInst", D = window, l = document, N = navigator, $a = !1, ka = [function() {
    if($a) {
  ...
  }], M = [], oa = [], aa = [], ea, na, Ga, Ua, T = !1, ma = !1, K, Ja, Ya = !0, g, mb = typeof l.getElementById != r && typeof l.getElementsByTagName != r && typeof l.createElement != r, qa = N.userAgent.toLowerCase(), ra = N.platform.toLowerCase(), nb = ra ? /win/.test(ra) : /win/.test(qa), ob = ra ? /mac/.test(ra) : /mac/.test(qa), pb = /webkit/.test(qa) ? parseFloat(qa.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Ka = !+"\v1", fa = [0, 0, 0], A = null;
  if(typeof N.plugins != r && typeof N.plugins["Shockwave Flash"] == J) {
    if((A = N.plugins["Shockwave Flash"].description) && !(typeof N.mimeTypes != r && N.mimeTypes[pa] && !N.mimeTypes[pa].enabledPlugin)) {
  ...
  g = {w3:mb, pv:fa, wk:pb, ie:Ka, win:nb, mac:ob};
  g.w3 && ((typeof l.readyState != r && "complete" == l.readyState || typeof l.readyState == r && (l.getElementsByTagName("body")[0] || l.body)) && $(), T || (typeof l.addEventListener != r && l.addEventListener("DOMContentLoaded", $, !1), g.ie && g.win && (l.attachEvent("onreadystatechange", function() {
  ...
  S = {registerObject:function(a, b, c, f) {
  ...
  }, embedSWF:function(a, b, c, f, d, e, q, m, p, i) {
    var j = {success:!1, id:b};
    g.w3 && !(g.wk && 312 > g.wk) && a && b && c && f && d ? (U(b, !1), Sa(function() {
      c += "";
      f += "";
      var g = {};
      if(p && typeof p === J) {
      ...
      if(q && typeof q === J) {
        for(var n in q) {
          k.flashvars = typeof k.flashvars != r ? k.flashvars + ("&" + n + "=" + q[n]) : n + "=" + q[n]
        }
      }
      if(la(d)) {
        l = Ia(g, k, b), g.id == b && U(b, !0), j.success = !0, j.ref = l
      }else {
        if(e && Da()) {
          g.data = e;
          Ea(g, k, b, i);
    ...
    if(ma) {
      var a = H(Va);
      a && ea && (a.parentNode.replaceChild(ea, a), na && (U(na, !0), g.ie && g.win && (ea.style.display = "block")), Ga && Ga(Ua));
      ma = !1
    }
  }};
  var sa;
  ...
  s.prototype.chooseTransport = function(a) {
    if(this.transport) {
      ...
      var b = this, c = this.transports.slice(), f = function(a) {
        var d = c.shift();
        d ? (e.logAction(e.LOG_MICRO, "ConnectionManager.chooseTransport()", "trying " + d), s.availableTransports[d].tryConnect(b, b.realtime.auth, b.options, function(c, g) {
          c ? f(a) : (e.logAction(e.LOG_MICRO, "ConnectionManager.chooseTransport()", "transport " + d + " connecting"), b.setupTransport(g), a(g))
        })) : a(null)
      };
      f(a)
    }
  ...
  u.prototype.connect = function() {
    ...
    this.auth.getAuthParams(function(c, f) {
      ...
      if(c) {
        ...
        try {
          var i = a.wsConnection = a.createWebSocket(b, f);
          i.binaryType = "arraybuffer";
          i.onopen = function() {
            a.onWsOpen()
          };
          i.onclose = function(b, c) {
            a.onWsClose(b, c)
          };
  ...
  u.prototype.onWsData = function(a, b) {
    var c = b ? new ua.TBinaryProtocol(new ua.TTransport(a)) : new ua.TJSONProtocol(new ua.TStringTransport(a)), f = new vb.TChannelMessage;
    try {
  ...
  B.tryConnect = function(a, b, c, d) {
    var h = new B(a, b, c), g = function(a) {
      d(a)
    };
    h.on("error", g);
  ...
  B.Request = function(a, b, c, d, e, g) {
    var a = v.paramStr(b, a), i;
    c ? (b = "POST", i = 201) : (b = "GET", i = 200);
    var m = this.xhr = eb();
    ...
    m.open(b, a, !0);
    m.setRequestHeader("Accept", e ? "application/x-thrift" : "application/json");
    m.onreadystatechange = function() {
      if(4 == m.readyState) {
        clearTimeout(k);
        var a = null;
        m.status != i ? (a = Error("Unexpected response: statusCode = " + m.status), a.statusCode = m.status, a.statusText = m.statusText, g(a)) : (a = null, e ? m.response && (a = new C, a.buf = m.response, a.view = new DataView(a.buf)) : a = m.responseText, g(null, a))
      }
    };
    m.send(c)
  };
  ...
  F.tryConnect = function(a, b, c, d) {
    var h = new F(a, b, c), g = function(a) {
      d(a)
    };
    h.on("error", g);
    h.on("preconnect", function() {
  ...
  F.Request = function(a, b, c, d, e) {
    var g = Ably._;
    this.callback = e;
    var i = this.requestId = wb++, k = this.timer = setTimeout(d ? 9E4 : 1E4, function() {
      l.abort()
    });
    ...
    j.src = v.paramStr(b, a);
    var l = this;
    Ably._["_" + i] = function(a) {
      clearTimeout(k);
      delete g["_" + i];
      l.aborted || (j.parentNode.removeChild(j), e(null, a))
    };
  ...
  P.prototype.get = function(a, b) {
    ...
    c.auth.getAuthHeaders(function(e, g) {
      e ? b(e) : Http.get(d, k.mixin(g, c.headers), a, b)
    })
  };
  P.prototype.post = function(a, b, c) {
    2 == arguments.length && "function" == typeof b && (c = b, b = null);
    var d = this.rest, e = this.uri;
    d.auth.getAuthHeaders(function(g, i) {
      g ? c(g) : Http.post(e, k.mixin(i, d.headers), a, b, c)
    })
  };
  var yb = function() {
  }, zb = function(a) {
  ...
  Oa && (window.CryptoJS && CryptoJS.HmacSHA1 && CryptoJS.enc.Base64) && (va = function(a, b) {
    return CryptoJS.HmacSHA1(a, b).toString(CryptoJS.enc.Base64)
  });
  Oa || (va = function(a, b) {
    var c = Ab.createHmac("SHA1", b);
    c.update(a);
  ...
  ba.prototype.requestToken = function(a, b) {
    ...
    var h = {}, g = a.client_id || this.rest.clientId;
    g && (h.client_id = g);
    g = a.expires || "";
    "expires" in a && (h.expires = g);
    "capability" in a && (h.capability = zb(a.capability));
    d = this;
    c(h, function(a, c) {
      if(a) {
        ...
        Http.post ? Http.post(d.tokenUri, null, c, null, h) : Http.get(d.tokenUri, null, c, h)
      }
    })
  };
  ...
  var Pa = function(a) {
    if("string" == typeof a) {
      a = a.split(":");
      if(3 > a.length) {
        throw Error("Realtime(): invalid key");
      }
      a = {appId:a[0], key:a[1] + ":" + a[2]}
    }
    this.options = a = a || {};
  ...
  I.prototype.setPresence = function(a, b) {
    e.logAction(e.LOG_MICRO, "Presence.setPresence()", "received presence for " + a.length + " participants; channel = " + this.channel.name + ", client = " + g);
    for(var c = 0;c < a.length;c++) {
      var d = a[c], h = void 0, g = d.clientId;
      "leave" == d.state ? delete this.clients[g] : h = this.clients[g] = ja.getPayload(d.clientData);
      b && this.emit(d.state, g, h)
    }
  };
  ...
  var ja, Qa = function(a, b, c, d) {
    ...
    this.name = c;
    this.data = d
  }, x = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), Db = {"[object Null]":function(a) {
    a.type = x.TType.NONE;
    return!0
  ...
  Qa.createPayload = function(a) {
    var b = new x.TData, c = Eb[typeof a];
    if(c && c(b, a)) {
      return b
    }
