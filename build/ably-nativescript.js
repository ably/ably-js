...
const eventemitter_1 = tslib_1.__importDefault(__webpack_require__(3388));
const logger_1 = tslib_1.__importDefault(__webpack_require__(1597));
const annotation_1 = tslib_1.__importDefault(__webpack_require__(9327));
...
class RealtimeAnnotations {
    ...
    async publish(refSerial, refType, data) {
        ...
        const annotation = annotation_1.default.fromValues({
        ...
        logger_1.default.logAction(this.logger, logger_1.default.LOG_MICRO, 'RealtimeAnnotations.publish()', 'channelName = ' + channelName + ', sending annotation with refSerial = ' + refSerial + ', refType = ' + refType);
    ...
    async subscribe(..._args /* [refType], listener */) {
...
class RestAnnotations {
    ...
    async publish(refSerial, refType, data) {
        ...
        await resource_1.default.post(client, basePathForSerial(this.channel, refSerial), requestBody, headers, params, null, true);
    }
    async get(serial, params) {
...
class DefaultAnnotation extends annotation_1.default {
    static async fromEncoded(encoded, inputOptions) {
        return (0, annotation_1.fromEncoded)(logger_1.default.defaultLogger, platform_1.default.Crypto, encoded, inputOptions);
    }
    static async fromEncodedArray(encodedArray, options) {
        return (0, annotation_1.fromEncodedArray)(logger_1.default.defaultLogger, platform_1.default.Crypto, encodedArray, options);
    }
    static fromValues(values) {
