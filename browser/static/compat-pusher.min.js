...
process.nextTick;var f={json:"application/json",jsonp:"application/javascript",xml:"application/xml",html:"text/html",msgpack:"application/x-msgpack"};b.defaultGetHeaders=function(a){a=a||"json";return{accept:"json"===a?f.json:f[a]+","+f.json,"X-Ably-Version":Defaults.apiVersion,"X-Ably-Lib":Defaults.libstring}};b.defaultPostHeaders=function(a){a=a||"json";return{accept:"json"===a?f.json:f[a]+","+f.json,"content-type":"json"===a?f.json:f[a],"X-Ably-Version":Defaults.apiVersion,"X-Ably-Lib":Defaults.libstring}};
b.arrPopRandomElement=function(a){return a.splice(Math.floor(Math.random()*a.length),1)[0]};b.toQueryString=function(a){var b=[];if(a)for(var e in a)b.push(encodeURIComponent(e)+"="+encodeURIComponent(a[e]));return b.length?"?"+b.join("&"):""};b.parseQueryString=function(a){for(var b,e=/([^?&=]+)=?([^&]*)/g,c={};b=e.exec(a);)c[decodeURIComponent(b[1])]=decodeURIComponent(b[2]);return c};b.now=Date.now||function(){return(new Date).getTime()};b.inspect=function(a){return JSON.stringify(a)};b.inspectError=
function(a){return a&&"ErrorInfo"==a.constructor.name?a.toString():b.inspect(a)};b.randStr=function(){return String(Math.random()).substr(2)};return b}();(function(){function b(a,b){var c=b.host||"",d=b.tlshost||"",k={key:a,tls:b.encrypted||!1,log:{level:4}};b.ablyClientId&&(k.clientId=b.ablyClientId);b.authEndpoint&&(k.authUrl=b.authEndpoint);b.auth&&b.auth.params&&(k.authParams=b.auth.params);b.auth&&b.auth.headers&&(k.authHeaders=b.auth.headers);c&&0!=c.length&&(c=c.split(":"),k.realtimeHost=k.restHost=
c[0],1<c.length&&(k.port=c[1]));d&&0!=d.length&&(c=d.split(":"),1<c.length&&(k.tlsPort=c[1]));d=this.ably=new (e||window.Ably).Realtime(k);this.clientId=k.clientId;this.connection=new g(d.connection);this.channels={}}function g(a){m.call(this);this.connection=a;var b=this;a.on(function(a){var c=n[a.previous],d=b.state=n[a.current];b.emit(d);b.emit("state_change",{previous:c,current:d});a.retryIn&&b.emit("connecting_in",a.retryIn)})}function f(a,b){var c=this;this.active=!0;this.channel=a.ably.channels.get(b);
this.name=b;if(this.isPresence=0==b.indexOf("presence-"))this.members=new d(this,a.clientId);this.channel.subscribe(function(a){JSON.stringify(this);JSON.stringify(a);c.channel.emit(a.name,a.data)});this.bindings={};this.bind_alls=[];if(this.isPresence){var e=this.channel.presence;this.entered=!1;e.subscribe("enter",function(a){c.entered&&a.clientId!==c.members.myID&&(a=c.members.addMember(a.clientId,a.clientInfo))&&c.channel.emit("pusher:member_added",a)});e.subscribe("leave",function(a){c.entered&&
(a=c.members.removeMember(a.clientId))&&c.channel.emit("pusher:member_removed",a)});e.enter(function(a){if(a=e.get())for(var b=0;b<a.length;b++)c.members.addMember(a[b].clientId,a[b].clientData);c.entered=!0;c._sendEvent("pusher:subscription_succeeded",c.members)})}this.channel.on(function(a){"attached"===this.event&&c.isPresence||("undefined"===typeof a&&(a={}),c._sendEvent(r[this.event]||this.event,a))})}function a(a,b){this.id=a;this.info=b}function d(a,b,c){this.count=0;this.members={};b&&(this.myID=
