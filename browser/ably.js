(function() {
  var UIMessages = {FAIL_REASON_DISCONNECTED:"Connection to server temporarily unavailable", FAIL_REASON_SUSPENDED:"Connection to server unavailable", FAIL_REASON_FAILED:"Connection failed or disconnected by server", FAIL_REASON_CLOSED:"Connection closed by client", FAIL_REASON_REFUSED:"Connection refused by the server", FAIL_REASON_DETACHED:"Channel not attached", FAIL_REASON_UNKNOWN:"Channel not attached"};
  var Defaults = {protocolVersion:1, HOST:"rt0.ably.io", HOST_CDN:"localhost", HOST_DEBUG:"sandbox.ably.io", PATH:"/", HTTP_PORT:8092, HTTPS_PORT:443, WS_PORT:8080, WSS_PORT:443, STATIC_PATH:"/", connectTimeout:2E4, disconnectTimeout:6E4, suspendedTimeout:12E4, cometRecvTimeout:9E4, cometSendTimeout:1E4, transports:["web_socket", "flash_socket", "xhr", "jsonp"]};
  ...
  var MASK31 = 2147483647, VAL31 = 2147483648;
  var MASK32 = 4294967295, VAL32 = 4294967296;
  var _HEX = [];
  for(var i = 0;i < 256;i++) {
  ...
  Int64.prototype = {_2scomp:function() {
    ...
    var b = this.buffer, o = this.offset;
    var negate = b[0] & 128, x = 0, carry = 1;
  ...
  var Thrift = {Version:"0.8.0", Type:{"STOP":0, "VOID":1, "BOOL":2, "BYTE":3, "I08":3, "DOUBLE":4, "I16":6, "I32":8, "I64":10, "STRING":11, "UTF7":11, "STRUCT":12, "MAP":13, "SET":14, "LIST":15, "UTF8":16, "UTF16":17}, MessageType:{"CALL":1, "REPLY":2, "EXCEPTION":3}, objectLength:function(obj) {
    var length = 0;
    for(var k in obj) {
  ...
  Thrift.TApplicationExceptionType = {"UNKNOWN":0, "UNKNOWN_METHOD":1, "INVALID_MESSAGE_TYPE":2, "WRONG_METHOD_NAME":3, "BAD_SEQUENCE_ID":4, "MISSING_RESULT":5, "INTERNAL_ERROR":6, "PROTOCOL_ERROR":7};
  ...
  Thrift.TXHRTransport.prototype = {getXmlHttpRequestObject:function() {
    try {
    ...
    var jqXHR = jQuery.ajax({url:this.url, data:postData, type:"POST", cache:false, dataType:"text", context:this, success:this.jqResponse, error:function(xhr, status, e) {
  ...
  Thrift.TStringTransport.prototype = {flush:function() {
    if(this.onFlush) {
  ...
  Thrift.Protocol.prototype = {getTransport:function() {
  ...
  Thrift.TJSONProtocol.prototype = {reset:function() {
    this.elementStack = []
  }, writeMessageBegin:function(name, messageType, seqid) {
    ...
    var map = {value:[Thrift.TJSONProtocol.Type[keyType], Thrift.TJSONProtocol.Type[valType], size]};
    this.elementStack.unshift(map)
  }, writeMapEnd:function() {
    var map = this.elementStack.shift();
    this.elementStack[0].value.push(map.value)
  }, writeListBegin:function(elemType, size) {
    var list = {name:name, value:[Thrift.TJSONProtocol.Type[elemType], size]};
    this.elementStack.unshift(list)
  }, writeListEnd:function() {
    var list = this.elementStack.shift();
    this.elementStack[0].value.push(list.value)
  }, writeSetBegin:function(elemType, size) {
    var set = {name:name, value:[Thrift.TJSONProtocol.Type[elemType], size]};
    ...
    this.elementStack.unshift({fields:fields, value:value});
    return{fname:""}
  }, readStructEnd:function() {
    ...
    for(var soleMember in fieldValue) {
      ...
      return{fname:"", fid:Number(fid), ftype:Thrift.Protocol.RType[soleMember]}
    }
    ...
    var result = {ktype:Thrift.Protocol.RType[value.shift()], vtype:Thrift.Protocol.RType[value.shift()], size:value.shift()};
    ...
    var scope = this.elementStack[0];
    var value = Thrift.TJSONProtocol.getValueFromScope(scope);
    var result = {etype:Thrift.Protocol.RType[value.shift()], size:value.shift()};
    this.elementStack.unshift({listvalue:value});
    return result
  }, readListEnd:function() {
    this.elementStack.shift()
  ...
  var Utf8 = {encode:function(string, view, off) {
    var pos = off;
  ...
  Buffer.prototype = {getArray:function() {
    if(!this.array) {
  ...
  inherits(CheckedBuffer, Buffer, {grow:function(extra) {
    extra = extra || 0;
  ...
  var UNKNOWN = 0, INVALID_DATA = 1, NEGATIVE_SIZE = 2, SIZE_LIMIT = 3, BAD_VERSION = 4;
  ...
  var VERSION_MASK = -65536, VERSION_1 = -2147418112, TYPE_MASK = 255;
  ...
  TTransport.prototype = {commitPosition:function() {
  ...
  TFramedTransport.receiver = function(callback) {
    var frameLeft = 0, framePos = 0, frame = null;
    var residual = null;
    return function(data) {
      if(residual) {
  ...
  inherits(TFramedTransport, TTransport, {flush:function() {
    var that = this;
  ...
  var clientmessage_types = {TData:TData, TPresence:TPresence, TMessage:TMessage, TChannelMessage:TChannelMessage, TMessageSet:TMessageSet};
  ...
  var clientmessage_refs = {TAction:TAction, TType:TType, TData:TData, TPresence:TPresence, TMessage:TMessage, TChannelMessage:TChannelMessage, TMessageSet:TMessageSet};
  ...
  var FlashWebSocket = function() {
    ...
    var __swfLocation = protocol + "//" + Defaults.HOST_CDN + ":" + (protocol == "https:" ? Defaults.HTTPS_PORT : Defaults.HTTP_PORT) + Defaults.STATIC_PATH + "WebSocketMainInsecure.swf";
    ...
    WebSocket.__initialize = function() {
      ...
      swfobject.embedSWF(__swfLocation, "webSocketFlash", "1", "1", "10.0.0", null, null, {hasPriority:true, swliveconnect:true, allowScriptAccess:"always"}, null, function(e) {
        if(!e.success) {
  ...
  var Logger = function() {
    ...
    var LOG_DEFAULT = LOG_MINOR, LOG_DEBUG = LOG_MICRO;
  ...
  var Utils = function() {
    ...
    Utils.nextTick = isBrowser ? function(f) {
      setTimeout(f, 0)
    } : process.nextTick;
    var contentTypes = {json:"application/json", jsonp:"application/javascript", xml:"application/xml", html:"text/html"};
  ...
  var ConnectionManager = function() {
    ...
    var states = {initialized:{state:"initialized", terminal:false, queueEvents:true, sendEvents:false}, connecting:{state:"connecting", terminal:false, queueEvents:true, sendEvents:false, retryDelay:Defaults.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:false, queueEvents:false, sendEvents:true, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:false, queueEvents:true, sendEvents:false, retryDelay:Defaults.disconnectTimeout, defaultMessage:UIMessages.FAIL_REASON_DISCONNECTED}, 
    suspended:{state:"suspended", terminal:false, queueEvents:false, sendEvents:false, retryDelay:Defaults.suspendedTimeout, defaultMessage:UIMessages.FAIL_REASON_SUSPENDED}, closed:{state:"closed", terminal:false, queueEvents:false, sendEvents:false, defaultMessage:UIMessages.FAIL_REASON_CLOSED}, failed:{state:"failed", terminal:true, queueEvents:false, sendEvents:false, defaultMessage:UIMessages.FAIL_REASON_FAILED}};
  ...
  var WebSocketTransport = function() {
    ...
    WebSocketTransport.prototype.connect = function() {
      ...
      this.auth.getAuthParams(function(err, params) {
        ...
        try {
          ...
          wsConnection.onclose = function(ev, wsReason) {
            self.onWsClose(ev, wsReason)
          };
          wsConnection.onmessage = function(ev) {
            self.onWsData(ev.data, typeof ev.data != "string")
          };
    ...
    WebSocketTransport.prototype.onWsData = function(data, binary) {
      var protocol = binary ? new thrift.TBinaryProtocol(new thrift.TTransport(data)) : new thrift.TJSONProtocol(new thrift.TStringTransport(data));
  ...
  var XHRTransport = function() {
    ...
    XHRTransport.Request = function(uri, params, body, expectToBlock, binary, callback) {
      ...
      if(body) {
        method = "POST", successCode = 201
      }else {
        method = "GET", successCode = 200
      }
      ...
      var timer = setTimeout(timeout, function() {
        xhr.abort()
      });
  ...
  var JSONPTransport = function() {
    ...
    JSONPTransport.Request = function(uri, params, body, expectToBlock, callback) {
      ...
      var timeout = expectToBlock ? Defaults.cometRecvTimeout : Defaults.cometSendTimeout;
      var timer = this.timer = setTimeout(timeout, function() {
        self.abort()
      });
      ...
      if(options.auth_callback) {
        ...
        if(options.auth_url) {
          ...
          if(options.key) {
            ...
            tokenRequestCallback = function(params, cb) {
              self.createTokenRequest(Utils.mixin(Utils.copy(options), params), cb)
            }
          }else {
      ...
      (function(authoriseCb) {
        ...
        if(options.queryTime) {
          rest.time(function(err, time) {
            ...
            options.timestamp = Math.floor(time / 1E3);
            authoriseCb()
          });
          return
        }
  ...
  var RealtimeChannel = function() {
    ...
    var defaultOptions = {queueEvents:true};
    ...
    RealtimeChannel.prototype.subscribeForEvent = function(name, listener, callback) {
      ...
      var msg = new messagetypes.TChannelMessage({action:messagetypes.TAction.SUBSCRIBE, channel:this.name, name:name});
      this.sendMessage(msg, noop)
    };
    ...
    RealtimeChannel.prototype.unsubscribeForEvent = function(name, listener, callback) {
      ...
      var msg = new messagetypes.TChannelMessage({action:messagetypes.TAction.UNSUBSCRIBE, channel:this.name, name:name});
      this.sendMessage(msg, noop)
    };
        ...
        case 13:
          ...
          if(tMessages) {
            ...
            for(var i in tMessages) {
              ...
              messages[i] = new Message(tMessage.channelSerial, tMessage.timestamp, tMessage.name, Message.getPayload(tMessage.payload))
            }
  ...
  var Presence = function() {
    ...
    Presence.prototype.enterClient = function(clientId, clientData, callback) {
      ...
      var presence = new messagetypes.TPresence({state:messagetypes.TPresenceState.ENTER, clientId:this.clientId});
      presence.clientData = Channel.createPayload(clientData);
      if(this.channel.state == "pending") {
        this.pendingPresence = {presence:"enter", callback:callback}
      }else {
    ...
    Presence.prototype.leaveClient = function(clientId, callback) {
      ...
      var presence = new messagetypes.TPresence({state:messagetypes.TPresenceState.LEAVE, clientId:this.channel.ably.options.clientId});
      if(this.channel.state == "subscribed") {
        this.channel.sendPresence(presence, callback)
      }else {
        if(this.channel.state == "pending") {
          this.pendingPresence = {presence:"leave", callback:callback}
        }else {
  ...
  var Message = function() {
    var messagetypes = typeof clientmessage_refs == "object" ? clientmessage_refs : require("../nodejs/lib/protocol/clientmessage_types");
    var resolveObjects = {"[object Null]":function(msg, data) {
    ...
    var resolveTypes = {"undefined":function(msg, data) {
      msg.type = messagetypes.TType.NONE;
      return true
