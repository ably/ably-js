...
suspendedRetryTimeout:3E4,httpRequestTimeout:15E3,channelRetryTimeout:15E3,fallbackRetryTimeout:6E5,connectionStateTtl:12E4,realtimeRequestTimeout:1E4,recvTimeout:9E4,preferenceConnectTimeout:6E3,parallelUpgradeDelay:6E3};t.httpMaxRetryCount=3;t.maxMessageSize=65536;t.version="1.1.19";t.libstring=w.libver+t.version;t.apiVersion="1.1";t.getHost=function(b,d,f){return d=f?d==b.restHost&&b.realtimeHost||d||b.realtimeHost:d||b.restHost};t.getPort=function(b,d){return d||b.tls?b.tlsPort:b.port};t.getHttpScheme=
...
l=this.body,n=this.method,t=this.headers,u=this.xhr=new XMLHttpRequest,w=t.accept,y="text";w?0===w.indexOf("application/x-msgpack")&&(y="arraybuffer"):t.accept="application/json";l&&-1<(t["content-type"]||(t["content-type"]="application/json")).indexOf("application/json")&&"string"!=typeof l&&(l=JSON.stringify(l));u.open(n,this.uri,!0);u.responseType=y;"authorization"in t&&(u.withCredentials=!0);for(var A in t)u.setRequestHeader(A,t[A]);u.onerror=function(b){a(b,"XHR error occurred",null,400)};u.onabort=
