(function() {
  ...
  var S = function() {
    ...
    function g(a, b, c, f) {
      ...
      var e = u(c);
      if(e) {
        "OBJECT" == e.nodeName ? (E = t(e), H = null) : (E = e, H = c);
        a.id = C;
    ...
    var z = "undefined", v = "object", A = "application/x-shockwave-flash", C = "SWFObjectExprInst", x = window, q = document, B = navigator, I = !1, F = [function() {
      I ? h() : e()
    }], O = [], G = [], D = [], E, H, K, M, Q = !1, J = !1, N, L, R = !0, n = function() {
      ...
      if(typeof B.plugins != z && typeof B.plugins["Shockwave Flash"] == v) {
        if((d = B.plugins["Shockwave Flash"].description) && !(typeof B.mimeTypes != z && B.mimeTypes[A] && !B.mimeTypes[A].enabledPlugin)) {
          I = !0, e = !1, d = d.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), h[0] = parseInt(d.replace(/^(.*)\..*$/, "$1"), 10), h[1] = parseInt(d.replace(/^.*\.(.*)\s.*$/, "$1"), 10), h[2] = /[a-zA-Z]/.test(d) ? parseInt(d.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        }
      }else {
    ...
    return{registerObject:function(a, b, c, f) {
      ...
      if(J) {
        var a = u(C);
        a && E && (a.parentNode.replaceChild(E, a), H && (P(H, !0), n.ie && n.win && (E.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), R = function() {
  ...
  (function() {
    ...
    a.isAvailable() && (B.httpTransports.xhr = B.transports.xhr = a, Http.Request = function(b, c, d, f, g) {
