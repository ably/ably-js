(function() {
  ...
  X.receiver = function(a) {
    ...
    return function(g) {
      ...
      for(;g.length;) {
        ...
        g.length >= c ? (g.copy(h, b, 0, c), g = g.slice(c, g.length), c = 0, a(new X(h))) : g.length && (g.copy(h, b, 0, g.length), c -= g.length, b += g.length, g = g.slice(g.length, g.length))
      }
    }
  };
  I(X, M, {flush:function() {
    var a = this;
  ...
  this.Http = function() {
    ...
    a.get = function(b, h, e, g, d) {
      ...
      if("string" == typeof l) {
        ...
        if(f) {
          ...
          var x = fallbackHosts.slice().unshift(t);
          p(x.shift(), function(a, b, c) {
            if(a) {
              var e = a.code;
    ...
    a.post = function(b, h, e, g, d, p) {
      ...
      if("string" == typeof f) {
        ...
        var s;
        e = b.connection;
        var t = b.options, x = t.restHost;
        "connected" == e.state ? s = e.connectionManager.host : t.fallbackHosts || (s = x);
        if(s) {
          l(f(s), p)
        }else {
          var k = fallbackHosts.slice().unshift(x);
  ...
  var T = function() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          ...
          if(0 < n.pv[0]) {
            ...
            if(v) {
              if(k(O[b].swfVersion) && !(n.wk && 312 > n.wk)) {
                ...
                if(O[b].expressInstall && d()) {
                  ...
                  for(var s = {}, v = v.getElementsByTagName("param"), P = v.length, x = 0;x < P;x++) {
                    "movie" != v[x].getAttribute("name").toLowerCase() && (s[v[x].getAttribute("name")] = v[x].getAttribute("value"))
                  }
                  f(h, s, c, e)
                }else {
                  l(v), e && e(h)
            ...
            if(Q(c, !0), e) {
              if((c = g(c)) && typeof c.SetVariable != y) {
                h.success = !0, h.ref = c
              }
              e(h)
            }
    ...
    function m(a, b, c, e) {
      if(!n.ie || !n.mac) {
        ...
        if(g) {
          ...
          n.ie && n.win ? N && typeof N.addRule == u && N.addRule(a, b) : N && typeof q.createTextNode != y && N.appendChild(q.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function Q(a, b) {
    ...
    var y = "undefined", u = "object", A = "application/x-shockwave-flash", C = "SWFObjectExprInst", w = window, q = document, B = navigator, I = !1, F = [function() {
      I ? h() : e()
    }], O = [], G = [], D = [], E, H, K, M, R = !1, J = !1, N, L, S = !0, n = function() {
      var a = typeof q.getElementById != y && typeof q.getElementsByTagName != y && typeof q.createElement != y, b = B.userAgent.toLowerCase(), c = B.platform.toLowerCase(), e = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, g = !+"\v1", h = [0, 0, 0], d = null;
      if(typeof B.plugins != y && typeof B.plugins["Shockwave Flash"] == u) {
        if((d = B.plugins["Shockwave Flash"].description) && !(typeof B.mimeTypes != y && B.mimeTypes[A] && !B.mimeTypes[A].enabledPlugin)) {
    ...
    (function() {
      n.w3 && ((typeof q.readyState != y && "complete" == q.readyState || typeof q.readyState == y && (q.getElementsByTagName("body")[0] || q.body)) && a(), R || (typeof q.addEventListener != y && q.addEventListener("DOMContentLoaded", a, !1), n.ie && n.win && (q.attachEvent("onreadystatechange", function() {
    ...
    return{registerObject:function(a, b, c, e) {
    ...
    }, embedSWF:function(a, b, e, g, h, l, v, s, t, x) {
      ...
      n.w3 && !(n.wk && 312 > n.wk) && a && b && e && g && h ? (Q(b, !1), c(function() {
        ...
        if(v && typeof v === u) {
          for(var U in v) {
            n.flashvars = typeof n.flashvars != y ? n.flashvars + ("\x26" + U + "\x3d" + v[U]) : U + "\x3d" + v[U]
          }
        }
        if(k(h)) {
      ...
      if(b) {
        ...
        for(var b = b.split("\x26"), c = 0;c < b.length;c++) {
          if(b[c].substring(0, b[c].indexOf("\x3d")) == a) {
            return z(b[c].substring(b[c].indexOf("\x3d") + 1))
          }
        }
      }
      return""
    ...
    function b(a, c) {
      ...
      this.httpTransports = m.intersect(c.transports || z.httpTransports, b.httpTransports);
      this.transports = m.intersect(c.transports || z.transports, b.transports);
      ...
      f.logAction(f.LOG_MICRO, "Realtime.ConnectionManager()", "requested transports \x3d [" + (c.transports || z.transports) + "]");
    ...
    }, p = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:z.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:z.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
    retryDelay:z.suspendedTimeout}, closed:{state:"closed", terminal:!1, queueEvents:!1, sendEvents:!1}, failed:{state:"failed", terminal:!0, queueEvents:!1, sendEvents:!1}};
  ...
  var S = function() {
    ...
    function a(a) {
      ...
      a.fallbackHosts = a.restHost ? null : z.fallbackHosts;
      a.restHost = a.restHost || z.REST_HOST;
      this.serverTimeOffset = null;
      this.baseUri = this.authority = function(b) {
        return"https://" + b + ":" + (a.tlsPort || z.TLS_PORT)
      };
  ...
  this.Realtime = function() {
    function a(a) {
      ea.call(this, a);
      a.wsHost = a.wsHost || z.WS_HOST;
      a.wsPort = a.encrypted ? a.tlsPort || z.TLS_PORT : a.port || z.PORT;
  ...
  var $ = function() {
    ...
    c.prototype.presence = function(b, c) {
      ...
      S.get(d, "/channels/" + this.name + "/presence", r, b, function(a, b) {
    ...
    c.prototype.history = function(b, c) {
      ...
      var d = this.rest, g = !d.options.useTextProtocol, r = m.copy(m.defaultGetHeaders(g));
      d.options.headers && m.mixin(r, d.options.headers);
      S.get(d, "/channels/" + this.name + "/history", r, b, function(a, b) {
        if(a) {
          c(a)
        }else {
          try {
    ...
    c.prototype.publish = function(b, c, d) {
      ...
      S.post(g, "/channels/" + this.name + "/publish", b, c, null, d)
    };
    return c
  }(), ca = function() {
    function a(a, b, c) {
  ...
  (function() {
    ...
    a.Request = function(a, c, d, f, k, l) {
      var m = Ably._;
      this.callback = l;
      var u = this.requestId = b++, s = this.timer = setTimeout(f ? z.cometRecvTimeout : z.cometSendTimeout, function() {
        x.abort()
      });
      c = c || {};
      ...
      Ably._["_" + u] = function(a) {
        clearTimeout(s);
        delete m["_" + u];
        x.aborted || (t.parentNode.removeChild(t), l(null, a))
      };
  ...
  (function() {
    ...
    a.Request = function(a, d, e, g, f, k) {
      ...
      var t = setTimeout(g ? z.cometRecvTimeout : z.cometSendTimeout, function() {
        w = !0;
        s.abort()
      });
      s.open(d, a, !0);
  ...
  (function() {
    ...
    a.tryConnect = function(b, c, d, g) {
      Y.__initialize(z.flashTransport.swfLocation);
      var k = new a(b, c, d);
      errorCb = function(a) {
        g(a)
      };
