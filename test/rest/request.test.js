...
define(['ably', 'shared_helper', 'async', 'chai'], function (Ably, helper, async, chai) {
  ...
  describe('rest/request', function () {
    ...
    restTestOnJsonMsgpackAsync('request_version', function (rest) {
    ...
    restTestOnJsonMsgpackAsync('request_time', async function (rest) {
    ...
    restTestOnJsonMsgpackAsync('request_404', async function (rest) {
    ...
    restTestOnJsonMsgpackAsync('request_post_get_messages', async function (rest, channelName) {
    ...
    restTestOnJsonMsgpackAsync('request_batch_api_success', async function (rest, name) {
    ...
    restTestOnJsonMsgpackAsync.skip('request_batch_api_partial_success', async function (rest, name) {
