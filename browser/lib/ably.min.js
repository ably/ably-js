(function() {
  ...
  this.Http = function() {
    ...
    a.get = function(b, g, e, f, d) {
      ...
      if("string" == typeof m) {
        ...
        1 == h.length ? l(m(h[0]), d) : l(h.shift(), function(a, b, c) {
          if(a) {
            var f = a.code;
    ...
    a.post = function(b, g, e, f, d, l) {
      ...
      if("string" == typeof p) {
        ...
        1 == B.length ? m(p(B[0]), l) : m(B.shift(), function(a, b, c) {
          if(a) {
            var f = a.code;
            if("ENETUNREACH" == f || "EHOSTUNREACH" == f || "EHOSTDOWN" == f) {
              m(B, l);
  ...
  this.Base64 = function() {
    ...
    var g = {codex:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode:function(b) {
      ...
      for(b = new c(b);b.moveNext();) {
        ...
        var m = b.current;
        b.moveNext();
        var p = b.current, h = l >> 2, l = (l & 3) << 4 | m >> 4, B = (m & 15) << 2 | p >> 6, y = p & 63;
        isNaN(m) ? B = y = 64 : isNaN(p) && (y = 64);
        f.append(d.charAt(h) + d.charAt(l) + d.charAt(B) + d.charAt(y))
      }
      return f.toString()
    }, decode:function(c) {
      var f = new a;
    ...
    b.prototype = {current:64, moveNext:function() {
      ...
      var a = g.codex.indexOf(this._input.charAt(++this._index)), b = g.codex.indexOf(this._input.charAt(++this._index)), c = g.codex.indexOf(this._input.charAt(++this._index)), d = g.codex.indexOf(this._input.charAt(++this._index)), m = (c & 3) << 6 | d;
  ...
  var S = function() {
    ...
    function h(a, b, c) {
      ...
      if(g) {
        if(typeof a.id == x && (a.id = c), q.ie && q.win) {
          ...
          m = s.createElement(r);
          m.setAttribute("type", w);
          for(var p in a) {
            a[p] != Object.prototype[p] && ("styleclass" == p.toLowerCase() ? m.setAttribute("class", a[p]) : "classid" != p.toLowerCase() && m.setAttribute(p, a[p]))
          }
          for(e in b) {
            b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = m, d = e, p = b[e], c = s.createElement("param"), c.setAttribute("name", d), c.setAttribute("value", p), a.appendChild(c))
          }
    ...
    }, embedSWF:function(a, b, f, g, e, m, p, B, y, O) {
    ...
    a.prototype.connect = function() {
      ...
      this.auth.getAuthParams(function(c, e) {
        ...
        if(c) {
          ...
          try {
            var m = a.wsConnection = a.createWebSocket(f, d);
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof r ? r : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, d = a.TMessage = {}, e = a.TPresence = {}, f = a.TProtocolMessage = {}, h = a.TMessageArray = {}, l = a.TMessageBundle = {}, m = c.TType.BUFFER;
    c.TMessage.prototype.toJSON = function() {
      ...
      (c = Data.isCipherData(a)) ? (b.encoding = "cipher+base64", c = Crypto.Data.asBase64(c), b.type = a.type) : (c = Data.fromTData(a), a.type == m && (b.encoding = "base64", c = c.toString("base64")));
      b.data = c;
      return b
    };
  ...
  var U = function() {
    ...
    a.get = function(a, b, d, e, f) {
      function h() {
        a.auth.getAuthHeaders(function(l, m) {
          l ? f(l) : Http.get(a, b, n.mixin(m, d), e, function(b, d, e) {
    ...
    a.post = function(a, b, d, e, f, h) {
      function l() {
        a.auth.getAuthHeaders(function(m, p) {
          m ? h(m) : Http.post(a, b, n.mixin(p, e), d, f, function(b, f, d) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? h(a) : l()
            }) : h(b, f, d)
          })
    ...
    b.prototype.authorise = function(a, b) {
      ...
      this.requestToken(a, function(a, c) {
        a ? b(a) : b(null, f.token = c.access_token)
      })
    };
    ...
    c.prototype.history = function(b, c) {
      ...
      void 0 === c && ("function" == typeof b ? (c = b, b = null) : c = a);
      var d = this.rest, f = !d.options.useTextProtocol, u = n.copy(n.defaultGetHeaders(f)), l = this.cipher;
      d.options.headers && n.mixin(u, d.options.headers);
    ...
    a.prototype._publish = function(a, b) {
      ...
      switch(this.state) {
        ...
        default:
          this.attach();
        case "attaching":
          h.logAction(h.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({messages:a, listener:b})
      }
    };
    ...
    c.prototype.leaveClient = function(a, c) {
      ...
      var e = new b.TPresence({state:d.LEAVE, clientId:a}), m = this.channel;
      switch(m.state) {
        case "attached":
          m.sendPresence(e, c);
          break;
    ...
    c.prototype.setPresence = function(b, c) {
      ...
      for(var l = 0;l < b.length;l++) {
        var m = b[l], p = a.call(m.clientId, m.memberId), k = new da(m.clientId, Data.fromTData(m.clientData), m.memberId);
        switch(m.state) {
          case d.LEAVE:
  ...
  (function() {
    ...
    a.Request.prototype.send = function(a, d, e, f, h, l) {
      a = M.paramStr(d, a);
      var k, p, n;
      e ? (d = "POST", k = 201) : (d = "GET", k = 200);
      var r = this.xhr = c();
        ...
        if(4 == r.readyState) {
          if(clearTimeout(v), p) {
            ...
            if(r.status == k) {
              ...
              0 != r.status && (p = Error("Unexpected response: statusCode \x3d " + r.status), p.statusCode = r.status, p.code = 8E4, p.statusText = r.statusText, l(p))
            }
          }
        }
      };
  ...
  (function() {
    ...
    a.tryConnect = function(b, c, d, f) {
      var k = t.flashTransport.swfLocation, l = t.flashTransport.policyPort;
      ...
      R.__initialize(k);
      var m = new a(b, c, d);
      l && R.loadFlashPolicyFile("xmlsocket://" + m.wsHost + ":" + l);
      errorCb = function(a) {
        f(a)
      };
      m.on("wserror", errorCb);
      m.on("wsopen", function() {
        h.logAction(h.LOG_MINOR, "FlashTransport.tryConnect()", "viable transport " + m);
