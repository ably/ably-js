(function() {
  window.Ably = {};
  for(var F = {disconnected:{statusCode:408, code:80003, reason:"Connection to server temporarily unavailable"}, suspended:{statusCode:408, code:80002, reason:"Connection to server unavailable"}, failed:{statusCode:408, code:8E4, reason:"Connection failed or disconnected by server"}}, J = function(a, c, b) {
    function e() {
    }
  ...
  H.MAX_INT = Math.pow(2, 53);
  H.MIN_INT = -Math.pow(2, 53);
  H.prototype = {_2scomp:function() {
    ...
    for(var e = this.buffer, h = this.offset, f = 7;0 <= f;f--) {
      e[h + f] = c & 255, c = 4 == f ? a : c >>> 8
    }
    b && this._2scomp()
  }, toNumber:function(a) {
    for(var c = this.buffer, b = this.offset, e = c[0] & 128, h = 0, f = 1, k = 7, d = 1;0 <= k;k--, d *= 256) {
      var m = c[b + k];
      e && (m = (m ^ 255) + f, f = m >> 8, m &= 255);
      h += m * d
    }
    return!a && h >= H.MAX_INT ? e ? -Infinity : Infinity : e ? -h : h
  }, valueOf:function() {
    return this.toNumber(!1)
  }, toString:function(a) {
    return this.valueOf().toString(a || 10)
  }, toOctetString:function(a) {
    for(var c = Array(8), b = this.buffer, e = this.offset, h = 0;8 > h;h++) {
      c[h] = aa[b[e + h]]
    }
    return c.join(a || "")
  }, inspect:function() {
  ...
  d.TXHRTransport.prototype = {getXmlHttpRequestObject:function() {
    ...
    var h = jQuery.Deferred(), f = jQuery._Deferred(), d = h.promise();
    d.success = d.done;
    d.error = d.fail;
    d.complete = f.done;
    c = jQuery.ajax({url:this.url, data:c, type:"POST", cache:!1, dataType:"text", context:this, success:this.jqResponse, error:function(b, c, e) {
      h.rejectWith(a, jQuery.merge([e], b.tArgs))
    ...
    try {
      ...
      b.tDfd.rejectWith(b, jQuery.merge([h], b.tArgs))
    }
  ...
  d.Protocol.prototype = {getTransport:function() {
    ...
    var a = this.tpos.pop(), c = this.tstack[a], b = "{", e = !0, h;
    for(h in c) {
      e ? e = !1 : b += ",", b += h + ":" + c[h]
    }
    this.tstack[a] = b + "}"
    ...
    if(a != this.tstack.length) {
      ...
      for(var c = "}", b = !0;this.tstack.length > a + 1;) {
        var e = this.tstack.pop(), h = this.tstack.pop();
        b ? b = !1 : c = "," + c;
        isNaN(h) || (h = '"' + h + '"');
        c = h + ":" + e + c
      }
  ...
  var V = {encode:function(a, c, b) {
    ...
    b += c;
    for(c = c1 = c2 = 0;h < b;) {
      c = a.getInt8(h++), 128 > c ? e += String.fromCharCode(c) : 191 < c && 224 > c ? (c2 = a.getInt8(h++), e += String.fromCharCode((c & 31) << 6 | c2 & 63)) : (c2 = a.getInt8(h++), c3 = a.getInt8(h++), e += String.fromCharCode((c & 15) << 12 | (c2 & 63) << 6 | c3 & 63))
    }
    return e
  }}, u = function(a) {
    this.offset = 0;
  ...
  u.prototype = {getArray:function() {
    ...
    a = a || 0;
    c = c || this.length;
    var b = new u, e = b.length = c - a, h = b.offset = this.offset + a, f = b.buf = this.buf;
    b.view = new DataView(f, h, e);
    return b
  }, getInt8:function(a) {
  ...
  l.prototype.writeI64 = function(a) {
    a.buffer ? this.trans.writeI64(a) : this.trans.writeI64(new H(a))
  };
  ...
  var fa = new u(0), K = d.TTransport = function(a, c) {
    this.buf = a || fa;
    this.onFlush = c;
    this.reset()
  };
  ...
  X.receiver = function(a) {
    var c = 0, b = 0, e = null, h = null;
    return function(f) {
      if(h) {
        var d = new u(f.length + h.length);
        h.copy(d, 0, 0);
        f.copy(d, h.length, 0);
        h = null
      }
      for(;f.length;) {
        ...
        f.length >= c ? (f.copy(e, b, 0, c), f = f.slice(c, f.length), c = 0, a(new X(e))) : f.length && (f.copy(e, b, 0, f.length), c -= f.length, b += f.length, f = f.slice(f.length, f.length))
      }
    }
  };
      ...
      switch(c.fid) {
        ...
        case 13:
          if(b == d.Type.LIST) {
            ...
            c = a.readListBegin().size;
            for(b = 0;b < c;++b) {
              e = void 0, e = new D, e.read(a), this.presence.push(e)
            }
            a.readListEnd()
          }else {
            a.skip(b)
      ...
      switch(c.fid) {
        case 1:
          if(b == d.Type.LIST) {
            ...
            c = a.readListBegin().size;
            for(b = 0;b < c;++b) {
              var e = void 0, e = new TProtocolMessage;
              e.read(a);
              this.items.push(e)
            }
            a.readListEnd()
  ...
  var B = {TAction:TAction, TFlags:TFlags, TType:TType, TData:G, TPresence:D, TMessage:E, TChannelMessage:void 0, TMessageSet:void 0};
  this.Cookie = function() {
    function a() {
    }
    "object" == typeof window && (a.create = function(a, b, e) {
      var h = "";
      e && (h = new Date, h.setTime(h.getTime() + e), h = "; expires\x3d" + h.toGMTString());
      document.cookie = a + "\x3d" + b + h + "; path\x3d/"
    }, a.read = function(a) {
      a += "\x3d";
      for(var b = document.cookie.split(";"), e = 0;e < b.length;e++) {
        for(var h = b[e];" " == h.charAt(0);) {
  ...
  this.Http = function() {
    ...
    a.get = function(b, e, h, f, d) {
      function w(b, c) {
        a.Request(b, f, null, s, c)
      }
      d = d || c;
      var m = "function" == typeof e ? e : function(a) {
        return b.baseUri(a) + e
      }, s = h && "application/json" != h.accept;
      if("string" == typeof m) {
        w(m, d)
      }else {
        var g;
        g = (h = b.connection) && "connected" == h.state ? [h.connectionManager.host] : r.getHosts(b.options);
        1 == g.length ? w(m(g[0]), d) : w(g.shift(), function(a, b, c) {
          if(a) {
            var e = a.code;
    ...
    a.post = function(b, e, d, f, k, w) {
      function m(b, c) {
        a.Request(b, k, f, g, c)
      }
      w = w || c;
      var s = "function" == typeof e ? e : function(a) {
        return b.baseUri(a) + e
      ...
      if("string" == typeof s) {
        ...
        var t;
        t = (d = b.connection) && "connected" == d.state ? [d.connectionManager.host] : r.getHosts(b.options);
        1 == t.length ? m(s(t[0]), w) : m(t.shift(), function(a, b, c) {
          if(a) {
            var e = a.code;
            if("ENETUNREACH" == e || "EHOSTUNREACH" == e || "EHOSTDOWN" == e) {
              m(t, w);
  ...
  this.ThriftUtil = function() {
    ...
    var b = new d.TTransport, e = new d.TBinaryProtocol(b), h = 16384, f = [];
    c.encode = function(a, b) {
      try {
        b(null, c.encodeSync(a))
      }catch(e) {
        var f = "Unexpected exception encoding Thrift; exception \x3d " + e;
        g.logAction(g.LOG_ERROR, "ThriftUtil.encode()", f, e);
        f = Error(f);
        f.statusCode = 400;
        b(f)
      }
    ...
    c.decodeSync = function(a, c) {
      try {
        ...
        var d = "Unexpected exception decoding thrift message; exception \x3d " + f;
        g.logAction(g.LOG_ERROR, "ThriftUtil.decode()", d, f);
        d = Error(d);
        d.statusCode = 400;
        throw d;
      }
  ...
  var S = function() {
    ...
    function b(a) {
      if(typeof v.addEventListener != y) {
        ...
        if(typeof q.addEventListener != y) {
      ...
      if(c) {
        ...
        (function() {
          if(typeof c.GetVariable != y) {
            ...
            f && (f = f.split(" ")[1].split(","), p.pv = [parseInt(f[0], 10), parseInt(f[1], 10), parseInt(f[2], 10)])
          }else {
            if(10 > e) {
              e++;
    ...
    function d() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          var c = N[b].id, e = N[b].callbackFn, h = {success:!1, id:c};
          if(0 < p.pv[0]) {
            var s = C(c);
            if(s) {
              if(l(N[b].swfVersion) && !(p.wk && 312 > p.wk)) {
                Q(c, !0), e && (h.success = !0, h.ref = f(c), e(h))
              }else {
                if(N[b].expressInstall && k()) {
                  h = {};
                  h.data = N[b].expressInstall;
                  ...
                  for(var t = {}, s = s.getElementsByTagName("param"), T = s.length, x = 0;x < T;x++) {
                    "movie" != s[x].getAttribute("name").toLowerCase() && (t[s[x].getAttribute("name")] = s[x].getAttribute("value"))
                  }
                  g(h, t, c, e)
                }else {
                  m(s), e && e(h)
            ...
            if(Q(c, !0), e) {
              if((c = f(c)) && typeof c.SetVariable != y) {
                h.success = !0, h.ref = c
              }
              e(h)
            }
    ...
    function f(a) {
      ...
      if((a = C(a)) && "OBJECT" == a.nodeName) {
        typeof a.SetVariable != y ? b = a : (a = a.getElementsByTagName(u)[0]) && (b = a)
      }
      return b
    }
    function k() {
    ...
    function g(a, b, c, e) {
      ...
      var f = C(c);
      if(f) {
        "OBJECT" == f.nodeName ? (E = s(f), H = null) : (E = f, H = c);
        a.id = B;
        ...
        b.flashvars = typeof b.flashvars != y ? b.flashvars + ("\x26" + e) : e;
        p.ie && (p.win && 4 != f.readyState) && (e = q.createElement("div"), c += "SWFObjectNew", e.setAttribute("id", c), f.parentNode.insertBefore(e, f), f.style.display = "none", function() {
    ...
    function T(a, b, c) {
      ...
      if(f) {
        if(typeof a.id == y && (a.id = c), p.ie && p.win) {
          var d = "", h;
          for(h in a) {
            a[h] != Object.prototype[h] && ("data" == h.toLowerCase() ? b.movie = a[h] : "styleclass" == h.toLowerCase() ? d += ' class\x3d"' + a[h] + '"' : "classid" != h.toLowerCase() && (d += " " + h + '\x3d"' + a[h] + '"'))
          }
          h = "";
          for(var m in b) {
            b[m] != Object.prototype[m] && (h += '\x3cparam name\x3d"' + m + '" value\x3d"' + b[m] + '" /\x3e')
          }
          f.outerHTML = '\x3cobject classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + d + "\x3e" + h + "\x3c/object\x3e";
          G[G.length] = a.id;
          e = C(a.id)
        }else {
          m = q.createElement(u);
          m.setAttribute("type", z);
          for(var k in a) {
            a[k] != Object.prototype[k] && ("styleclass" == k.toLowerCase() ? m.setAttribute("class", a[k]) : "classid" != k.toLowerCase() && m.setAttribute(k, a[k]))
          }
          for(d in b) {
            b[d] != Object.prototype[d] && "movie" != d.toLowerCase() && (a = m, h = d, k = b[d], c = q.createElement("param"), c.setAttribute("name", h), c.setAttribute("value", k), a.appendChild(c))
          }
    ...
    function n(a, b, c, e) {
      if(!p.ie || !p.mac) {
        ...
        if(f) {
          ...
          e && (O = L = null);
          if(!L || O != c) {
            e = q.createElement("style"), e.setAttribute("type", "text/css"), e.setAttribute("media", c), L = f.appendChild(e), p.ie && (p.win && typeof q.styleSheets != y && 0 < q.styleSheets.length) && (L = q.styleSheets[q.styleSheets.length - 1]), O = c
          }
          p.ie && p.win ? L && typeof L.addRule == u && L.addRule(a, b) : L && typeof q.createTextNode != y && L.appendChild(q.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function Q(a, b) {
    ...
    var y = "undefined", u = "object", z = "application/x-shockwave-flash", B = "SWFObjectExprInst", v = window, q = document, A = navigator, I = !1, F = [function() {
      I ? e() : d()
    }], N = [], G = [], D = [], E, H, K, M, P = !1, J = !1, L, O, R = !0, p = function() {
      var a = typeof q.getElementById != y && typeof q.getElementsByTagName != y && typeof q.createElement != y, b = A.userAgent.toLowerCase(), c = A.platform.toLowerCase(), e = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, f = !+"\v1", d = [0, 0, 0], h = null;
      if(typeof A.plugins != y && typeof A.plugins["Shockwave Flash"] == u) {
        if((h = A.plugins["Shockwave Flash"].description) && !(typeof A.mimeTypes != y && A.mimeTypes[z] && !A.mimeTypes[z].enabledPlugin)) {
          I = !0, f = !1, h = h.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), d[0] = parseInt(h.replace(/^(.*)\..*$/, "$1"), 10), d[1] = parseInt(h.replace(/^.*\.(.*)\s.*$/, "$1"), 10), d[2] = /[a-zA-Z]/.test(h) ? parseInt(h.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        }
      }else {
        if(typeof v.ActiveXObject != y) {
          try {
            var m = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
            if(m && (h = m.GetVariable("$version"))) {
              f = !0, h = h.split(" ")[1].split(","), d = [parseInt(h[0], 10), parseInt(h[1], 10), parseInt(h[2], 10)]
            }
          }catch(k) {
          }
        }
      }
      return{w3:a, pv:d, wk:b, ie:f, win:e, mac:c}
    }();
    (function() {
      p.w3 && ((typeof q.readyState != y && "complete" == q.readyState || typeof q.readyState == y && (q.getElementsByTagName("body")[0] || q.body)) && a(), P || (typeof q.addEventListener != y && q.addEventListener("DOMContentLoaded", a, !1), p.ie && p.win && (q.attachEvent("onreadystatechange", function() {
    ...
    return{registerObject:function(a, b, c, e) {
    ...
    }, embedSWF:function(a, b, e, f, d, h, m, s, t, C) {
      var x = {success:!1, id:b};
      p.w3 && !(p.wk && 312 > p.wk) && a && b && e && f && d ? (Q(b, !1), c(function() {
        e += "";
        f += "";
        var c = {};
        if(t && typeof t === u) {
        ...
        if(m && typeof m === u) {
          for(var U in m) {
            p.flashvars = typeof p.flashvars != y ? p.flashvars + ("\x26" + U + "\x3d" + m[U]) : U + "\x3d" + m[U]
          }
        }
        if(l(d)) {
          n = T(c, p, b), c.id == b && Q(b, !0), x.success = !0, x.ref = n
        }else {
          if(h && k()) {
            c.data = h;
            g(c, p, b, C);
      ...
      if(J) {
        var a = C(B);
        a && E && (a.parentNode.replaceChild(E, a), H && (Q(H, !0), p.ie && p.win && (E.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), O = function() {
    ...
    var a = function(c, b, e, d, f) {
      ...
      k.__createTask = setTimeout(function() {
        a.__addTask(function() {
          k.__createTask = null;
          a.__flash.create(k.__id, c, b, e || null, d || 0, f || null)
        })
      }, 0)
    };
    ...
    a.prototype.off = function(a, b) {
      if(0 == arguments.length) {
        ...
        if(null === a) {
          ...
          if(b) {
            d = -1;
            if(!(e = this.events[a]) || -1 == (d = e.indexOf(b))) {
    ...
    var d = "undefined" !== typeof Cookie && Cookie.read, h = "undefined" !== typeof Cookie && Cookie.create, f = ("object" == typeof B ? B : require("../nodejs/lib/protocol/clientmessage_types")).TAction, k = function() {
    }, w = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:r.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:r.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
    ...
    b.prototype.chooseTransport = function(b) {
      ...
      if(this.transport) {
        ...
        var f = this;
        this.httpTransports.length ? this.chooseHttpTransport(d, function(c, e) {
          if(c) {
            g.logAction(g.LOG_ERROR, "ConnectionManager.chooseTransport()", "Unexpected error establishing transport; err \x3d " + c), b(c)
          }else {
            if(g.logAction(g.LOG_MINOR, "ConnectionManager.chooseTransport()", "Establishing http transport: " + e), b(null, e), f.upgradeTransports.length) {
              e.on("connected", function(b, c) {
                g.logAction(g.LOG_MAJOR, "ConnectionManager.chooseTransport()", "upgrading ... connectionId \x3d " + c);
                d = new a(f.options, d.host, "resume", c, f.connectionSerial);
                f.chooseTransportForHost(d, f.upgradeTransports.slice(), k)
              })
            }
          }
        }) : (d.host = this.hosts[0], g.logAction(g.LOG_MINOR, "ConnectionManager.chooseTransport()", "No http transports available; ignoring fallback hosts"), this.chooseTransportForHost(d, f.transports.slice(), b))
      }
    };
    b.prototype.chooseTransportForHost = function(a, c, d) {
      ...
      if(f) {
        ...
        b.transports[f].tryConnect(this, this.realtime.auth, a, function(b, h) {
          b ? e.chooseTransportForHost(a, c, d) : (g.logAction(g.LOG_MICRO, "ConnectionManager.chooseTransport()", "transport " + f + " connecting"), e.setTransportPending(h), d(null, h))
        })
      }else {
    ...
    b.prototype.chooseHttpTransport = function(a, c) {
      function d() {
        if(f.length) {
          b.httpTransports[h.httpTransports[0]].checkConnectivity(function(b, e) {
            b ? c(b) : e ? (a.host = n.arrRandomElement(f), h.chooseTransportForHost(a, h.httpTransports.slice(), function(a, b) {
              a ? d() : c(null, b)
      ...
      var f = this.hosts.slice(), e = f.shift();
      if(e) {
        a.host = e;
        var h = this;
      ...
      if(this.state == w.closed) {
        ...
        for(var b = this, c = function(c) {
          return function(d, f) {
            ...
            var e;
            "connected" == c ? (b.activateTransport(a, f), e = !0) : e = b.deactivateTransport(a);
            e && b.notifyState({state:c, error:d})
          }
        }, d = ["connected", "disconnected", "closed", "failed"], f = 0;f < d.length;f++) {
          var e = d[f];
          a.on(e, c(e))
        }
    ...
    b.prototype.startConnectTimer = function() {
      ...
      this.connectTimer = setTimeout(function() {
        a.connectTimer && (g.logAction(g.LOG_MINOR, "ConnectionManager connect timer expired", "requesting new state: " + w.connecting.failState), a.notifyState({state:w.connecting.failState}))
      }, r.connectTimeout)
    };
    ...
    b.prototype.startSuspendTimer = function() {
      ...
      this.suspendTimer || (this.suspendTimer = setTimeout(function() {
        a.suspendTimer && (g.logAction(g.LOG_MINOR, "ConnectionManager suspend timer expired", "requesting new state: suspended"), w.connecting.failState = "suspended", w.connecting.queueEvents = !1, a.notifyState({state:"suspended"}))
      }, r.suspendedTimeout))
    };
    b.prototype.cancelSuspendTimer = function() {
      w.connecting.failState = "disconnected";
      w.connecting.queueEvents = !0;
    ...
    b.prototype.notifyState = function(a) {
      if(!(this.state.terminal || a.state == this.state.state)) {
        ...
        a = new Z(this.state.state, b.state, b.retryDelay, a.error || F[b.state]);
    ...
    b.prototype.requestState = function(a) {
      ...
      if(a.state != this.state.state) {
        ...
        if(a.state != this.state.state) {
          var b = w[a.state];
          a = new Z(this.state.state, b.state, b.retryIn, a.error || F[b.state]);
          this.enactStateChange(a)
        }
      }
    };
    b.prototype.connectImpl = function() {
      ...
      var a = this, b = this.realtime.auth, c = function(d) {
        ...
        a.notifyState({state:w.connecting.failState, error:d})
      }, d = function() {
    ...
    b.prototype.send = function(a, b, d) {
      d = d || k;
      var f = this.state;
      f.sendEvents ? (g.logAction(g.LOG_MICRO, "ConnectionManager.send()", "sending event"), this.sendImpl(new c(a, d))) : f.queueEvents && (b ? this.queue(a, d) : (g.logAction(g.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), d(this.error)))
    };
    ...
    b.prototype.ackMessage = function(a, b, c) {
      ...
      c = c || null;
      var d = this.pendingMessages, f = d[0];
    ...
    b.prototype.queue = function(a, b) {
      ...
      d && ba.mergeTo(d.msg, a) ? (d.merged || (d.callback = new Y([d.callback]), d.merged = !0), d.listener.push(b)) : this.queuedMessages.push(new c(a, b))
    };
    ...
    b.prototype.onChannelMessage = function(a, b) {
      b === this.transport ? (this.connectionSerial = a.connectionSerial, this.realtime.channels.onChannelMessage(a)) : this.realtime.channels.retryChannelMessage(a)
    };
    return b
  }(), I = function() {
    function a(a, c, d) {
    ...
    var c = ("object" == typeof window ? B : require("../nodejs/lib/protocol/clientmessage_types")).TAction;
    n.inherits(a, v);
    ...
    var c = "object" == typeof window, b = c ? B : require("../nodejs/lib/protocol/clientmessage_types"), d = c ? window.WebSocket || window.MozWebSocket : require("ws"), h = c ? !1 : !!u, f = function() {
    };
    n.inherits(a, I);
    a.isAvailable = function() {
      return!!d
    };
    a.isAvailable() && (A.transports.web_socket = a);
    a.tryConnect = function(b, c, d, f) {
      var e = new a(b, c, d), h = function(a) {
        f(a)
      };
      e.on("wserror", h);
      e.on("wsopen", function() {
        g.logAction(g.LOG_MINOR, "WebSocketTransport.tryConnect()", "viable transport " + e);
        e.off("wserror", h);
        f(null, e)
      });
      e.connect()
    ...
    a.prototype.connect = function() {
      ...
      I.prototype.connect.call(this);
      var a = this, b = this.params, c = b.options, d = r.getHost(c, b.host, !0), f = r.getPort(c), e = (c.encrypted ? "wss://" : "ws://") + d + ":" + f + "/";
      g.logAction(g.LOG_MINOR, "WebSocketTransport.connect()", "uri: " + e);
      this.auth.getAuthParams(function(c, d) {
        ...
        if(c) {
          ...
          f = b.getConnectParams(d);
          try {
            var m = a.wsConnection = a.createWebSocket(e, f);
    ...
    "object" == typeof B || require("../nodejs/lib/protocol/clientmessage_types");
    (n || require("util")).inherits(a, I);
    ...
    a.prototype.connect = function() {
      ...
      I.prototype.connect.call(this);
      var c = this, b = this.params, d = b.options, b = r.getHost(d, b.host), h = r.getPort(d);
      this.baseUri = (d.encrypted ? "https://" : "http://") + b + ":" + h + "/comet/";
      var f = this.baseUri + "connect";
      g.logAction(g.LOG_MINOR, "CometTransport.connect()", "uri: " + f);
      this.auth.getAuthParams(function(b, d) {
        if(b) {
          c.abort(UIMessages.FAIL_REASON_REFUSED)
        }else {
          c.authParams = d;
          var e = c.params.getConnectParams(d);
          g.logAction(g.LOG_MINOR, "CometTransport.connect()", "connectParams:" + a.paramStr(e));
          try {
            c.request(f, e, null, !1, function(a, b) {
    ...
    a.prototype.onConnect = function(a) {
      ...
      I.prototype.onConnect.call(this, a);
      b = this.baseUri + b;
      g.logAction(g.LOG_MICRO, "CometTransport.onConnect()", "baseUri \x3d " + b + "; connectionId \x3d " + a.connectionId);
      this.sendUri = b + "/send";
      this.recvUri = b + "/recv";
      this.closeUri = b + "/close";
      this.recv()
    };
    a.prototype.send = function(a, b) {
      if(this.sendRequest) {
    ...
    a.prototype.sendItems = function(a, b) {
      ...
      try {
        ...
        var f = "Unexpected send exception: " + h;
        g.logAction(g.LOG_ERROR, "CometTransport.sendItems()", f);
        b(Error(f))
      }
    };
  ...
  this.Data = function() {
    ...
    var c = "object" == typeof B ? B : require("../nodejs/lib/protocol/clientmessage_types"), b = {"[object Null]":function(a, b) {
      a.type = c.TType.NONE;
      return!0
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof B ? B : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, d = a.TMessage = {}, h = a.TPresence = {}, f = a.TProtocolMessage = {}, k = a.TMessageArray = {}, g = a.TMessageBundle = {}, m = c.TType.BUFFER;
    b.fromREST = function(a) {
      var c, d = a.data, f = a.encoding;
      f ? (c = new b, c.type = m, c.binaryData = new u(d, f)) : Data.toTData(d);
      a.data = d
    };
    ...
    b.fromREST = function(a, c) {
      var d, f = a.encoding;
      f ? (d = new b, d.type = m, d.binaryData = new u(c, f)) : d = Data.toTData(c);
      return d
    };
    ...
    f.fromJSON = function(a) {
      var b;
      if(b = a.messages) {
        for(var f = b.length, k = a.messages = Array(f), g = 0;g < f;g++) {
          k[g] = d.fromJSON(b[g])
        }
      }
      if(b = a.presence) {
        f = b.length;
        k = a.presence = Array(f);
        for(g = 0;g < f;g++) {
          k[g] = h.fromJSON(b[g])
        }
      }
    ...
    f.decode = function(a, b) {
      var d, e;
      if(b) {
        if(e = ThriftUtil.decodeSync(d = new c.TProtocolMessage, a)) {
          throw e;
        }
      }else {
        d = f.fromJSON(JSON.parse(a))
      }
      return d
    };
    g.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          var e;
          if(d = ThriftUtil.decodeSync(e = new c.TMessageBundle, a)) {
            throw d;
          }
          d = e.items
        }else {
          e = JSON.parse(a);
          for(var h = e.length, d = Array(h), k = 0;k < h;k++) {
            d[k] = f.fromJSON(e[k])
          }
        }
      }
    ...
    k.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          var h;
          if(f = ThriftUtil.decodeSync(h = new c.TMessageArray, a)) {
            throw f;
          }
          f = h.items
        }else {
          h = JSON.parse(a);
          for(var k = h.length, f = Array(k), g = 0;g < k;g++) {
            f[g] = d.fromJSON(h[g])
          }
        }
      }
  ...
  var R = function() {
    ...
    a.get = function(a, b, d, h, f) {
      function k() {
        a.auth.getAuthHeaders(function(g, m) {
          g ? f(g) : Http.get(a, b, n.mixin(m, d), h, function(b, d) {
    ...
    a.post = function(a, b, d, h, f, k) {
      function g() {
        a.auth.getAuthHeaders(function(m, s) {
          m ? k(m) : Http.post(a, b, n.mixin(s, h), d, f, function(b, d) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? k(a) : g()
            }) : k(b, d)
          })
    ...
    var d = "object" == typeof window, h = d ? null : require("crypto"), f = void 0;
    d && (window.CryptoJS && CryptoJS.HmacSHA256 && CryptoJS.enc.Base64) && (f = function(a, b) {
    ...
    b.prototype.requestToken = function(b, d) {
      ...
      var f, e = this.rest;
      if(b.authCallback) {
        g.logAction(g.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_callback"), f = b.authCallback
      }else {
        if(b.authUrl) {
          g.logAction(g.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), f = function(a, c) {
            Http.get(e, b.authUrl, b.authHeaders || {}, n.mixin(a, b.authParams), c)
          }
        }else {
          if(b.keyValue) {
            var h = this;
      ...
      var e = this.rest, x = function(a) {
        return e.baseUri(a) + "/keys/" + b.keyId + "/authorise"
      }, u = function(a, b) {
        Http.post ? Http.post(e, x, n.defaultPostHeaders(), a, null, b) : Http.get(e, x, n.defaultGetHeaders(), a, b)
      };
      f(l, function(a, b) {
    ...
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        (function(c) {
          a.timestamp ? c() : a.queryTime ? r.time(function(d, f) {
            d ? b(d) : (a.timestamp = Math.floor(f / 1E3), c())
          }) : (a.timestamp = u.getTimestamp(), c())
        })(function() {
          var c = e.nonce = a.nonce || ("000000" + Math.floor(1E16 * Math.random())).slice(-16), m = e.timestamp = a.timestamp, c = e.id + "\n" + l + "\n" + n + "\n" + h + "\n" + m + "\n" + c + "\n";
          e.mac = a.mac || f(c, d);
    ...
    a.prototype.time = function(a, c) {
      ...
      Http.get(this, function(a) {
        return g.authority(a) + "/time"
      }, d, a, function(a, b) {
        if(a) {
          c(a)
        }else {
          var d = b[0];
          d ? (g.serverTimeOffset = d - Date.now(), c(null, d)) : (a = Error("Internal error (unexpected result type from GET /time"), a.statusCode = 500, c(a))
        }
      })
    };
    ...
    c.prototype.retryChannelMessage = function(a) {
      ...
      if(c) {
        var d = this.attached[c];
        d ? d.retryMessage(a) : g.logAction(g.LOG_ERROR, "ConnectionManager on(channelmessage)", "received event for non-existent channel: " + c)
      }else {
        g.logAction(g.LOG_ERROR, "ConnectionManager on(channelmessage)", "received event unspecified channel: " + c)
      }
    };
    ...
    function a(a, b) {
      v.call(this);
      this.ably = a;
      this.connectionManager = new A(a, b);
    ...
    c.prototype.presence = function(b, c) {
      ...
      R.get(d, "/channels/" + this.name + "/presence", k, b, function(a, b) {
        a ? c(a) : f ? da.decodeTPresenceArray(b, c) : c(null, b)
      })
    };
    c.prototype.history = function(b, c) {
      ...
      R.get(d, "/channels/" + this.name + "/history", k, b, function(a, b) {
        if(a) {
          ...
          try {
            c(null, Serialize.TMessageArray.decode(b, f))
          }catch(d) {
            c(d)
          }
        }
    ...
    c.prototype.publish = function(b, c, d) {
      ...
      R.post(f, "/channels/" + this.name + "/publish", b, k, null, d)
    };
    return c
  }(), ba = function() {
    function a(a, b, c) {
    ...
    var c = "object" == typeof B ? B : require("../nodejs/lib/protocol/clientmessage_types"), b = c.TAction, d = function() {
    }, h = {queueEvents:!0};
    n.inherits(a, $);
    ...
    a.prototype.publish = function(a, b, h) {
      ...
      A.activeState(m.state) ? (m = new c.TMessage, m.name = a, m.data = Data.toTData(b), "attached" == this.state ? (g.logAction(g.LOG_MICRO, "RealtimeChannel.publish()", "sending message"), a = new c.TProtocolMessage, a.action = c.TAction.MESSAGE, a.channel = this.name, a.messages = [m], this.sendMessage(a, h)) : ("pending" != this.state && this.attach(), g.logAction(g.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:m, listener:h}))) : h(m.getStateError())
    };
    ...
    a.prototype.attach = function(a) {
      ...
      A.activeState(b.state) ? "attached" == this.state ? a() : "failed" == this.state ? a(b.getStateError()) : (this.once(function(c) {
        switch(this.event) {
          case "attached":
            a();
            break;
    ...
    a.prototype.detach = function(a) {
      a = a || d;
      var b = this.connectionManager;
      A.activeState(b.state) ? "detached" == this.state ? a() : (this.once(function(c) {
        switch(this.event) {
          case "detached":
            a();
            break;
    ...
    a.prototype.onMessage = function(a) {
      switch(a.action) {
        ...
        case b.MESSAGE:
          ...
          break;
        default:
          g.logAction(g.LOG_ERROR, "RealtimeChannel.onMessage()", "Fatal protocol error: unrecognised action (" + a.action + ")"), this.connectionManager.abort(UIMessages.FAIL_REASON_FAILED)
      }
    };
    ...
    a.prototype.retryMessage = function(a) {
      switch(a.action) {
        ...
        case b.DETACHED:
          ...
          break;
        default:
          g.logAction(g.LOG_ERROR, "RealtimeChannel.retryMessage()", "Unable to retry action (" + a.action + "); ignoring")
      }
    };
    return a
  }(), ja = function() {
    ...
    var b = "object" == typeof B ? B : require("../nodejs/lib/protocol/clientmessage_types"), d = b.TPresenceState, h = ["enter", "leave", "update"];
    n.inherits(c, v);
    ...
    c.prototype.leaveClient = function(a, c) {
      ...
      var h = new b.TPresence({state:d.LEAVE, clientId:a}), m = this.channel;
      switch(m.state) {
        case "attached":
          m.sendPresence(h, c);
          break;
  ...
  (function() {
    ...
    A.httpTransports.jsonp = A.transports.jsonp = a;
    var h = null;
    ...
    a.prototype.request = function(b, c, d, e, h) {
      return(new a.Request).send(b, c, d, e, !1, h)
    };
    a.Request = function(a) {
      this.requestId = a || d++
    };
    a.Request.prototype.send = function(a, c, d, e, h, g) {
      this.callback = g;
      var l = this.requestId, n = this.timer = setTimeout(e ? r.cometRecvTimeout : r.cometSendTimeout, function() {
        v.abort()
      });
      c = c || {};
      c.callback = "Ably._(" + l + ")";
      ...
      x.src = M.paramStr(c, a);
      var u = this._finish = function() {
        clearTimeout(n);
    ...
    Http.Request = function(b, c, d, e, h) {
      (new a.Request).send(b, c, d, !1, e, h)
    };
    return a
  })();
  (function() {
    ...
    a.prototype.request = function(b, c, d, f, g) {
      (new a.Request).send(b, c, d, f, this.binary, g)
    };
    a.prototype.toString = function() {
    ...
    a.Request.prototype.send = function(a, d, g, f, k, l) {
      a = M.paramStr(d, a);
      var m, n, v;
      g ? (d = "POST", m = 201) : (d = "GET", m = 200);
      var t = this.xhr = c();
      k && (t.responseType = "arraybuffer");
      var z = setTimeout(f ? r.cometRecvTimeout : r.cometSendTimeout, function() {
        v = !0;
        t.abort()
      });
      t.open(d, a, !0);
      t.setRequestHeader("Accept", k ? "application/x-thrift" : "application/json");
      ...
      t.onreadystatechange = function() {
        if(4 == t.readyState) {
          if(clearTimeout(z), n) {
            ...
            if(t.status == m) {
              var a = null;
              k ? t.response && (a = new u, a.buf = t.response, a.view = new DataView(a.buf)) : a = t.responseText;
              l(null, a)
            }else {
              0 != t.status && (n = Error("Unexpected response: statusCode \x3d " + t.status), n.statusCode = t.status, n.code = 8E4, n.statusText = t.statusText, l(n))
            }
          }
        }
      };
    ...
    a.isAvailable() && (A.httpTransports.xhr = A.transports.xhr = a, Http.Request = function(b, c, d, f, g) {
  ...
  (function() {
    ...
    n.inherits(a, ca);
    a.isAvailable = function() {
      return c && S && 10 <= S.getFlashPlayerVersion().major && O
    };
    a.isAvailable() && (A.transports.flash_socket = a);
    a.tryConnect = function(b, c, d, f) {
