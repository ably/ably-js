    ...
    it('presence_sync_interruptus', function (done) {
      ...
      async.series(
        [
          waitForBothConnect,
          function (cb) {
            ptcb(entererChannel.attach(), cb);
          },
          function (cb) {
            async.times(
              110,
              function (i, presCb) {
                ptcb(entererChannel.presence.enterClient(i.toString(), null), presCb);
              },
              cb
            );
          },
          function (cb) {
            ...
            ptcb(syncerChannel.attach(), cb);
          },
          function (cb) {
            ptcb(syncerChannel.presence.get(), function (err, presenceSet) {
              try {
