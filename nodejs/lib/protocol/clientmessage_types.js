...
var CTraffic = module.exports.CTraffic = function(args) {
...
var CConnections = module.exports.CConnections = function(args) {
  this.plain = null;
  this.tls = null;
  if (args) {
...
var CTimelineStats = module.exports.CTimelineStats = function(args) {
  this.published = null;
...
CTimelineStats.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.published = new ttypes.CTraffic();
      ...
      case 2:
      if (ftype == Thrift.Type.STRUCT) {
        this.deliveredAll = new ttypes.CTraffic();
      ...
      case 3:
      if (ftype == Thrift.Type.STRUCT) {
        this.deliveredRealtime = new ttypes.CTraffic();
      ...
      case 4:
      if (ftype == Thrift.Type.STRUCT) {
        this.deliveredRest = new ttypes.CTraffic();
      ...
      case 5:
      if (ftype == Thrift.Type.STRUCT) {
        this.deliveredPost = new ttypes.CTraffic();
      ...
      case 6:
      if (ftype == Thrift.Type.STRUCT) {
        this.deliveredHttpStream = new ttypes.CTraffic();
      ...
      case 7:
      if (ftype == Thrift.Type.STRUCT) {
        this.connections = new ttypes.CConnections();
...
var TStatsArray = module.exports.TStatsArray = function(args) {
  this.items = null;
  if (args) {
    if (args.items !== undefined) {
      this.items = args.items;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem54 = null;
          elem54 = new ttypes.CTimelineStats();
          elem54.read(input);
