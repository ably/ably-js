(function() {
  ...
  u.prototype = {getArray:function() {
    ...
    a = a || 0;
    c = c || this.length;
    var b = new u, h = b.length = c - a, e = b.offset = this.offset + a, f = b.buf = this.buf;
  ...
  this.Http = function() {
    ...
    a.get = function(b, h, e, f, d) {
      ...
      if("string" == typeof m) {
        ...
        var g;
        e = b.connection;
        var s = b.options, v = s.restHost;
        "connected" == e.state ? g = e.connectionManager.host : s.fallbackHosts || (g = v);
        if(g) {
          p(m(g), d)
        }else {
          var w = fallbackHosts.slice().unshift(v);
    ...
    a.post = function(b, h, e, f, d, p) {
      ...
      if("string" == typeof t) {
        ...
        var s;
        e = b.connection;
        var v = b.options, w = v.restHost;
        "connected" == e.state ? s = e.connectionManager.host : v.fallbackHosts || (s = w);
        if(s) {
          m(t(s), p)
        }else {
          var P = fallbackHosts.slice().unshift(w);
          m(P.shift(), function(a, b, c) {
            if(a) {
              var f = a.code;
              if("ENETUNREACH" == f || "EHOSTUNREACH" == f || "EHOSTDOWN" == f) {
                m(P, p);
  ...
  var S = function() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          ...
          if(0 < n.pv[0]) {
            var t = v(c);
            if(t) {
              if(P(O[b].swfVersion) && !(n.wk && 312 > n.wk)) {
                l(c, !0), e && (h.success = !0, h.ref = f(c), e(h))
              }else {
    ...
    function f(a) {
      var b = null;
      if((a = v(a)) && "OBJECT" == a.nodeName) {
        typeof a.SetVariable != z ? b = a : (a = a.getElementsByTagName(u)[0]) && (b = a)
      }
      return b
    }
    function d() {
      return!J && P("6.0.65") && (n.win || n.mac) && !(n.wk && 312 > n.wk)
    }
    function g(a, b, c, f) {
      J = !0;
      K = f || null;
    ...
    function l(a, b) {
      if(R) {
        ...
        Q && v(a) ? v(a).style.visibility = c : k("#" + a, "visibility:" + c)
      }
    }
    function y(a) {
      return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != z ? encodeURIComponent(a) : a
    }
    var z = "undefined", u = "object", A = "application/x-shockwave-flash", C = "SWFObjectExprInst", x = window, q = document, B = navigator, I = !1, F = [function() {
      I ? h() : e()
    ...
    return{registerObject:function(a, b, c, f) {
    ...
    }, embedSWF:function(a, b, f, e, h, m, t, s, v, w) {
      var k = {success:!1, id:b};
      n.w3 && !(n.wk && 312 > n.wk) && a && b && f && e && h ? (l(b, !1), c(function() {
        f += "";
        e += "";
        var c = {};
        if(v && typeof v === u) {
        ...
        if(t && typeof t === u) {
          for(var U in t) {
            n.flashvars = typeof n.flashvars != z ? n.flashvars + ("\x26" + U + "\x3d" + t[U]) : U + "\x3d" + t[U]
          }
        }
        if(P(h)) {
          q = T(c, n, b), c.id == b && l(b, !0), k.success = !0, k.ref = q
        }else {
          if(m && d()) {
            c.data = m;
            g(c, n, b, w);
    ...
    }, hasFlashPlayerVersion:P, createSWF:function(a, b, c) {
      if(n.w3) {
        return T(a, b, c)
      }
      ...
      if(J) {
        var a = v(C);
        a && E && (a.parentNode.replaceChild(E, a), H && (l(H, !0), n.ie && n.win && (E.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), R = function() {
    ...
    a.prototype.connect = function() {
      ...
      this.auth.getAuthParams(function(c, h) {
        ...
        if(c) {
          ...
          try {
            var v = a.wsConnection = a.createWebSocket(d, r);
            v.binaryType = "arraybuffer";
            v.onopen = function() {
              a.onWsOpen()
            };
            v.onclose = function(b, c) {
              a.onWsClose(b, c)
            };
  ...
  var V = function() {
    ...
    b.prototype.requestToken = function(b, d) {
      ...
      var k = {}, v = b.clientId || this.rest.clientId;
      v && (k.client_id = v);
      v = b.ttl || "";
      "ttl" in b && (k.ttl = v);
    ...
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        var l = a.capability || "";
        l && (e.capability = l);
        var u = this.rest, y = this;
        (function(c) {
          a.timestamp ? c() : a.queryTime ? u.time(function(d, f) {
  ...
  (function() {
    ...
    a.checkConnectivity = function(b) {
      e ? e.push(b) : (e = [b], (new a.Request("isTheInternetUp")).send("http://live.cdn.ably-realtime.com/is-the-internet-up.js", null, null, !1, function(a, b) {
    ...
    a.Request.prototype.send = function(a, c, d, e, h, g) {
      ...
      var u = this, x = this._finish = function() {
        clearTimeout(l);
  ...
  (function() {
    ...
    a.Request.prototype.send = function(a, d, e, f, g, k) {
      ...
      var v = setTimeout(f ? y.cometRecvTimeout : y.cometSendTimeout, function() {
        x = !0;
        s.abort()
      });
      s.open(d, a, !0);
      ...
      s.onreadystatechange = function() {
        if(4 == s.readyState) {
          if(clearTimeout(v), l) {
            ...
            if(s.status == m) {
              var a = null;
              g ? s.response && (a = new u, a.buf = s.response, a.view = new DataView(a.buf)) : a = s.responseText;
              k(null, a)
            }else {
