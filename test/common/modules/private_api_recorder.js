...
define(['test/support/output_directory_paths'], function (outputDirectoryPaths) {
  const privateAPIIdentifiers = [
    ...
    'call.RealtimeObjects._objectsPool._onGCInterval',
    'call.RealtimeObjects._objectsPool.get',
    'call.Utils.copy',
    ...
    'read.RealtimeObjects._DEFAULTS.gcGracePeriod',
    'read.RealtimeObjects.gcGracePeriod',
    ...
    'read.realtime.options.primaryDomain',
    ...
    'read.rest.options.primaryDomain',
    'read.rest.options.token',
    'read.rest.serverTimeOffset',
    'read.transport.params.mode',
    'read.transport.recvRequest.recvUri',
    'read.transport.uri',
    'replace.RealtimeObjects._objectsPool._onGCInterval',
    'replace.RealtimeObjects.publish',
    ...
    'write.RealtimeObjects._DEFAULTS.gcInterval',
    'write.RealtimeObjects.gcGracePeriod',
    ...
    'write.realtime.options.primaryDomain',
