(function() {
  for(var kb = ["web_socket", "flash_socket", "xhr", "jsonp"], xa = function(a, b, c) {
    function f() {
    }
  ...
  var lb = d.CheckedBuffer = function(a) {
    B.call(this, a)
  };
  xa(lb, B, {grow:function(a) {
  ...
  var mb = new B(0), V = d.TTransport = function(a, b) {
    this.buf = a || mb;
    this.onFlush = b;
    this.reset()
  };
  ...
  }], N = [], oa = [], $ = [], da, na, Fa, Ua, S = !1, ma = !1, K, Ia, Ya = !0, h, ob = typeof l.getElementById != q && typeof l.getElementsByTagName != q && typeof l.createElement != q, qa = O.userAgent.toLowerCase(), ra = O.platform.toLowerCase(), pb = ra ? /win/.test(ra) : /win/.test(qa), qb = ra ? /mac/.test(ra) : /mac/.test(qa), rb = /webkit/.test(qa) ? parseFloat(qa.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Ja = !+"\v1", ea = [0, 0, 0], A = null;
  ...
  h = {w3:ob, pv:ea, wk:rb, ie:Ja, win:pb, mac:qb};
  ...
  var Ka, bb = window.location.protocol, cb = bb + "//rest.ably.io:" + ("https:" == bb ? 443 : 80) + "/static/0/WebSocketMainInsecure.swf";
  ...
  k.nextTick = sb ? function(a) {
    setTimeout(a, 0)
  } : process.nextTick;
  var tb = {json:"application/json", jsonp:"application/javascript", xml:"application/xml", html:"text/html"};
  ...
  }, E = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:15E3, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:3E4, defaultMessage:"Connection to server temporarily unavailable"}, suspended:{state:"suspended", terminal:!1, 
  ...
  var t = function(a, b, c) {
    ...
    this.auth = b;
    this.options = c;
    c.useTextProtocol ? (this.thriftTransport = ga.TStringTransport, this.thriftProtocol = ga.TJSONProtocol) : (this.thriftTransport = ga.TTransport, this.thriftProtocol = ga.TBinaryProtocol, this.protocolBuffer = new ga.CheckedBuffer(vb));
    this.isConnected = !1
  }, ga = "object" == typeof window ? d : require("thrift"), vb = 1024;
  k.inherits(t, w);
  ...
  var u = function(a, b, c) {
    c.useTextProtocol = c.useTextProtocol || !wb;
    this.sendOptions = {binary:!c.useTextProtocol};
    t.call(this, a, b, c)
  }, Ma = "object" == typeof window, fb = Ma ? window.WebSocket || window.MozWebSocket : require("ws"), wb = Ma ? !1 : B, xb = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), ta = Ma ? d : require("thrift");
  k.inherits(u, t);
  ...
  u.prototype.connect = function() {
    ...
    this.auth.getAuthParams(function(c, d) {
      ...
      e.logAction(e.LOG_MINOR, "WebSocketTransport.connect()", "authParams:" + g);
      if(c) {
        a.abort("Connection refused by the server")
      }else {
        try {
          var n = a.wsConnection = a.createWebSocket(b, d);
  ...
  u.prototype.onWsData = function(a, b) {
    var c = b ? new ta.TBinaryProtocol(new ta.TTransport(a)) : new ta.TJSONProtocol(new ta.TStringTransport(a)), d = new xb.TChannelMessage;
    try {
  ...
  }, Na = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types");
  ...
  v.prototype.send = function(a, b) {
    if(this.sendRequest) {
      this.pendingMessage = this.pendingMessage || new Na.TMessageSet({items:[]}), this.pendingMessage.push(a), this.pendingCallback = this.pendingCallback || new fa, this.pendingCallback.push(b)
    }else {
      var c = this.pendingMessage || new Na.TMessageSet({items:[]});
      c.items.push(a);
  ...
  v.prototype.onResponseData = function(a) {
    var a = new this.thriftProtocol(new this.thriftTransport(a)), b = new Na.TMessageSet;
    try {
      b.read(a);
      var c = b.items;
      if(c && c.length) {
  ...
  F.Request = function(a, b, c, d, e) {
    var h = Ably._;
    this.callback = e;
    var i = this.requestId = yb++, j = this.timer = setTimeout(d ? 9E4 : 1E4, function() {
      k.abort()
    });
  ...
  var P = function(a, b, c) {
    c.useTextProtocol = !0;
    u.call(this, a, b, c)
  }, zb = "object" == typeof window;
  k.inherits(P, u);
  P.isAvailable = function() {
    return zb && M && 10 <= M.getFlashPlayerVersion().major && Ka
  };
  ...
  }, Oa = "object" == typeof window, Bb = Oa ? null : require("crypto"), ua = void 0;
  Oa && (window.CryptoJS && CryptoJS.HmacSHA256 && CryptoJS.enc.Base64) && (ua = function(a, b) {
    return CryptoJS.HmacSHA256(a, b).toString(CryptoJS.enc.Base64)
  });
  Oa || (ua = function(a, b) {
    var c = Bb.createHmac("SHA256", b);
    c.update(a);
  ...
  aa.prototype.requestToken = function(a, b) {
    ...
    var a = a || {}, b = b || Ab, a = k.mixin(k.copy(this.authOptions), a), c;
    if(a.auth_callback) {
  ...
  var Pa = function(a) {
    ...
    this.connection = new hb(this, a);
    this.channels = new ib(this);
  ...
  ib.prototype.get = function(a, b) {
    ...
    c || (this.attached[a] = c = new La(this.realtime, a, b || {}));
    return c
  };
  this.Realtime = Pa;
  var sa;
  ...
  k.inherits(ha, w);
  ha.prototype.publish = function(a, b, c) {
  ...
  I.prototype.enterClient = function(a, b, c) {
    ...
    a.clientData = ha.createPayload(b);
  ...
  var ja, Qa = function(a, b, c, d) {
    ...
    this.name = c;
    this.data = d
  }, x = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), Eb = {"[object Null]":function(a) {
    a.type = x.TType.NONE;
    return!0
    ...
    var c = Eb[Object.prototype.toString.call(b)];
    return c && c(result, b)
  }};
  Qa.createPayload = function(a) {
    var b = new x.TData, c = Fb[typeof a];
    if(c && c(b, a)) {
      return b
    }
