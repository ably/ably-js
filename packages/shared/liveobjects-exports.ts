 ...
 *
 * `LiveObjects` is the only value `@ably/pubsub-core/liveobjects` exports; everything else it declares is a
 ...
 */
export { LiveObjects } from '@ably/pubsub-core/liveobjects';
