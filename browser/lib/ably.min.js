(function() {
  ...
  this.Http = function() {
    ...
    a.get = function(b, g, e, f, d) {
      ...
      if("string" == typeof l) {
        ...
        var L;
        L = (e = b.connection) && "connected" == e.state ? [e.connectionManager.host] : t.getHosts(b.options);
        1 == L.length ? m(l(L[0]), d) : m(L.shift(), function(a, b, c) {
          if(a) {
            var f = a.code;
  ...
  this.Base64 = function() {
    ...
    var g = {codex:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode:function(b) {
      ...
      for(b = new c(b);b.moveNext();) {
        ...
        var l = b.current;
        b.moveNext();
        var p = b.current, h = m >> 2, m = (m & 3) << 4 | l >> 4, C = (l & 15) << 2 | p >> 6, y = p & 63;
        isNaN(l) ? C = y = 64 : isNaN(p) && (y = 64);
        f.append(d.charAt(h) + d.charAt(m) + d.charAt(C) + d.charAt(y))
      }
      return f.toString()
    }, decode:function(c) {
      var f = new a;
  ...
  var T = function() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          ...
          if(0 < q.pv[0]) {
            var p = y(c);
            if(p) {
              if(k(B[b].swfVersion) && !(q.wk && 312 > q.wk)) {
                R(c, !0), e && (g.success = !0, g.ref = f(c), e(g))
              }else {
                if(B[b].expressInstall && d()) {
                  ...
                  for(var h = {}, p = p.getElementsByTagName("param"), L = p.length, C = 0;C < L;C++) {
                    "movie" != p[C].getAttribute("name").toLowerCase() && (h[p[C].getAttribute("name")] = p[C].getAttribute("value"))
                  }
                  m(g, h, c, e)
                }else {
                  l(p), e && e(g)
    ...
    function n(a, b, c, f) {
      if(!q.ie || !q.mac) {
        ...
        if(g) {
          ...
          f && (O = M = null);
          if(!M || O != c) {
            f = s.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), M = g.appendChild(f), q.ie && (q.win && typeof s.styleSheets != x && 0 < s.styleSheets.length) && (M = s.styleSheets[s.styleSheets.length - 1]), O = c
          }
          q.ie && q.win ? M && typeof M.addRule == r && M.addRule(a, b) : M && typeof s.createTextNode != x && M.appendChild(s.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function R(a, b) {
      if(S) {
        ...
        Q && y(a) ? y(a).style.visibility = c : n("#" + a, "visibility:" + c)
      }
    }
    function t(a) {
    ...
    var x = "undefined", r = "object", w = "application/x-shockwave-flash", A = "SWFObjectExprInst", v = window, s = document, z = navigator, F = !1, E = [function() {
      F ? g() : e()
    }], B = [], H = [], D = [], G, I, K, N, Q = !1, J = !1, M, O, S = !0, q = function() {
    ...
    (function() {
      q.w3 && ((typeof s.readyState != x && "complete" == s.readyState || typeof s.readyState == x && (s.getElementsByTagName("body")[0] || s.body)) && a(), Q || (typeof s.addEventListener != x && s.addEventListener("DOMContentLoaded", a, !1), q.ie && q.win && (s.attachEvent("onreadystatechange", function() {
        ...
        Q || (/loaded|complete/.test(s.readyState) ? a() : setTimeout(arguments.callee, 0))
      }(), b(a)))
    })();
    (function() {
    ...
    return{registerObject:function(a, b, c, f) {
    ...
    }, embedSWF:function(a, b, f, g, e, l, p, C, y, P) {
      var n = {success:!1, id:b};
      q.w3 && !(q.wk && 312 > q.wk) && a && b && f && g && e ? (R(b, !1), c(function() {
        f += "";
        g += "";
        var c = {};
        if(y && typeof y === r) {
        ...
        if(k(e)) {
          s = h(c, q, b), c.id == b && R(b, !0), n.success = !0, n.ref = s
        }else {
          if(l && d()) {
            c.data = l;
            m(c, q, b, P);
      ...
      if(J) {
        var a = y(A);
        a && G && (a.parentNode.replaceChild(G, a), I && (R(I, !0), q.ie && q.win && (G.style.display = "block")), K && K(N));
        J = !1
      }
    }}
  }(), S = function() {
        ...
        case b.MESSAGE:
          if(a = a.messages) {
            for(var c = Array(a.length), d = this.cipher, e = 0;e < c.length;e++) {
              ...
              c[e] = new O(g.channelSerial, g.timestamp, g.name, Data.fromTData(g.data))
            }
            this.onEvent(c)
          }
          break;
  ...
  (function() {
    ...
    a.tryConnect = function(b, c, d, f) {
      ...
      S.__initialize(k);
      m && S.loadFlashPolicyFile("xmlsocket://" + d.host + ":" + m);
      var l = new a(b, c, d);
      errorCb = function(a) {
        f(a)
      };
