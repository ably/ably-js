(function() {
  for(var t = {protocolVersion:1, REST_HOST_DEBUG:"rest-debug.ably.io", REST_HOST:"rest.ably.io", CDN_HOST:"rest.ably.io", WS_HOST_DEBUG:"realtime-debug.ably.io", WS_HOST:"realtime.ably.io", WS_PORT:80, WSS_PORT:443, HOST_DEBUG:"sandbox.ably.io", connectTimeout:2E4, disconnectTimeout:6E4, suspendedTimeout:12E4, cometRecvTimeout:9E4, cometSendTimeout:1E4, transports:["web_socket", "flash_socket", "xhr", "jsonp"]}, ya = function(a, b, c) {
    function f() {
    }
  ...
  V.MAX_INT = Math.pow(2, 53);
  V.MIN_INT = -Math.pow(2, 53);
  V.prototype = {_2scomp:function() {
    ...
    return!a && g >= V.MAX_INT ? f ? -Infinity : Infinity : f ? -g : g
  }, valueOf:function() {
  ...
  D.prototype = {getArray:function() {
    ...
    var a = a || 0, b = b || this.length, c = new D, f = c.length = b - a, g = c.offset = this.offset + a, d = c.buf = this.buf;
    ...
    return za.decode(this.view, a, b)
    ...
    return za.encode(b, this.view, a)
  }, inspect:function() {
  ...
  i.prototype.writeI64 = function(a) {
    a.buffer ? this.trans.writeI64(a) : this.trans.writeI64(new V(a))
  };
  ...
  i.prototype.readMessageBegin = function() {
    ...
    if(0 > a) {
      b = a & -65536;
      if(-2147418112 != b) {
        throw console.log("BAD: " + b), Aa(4, "Bad version in readMessageBegin: " + a);
      }
      a &= 255;
      b = this.readString()
    }else {
      if(this.strictRead) {
        throw Aa(4, "No protocol version header");
      }
      b = this.trans.read(a);
      a = this.readByte()
    }
  ...
  var mb = new D(0), W = d.TTransport = function(a, b) {
    this.buf = a || mb;
    this.onFlush = b;
    this.reset()
  };
  W.receiver = function(a) {
    return function(b) {
      a(new W(b))
    }
  };
  W.prototype = {commitPosition:function() {
  ...
  var Ba = d.TFramedTransport = function(a, b) {
    W.call(this, a, b)
  };
  Ba.receiver = function(a) {
    var b = 0, c = 0, f = null, g = null;
    return function(d) {
      if(g) {
        var e = new D(d.length + g.length);
        g.copy(e, 0, 0);
        d.copy(e, g.length, 0);
        g = null
      }
      for(;d.length;) {
        ...
        d.length >= b ? (d.copy(f, c, 0, b), d = d.slice(b, d.length), b = 0, a(new Ba(f))) : d.length && (d.copy(f, c, 0, d.length), b -= d.length, c += d.length, d = d.slice(d.length, d.length))
      }
    }
  };
  ya(Ba, W, {flush:function() {
    var a = this;
    W.prototype.flush.call(this, function(b) {
      if(a.onFlush) {
        var c = new D(b.length + 4);
    ...
    for(a.readStructBegin();;) {
      ...
      switch(b.fid) {
        ...
        case 4:
          ...
          break;
        case 5:
          c == d.Type.STRUCT ? (this.payload = new S, this.payload.read(a)) : a.skip(c);
          break;
        case 6:
          if(c == d.Type.LIST) {
            b = 0;
      ...
      switch(b.fid) {
        ...
        case 14:
          if(c == d.Type.SET) {
            ...
            for(c = 0;c < b;++c) {
              f = null, f = new X, f.read(a), this.presence.push(f)
            }
            a.readSetEnd()
          }else {
            a.skip(c)
  ...
  var H = {TAction:TAction, TType:TType, TData:S, TPresence:X, TMessage:Y, TChannelMessage:Z, TMessageSet:da}, N, $ = function() {
    if(!T) {
      try {
    ...
    if(0 < a) {
      for(var b = 0;b < a;b++) {
        ...
        if(0 < h.pv[0]) {
          var e = I(c);
          if(e) {
            if(ma(O[b].swfVersion) && !(h.wk && 312 > h.wk)) {
              U(c, !0), f && (d.success = !0, d.ref = Ca(c), f(d))
            }else {
              if(O[b].expressInstall && Da()) {
                d = {};
          ...
          if(U(c, !0), f) {
            if((c = Ca(c)) && typeof c.SetVariable != q) {
              d.success = !0, d.ref = c
            }
            f(d)
          }
    ...
    if((a = I(a)) && "OBJECT" == a.nodeName) {
      typeof a.SetVariable != q ? b = a : (a = a.getElementsByTagName(K)[0]) && (b = a)
    }
    return b
  }, Da = function() {
    return!na && ma("6.0.65") && (h.win || h.mac) && !(h.wk && 312 > h.wk)
  }, Ea = function(a, b, c, f) {
    na = !0;
    Ga = f || null;
    Ua = {success:!1, id:c};
    var d = I(c);
    if(d) {
      "OBJECT" == d.nodeName ? (ea = Ha(d), oa = null) : (ea = d, oa = c);
      a.id = Va;
      ...
      f = "MMredirectURL=" + E.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + f + "&MMdoctitle=" + l.title;
    ...
    if(h.ie && h.win && 4 != a.readyState) {
      ...
      a.parentNode.replaceChild(Ha(a), a)
    }
  }, Ha = function(a) {
    var b = l.createElement("div");
    if(h.win && h.ie) {
    ...
    if(!h.ie || !h.mac) {
      ...
      if(d) {
        ...
        f && (Ja = L = null);
        if(!L || Ja != c) {
          f = l.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), L = d.appendChild(f), h.ie && (h.win && typeof l.styleSheets != q && 0 < l.styleSheets.length) && (L = l.styleSheets[l.styleSheets.length - 1]), Ja = c
        }
        h.ie && h.win ? L && typeof L.addRule == K && L.addRule(a, b) : L && typeof l.createTextNode != q && L.appendChild(l.createTextNode(a + " {" + b + "}"))
      }
    }
  }, U = function(a, b) {
    if(Ya) {
      var c = b ? "visible" : "hidden";
      T && I(a) ? I(a).style.visibility = c : Xa("#" + a, "visibility:" + c)
    }
  }, Za = function(a) {
    return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != q ? encodeURIComponent(a) : a
  }, q = "undefined", K = "object", qa = "application/x-shockwave-flash", Va = "SWFObjectExprInst", E = window, l = document, P = navigator, $a = !1, la = [function() {
    if($a) {
      var a = l.getElementsByTagName("body")[0], b = l.createElement(K);
      b.setAttribute("type", qa);
  ...
  }], O = [], pa = [], aa = [], ea, oa, Ga, Ua, T = !1, na = !1, L, Ja, Ya = !0, h, ob = typeof l.getElementById != q && typeof l.getElementsByTagName != q && typeof l.createElement != q, ra = P.userAgent.toLowerCase(), sa = P.platform.toLowerCase(), pb = sa ? /win/.test(sa) : /win/.test(ra), qb = sa ? /mac/.test(sa) : /mac/.test(ra), rb = /webkit/.test(ra) ? parseFloat(ra.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Ka = !+"\v1", fa = [0, 0, 0], B = null;
  if(typeof P.plugins != q && typeof P.plugins["Shockwave Flash"] == K) {
    if((B = P.plugins["Shockwave Flash"].description) && !(typeof P.mimeTypes != q && P.mimeTypes[qa] && !P.mimeTypes[qa].enabledPlugin)) {
      $a = !0, Ka = !1, B = B.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), fa[0] = parseInt(B.replace(/^(.*)\..*$/, "$1"), 10), fa[1] = parseInt(B.replace(/^.*\.(.*)\s.*$/, "$1"), 10), fa[2] = /[a-zA-Z]/.test(B) ? parseInt(B.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    }
  }else {
    if(typeof E.ActiveXObject != q) {
      try {
        var ab = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
        if(ab && (B = ab.GetVariable("$version"))) {
          Ka = !0, B = B.split(" ")[1].split(","), fa = [parseInt(B[0], 10), parseInt(B[1], 10), parseInt(B[2], 10)]
        }
      }catch(Fb) {
      }
    }
  }
  h = {w3:ob, pv:fa, wk:rb, ie:Ka, win:pb, mac:qb};
  h.w3 && ((typeof l.readyState != q && "complete" == l.readyState || typeof l.readyState == q && (l.getElementsByTagName("body")[0] || l.body)) && $(), T || (typeof l.addEventListener != q && l.addEventListener("DOMContentLoaded", $, !1), h.ie && h.win && (l.attachEvent("onreadystatechange", function() {
    ...
    T || (/loaded|complete/.test(l.readyState) ? $() : setTimeout(arguments.callee, 0))
  }(), Ta($)));
  h.ie && h.win && window.attachEvent("onunload", function() {
    for(var a = aa.length, b = 0;b < a;b++) {
      aa[b][0].detachEvent(aa[b][1], aa[b][2])
    }
    a = pa.length;
    for(b = 0;b < a;b++) {
      Wa(pa[b])
  ...
  N = {registerObject:function(a, b, c, f) {
    if(h.w3 && a && b) {
      var d = {};
      d.id = a;
      d.swfVersion = b;
    ...
    h.w3 && !(h.wk && 312 > h.wk) && a && b && c && f && d ? (U(b, !1), Sa(function() {
      c += "";
      f += "";
      var h = {};
      if(m && typeof m === K) {
      ...
      if(ma(d)) {
        l = Ia(h, i, b), h.id == b && U(b, !0), k.success = !0, k.ref = l
      }else {
        if(e && Da()) {
          h.data = e;
          Ea(h, i, b, j);
  ...
  }, hasFlashPlayerVersion:ma, createSWF:function(a, b, c) {
    if(h.w3) {
      return Ia(a, b, c)
    }
    ...
    if(na) {
      var a = I(Va);
      a && ea && (a.parentNode.replaceChild(ea, a), oa && (U(oa, !0), h.ie && h.win && (ea.style.display = "block")), Ga && Ga(Ua));
      na = !1
    }
  }};
  var La, bb = window.location.protocol, cb = bb + "//" + t.HOST_CDN + ":" + ("https:" == bb ? t.HTTPS_PORT : t.HTTP_PORT) + t.STATIC_PATH + "WebSocketMainInsecure.swf";
  ...
  j.__initialize = function() {
    if(!j.__initialized) {
      ...
      N.embedSWF(cb, "webSocketFlash", "1", "1", "10.0.0", null, null, {hasPriority:!0, swliveconnect:!0, allowScriptAccess:"always"}, null, function(a) {
  ...
  k.copyFile = function(a, b, c) {
    ...
    c = path.dirname(b);
    k.mkdirs(c);
    for(var c = new D(1024), a = fs.openSync(a, "r"), b = fs.openSync(b, "w"), f;0 < (f = fs.readSync(a, c, 0, 1024));) {
  ...
  k.inherits(ga, Function);
  ga.prototype.push = function() {
  ...
  var M, p = function(a, b) {
    ...
    b.transports = b.transports || t.transports;
  ...
  }, F = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:t.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:t.disconnectTimeout, defaultMessage:"Connection to server temporarily unavailable"}, suspended:{state:"suspended", 
  terminal:!1, queueEvents:!1, sendEvents:!1, retryDelay:t.suspendedTimeout, defaultMessage:"Connection to server unavailable"}, closed:{state:"closed", terminal:!1, queueEvents:!1, sendEvents:!1, defaultMessage:"Connection closed by client"}, failed:{state:"failed", terminal:!0, queueEvents:!1, sendEvents:!1, defaultMessage:"Connection failed or disconnected by server"}};
  k.inherits(p, x);
  ...
  p.prototype.notifyState = function(a) {
    if(!(this.state.terminal || a.state == this.state.state)) {
      ...
      a = new ta(this.state.state, b.state, b.retryDelay, a.reason || b.defaultMessage);
  ...
  p.prototype.requestState = function(a) {
    ...
    if(a.state != this.state.state) {
      ...
      var b = F[a.state], a = new ta(this.state.state, b.state, b.retryIn, a.reason || b.defaultMessage);
      this.enactStateChange(a)
    }
  };
  p.prototype.connectImpl = function() {
    ...
    var a = this, b = this.ably.auth, c = function(f) {
      ...
      a.notifyState({state:F.connecting.failState, reason:"Connection to server unavailable(" + f + ")"})
    }, f = function() {
  ...
  p.prototype.send = function(a, b, c) {
    c = c || ub;
    this.state.queueEvents && (b ? (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "queueing event"), (b = this.pendingMessages[this.pendingMessages.length - 1]) && Ma.mergeTo(b.msg, a) ? (b.isMerged || (b.callback = new ga([b.callback]), b.isMerged = !0), b.listener.push(c)) : this.pendingMessages.push({msg:a, callback:c})) : (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), c(this.state.defaultMessage)));
  ...
  var u = function(a, b, c) {
    ...
    this.auth = b;
    this.options = c;
    c.useTextProtocol ? (this.thriftTransport = ha.TStringTransport, this.thriftProtocol = ha.TJSONProtocol) : (this.thriftTransport = ha.TTransport, this.thriftProtocol = ha.TBinaryProtocol, this.protocolBuffer = new ha.CheckedBuffer(vb));
    this.isConnected = !1
  }, ha = "object" == typeof window ? d : require("thrift"), vb = 1024;
  k.inherits(u, x);
  ...
  u.prototype.sendMessage = function(a, b) {
  ...
  var v = function(a, b, c) {
    ...
    u.call(this, a, b, c)
  }, fb = "object" == typeof window, gb = fb ? window.WebSocket || window.MozWebSocket : require("ws"), wb = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types"), ua = fb ? d : require("thrift");
  k.inherits(v, u);
  v.isAvailable = function() {
    return!!gb
  };
  v.isAvailable() && (M.availableTransports.web_socket = v);
  v.tryConnect = function(a, b, c, f) {
    var d = new v(a, b, c), h = function(a) {
      f(a)
    };
    d.on("wserror", h);
  ...
  v.prototype.onWsData = function(a, b) {
    var c = b ? new ua.TBinaryProtocol(new ua.TTransport(a)) : new ua.TJSONProtocol(new ua.TStringTransport(a)), d = new wb.TChannelMessage;
    try {
  ...
  v.prototype.onWsClose = function(a, b) {
    ...
    u.prototype.onClose.call(this, c, g)
  };
  ...
  }, Na = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types");
  (k || require("util")).inherits(w, u);
  ...
  w.prototype.connect = function() {
    ...
    this.auth.getAuthParams(function(c, d) {
      a.params = d;
      e.logAction(e.LOG_MINOR, "CometTransport.connect()", "authParams:" + w.paramStr(d));
      if(c) {
        a.abort("Connection refused by the server")
      }else {
        try {
  ...
  w.prototype.send = function(a, b) {
    if(this.sendRequest) {
      this.pendingMessage = this.pendingMessage || new Na.TMessageSet({items:[]}), this.pendingMessage.push(a), this.pendingCallback = this.pendingCallback || new ga, this.pendingCallback.push(b)
    }else {
  ...
  C.isAvailable() && (M.availableTransports.xhr = C);
  ...
  C.Request = function(a, b, c, d, e, h) {
    var a = w.paramStr(b, a), j;
    c ? (b = "POST", j = 201) : (b = "GET", j = 200);
    var i = this.xhr = hb();
    e && (i.responseType = "arraybuffer");
    var m = setTimeout(d ? t.cometRecvTimeout : t.cometSendTimeout, function() {
      i.abort()
    });
    i.open(b, a, !0);
    ...
    i.onreadystatechange = function() {
      if(4 == i.readyState) {
        clearTimeout(m);
        var a = null;
        i.status != j ? (a = Error("Unexpected response: statusCode = " + i.status), a.statusCode = i.status, a.statusText = i.statusText, h(a)) : (a = null, e ? i.response && (a = new D, a.buf = i.response, a.view = new DataView(a.buf)) : a = i.responseText, h(null, a))
      }
    };
    i.send(c)
  };
  ...
  G.tryConnect = function(a, b, c, d) {
    var g = new G(a, b, c), h = function(a) {
      d(a)
    };
    g.on("error", h);
    g.on("preconnect", function() {
  ...
  G.Request = function(a, b, c, d, e) {
    var h = Ably._;
    this.callback = e;
    var i = this.requestId = xb++, j = this.timer = setTimeout(d ? t.cometRecvTimeout : t.cometSendTimeout, function() {
      k.abort()
    });
  ...
  var Q = function(a, b, c) {
    c.useTextProtocol = !0;
    v.call(this, a, b, c)
  }, yb = "object" == typeof window;
  k.inherits(Q, v);
  Q.isAvailable = function() {
    return yb && N && 10 <= N.getFlashPlayerVersion().major && La
  };
  Q.isAvailable() && (M.availableTransports.flash_socket = Q);
  ...
  Q.prototype.createWebSocket = function(a, b) {
    ...
    this.uri = a;
    return new La(a, [], this.options.proxyHost, this.options.proxyPort)
  };
  ...
  R.prototype.post = function(a, b, c) {
  ...
  }, Oa = "object" == typeof window, Ab = Oa ? null : require("crypto"), va = void 0;
  Oa && (window.CryptoJS && CryptoJS.HmacSHA256 && CryptoJS.enc.Base64) && (va = function(a, b) {
    return CryptoJS.HmacSHA256(a, b).toString(CryptoJS.enc.Base64)
  });
  Oa || (va = function(a, b) {
    var c = Ab.createHmac("SHA256", b);
    c.update(a);
    return c.digest("base64")
  });
  ba.prototype.authorise = function(a, b) {
    if(this.token) {
  ...
  ba.prototype.requestToken = function(a, b) {
    "function" == typeof a && !b && (b = a, a = {});
    var a = a || {}, b = b || zb, a = k.mixin(k.copy(this.authOptions), a), c;
    if(a.auth_callback) {
  ...
  ba.prototype.createTokenRequest = function(a, b) {
  ...
  ba.prototype.getAuthParams = function(a) {
  ...
  ba.prototype.getAuthHeaders = function(a) {
    "basic" == this.method ? a(null, {authorization:"Basic " + (new D(this.key || this.key_id + ":" + this.key_value, "ascii")).toString("base64")}) : this.authorise({}, function(b, c) {
  ...
  var Pa = function(a) {
    ...
    var b = a.restHost = a.restHost || (a.debug ? t.REST_HOST_DEBUG : t.REST_HOST), c = a.restPort = a.tlsPort || a.encrypted && a.port || t.WSS_PORT;
    this.baseUri = (this.authority = "https://" + b + ":" + c) + "/apps/" + this.options.appId;
    a.wsHost = a.wsHost || (a.debug ? t.WS_HOST_DEBUG : t.WS_HOST);
    a.wsPort = a.encrypted ? c : a.wsPort || t.WS_PORT;
    b = k.defaultHeaders["json" == a.format];
    a.headers && (b = k.mixin(k.copy(a.headers), this.headers));
    this.headers = b;
    this.auth = new ba(this, a);
    this.connection = new ib(this, a);
    this.channels = new jb(this);
    this.events = new R(this, "/events");
    this.stats = new R(this, "/stats");
  ...
  jb.prototype.get = function(a, b) {
    ...
    c || (this.attached[a] = c = new Ma(this.realtime, a, b || {}));
    return c
  };
  this.Realtime = Pa;
  var ta;
  ...
  var ia = function(a, b) {
    ...
    this.rest = a;
    this.name = b;
    this.presence = new R(a, "/channels/" + b + "/presence");
    this.events = new R(a, "/channels/" + b + "/events");
    this.stats = new R(a, "/channels/" + b + "/stats")
  }, Bb = function() {
  };
  k.inherits(ia, x);
  ia.prototype.publish = function(a, b, c) {
    e.logAction(e.LOG_MICRO, "Channel.publish()", "name = " + a);
    c = c || Bb;
    (this._publish = this._publish || new R(this.rest, "/channels/" + this.name + "/publish")).post({name:a, payload:b}, c)
  };
  var Ma, s = function(a, b, c) {
    ...
    this.options = k.prototypicalClone(Cb, c);
    this.state = "initialized";
    this.subscriptions = new x;
    this.pendingSubscriptions = {};
    this.pendingEvents = []
  }, A = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types"), ja = function() {
  }, Cb = {queueEvents:!0};
  k.inherits(s, ia);
  s.prototype.publish = function(a, b, c) {
    ...
    M.activeState(d) ? (d = new A.TMessage, d.name = a, d.payload = ka.createPayload(b), "attached" == this.state ? (e.logAction(e.LOG_MICRO, "RealtimeChannel.publish()", "sending message"), b = new A.TChannelMessage, b.action = A.TAction.EVENT, b.name = a, b.channel = this.name, b.messages = [d], this.sendMessage(b, c)) : ("pending" != this.state && this.attach(), e.logAction(e.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:d, listener:c}))) : c(d.defaultMessage)
  };
  ...
  s.prototype.attach = function(a) {
    ...
    }), e.logAction(e.LOG_MICRO, "RealtimeChannel.attach()", "sending ATTACH message"), this.state = "pending", c = new A.TChannelMessage({action:A.TAction.ATTACH, channel:this.name}), this.sendMessage(c, ja)) : a(c.defaultMessage)
  };
  s.prototype.detach = function(a) {
    ...
    }), e.logAction(e.LOG_MICRO, "RealtimeChannel.attach()", "sending DETACH message"), c = new A.TChannelMessage({action:A.TAction.DETACH, channel:this.name}), this.sendMessage(c)) : a(c.defaultMessage)
  };
  s.prototype.subscribe = function() {
    var a = Array.prototype.slice.call(arguments);
    "function" == typeof a[0] && a.unshift("*");
    var b = a[0], c = a[1], d = a[2] = a[2] || ja;
  ...
  s.prototype.subscribeForEvent = function(a, b, c) {
    if(this.subscriptions.listeners("*" === a ? null : a)) {
      ...
      a = new A.TChannelMessage({action:A.TAction.SUBSCRIBE, channel:this.name, name:a});
      this.sendMessage(a, ja)
    }
  };
  ...
  s.prototype.unsubscribeForEvent = function(a, b, c) {
    ...
    d.off(a, b);
    d.listeners("*" === a ? null : a) ? c() : (e.logAction(e.LOG_MICRO, "RealtimeChannel.unsubscribe()", "sending UNSUBSCRIBE message"), a = new A.TChannelMessage({action:A.TAction.UNSUBSCRIBE, channel:this.name, name:a}), this.sendMessage(a, ja))
  };
  ...
  s.prototype.sendPresence = function(a, b) {
    var c = new A.TChannelMessage({action:A.TAction.PRESENCE, name:name});
    this.sendMessage(c, b)
  };
    ...
    switch(a.action) {
      ...
      case 13:
        if(a = a.messages) {
          ...
          for(c in a) {
            var d = a[c];
            b[c] = new ka(d.channelSerial, d.timestamp, d.name, ka.getPayload(d.payload))
          }
          this.onEvent(b)
        }
        break;
  ...
  s.prototype.setAttached = function(a) {
    ...
    try {
      if(this.pendingEvents.length) {
        var b = new A.TChannelMessage({action:A.TAction.EVENT, name:this.name}), c = new ga;
  ...
  Ma = s;
  var kb, J = function(a, b) {
    x.call(this);
    this.channel = a;
    this.clientId = b.clientId;
    this.clients = {}
  }, xa = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types");
  k.inherits(J, x);
  ...
  J.prototype.enterClient = function(a, b, c) {
    ...
    this.clients[a] = b;
    a = new xa.TPresence({state:xa.TPresenceState.ENTER, clientId:this.clientId});
    a.clientData = ia.createPayload(b);
  ...
  J.prototype.leaveClient = function(a, b) {
    ...
    var c = new xa.TPresence({state:xa.TPresenceState.LEAVE, clientId:this.channel.ably.options.clientId});
  ...
  J.prototype.setPresence = function(a, b) {
    ...
    for(var c in a) {
      ...
      "leave" == d.state ? delete this.clients[h] : g = this.clients[h] = ka.getPayload(d.clientData);
  ...
  kb = J;
  var ka, Qa = function(a, b, c, d) {
    this.channelSerial = a;
    this.timestamp = b;
    this.name = c;
    this.data = d
  }, y = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types"), Db = {"[object Null]":function(a) {
    a.type = y.TType.NONE;
    return!0
  }, "[object Buffer]":function(a, b) {
    a.type = y.TType.BUFFER;
    a.binaryData = b;
    return!0
    ...
    result.mapData = b;
    return!0
  }}, Eb = {undefined:function(a) {
    a.type = y.TType.NONE;
    return!0
  }, "boolean":function(a, b) {
    a.type = b ? y.TType.TRUE : y.TType.FALSE;
    return!0
  }, string:function(a, b) {
    a.type = y.TType.STRING;
    a.stringData = b;
    ...
    var c = Db[Object.prototype.toString.call(b)];
    return c && c(result, b)
  }};
  Qa.createPayload = function(a) {
    var b = new y.TData, c = Eb[typeof a];
    if(c && c(b, a)) {
      return b
    }
