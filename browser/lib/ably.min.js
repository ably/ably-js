(function() {
  ...
  Y.receiver = function(a) {
    ...
    return function(f) {
      ...
      for(;f.length;) {
        ...
        f.length >= c ? (f.copy(g, b, 0, c), f = f.slice(c, f.length), c = 0, a(new Y(g))) : f.length && (f.copy(g, b, 0, f.length), c -= f.length, b += f.length, f = f.slice(f.length, f.length))
      }
    }
  };
  L(Y, I, {flush:function() {
    var a = this;
    ...
    for(a.readStructBegin();;) {
      ...
      switch(c.fid) {
        ...
        case 3:
          ...
          break;
        case 4:
          b == d.Type.STRUCT ? (this.error = new K, this.error.read(a)) : a.skip(b);
          break;
        case 5:
  ...
  var r = {TAction:TAction, TFlags:TFlags, TType:TType, TError:K, TData:E, TPresence:H, TMessage:D, TChannelMessage:void 0, TProtocolMessage:M};
  ...
  var S = function() {
    ...
    function n(a, b, c, f) {
      if(!q.ie || !q.mac) {
        ...
        if(g) {
          ...
          f && (L = N = null);
          if(!N || L != c) {
            f = s.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), N = g.appendChild(f), q.ie && (q.win && typeof s.styleSheets != x && 0 < s.styleSheets.length) && (N = s.styleSheets[s.styleSheets.length - 1]), L = c
          }
          q.ie && q.win ? N && typeof N.addRule == r && N.addRule(a, b) : N && typeof s.createTextNode != x && N.appendChild(s.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function R(a, b) {
    ...
    var x = "undefined", r = "object", w = "application/x-shockwave-flash", A = "SWFObjectExprInst", v = window, s = document, z = navigator, F = !1, E = [function() {
      F ? g() : e()
    }], C = [], H = [], D = [], G, I, K, M, Q = !1, J = !1, N, L, O = !0, q = function() {
    ...
    return{registerObject:function(a, b, c, f) {
    ...
    }, embedSWF:function(a, b, f, g, e, l, p, B, y, P) {
      ...
      if(J) {
        var a = y(A);
        a && G && (a.parentNode.replaceChild(G, a), I && (R(I, !0), q.ie && q.win && (G.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), U = function() {
    ...
    h.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          ...
          var h = JSON.parse(a), m = h.length, f = Array(m);
          for(e = 0;e < m;e++) {
            f[e] = d.fromJSON(h[e])
          }
        }
  ...
  var V = function() {
    ...
    a.prototype.get = function(a) {
      var b = this;
      V.get(this.rest, this.path, this.headers, this.params, function(d, e, f) {
        if(d) {
    ...
    b.prototype.authorise = function(a, b) {
      ...
      this.requestToken(a, function(a, c) {
        a ? b(a) : b(null, f.token = c)
      })
    };
    b.prototype.requestToken = function(b, f) {
      "function" == typeof b && !f && (f = b, b = {});
      b = b || {};
      f = f || a;
      b = n.mixin(n.copy(this.tokenOptions), b);
      var d, e = this.rest;
      if(b.authCallback) {
        h.logAction(h.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_callback"), d = b.authCallback
      }else {
        if(b.authUrl) {
          h.logAction(h.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), d = function(a, c) {
      ...
      d(u, function(a, b) {
        a ? (h.logAction(h.LOG_ERROR, "Auth.requestToken()", "token request signing call returned error; err \x3d " + a), f(a)) : r(b, function(a, b) {
          a ? (h.logAction(h.LOG_ERROR, "Auth.requestToken()", "token request API call returned error; err \x3d " + a), f(a)) : (h.logAction(h.LOG_MINOR, "Auth.getToken()", "token received"), f(null, b.access_token))
        })
      })
    };
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        (function(c) {
          a.timestamp ? c() : a.queryTime ? n.time(function(f, d) {
            f ? b(f) : (a.timestamp = Math.floor(d / 1E3), c())
    ...
    n.inherits(a, v);
    a.prototype.on = function(a, b) {
      v.prototype.on.apply(this, arguments);
      if(this.state == a && b) {
        try {
          b(new $(void 0, a))
        }catch(d) {
    ...
    c.prototype.presence = function(b, c) {
      ...
      V.get(d, "/channels/" + this.name + "/presence", u, b, function(a, b) {
        a ? c(a) : f ? ea.decodeTPresenceArray(b, c) : c(null, b)
      })
    };
    c.prototype.history = function(b, c) {
      ...
      d.options.headers && n.mixin(u, d.options.headers);
      V.get(d, "/channels/" + this.name + "/history", u, b, function(a, b) {
        if(a) {
          c(a)
        }else {
          try {
    ...
    c.prototype.publish = function(b, c, d) {
      ...
      V.post(f, "/channels/" + this.name + "/publish", b, u, null, d)
    };
    return c
  }(), ca = function() {
    function a(a, b, c) {
    ...
    a.prototype.publish = function() {
      ...
      if(z.activeState(a.state)) {
        var b = arguments.length, a = arguments[0], e = arguments[b - 1];
        "function" !== typeof e && (e = d, ++b);
        2 == b ? n.isArray(a) || (a = [a]) : (a = new c.TMessage, a.name = arguments[0], a.data = Data.toTData(arguments[1]), a = [a]);
        if(b = this.cipher) {
    ...
    c.prototype.setPresence = function(b, c) {
      ...
      for(var m = 0;m < b.length;m++) {
        var l = b[m], p = a.call(l.clientId, l.memberId), k = new ea(l.clientId, Data.fromTData(l.clientData), l.memberId);
        switch(l.state) {
          case d.LEAVE:
  ...
  (function() {
    ...
    a.Request.prototype.send = function(a, d, e, f, h, k) {
      a = J.paramStr(d, a);
      var l, p, n;
      ...
      r.onabort = function() {
        p = Error(n ? "Request timed out" : "Request cancelled");
        p.statusCode = 404;
        p.code = 8E4;
        k(p)
      };
        ...
        if(4 == r.readyState) {
          if(clearTimeout(v), p) {
            ...
            if(r.status == l) {
              ...
              0 != r.status && (p = Error("Unexpected response: statusCode \x3d " + r.status), p.statusCode = r.status, p.code = 8E4, p.statusText = r.statusText, k(p))
            }
          }
        }
      };
  ...
  (function() {
    ...
    n.inherits(a, da);
    a.isAvailable = function() {
      return c && S && 10 <= S.getFlashPlayerVersion().major && U
    };
    ...
    a.tryConnect = function(b, c, d, f) {
      ...
      U.__initialize(k);
      var l = new a(b, c, d);
      m && U.loadFlashPolicyFile("xmlsocket://" + l.wsHost + ":" + m);
      errorCb = function(a) {
        f(a)
      };
