(function() {
  for(var mb = ["web_socket", "flash_socket", "xhr", "jsonp"], na = {disconnected:{statusCode:408, code:80003, reason:"Connection to server temporarily unavailable"}, suspended:{statusCode:408, code:80002, reason:"Connection to server unavailable"}, failed:{statusCode:408, code:8E4, reason:"Connection failed or disconnected by server"}}, Ca = function(a, b, c) {
    function f() {
    }
  ...
  $.MIN_INT = -Math.pow(2, 53);
  $.prototype = {_2scomp:function() {
    ...
    for(var b = this.buffer, c = this.offset, f = b[0] & 128, h = 0, d = 1, e = 7, m = 1;0 <= e;e--, m *= 256) {
      var q = b[c + e];
      f && (q = (q ^ 255) + d, d = q >> 8, q &= 255);
      h += q * m
    }
    return!a && h >= $.MAX_INT ? f ? -Infinity : Infinity : f ? -h : h
  }, valueOf:function() {
  ...
  D.prototype = {getArray:function() {
    ...
    var a = a || 0, b = b || this.length, c = new D, f = c.length = b - a, d = c.offset = this.offset + a, e = c.buf = this.buf;
    ...
    return Da.decode(this.view, a, b)
    ...
    return Da.encode(b, this.view, a)
  }, inspect:function() {
  ...
  k.prototype.writeI64 = function(a) {
    a.buffer ? this.trans.writeI64(a) : this.trans.writeI64(new $(a))
  };
  ...
  k.prototype.readMessageBegin = function() {
    ...
    if(0 > a) {
      b = a & -65536;
      if(-2147418112 != b) {
        throw console.log("BAD: " + b), Ea(4, "Bad version in readMessageBegin: " + a);
      }
      a &= 255;
      b = this.readString()
    }else {
      if(this.strictRead) {
        throw Ea(4, "No protocol version header");
      }
      b = this.trans.read(a);
      a = this.readByte()
    }
  ...
  var ob = new D(0), aa = d.TTransport = function(a, b) {
    this.buf = a || ob;
    this.onFlush = b;
    this.reset()
  };
  ...
  aa.prototype = {commitPosition:function() {
  ...
  var Fa = d.TFramedTransport = function(a, b) {
    aa.call(this, a, b)
  };
  Fa.receiver = function(a) {
    ...
    return function(e) {
      ...
      for(;e.length;) {
        ...
        e.length >= b ? (e.copy(f, c, 0, b), e = e.slice(b, e.length), b = 0, a(new Fa(f))) : e.length && (e.copy(f, c, 0, e.length), b -= e.length, c += e.length, e = e.slice(e.length, e.length))
      }
    }
  };
  Ca(Fa, aa, {flush:function() {
    var a = this;
    aa.prototype.flush.call(this, function(b) {
      if(a.onFlush) {
  ...
  var H = {TAction:TAction, TType:TType, TData:S, TPresence:T, TMessage:U, TChannelMessage:ba, TMessageSet:ga}, V, ca = function() {
    if(!W) {
      try {
    ...
    if(0 < a) {
      for(var b = 0;b < a;b++) {
        ...
        if(0 < g.pv[0]) {
          var e = I(c);
          if(e) {
            if(pa(N[b].swfVersion) && !(g.wk && 312 > g.wk)) {
              X(c, !0), f && (d.success = !0, d.ref = Ga(c), f(d))
            }else {
              if(N[b].expressInstall && Ha()) {
                d = {};
                ...
                for(var l = {}, e = e.getElementsByTagName("param"), m = e.length, q = 0;q < m;q++) {
          ...
          if(X(c, !0), f) {
            if((c = Ga(c)) && typeof c.SetVariable != r) {
              d.success = !0, d.ref = c
            }
            f(d)
          }
    ...
    return!qa && pa("6.0.65") && (g.win || g.mac) && !(g.wk && 312 > g.wk)
  }, Ia = function(a, b, c, f) {
    qa = !0;
    Ka = f || null;
    Xa = {success:!1, id:c};
    var d = I(c);
    if(d) {
      "OBJECT" == d.nodeName ? (ha = La(d), ra = null) : (ha = d, ra = c);
      a.id = Ya;
      ...
      f = "MMredirectURL=" + E.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + f + "&MMdoctitle=" + j.title;
      b.flashvars = typeof b.flashvars != r ? b.flashvars + ("&" + f) : f;
      g.ie && (g.win && 4 != d.readyState) && (f = j.createElement("div"), c += "SWFObjectNew", f.setAttribute("id", c), d.parentNode.insertBefore(f, d), d.style.display = "none", function() {
    ...
    if(g.ie && g.win && 4 != a.readyState) {
      ...
      b.parentNode.replaceChild(La(a), b);
      a.style.display = "none";
      (function() {
        4 == a.readyState ? a.parentNode.removeChild(a) : setTimeout(arguments.callee, 10)
      })()
    }else {
      a.parentNode.replaceChild(La(a), a)
    }
  }, La = function(a) {
    var b = j.createElement("div");
    if(g.win && g.ie) {
    ...
    if(d) {
      if(typeof a.id == r && (a.id = c), g.ie && g.win) {
        var e = "", l;
        for(l in a) {
          a[l] != Object.prototype[l] && ("data" == l.toLowerCase() ? b.movie = a[l] : "styleclass" == l.toLowerCase() ? e += ' class="' + a[l] + '"' : "classid" != l.toLowerCase() && (e += " " + l + '="' + a[l] + '"'))
        }
        l = "";
        for(var m in b) {
          b[m] != Object.prototype[m] && (l += '<param name="' + m + '" value="' + b[m] + '" />')
        }
        d.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + e + ">" + l + "</object>";
        sa[sa.length] = a.id;
        f = I(a.id)
      }else {
        m = j.createElement(K);
        m.setAttribute("type", ta);
        for(var q in a) {
          a[q] != Object.prototype[q] && ("styleclass" == q.toLowerCase() ? m.setAttribute("class", a[q]) : "classid" != q.toLowerCase() && m.setAttribute(q, a[q]))
        }
        for(e in b) {
          b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = m, l = e, q = b[e], c = j.createElement("param"), c.setAttribute("name", l), c.setAttribute("value", q), a.appendChild(c))
        }
    ...
    if(!g.ie || !g.mac) {
      ...
      if(d) {
        ...
        f && (Na = L = null);
        if(!L || Na != c) {
          f = j.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), L = d.appendChild(f), g.ie && (g.win && typeof j.styleSheets != r && 0 < j.styleSheets.length) && (L = j.styleSheets[j.styleSheets.length - 1]), Na = c
        }
        g.ie && g.win ? L && typeof L.addRule == K && L.addRule(a, b) : L && typeof j.createTextNode != r && L.appendChild(j.createTextNode(a + " {" + b + "}"))
      }
    }
  }, X = function(a, b) {
    if(ab) {
      var c = b ? "visible" : "hidden";
      W && I(a) ? I(a).style.visibility = c : $a("#" + a, "visibility:" + c)
    }
  }, bb = function(a) {
    return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != r ? encodeURIComponent(a) : a
  }, r = "undefined", K = "object", ta = "application/x-shockwave-flash", Ya = "SWFObjectExprInst", E = window, j = document, O = navigator, cb = !1, oa = [function() {
    if(cb) {
      var a = j.getElementsByTagName("body")[0], b = j.createElement(K);
  ...
  }], N = [], sa = [], da = [], ha, ra, Ka, Xa, W = !1, qa = !1, L, Na, ab = !0, g, qb = typeof j.getElementById != r && typeof j.getElementsByTagName != r && typeof j.createElement != r, ua = O.userAgent.toLowerCase(), va = O.platform.toLowerCase(), rb = va ? /win/.test(va) : /win/.test(ua), sb = va ? /mac/.test(va) : /mac/.test(ua), tb = /webkit/.test(ua) ? parseFloat(ua.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Oa = !+"\v1", ia = [0, 0, 0], B = null;
  if(typeof O.plugins != r && typeof O.plugins["Shockwave Flash"] == K) {
    if((B = O.plugins["Shockwave Flash"].description) && !(typeof O.mimeTypes != r && O.mimeTypes[ta] && !O.mimeTypes[ta].enabledPlugin)) {
      cb = !0, Oa = !1, B = B.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), ia[0] = parseInt(B.replace(/^(.*)\..*$/, "$1"), 10), ia[1] = parseInt(B.replace(/^.*\.(.*)\s.*$/, "$1"), 10), ia[2] = /[a-zA-Z]/.test(B) ? parseInt(B.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    }
  }else {
    if(typeof E.ActiveXObject != r) {
      try {
        var db = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
        if(db && (B = db.GetVariable("$version"))) {
          Oa = !0, B = B.split(" ")[1].split(","), ia = [parseInt(B[0], 10), parseInt(B[1], 10), parseInt(B[2], 10)]
        }
      }catch(Ib) {
      }
    }
  }
  g = {w3:qb, pv:ia, wk:tb, ie:Oa, win:rb, mac:sb};
  g.w3 && ((typeof j.readyState != r && "complete" == j.readyState || typeof j.readyState == r && (j.getElementsByTagName("body")[0] || j.body)) && ca(), W || (typeof j.addEventListener != r && j.addEventListener("DOMContentLoaded", ca, !1), g.ie && g.win && (j.attachEvent("onreadystatechange", function() {
    "complete" == j.readyState && (j.detachEvent("onreadystatechange", arguments.callee), ca())
  }), E == top && function() {
    if(!W) {
      try {
    ...
    W || (/loaded|complete/.test(j.readyState) ? ca() : setTimeout(arguments.callee, 0))
  }(), Wa(ca)));
  g.ie && g.win && window.attachEvent("onunload", function() {
    for(var a = da.length, b = 0;b < a;b++) {
      da[b][0].detachEvent(da[b][1], da[b][2])
    }
    a = sa.length;
    for(b = 0;b < a;b++) {
      Za(sa[b])
  ...
  V = {registerObject:function(a, b, c, f) {
    if(g.w3 && a && b) {
      var d = {};
      d.id = a;
      d.swfVersion = b;
  ...
  }, embedSWF:function(a, b, c, f, d, e, l, m, q, i) {
    var k = {success:!1, id:b};
    g.w3 && !(g.wk && 312 > g.wk) && a && b && c && f && d ? (X(b, !1), Va(function() {
      c += "";
      f += "";
      var g = {};
      if(q && typeof q === K) {
      ...
      if(l && typeof l === K) {
        for(var p in l) {
          j.flashvars = typeof j.flashvars != r ? j.flashvars + ("&" + p + "=" + l[p]) : p + "=" + l[p]
        }
      }
      if(pa(d)) {
        n = Ma(g, j, b), g.id == b && X(b, !0), k.success = !0, k.ref = n
      }else {
        if(e && Ha()) {
          g.data = e;
          Ia(g, j, b, i);
  ...
  }, hasFlashPlayerVersion:pa, createSWF:function(a, b, c) {
    if(g.w3) {
      return Ma(a, b, c)
    }
    ...
    if(qa) {
      var a = I(Ya);
      a && ha && (a.parentNode.replaceChild(ha, a), ra && (X(ra, !0), g.ie && g.win && (ha.style.display = "block")), Ka && Ka(Xa));
      qa = !1
    }
  }};
  var wa;
  ...
  z.addProperties = z.mixin = function(a, b) {
    for(var c in b) {
      a[c] = b[c]
    }
    return a
  ...
  z.prototypicalClone = function(a, b) {
    function c() {
    }
    c.prototype = a;
    var f = new c;
  ...
  n.inherits(ja, Function);
  ja.prototype.push = function() {
  ...
  var M, s = function(a, b) {
    ...
    for(var c = this.transports = [], d = 0;d < b.transports.length;d++) {
      b.transports[d] in s.availableTransports && c.push(b.transports[d])
    }
  ...
  s.prototype.chooseTransport = function(a) {
    if(this.transport) {
      ...
      var b = this, c = this.transports.slice(), d = function(a) {
        var R = c.shift();
        R ? (e.logAction(e.LOG_MICRO, "ConnectionManager.chooseTransport()", "trying " + R), s.availableTransports[R].tryConnect(b, b.realtime.auth, b.options, function(c, m) {
          c ? d(a) : (e.logAction(e.LOG_MICRO, "ConnectionManager.chooseTransport()", "transport " + R + " connecting"), b.setupTransport(m), a(m))
        })) : a(null)
      };
      d(a)
    }
  ...
  s.prototype.setupTransport = function(a) {
    ...
    for(var c = function(c) {
      return function(d, f) {
        ...
        d && d.reason && e.logAction(e.LOG_MICRO, "ConnectionManager.setupTransport; reason =  " + d.reason);
        f && e.logAction(e.LOG_MICRO, "ConnectionManager.setupTransport; connectionId =  " + f);
        b.transport === a && (f && (b.realtime.connection.id = f), b.notifyState({state:c, error:d}))
      }
    }, d = ["connected", "disconnected", "closed", "failed"], h = 0;h < d.length;h++) {
      var R = d[h];
      a.on(R, c(R))
    }
  };
  ...
  s.prototype.notifyState = function(a) {
    if(!(this.state.terminal || a.state == this.state.state)) {
      ...
      a = new xa(this.state.state, b.state, b.retryDelay, a.error || na[b.state]);
  ...
  s.prototype.requestState = function(a) {
    ...
    if(a.state != this.state.state) {
      ...
      var b = F[a.state], a = new xa(this.state.state, b.state, b.retryIn, a.error || na[b.state]);
      this.enactStateChange(a)
    }
  };
  s.prototype.connectImpl = function() {
    ...
    var a = this, b = this.realtime.auth, c = function(d) {
      ...
      a.notifyState({state:F.connecting.failState, error:d})
    }, d = function() {
  ...
  s.prototype.send = function(a, b, c) {
    c = c || wb;
    this.state.queueEvents && (b ? (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "queueing event"), (b = this.pendingMessages[this.pendingMessages.length - 1]) && Pa.mergeTo(b.msg, a) ? (b.isMerged || (b.callback = new ja([b.callback]), b.isMerged = !0), b.listener.push(c)) : this.pendingMessages.push({msg:a, callback:c})) : (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), c(this.error)));
  ...
  var t = function(a, b, c) {
    ...
    this.auth = b;
    this.options = c;
    c.useTextProtocol ? (this.thriftTransport = ka.TStringTransport, this.thriftProtocol = ka.TJSONProtocol) : (this.thriftTransport = ka.TTransport, this.thriftProtocol = ka.TBinaryProtocol, this.protocolBuffer = new ka.CheckedBuffer(xb));
    this.isConnected = !1
  }, ka = "object" == typeof window ? d : require("thrift"), xb = 1024;
  n.inherits(t, w);
  t.prototype.connect = function() {
  };
  t.prototype.close = function() {
    this.isConnected = !1;
    this.emit("closed", na.closed)
  };
  ...
  t.prototype.sendMessage = function(a, b) {
    ...
    var c = this;
    try {
      var d = new this.thriftProtocol(new this.thriftTransport(void 0, function(a) {
        c.sendData(a, b)
      }));
      a.write(d);
      d.flush()
    }catch(h) {
      d = "Unexpected send exception: " + h, e.logAction(e.LOG_ERROR, "Transport.sendMessage()", d), b({statusCode:500, code:5E4, reason:d})
    }
  };
  ...
  var u = function(a, b, c) {
    c.useTextProtocol = c.useTextProtocol || !yb;
    this.sendOptions = {binary:!c.useTextProtocol};
    t.call(this, a, b, c)
  }, Qa = "object" == typeof window, gb = Qa ? window.WebSocket || window.MozWebSocket : require("ws"), yb = Qa ? !1 : D, zb = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types"), ya = Qa ? d : require("thrift");
  n.inherits(u, t);
  ...
  u.tryConnect = function(a, b, c, d) {
    var h = new u(a, b, c), g = function(a) {
      d(a)
    };
    h.on("wserror", g);
    h.on("wsopen", function() {
      e.logAction(e.LOG_MINOR, "WebSocketTransport.tryConnect()", "viable transport " + h);
      h.off("wserror", g);
      d(null, h)
    });
    h.connect()
  ...
  u.prototype.connect = function() {
    ...
    this.auth.getAuthParams(function(c, d) {
      ...
      e.logAction(e.LOG_MINOR, "WebSocketTransport.connect()", "authParams:" + h);
      if(c) {
        a.abort(UIMessages.FAIL_REASON_REFUSED)
      }else {
        try {
          var l = a.wsConnection = a.createWebSocket(b, d);
  ...
  u.prototype.send = function(a, b) {
    ...
    try {
      ...
      a = "Unexpected send exception: " + h, e.logAction(e.LOG_ERROR, "WebSocketTransport.send()", a), b(Error(a))
    }
  };
  u.prototype.onWsData = function(a, b) {
    var c = b ? new ya.TBinaryProtocol(new ya.TTransport(a)) : new ya.TJSONProtocol(new ya.TStringTransport(a)), d = new zb.TChannelMessage;
    try {
      d.read(c), this.onChannelMessage(d)
    }catch(h) {
      e.logAction(e.LOG_ERROR, "Transport.onChannelEvent()", "Unexpected exception handing channel event: " + h.stack)
    }
  };
  ...
  u.prototype.onWsClose = function(a, b) {
    ...
    t.prototype.onClose.call(this, c, h)
  };
  ...
  }, Ra = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types");
  (n || require("util")).inherits(v, t);
  ...
  v.prototype.send = function(a, b) {
    if(this.sendRequest) {
      this.pendingMessage = this.pendingMessage || new Ra.TMessageSet({items:[]}), this.pendingMessage.items.push(a), this.pendingCallback = this.pendingCallback || new ja, this.pendingCallback.push(b)
    }else {
      var c = this.pendingMessage || new Ra.TMessageSet({items:[]});
      c.items.push(a);
  ...
  v.prototype.onResponseData = function(a) {
    var a = new this.thriftProtocol(new this.thriftTransport(a)), b = new Ra.TMessageSet;
    try {
      b.read(a);
      var c = b.items;
      if(c && c.length) {
  ...
  var C = function(a, b, c) {
    c.useTextProtocol = c.useTextProtocol || !C.binary;
    v.call(this, a, b, c)
  }, hb = function() {
  ...
  C.tryConnect = function(a, b, c, d) {
    var h = new C(a, b, c), g = function(a) {
      d(a)
    };
    h.on("error", g);
  ...
  C.Request = function(a, b, c, d, e, g) {
    var a = v.paramStr(b, a), l;
    c ? (b = "POST", l = 201) : (b = "GET", l = 200);
    var m = this.xhr = hb();
    e && (m.responseType = "arraybuffer");
    var i = setTimeout(d ? 9E4 : 1E4, function() {
      m.abort()
    });
    m.open(b, a, !0);
    ...
    m.onreadystatechange = function() {
      if(4 == m.readyState) {
        clearTimeout(i);
        var a = null;
        m.status != l ? (a = Error("Unexpected response: statusCode = " + m.status), a.statusCode = m.status, a.statusText = m.statusText, g(a)) : (a = null, e ? m.response && (a = new D, a.buf = m.response, a.view = new DataView(a.buf)) : a = m.responseText, g(null, a))
      }
    };
    m.send(c)
  };
  ...
  G.Request = function(a, b, c, d, e) {
    var g = Ably._;
    this.callback = e;
    var l = this.requestId = Ab++, i = this.timer = setTimeout(d ? 9E4 : 1E4, function() {
      k.abort()
    });
    b.callback = "Ably._._" + l;
    ...
    var k = this;
    Ably._["_" + l] = function(a) {
      clearTimeout(i);
      delete g["_" + l];
      k.aborted || (j.parentNode.removeChild(j), e(null, a))
    };
  ...
  P.isAvailable = function() {
    return Bb && V && 10 <= V.getFlashPlayerVersion().major && wa
  };
  ...
  P.prototype.createWebSocket = function(a, b) {
    ...
    this.uri = a;
    return new wa(a, [], this.options.proxyHost, this.options.proxyPort)
  };
  ...
  Y.get = function(a, b, c, d) {
    function e() {
      a.auth.getAuthHeaders(function(g, l) {
        g ? d(g) : Http.get(a.baseUri + b, n.mixin(l, a.headers), c, function(b, c) {
    ...
    void 0 === d && "function" == typeof c ? (d = c, c = null) : d = ib;
    e()
  };
  Y.post = function(a, b, c, d, e) {
    function g() {
      a.auth.getAuthHeaders(function(l, i) {
        l ? e(l) : Http.post(a.baseUri + b, n.mixin(i, a.headers), c, d, function(b, c) {
          b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
            a ? e(a) : g()
          }) : e(b, c)
        })
  ...
  var Cb = function() {
    ...
    if(b.keyValue) {
      if(!b.clientId) {
        ...
        this.basicKey = (new D(c, "ascii")).toString("base64");
        this.keyId = b.keyId;
  ...
  }, Sa = "object" == typeof window, Eb = Sa ? null : require("crypto"), za = void 0;
  Sa && (window.CryptoJS && CryptoJS.HmacSHA256 && CryptoJS.enc.Base64) && (za = function(a, b) {
    return CryptoJS.HmacSHA256(a, b).toString(CryptoJS.enc.Base64)
  });
  Sa || (za = function(a, b) {
    var c = Eb.createHmac("SHA256", b);
    c.update(a);
    return c.digest("base64")
  });
  ea.prototype.authorise = function(a, b) {
    if(this.token) {
  ...
  ea.prototype.requestToken = function(a, b) {
    "function" == typeof a && !b && (b = a, a = {});
    var a = a || {}, b = b || Cb, a = n.mixin(n.copy(this.tokenOptions), a), c;
    if(a.authCallback) {
      ...
      if(a.authUrl) {
        e.logAction(e.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), c = function(b, c) {
          Http.get(a.authUrl, a.authHeaders || {}, n.mixin(b, a.authParams), c)
        }
      }else {
        if(a.keyValue) {
          var d = this;
          ...
          c = function(b, c) {
            d.createTokenRequest(n.mixin(n.copy(a), b), c)
          }
        }else {
    ...
    g = a.ttl || "";
    "ttl" in a && (h.ttl = g);
    "capability" in a && (h.capability = Db(a.capability));
    d = this;
    c(h, function(a, c) {
      if(a) {
  ...
  ea.prototype.createTokenRequest = function(a, b) {
  ...
  ea.prototype.getAuthParams = function(a) {
  ...
  ea.prototype.getAuthHeaders = function(a) {
  ...
  var la = function(a) {
    ...
    b = n.defaultHeaders["json" == a.format];
    a.headers && (b = n.mixin(n.copy(a.headers), this.headers));
    this.headers = b;
    this.auth = new ea(this, a);
  ...
  la.prototype.history = function(a, b) {
    Y.get(this, "/events", a, b)
  };
  la.prototype.stats = function(a, b) {
    Y.get(this, "/stats", a, b)
  };
  ...
  kb.prototype.get = function(a, b) {
    ...
    c || (this.attached[a] = c = new Pa(this.realtime, a, b || {}));
    return c
  };
  this.Realtime = la;
  var xa;
  ...
  n.inherits(Z, w);
  Z.prototype.presence = function(a, b) {
    e.logAction(e.LOG_MICRO, "Channel.presence()", "channel = " + this.name);
    Y.get(this.rest, "/channels/" + this.name + "/presence", a, b)
  };
  Z.prototype.history = function(a, b) {
    e.logAction(e.LOG_MICRO, "Channel.history()", "channel = " + this.name);
    Y.get(this.rest, "/channels/" + this.name + "/history", a, b)
  };
  Z.prototype.publish = function(a, b, c) {
    e.logAction(e.LOG_MICRO, "Channel.publish()", "channel = " + this.name + "; name = " + a);
    Y.post(this.rest, "/channels/" + this.name + "/publish", {name:a, data:b}, c)
  };
  var Pa, p = function(a, b, c) {
    ...
    this.options = n.prototypicalClone(Fb, c);
    this.state = "initialized";
    this.subscriptions = new w;
    this.pendingSubscriptions = {};
    this.pendingEvents = []
  }, A = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types"), Q = function() {
  }, Fb = {queueEvents:!0};
  n.inherits(p, Z);
  p.prototype.publish = function(a, b, c) {
    ...
    M.activeState(d) ? (d = new A.TMessage, d.name = a, d.payload = ma.createPayload(b), "attached" == this.state ? (e.logAction(e.LOG_MICRO, "RealtimeChannel.publish()", "sending message"), a = new A.TChannelMessage, a.action = A.TAction.EVENT, a.channel = this.name, a.messages = [d], this.sendMessage(a, c)) : ("pending" != this.state && this.attach(), e.logAction(e.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:d, listener:c}))) : c(d.defaultMessage)
  };
  ...
  p.prototype.attachImpl = function(a) {
    ...
    this.state = "pending";
    var b = new A.TChannelMessage({action:A.TAction.ATTACH, channel:this.name});
  ...
  p.prototype.detachImpl = function(a) {
    ...
    var b = new A.TChannelMessage({action:A.TAction.DETACH, channel:this.name});
    this.sendMessage(b, a || Q)
  };
  ...
  p.prototype.unsubscribeForEvent = function(a, b, c) {
    ...
    d.off(a, b);
    d.listeners(a) ? c() : (e.logAction(e.LOG_MICRO, "RealtimeChannel.unsubscribe()", "sending UNSUBSCRIBE message"), a = new A.TChannelMessage({action:A.TAction.UNSUBSCRIBE, channel:this.name, name:a}), this.sendMessage(a, Q))
  };
      ...
      case 13:
        if(a = a.messages) {
          for(var b = Array(a.length), c = 0;c < b.length;c++) {
            var d = a[c];
            b[c] = new ma(d.channelSerial, d.timestamp, d.name, ma.getPayload(d.payload))
          }
          this.onEvent(b)
        }
        break;
  ...
  p.prototype.setAttached = function(a) {
    ...
    try {
      if(this.pendingEvents.length) {
        var b = new A.TChannelMessage({action:A.TAction.EVENT, channel:this.name, messages:[]}), c = new ja;
  ...
  var lb, J = function(a, b) {
    ...
    this.clients = {}
  }, Ba = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types");
  n.inherits(J, w);
  ...
  J.prototype.enterClient = function(a, b, c) {
    ...
    this.clients[a] = b;
    a = new Ba.TPresence({state:Ba.TPresenceState.ENTER, clientId:this.clientId});
    a.clientData = Z.createPayload(b);
  ...
  J.prototype.leaveClient = function(a, b) {
    ...
    var c = new Ba.TPresence({state:Ba.TPresenceState.LEAVE, clientId:this.channel.ably.options.clientId});
  ...
  J.prototype.setPresence = function(a, b) {
    ...
    for(var c = 0;c < a.length;c++) {
      ...
      "leave" == d.state ? delete this.clients[i] : g = this.clients[i] = ma.getPayload(d.clientData);
  ...
  lb = J;
  var ma, Ta = function(a, b, c, d) {
    this.channelSerial = a;
    this.timestamp = b;
    this.name = c;
    this.data = d
  }, x = "object" == typeof H ? H : require("../nodejs/lib/protocol/clientmessage_types"), Gb = {"[object Null]":function(a) {
    a.type = x.TType.NONE;
    return!0
    ...
    var c = Gb[Object.prototype.toString.call(b)];
    return c && c(a, b)
  }};
  Ta.createPayload = function(a) {
    var b = new x.TData, c = Hb[typeof a];
    if(c && c(b, a)) {
      return b
    }
