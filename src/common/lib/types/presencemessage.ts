...
import { IMessageConstructor, CipherOptions } from './message';
...
export interface IPresenceMessageConstructor {
  encode: IMessageConstructor['encode'];
  decode: IMessageConstructor['decode'];
  fromResponseBody(
    body: Record<string, unknown>[],
    options: CipherOptions,
    format?: Utils.Format
  ): Promise<IPresenceMessage[]>;
  fromValues(values: IPresenceMessage | Record<string, unknown>, stringifyAction?: boolean): IPresenceMessage;
  fromValuesArray(values: unknown[]): IPresenceMessage[];
}

const presenceMessageClassFactory = (messageClass: IMessageConstructor): IPresenceMessageConstructor => {
  return class PresenceMessage implements IPresenceMessage {
    action?: string | number;
    id?: string;
    timestamp?: number;
    clientId?: string;
    ...
    static encode = messageClass.encode;
    static decode = messageClass.decode;
    ...
    static getMessagesSize = messageClass.getMessagesSize;
  };
};

export { presenceMessageClassFactory };
