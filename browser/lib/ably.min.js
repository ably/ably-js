(function() {
  window.Ably = {};
  for(var G = {disconnected:{statusCode:408, code:80003, reason:"Connection to server temporarily unavailable"}, suspended:{statusCode:408, code:80002, reason:"Connection to server unavailable"}, failed:{statusCode:408, code:8E4, reason:"Connection failed or disconnected by server"}}, B = function(a, c, b) {
    function h() {
    }
  ...
  K.prototype = {_2scomp:function() {
    ...
    for(var h = this.buffer, e = this.offset, f = 7;0 <= f;f--) {
      h[e + f] = c & 255, c = 4 == f ? a : c >>> 8
    }
    b && this._2scomp()
  }, toNumber:function(a) {
    for(var c = this.buffer, b = this.offset, h = c[0] & 128, e = 0, f = 1, d = 7, p = 1;0 <= d;d--, p *= 256) {
      var m = c[b + d];
      h && (m = (m ^ 255) + f, f = m >> 8, m &= 255);
      e += m * p
    }
  ...
  d.TXHRTransport.prototype = {getXmlHttpRequestObject:function() {
    ...
    var e = jQuery.Deferred(), f = jQuery._Deferred(), d = e.promise();
    d.success = d.done;
    d.error = d.fail;
    d.complete = f.done;
    c = jQuery.ajax({url:this.url, data:c, type:"POST", cache:!1, dataType:"text", context:this, success:this.jqResponse, error:function(b, c, f) {
      e.rejectWith(a, jQuery.merge([f], b.tArgs))
  ...
  var W = {encode:function(a, c, b) {
    for(var h = b, e = 0;e < a.length;e++) {
      ...
      128 > f ? c.setInt8(h++, f) : (127 < f && 2048 > f ? c.setInt8(h++, f >> 6 | 192) : (c.setInt8(h++, f >> 12 | 224), c.setInt8(h++, f >> 6 & 63 | 128)), c.setInt8(h++, f & 63 | 128))
    }
    return h - b
  ...
  v.prototype = {getArray:function() {
    this.array || (this.array = new Uint8Array(this.buf, this.offset, this.length));
    return this.array
  }, slice:function(a, c) {
    a = a || 0;
    c = c || this.length;
    var b = new v, h = b.length = c - a, e = b.offset = this.offset + a, f = b.buf = this.buf;
    b.view = new DataView(f, e, h);
    return b
  }, getInt8:function(a) {
  ...
  var fa = new v(0), M = d.TTransport = function(a, c) {
    this.buf = a || fa;
    this.onFlush = c;
    this.reset()
  };
  ...
  Y.receiver = function(a) {
    ...
    return function(f) {
      ...
      for(;f.length;) {
        ...
        f.length >= c ? (f.copy(h, b, 0, c), f = f.slice(c, f.length), c = 0, a(new Y(h))) : f.length && (f.copy(h, b, 0, f.length), c -= f.length, b += f.length, f = f.slice(f.length, f.length))
      }
    }
  };
  B(Y, M, {flush:function() {
    var a = this;
    M.prototype.flush.call(this, function(c) {
      if(a.onFlush) {
        var b = new v(c.length + 4);
  ...
  var C = {TAction:TAction, TFlags:TFlags, TType:TType, TData:H, TPresence:D, TMessage:E, TChannelMessage:J, TMessageSet:B};
  ...
  var y = {protocolVersion:1, REST_HOST:"rest.ably.io", WS_HOST:"realtime.ably.io", FALLBACK_HOSTS:["A.ably-realtime.com", "B.ably-realtime.com", "C.ably-realtime.com", "D.ably-realtime.com", "E.ably-realtime.com"], PORT:80, TLS_PORT:443, connectTimeout:15E3, disconnectTimeout:3E4, suspendedTimeout:12E4, cometRecvTimeout:9E4, cometSendTimeout:1E4, httpTransports:["xhr", "jsonp"], transports:["web_socket", "flash_socket", "xhr", "jsonp"], flashTransport:{swfLocation:("undefined" !== typeof window ? 
  window.location.protocol : "https:") + "//cdn.ably.io/lib/swf/WebSocketMainInsecure-0.9.swf", policyPort:"8843"}};
  "undefined" !== typeof exports && this.exports !== exports && (exports.defaults = y);
  this.Http = function() {
    function a() {
    }
    var c = function() {
    };
    a.get = function(b, h, e, f, d) {
      function p(b, c) {
        a.Request(b, f, null, t, c)
      }
      d = d || c;
      var m = "function" == typeof h ? h : function(a) {
        return b.baseUri(a) + h
      }, t = e && "application/json" != e.accept;
      if("string" == typeof m) {
        p(m, d)
      }else {
        var g;
        e = b.connection;
        var s = b.options, u = s.restHost;
        "connected" == e.state ? g = e.connectionManager.host : s.fallbackHosts || (g = u);
        if(g) {
          p(m(g), d)
        }else {
          var w = fallbackHosts.slice().unshift(u);
          p(w.shift(), function(a, b, c) {
            if(a) {
              var f = a.code;
    ...
    a.post = function(b, h, e, f, d, p) {
      function m(b, c) {
        a.Request(b, d, f, g, c)
      }
      p = p || c;
      var t = "function" == typeof h ? h : function(a) {
        return b.baseUri(a) + h
      }, g = e && "application/json" != e.accept;
      if("string" == typeof t) {
        tryGet(t, p)
      }else {
        var s;
        e = b.connection;
        var u = b.options, w = u.restHost;
        "connected" == e.state ? s = e.connectionManager.host : u.fallbackHosts || (s = w);
        if(s) {
          m(t(s), p)
        }else {
          var k = fallbackHosts.slice().unshift(w);
          m(k.shift(), function(a, b, c) {
            if(a) {
              var f = a.code;
              if("ENETUNREACH" == f || "EHOSTUNREACH" == f || "EHOSTDOWN" == f) {
                m(k, p);
  ...
  this.ThriftUtil = function() {
    ...
    var b = new d.TTransport, h = new d.TBinaryProtocol(b), e = 16384, f = [];
    c.encode = function(a, b) {
      try {
        b(null, c.encodeSync(a))
      }catch(f) {
        var e = "Unexpected exception encoding Thrift; exception \x3d " + f;
        g.logAction(g.LOG_ERROR, "ThriftUtil.encode()", e, f);
        e = Error(e);
        e.statusCode = 400;
        b(e)
      }
    ...
    c.decodeSync = function(a, c) {
      try {
        ...
        var e = "Unexpected exception decoding thrift message; exception \x3d " + f;
        g.logAction(g.LOG_ERROR, "ThriftUtil.decode()", e, f);
        e = Error(e);
        e.statusCode = 400;
        throw e;
      }
  ...
  var S = function() {
    ...
    function h() {
      var a = q.getElementsByTagName("body")[0], b = q.createElement(v);
          ...
          if(0 < n.pv[0]) {
            ...
            if(t) {
              if(k(O[b].swfVersion) && !(n.wk && 312 > n.wk)) {
                P(c, !0), e && (h.success = !0, h.ref = f(c), e(h))
              }else {
                if(O[b].expressInstall && d()) {
                  ...
                  for(var s = {}, t = t.getElementsByTagName("param"), T = t.length, w = 0;w < T;w++) {
                    "movie" != t[w].getAttribute("name").toLowerCase() && (s[t[w].getAttribute("name")] = t[w].getAttribute("value"))
                  }
                  g(h, s, c, e)
                }else {
                  m(t), e && e(h)
    ...
    function f(a) {
      ...
      if((a = u(a)) && "OBJECT" == a.nodeName) {
        typeof a.SetVariable != z ? b = a : (a = a.getElementsByTagName(v)[0]) && (b = a)
      }
      return b
    }
    function d() {
    ...
    function g(a, b, c, f) {
      ...
      var e = u(c);
      if(e) {
        "OBJECT" == e.nodeName ? (E = t(e), I = null) : (E = e, I = c);
        a.id = C;
        ...
        f = n.ie && n.win ? "ActiveX" : "PlugIn";
        f = "MMredirectURL\x3d" + x.location.toString().replace(/&/g, "%26") + "\x26MMplayerType\x3d" + f + "\x26MMdoctitle\x3d" + q.title;
        b.flashvars = typeof b.flashvars != z ? b.flashvars + ("\x26" + f) : f;
        n.ie && (n.win && 4 != e.readyState) && (f = q.createElement("div"), c += "SWFObjectNew", f.setAttribute("id", c), e.parentNode.insertBefore(f, e), e.style.display = "none", function() {
    ...
    function m(a) {
      if(n.ie && n.win && 4 != a.readyState) {
        ...
        b.parentNode.replaceChild(t(a), b);
        a.style.display = "none";
        (function() {
          4 == a.readyState ? a.parentNode.removeChild(a) : setTimeout(arguments.callee, 10)
        })()
      }else {
        a.parentNode.replaceChild(t(a), a)
      }
    }
    function t(a) {
      var b = q.createElement("div");
      if(n.win && n.ie) {
        ...
        if(a = a.getElementsByTagName(v)[0]) {
          if(a = a.childNodes) {
    ...
    function T(a, b, c) {
      ...
      if(e) {
        if(typeof a.id == z && (a.id = c), n.ie && n.win) {
          ...
          e.outerHTML = '\x3cobject classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + h + "\x3e" + d + "\x3c/object\x3e";
          H[H.length] = a.id;
          f = u(a.id)
        }else {
          m = q.createElement(v);
          m.setAttribute("type", A);
          for(var r in a) {
            a[r] != Object.prototype[r] && ("styleclass" == r.toLowerCase() ? m.setAttribute("class", a[r]) : "classid" != r.toLowerCase() && m.setAttribute(r, a[r]))
          }
          for(h in b) {
            b[h] != Object.prototype[h] && "movie" != h.toLowerCase() && (a = m, d = h, r = b[h], c = q.createElement("param"), c.setAttribute("name", d), c.setAttribute("value", r), a.appendChild(c))
          }
    ...
    function l(a, b, c, f) {
      if(!n.ie || !n.mac) {
        ...
        if(e) {
          ...
          f && (L = N = null);
          if(!N || L != c) {
            f = q.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), N = e.appendChild(f), n.ie && (n.win && typeof q.styleSheets != z && 0 < q.styleSheets.length) && (N = q.styleSheets[q.styleSheets.length - 1]), L = c
          }
          n.ie && n.win ? N && typeof N.addRule == v && N.addRule(a, b) : N && typeof q.createTextNode != z && N.appendChild(q.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function P(a, b) {
      if(R) {
        ...
        Q && u(a) ? u(a).style.visibility = c : l("#" + a, "visibility:" + c)
      }
    }
    function y(a) {
      return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != z ? encodeURIComponent(a) : a
    }
    var z = "undefined", v = "object", A = "application/x-shockwave-flash", C = "SWFObjectExprInst", x = window, q = document, B = navigator, F = !1, G = [function() {
      F ? h() : e()
    }], O = [], H = [], D = [], E, I, K, M, Q = !1, J = !1, N, L, R = !0, n = function() {
      var a = typeof q.getElementById != z && typeof q.getElementsByTagName != z && typeof q.createElement != z, b = B.userAgent.toLowerCase(), c = B.platform.toLowerCase(), f = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, e = !+"\v1", h = [0, 0, 0], d = null;
      if(typeof B.plugins != z && typeof B.plugins["Shockwave Flash"] == v) {
        if((d = B.plugins["Shockwave Flash"].description) && !(typeof B.mimeTypes != z && B.mimeTypes[A] && !B.mimeTypes[A].enabledPlugin)) {
          F = !0, e = !1, d = d.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), h[0] = parseInt(d.replace(/^(.*)\..*$/, "$1"), 10), h[1] = parseInt(d.replace(/^.*\.(.*)\s.*$/, "$1"), 10), h[2] = /[a-zA-Z]/.test(d) ? parseInt(d.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        }
      }else {
        if(typeof x.ActiveXObject != z) {
          try {
            var m = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
            if(m && (d = m.GetVariable("$version"))) {
              e = !0, d = d.split(" ")[1].split(","), h = [parseInt(d[0], 10), parseInt(d[1], 10), parseInt(d[2], 10)]
            }
          }catch(r) {
          }
        }
      }
      return{w3:a, pv:h, wk:b, ie:e, win:f, mac:c}
    }();
    (function() {
      n.w3 && ((typeof q.readyState != z && "complete" == q.readyState || typeof q.readyState == z && (q.getElementsByTagName("body")[0] || q.body)) && a(), Q || (typeof q.addEventListener != z && q.addEventListener("DOMContentLoaded", a, !1), n.ie && n.win && (q.attachEvent("onreadystatechange", function() {
        ...
        Q || (/loaded|complete/.test(q.readyState) ? a() : setTimeout(arguments.callee, 0))
      }(), b(a)))
    })();
    (function() {
    ...
    return{registerObject:function(a, b, c, f) {
    ...
    }, embedSWF:function(a, b, f, e, h, m, t, s, u, w) {
      var l = {success:!1, id:b};
      n.w3 && !(n.wk && 312 > n.wk) && a && b && f && e && h ? (P(b, !1), c(function() {
        f += "";
        e += "";
        var c = {};
        if(u && typeof u === v) {
        ...
        if(t && typeof t === v) {
          for(var q in t) {
            n.flashvars = typeof n.flashvars != z ? n.flashvars + ("\x26" + q + "\x3d" + t[q]) : q + "\x3d" + t[q]
          }
        }
        if(k(h)) {
          U = T(c, n, b), c.id == b && P(b, !0), l.success = !0, l.ref = U
        }else {
          if(m && d()) {
            c.data = m;
            g(c, n, b, w);
      ...
      if(b) {
        ...
        for(var b = b.split("\x26"), c = 0;c < b.length;c++) {
          if(b[c].substring(0, b[c].indexOf("\x3d")) == a) {
            return y(b[c].substring(b[c].indexOf("\x3d") + 1))
          }
        }
      }
      return""
      ...
      if(J) {
        var a = u(C);
        a && E && (a.parentNode.replaceChild(E, a), I && (P(I, !0), n.ie && n.win && (E.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), R = function() {
    ...
    var a = function(c, b, h, e, f) {
      ...
      d.__createTask = setTimeout(function() {
        a.__addTask(function() {
          d.__createTask = null;
          a.__flash.create(d.__id, c, b, h || null, e || 0, f || null)
        })
      }, 0)
    };
    ...
    a.valuesArray = function(a, c) {
      var e = [], f;
      for(f in a) {
        (!c || a.hasOwnProperty(f)) && e.push(a[f])
      }
      return e.length ? e : void 0
    };
    ...
    function b(a, c) {
      ...
      this.httpTransports = l.intersect(c.transports || y.httpTransports, b.httpTransports);
      this.transports = l.intersect(c.transports || y.transports, b.transports);
      this.upgradeTransports = l.arrSubtract(this.transports, this.httpTransports);
      var f = c.fallbackHosts;
      if(f) {
        var d;
        this.httpHosts = d = f.slice();
        d.unshift(c.restHost);
        this.wsHosts = d = f.slice();
        d.unshift(c.wsHost)
      }else {
      ...
      g.logAction(g.LOG_MICRO, "Realtime.ConnectionManager()", "requested transports \x3d [" + (c.transports || y.transports) + "]");
      ...
      g.logAction(g.LOG_MICRO, "Realtime.ConnectionManager()", "http hosts \x3d [" + this.httpHosts + "]");
      g.logAction(g.LOG_MICRO, "Realtime.ConnectionManager()", "ws hosts \x3d [" + this.wsHosts + "]");
    ...
    var d = "undefined" !== typeof Cookie && Cookie.read, e = "undefined" !== typeof Cookie && Cookie.create, f = ("object" == typeof C ? C : require("../nodejs/lib/protocol/clientmessage_types")).TAction, r = function() {
    }, p = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:y.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:y.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
    retryDelay:y.suspendedTimeout}, closed:{state:"closed", terminal:!1, queueEvents:!1, sendEvents:!1}, failed:{state:"failed", terminal:!0, queueEvents:!1, sendEvents:!1}};
    a.prototype.getConnectParams = function(a) {
      a = a ? l.prototypicalClone(a) : {};
      var b = this.options;
      switch(this.mode) {
        case "resume":
    ...
    b.prototype.chooseTransport = function(b) {
      ...
      if(this.transport) {
        ...
        g.logAction(g.LOG_MINOR, "ConnectionManager.chooseTransport()", "Transport recovery mode \x3d " + c + ("clean" == c ? "" : "; connectionId \x3d " + this.connectionId));
        var e = this;
        this.httpTransports.length ? this.chooseHttpTransport(f, function(c, d) {
          if(c) {
            ...
            if(g.logAction(g.LOG_MINOR, "ConnectionManager.chooseTransport()", "Establishing http transport: " + d), b(null, d), e.upgradeTransports.length) {
              d.on("connected", function(b, c) {
                ...
                e.chooseTransportForHost(f, e.upgradeTransports.slice(), r)
              })
            }
          }
        }) : (f.host = this.httpHosts[0], g.logAction(g.LOG_MINOR, "ConnectionManager.chooseTransport()", "No http transports available; ignoring fallback hosts"), this.chooseTransportForHost(f, e.transports.slice(), b))
      }
    };
    b.prototype.chooseTransportForHost = function(a, c, f) {
      ...
      if(e) {
        ...
        b.transports[e].tryConnect(this, this.realtime.auth, a, function(b, h) {
          b ? d.chooseTransportForHost(a, c, f) : (g.logAction(g.LOG_MICRO, "ConnectionManager.chooseTransport()", "transport " + e + " connecting"), d.setTransportPending(h), f(null, h))
        })
      }else {
      ...
      function f() {
        if(e.length) {
          b.httpTransports[h.httpTransports[0]].checkConnectivity(function(b, d) {
            b ? c(b) : d ? (a.host = l.arrRandomElement(e), h.chooseTransportForHost(a, h.httpTransports.slice(), function(a, b) {
              a ? f() : c(null, b)
      ...
      if(this.state == p.closed) {
        ...
        for(var b = this, c = function(c) {
          return function(f, e) {
            ...
            f && f.reason && g.logAction(g.LOG_MICRO, "ConnectionManager.setTransportPending", "reason \x3d  " + f.reason);
            e && g.logAction(g.LOG_MICRO, "ConnectionManager.setTransportPending", "connectionId \x3d  " + e);
            "connected" == c ? b.activateTransport(a, e) : b.deactivateTransport(a);
            b.transport === a && b.notifyState({state:c, error:f})
          }
    ...
    b.prototype.startConnectTimer = function() {
      ...
      this.connectTimer = setTimeout(function() {
        a.connectTimer && (g.logAction(g.LOG_MINOR, "ConnectionManager connect timer expired", "requesting new state: " + p.connecting.failState), a.notifyState({state:p.connecting.failState}))
      }, y.connectTimeout)
    };
    ...
    b.prototype.startSuspendTimer = function() {
      ...
      this.suspendTimer || (this.suspendTimer = setTimeout(function() {
        a.suspendTimer && (g.logAction(g.LOG_MINOR, "ConnectionManager suspend timer expired", "requesting new state: suspended"), p.connecting.failState = "suspended", p.connecting.queueEvents = !1, a.notifyState({state:"suspended"}))
      }, y.suspendedTimeout))
    };
    ...
    b.prototype.notifyState = function(a) {
      if(!(this.state.terminal || a.state == this.state.state)) {
        ...
        a = new $(this.state.state, b.state, b.retryDelay, a.error || G[b.state]);
    ...
    b.prototype.requestState = function(a) {
      ...
      if(a.state != this.state.state) {
        ...
        if(a.state != this.state.state) {
          var b = p[a.state];
          a = new $(this.state.state, b.state, b.retryIn, a.error || G[b.state]);
          this.enactStateChange(a)
        }
      }
    };
    b.prototype.connectImpl = function() {
      ...
      var a = this, b = this.realtime.auth, c = function(f) {
        g.logAction(g.LOG_ERROR, "ConnectionManager.connectImpl()", f);
        401 == f.statusCode && (-1 != f.message.indexOf("expire") && "token" == b.method) && b.getToken(!0, function(b) {
          b ? c(b) : a.connectImpl()
        });
        a.notifyState({state:p.connecting.failState, error:f})
      }, f = function() {
        a.chooseTransport(function(a, b) {
          a && c(a)
        })
      };
      "basic" == b.method ? f() : b.authorise(!1, function(a) {
        a ? c(a) : f()
      })
    };
    b.prototype.send = function(a, b, f) {
      f = f || r;
      this.state.queueEvents && (b ? this.queue(a, f) : (g.logAction(g.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), f(this.error)));
      this.state.sendEvents && (g.logAction(g.LOG_MICRO, "ConnectionManager.send()", "sending event"), this.sendImpl(new c(a, f)))
    };
    ...
    b.prototype.queue = function(a, b) {
      ...
      f && ca.mergeTo(f.msg, a) ? (f.merged || (f.callback = new Z([f.callback]), f.merged = !0), f.listener.push(b)) : this.queuedMessages.push(new c(a, b))
    };
    ...
    var c = "object" == typeof window, b = c ? window.WebSocket || window.MozWebSocket : require("ws"), d = c ? !1 : !!v;
    l.inherits(a, I);
    a.isAvailable = function() {
      return!!b
    };
    a.isAvailable() && (F.transports.web_socket = a);
    a.tryConnect = function(b, c, d, h) {
      var m = new a(b, c, d), t = function(a) {
        h(a)
      };
      m.on("wserror", t);
      m.on("wsopen", function() {
        g.logAction(g.LOG_MINOR, "WebSocketTransport.tryConnect()", "viable transport " + m);
        m.off("wserror", t);
        h(null, m)
      });
      m.connect()
    ...
    a.prototype.connect = function() {
      ...
      this.auth.getAuthParams(function(c, h) {
        ...
        g.logAction(g.LOG_MINOR, "WebSocketTransport.connect()", "authParams:" + r);
        if(c) {
          a.abort(UIMessages.FAIL_REASON_REFUSED)
        }else {
          r = b.getConnectParams(h);
          try {
            var u = a.wsConnection = a.createWebSocket(d, r);
            u.binaryType = "arraybuffer";
            u.onopen = function() {
              a.onWsOpen()
            };
            u.onclose = function(b, c) {
              a.onWsClose(b, c)
            };
    ...
    a.prototype.onWsClose = function(a, b) {
      ...
      I.prototype.onClose.call(this, c, h)
    };
    ...
    a.prototype.connect = function() {
      ...
      this.auth.getAuthParams(function(b, d) {
        if(b) {
          ...
          g.logAction(g.LOG_MINOR, "CometTransport.connect()", "connectParams:" + a.paramStr(h));
          try {
    ...
    a.prototype.sendItems = function(a, b) {
      ...
      try {
        ...
        var f = "Unexpected send exception: " + e;
  ...
  this.Data = function() {
    ...
    var c = "object" == typeof C ? C : require("../nodejs/lib/protocol/clientmessage_types"), b = {"[object Null]":function(a, b) {
      ...
      "undefined" !== typeof v && v.isBuffer(b) ? (a.type = c.TType.BUFFER, a.binaryData = b) : (a.type = c.TType.JSONOBJECT, a.stringData = JSON.stringify(b));
      return!0
    ...
    a.toTData = function(a) {
      var b = new c.TData, g = d[typeof a];
      if(g && g(b, a)) {
        return b
      }
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof C ? C : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, d = a.TMessage = {}, e = a.TPresence = {}, f = a.TChannelMessage = {}, g = a.TMessageArray = {}, p = a.TMessageSet = {}, m = c.TType.BUFFER;
    b.fromREST = function(a) {
      var c, d = a.data, f = a.encoding;
      f ? (c = new b, c.type = m, c.binaryData = new v(d, f)) : Data.toTData(d);
      a.data = d
    };
    ...
    b.fromREST = function(a, c) {
      var d, f = a.encoding;
      f ? (d = new b, d.type = m, d.binaryData = new v(c, f)) : d = Data.toTData(c);
      return d
    };
    ...
    f.fromJSON = function(a) {
      var b;
      if(b = a.messages) {
        for(var f = b.length, g = a.messages = Array(f), r = 0;r < f;r++) {
          g[r] = d.fromJSON(b[r])
        }
      }
      if(b = a.presence) {
        f = b.length;
        g = a.presence = Array(f);
        for(r = 0;r < f;r++) {
          g[r] = e.fromJSON(b[r])
        }
      }
    ...
    p.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          ...
          e = JSON.parse(a);
          for(var h = e.length, d = Array(h), g = 0;g < h;g++) {
            d[g] = f.fromJSON(e[g])
          }
        }
      }
    ...
    g.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          var e;
          if(f = ThriftUtil.decodeSync(e = new c.TMessageArray, a)) {
            throw f;
          }
          f = e.items
        }else {
          e = JSON.parse(a);
          for(var g = e.length, f = Array(g), r = 0;r < g;r++) {
            f[r] = d.fromJSON(e[r])
          }
        }
      }
  ...
  var V = function() {
    ...
    a.get = function(a, b, d, e, f) {
      function g() {
        a.auth.getAuthHeaders(function(p, m) {
          p ? f(p) : Http.get(a, b, l.mixin(m, d), e, function(b, d) {
    ...
    a.post = function(a, b, d, e, f, g) {
      function p() {
        a.auth.getAuthHeaders(function(m, t) {
          m ? g(m) : Http.post(a, b, l.mixin(t, e), d, f, function(b, d) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? g(a) : p()
            }) : g(b, d)
          })
    ...
    function b(a, b) {
      ...
      if(b.keyValue) {
        if(!b.clientId) {
          ...
          this.method = "basic";
          this.basicKey = (new v(b.key || b.keyId + ":" + b.keyValue, "ascii")).toString("base64");
          this.keyId = b.keyId;
    ...
    var d = "object" == typeof window, e = d ? null : require("crypto"), f = void 0;
    ...
    b.prototype.requestToken = function(b, d) {
      ...
      b = b || {};
      d = d || a;
      b = l.mixin(l.copy(this.tokenOptions), b);
      var f, e = this.rest;
      if(b.authCallback) {
        ...
        if(b.authUrl) {
          g.logAction(g.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), f = function(a, c) {
            Http.get(e, b.authUrl, b.authHeaders || {}, l.mixin(a, b.authParams), c)
          }
        }else {
          if(b.keyValue) {
            var h = this;
            ...
            f = function(a, c) {
              h.createTokenRequest(l.mixin(l.copy(b), a), c)
            }
          }else {
      ...
      var k = {}, u = b.clientId || this.rest.clientId;
      u && (k.client_id = u);
      u = b.ttl || "";
      "ttl" in b && (k.ttl = u);
      "capability" in b && (k.capability = c(b.capability));
      var e = this.rest, w = function(a) {
        return e.baseUri(a) + "/keys/" + b.keyId + "/authorise"
      }, v = function(a, b) {
        Http.post ? Http.post(e, w, l.defaultPostHeaders(), a, null, b) : Http.get(e, w, l.defaultGetHeaders(), a, b)
      };
      f(k, function(a, b) {
        a ? (g.logAction(g.LOG_ERROR, "Auth.requestToken()", "token request signing call returned error; err \x3d " + a), d(a)) : v(b, function(a, b) {
    ...
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        var l = a.capability || "";
        l && (e.capability = l);
        var v = this.rest, y = this;
        (function(c) {
          a.timestamp ? c() : a.queryTime ? v.time(function(d, f) {
            d ? b(d) : (a.timestamp = Math.floor(f / 1E3), c())
          }) : (a.timestamp = y.getTimestamp(), c())
        })(function() {
    ...
    b.prototype.getAuthHeaders = function(a) {
      "basic" == this.method ? a(null, {authorization:"Basic " + this.basicKey}) : this.authorise({}, function(b, c) {
        b ? a(b) : a(null, {authorization:"Bearer " + (new v(c.id, "ascii")).toString("base64")})
      })
    };
    ...
    function a(a) {
      ...
      a.fallbackHosts = a.restHost ? null : y.fallbackHosts;
      a.restHost = a.restHost || y.REST_HOST;
      this.serverTimeOffset = null;
      this.baseUri = this.authority = function(b) {
        return"https://" + b + ":" + (a.tlsPort || y.TLS_PORT)
      };
    ...
    a.prototype.stats = function(a, c) {
      ...
      var d = l.copy(l.defaultGetHeaders());
      this.options.headers && l.mixin(d, this.options.headers);
    ...
    function a(a) {
      ea.call(this, a);
      a.wsHost = a.wsHost || y.WS_HOST;
      a.wsPort = a.encrypted ? a.tlsPort || y.TLS_PORT : a.port || y.PORT;
    ...
    function a(a, b) {
      x.call(this);
      this.ably = a;
      this.connectionManager = new F(a, b);
    ...
    c.prototype.presence = function(b, c) {
      ...
      var d = this.rest, f = !d.options.useTextProtocol, r = l.copy(l.defaultGetHeaders(f));
      d.options.headers && l.mixin(r, d.options.headers);
      V.get(d, "/channels/" + this.name + "/presence", r, b, function(a, b) {
        a ? c(a) : f ? PresenceMessage.decodeTPresenceArray(b, c) : c(null, b)
      })
    };
    ...
    c.prototype.publish = function(b, c, d) {
      ...
      var f = this.rest;
      b = {name:b, data:c};
      c = l.copy(l.defaultPostHeaders(!1));
      f.options.headers && l.mixin(c, f.options.headers);
      V.post(f, "/channels/" + this.name + "/publish", b, c, null, d)
    };
    return c
  }(), ca = function() {
    function a(a, b, c) {
      ...
      this.options = l.prototypicalClone(e, c);
    ...
    a.prototype.publish = function(a, b, e) {
      ...
      F.activeState(m.state) ? (m = new c.TMessage, m.name = a, m.data = Data.toTData(b), "attached" == this.state ? (g.logAction(g.LOG_MICRO, "RealtimeChannel.publish()", "sending message"), a = new c.TChannelMessage, a.action = c.TAction.MESSAGE, a.channel = this.name, a.messages = [m], this.sendMessage(a, e)) : ("pending" != this.state && this.attach(), g.logAction(g.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:m, listener:e}))) : e(m.getStateError())
    };
    ...
    a.prototype.attach = function(a) {
      ...
      F.activeState(b.state) ? "attached" == this.state ? a() : "failed" == this.state ? a(b.getStateError()) : (this.once(function(c) {
        switch(this.event) {
          case "attached":
            a();
            break;
    ...
    a.prototype.detach = function(a) {
      a = a || d;
      var b = this.connectionManager;
      F.activeState(b.state) ? "detached" == this.state ? a() : (this.once(function(c) {
        switch(this.event) {
          case "detached":
            a();
            break;
    ...
    a.prototype.setAttached = function(a) {
      ...
      try {
        ...
        g.logAction(g.LOG_ERROR, "RealtimeChannel.setSubscribed()", "Unexpected exception sending pending messages: " + h.stack)
      }
    };
    ...
    a.prototype.leaveClient = function(a, d) {
      ...
      switch(p.state) {
        ...
        case "initialized":
          ...
          break;
        default:
          this.pendingPresence = null, d(G.failed)
      }
    };
    ...
    a.prototype.setPresence = function(a, c) {
      g.logAction(g.LOG_MICRO, "Presence.setPresence()", "received presence for " + a.length + " participants");
      for(var r = 0;r < a.length;r++) {
        var p = a[r], m = void 0, k = p.clientId;
        p.state == b.LEAVE ? delete this.clients[k] : m = this.clients[k] = Data.toTData(p.clientData);
        c && this.emit(d[p.state], k, m)
      }
    };
  ...
  (function() {
    ...
    F.httpTransports.jsonp = F.transports.jsonp = a;
    var e = null;
    a.checkConnectivity = function(b) {
      e ? e.push(b) : (e = [b], (new a.Request("isTheInternetUp")).send("http://live.cdn.ably-realtime.com/is-the-internet-up.js", null, null, !1, !1, function(a, b) {
        for(var c = !a && b, d = 0;d < e.length;d++) {
          e[d](null, c)
        }
        e = null
      }))
    ...
    a.tryConnect = function(b, c, d, e) {
      var h = new a(b, c, d), k = function(a) {
        e(a)
      };
      h.on("error", k);
    ...
    a.Request.prototype.send = function(a, c, d, e, h, g) {
      this.callback = g;
      var k = this.requestId, l = this.timer = setTimeout(e ? y.cometRecvTimeout : y.cometSendTimeout, function() {
        x.abort()
      });
      c = c || {};
      c.callback = "Ably._(" + k + ")";
  ...
  (function() {
    ...
    a.Request.prototype.send = function(a, d, e, f, g, k) {
      a = L.paramStr(d, a);
      var m, l, x;
      e ? (d = "POST", m = 201) : (d = "GET", m = 200);
      var s = this.xhr = c();
      g && (s.responseType = "arraybuffer");
      var u = setTimeout(f ? y.cometRecvTimeout : y.cometSendTimeout, function() {
        x = !0;
        s.abort()
      });
      s.open(d, a, !0);
      s.setRequestHeader("Accept", g ? "application/x-thrift" : "application/json");
      s.onerror = function(a) {
        a.code = 8E4;
        k(a)
      };
      s.onabort = function() {
        l = Error(x ? "Request timed out" : "Request cancelled");
        l.statusCode = 404;
        l.code = 8E4;
        k(l)
      };
      s.onreadystatechange = function() {
        if(4 == s.readyState) {
          if(clearTimeout(u), l) {
            ...
            if(s.status == m) {
              var a = null;
              g ? s.response && (a = new v, a.buf = s.response, a.view = new DataView(a.buf)) : a = s.responseText;
              k(null, a)
            }else {
              0 != s.status && (l = Error("Unexpected response: statusCode \x3d " + s.status), l.statusCode = s.status, l.code = 8E4, l.statusText = s.statusText, k(l))
            }
          }
        }
      };
    ...
    a.isAvailable() && (F.httpTransports.xhr = F.transports.xhr = a, Http.Request = function(b, c, d, f, g) {
  ...
  (function() {
    ...
    l.inherits(a, da);
    a.isAvailable = function() {
      return c && S && 10 <= S.getFlashPlayerVersion().major && R
    };
    a.isAvailable() && (F.transports.flash_socket = a);
    a.tryConnect = function(b, c, d, f) {
      var k = y.flashTransport.swfLocation, l = y.flashTransport.policyPort;
      ...
      R.__initialize(k);
      l && R.loadFlashPolicyFile("xmlsocket://" + d.host + ":" + l);
      var m = new a(b, c, d);
      errorCb = function(a) {
        f(a)
      };
    ...
    a.prototype.createWebSocket = function(a, c) {
      ...
      return new R(a, [], d.proxyHost, d.proxyPort)
    };
    a.prototype.toString = function() {
