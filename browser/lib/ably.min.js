  ...
  n.prototype.setAttached = function(a) {
    ...
    try {
      if(this.pendingEvents.length) {
        var b = new z.TChannelMessage({action:z.TAction.EVENT, channel:this.name, messages:[]}), c = new ga;
