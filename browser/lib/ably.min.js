(function() {
  window.Ably = {};
  for(var A = {disconnected:{statusCode:408, code:80003, reason:"Connection to server temporarily unavailable"}, suspended:{statusCode:408, code:80002, reason:"Connection to server unavailable"}, failed:{statusCode:408, code:8E4, reason:"Connection failed or disconnected by server"}, unknownConnectionErr:{statusCode:500, code:50002, reason:"Internal connection error"}, unknownChannelErr:{statusCode:500, code:50001, reason:"Internal channel error"}}, J = function(a, c, b) {
    function e() {
    }
  ...
  L.MAX_INT = Math.pow(2, 53);
  L.MIN_INT = -Math.pow(2, 53);
  L.prototype = {_2scomp:function() {
    ...
    return!a && g >= L.MAX_INT ? e ? -Infinity : Infinity : e ? -g : g
  }, valueOf:function() {
  ...
  w.prototype = {getArray:function() {
    ...
    a = a || 0;
    c = c || this.length;
    var b = new w, e = b.length = c - a, g = b.offset = this.offset + a, f = b.buf = this.buf;
  ...
  l.prototype.writeI64 = function(a) {
    a.buffer ? this.trans.writeI64(a) : this.trans.writeI64(new L(a))
  };
  ...
  l.prototype.readMessageBegin = function() {
    ...
    if(0 > a) {
      c = a & -65536;
      if(-2147418112 != c) {
        throw console.log("BAD: " + c), Z(4, "Bad version in readMessageBegin: " + a);
      }
      a &= 255;
      c = this.readString()
    }else {
      if(this.strictRead) {
        throw Z(4, "No protocol version header");
      }
      c = this.trans.read(a);
      a = this.readByte()
    }
  ...
  var ja = new w(0), I = d.TTransport = function(a, c) {
    this.buf = a || ja;
    this.onFlush = c;
    this.reset()
  };
  ...
  var $ = d.TFramedTransport = function(a, c) {
    I.call(this, a, c)
  };
  $.receiver = function(a) {
    ...
    return function(f) {
      ...
      for(;f.length;) {
        ...
        f.length >= c ? (f.copy(e, b, 0, c), f = f.slice(c, f.length), c = 0, a(new $(e))) : f.length && (f.copy(e, b, 0, f.length), c -= f.length, b += f.length, f = f.slice(f.length, f.length))
      }
    }
  };
  J($, I, {flush:function() {
      ...
      switch(c.fid) {
        ...
        case 13:
          if(b == d.Type.LIST) {
            ...
            c = a.readListBegin().size;
            for(b = 0;b < c;++b) {
              e = void 0, e = new E, e.read(a), this.presence.push(e)
            }
            a.readListEnd()
          }else {
            a.skip(b)
  ...
  var t = {TAction:TAction, TFlags:TFlags, TType:TType, TError:K, TData:D, TPresence:E, TMessage:H, TChannelMessage:void 0, TProtocolMessage:M, TPresenceState:TPresenceState, TMessageArray:TMessageArray};
  ...
  this.Http = function() {
    ...
    a.get = function(b, e, g, f, k) {
      ...
      p = r && "connected" == r.state ? [r.connectionManager.host] : u.getHosts(b.options);
    ...
    a.getUri = function(b, c, g, f, k) {
      a.Request(c, f, g, null, g && "application/json" != g.accept, cb)
    };
    a.post = function(b, e, g, f, k, d) {
      ...
      r = P && "connected" == P.state ? [P.connectionManager.host] : u.getHosts(b.options);
    ...
    a.postUri = function(b, c, g, f, d, m) {
      a.Request(c, d, g, f, g && "application/json" != g.accept, cb)
    };
  ...
  this.Base64 = function() {
    ...
    var e = {codex:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode:function(b) {
      ...
      for(b = new c(b);b.moveNext();) {
        ...
        var p = b.current;
        b.moveNext();
        var r = b.current, P = m >> 2, m = (m & 3) << 4 | p >> 4, h = (p & 15) << 2 | r >> 6, v = r & 63;
        isNaN(p) ? h = v = 64 : isNaN(r) && (v = 64);
        f.append(d.charAt(P) + d.charAt(m) + d.charAt(h) + d.charAt(v))
      }
      return f.toString()
    }, decode:function(c) {
      var f = new a;
  ...
  var C = Ably.Crypto = window.CryptoJS && function() {
    function a() {
    }
    function c() {
    ...
    a.getDefaultParams = function(b, e) {
      ...
      if(b) {
        b = "string" === typeof b ? CryptoJS.enc.Hex.parse(b) : CryptoJS.lib.WordArray.create(b);
        var g = new c;
    ...
    function b(a) {
      if(typeof w.addEventListener != y) {
        ...
        if(typeof s.addEventListener != y) {
    ...
    function e() {
      var a = s.getElementsByTagName("body")[0], b = s.createElement(N);
      ...
      if(c) {
        ...
        (function() {
          if(typeof c.GetVariable != y) {
            ...
            e && (e = e.split(" ")[1].split(","), q.pv = [parseInt(e[0], 10), parseInt(e[1], 10), parseInt(e[2], 10)])
          }else {
            if(10 > f) {
              f++;
    ...
    function g() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          var c = A[b].id, e = A[b].callbackFn, g = {success:!1, id:c};
          if(0 < q.pv[0]) {
            var r = v(c);
            if(r) {
              if(V(A[b].swfVersion) && !(q.wk && 312 > q.wk)) {
                l(c, !0), e && (g.success = !0, g.ref = f(c), e(g))
              }else {
                if(A[b].expressInstall && d()) {
                  g = {};
    ...
    function f(a) {
      ...
      if((a = v(a)) && "OBJECT" == a.nodeName) {
        typeof a.SetVariable != y ? b = a : (a = a.getElementsByTagName(N)[0]) && (b = a)
      }
      return b
    }
    function d() {
      return!I && V("6.0.65") && (q.win || q.mac) && !(q.wk && 312 > q.wk)
    }
    function m(a, b, c, e) {
      I = !0;
      J = e || null;
      ...
      var f = v(c);
      if(f) {
        "OBJECT" == f.nodeName ? (E = r(f), H = null) : (E = f, H = c);
        a.id = z;
        ...
        e = "MMredirectURL\x3d" + w.location.toString().replace(/&/g, "%26") + "\x26MMplayerType\x3d" + e + "\x26MMdoctitle\x3d" + s.title;
        b.flashvars = typeof b.flashvars != y ? b.flashvars + ("\x26" + e) : e;
        q.ie && (q.win && 4 != f.readyState) && (e = s.createElement("div"), c += "SWFObjectNew", e.setAttribute("id", c), f.parentNode.insertBefore(e, f), f.style.display = "none", function() {
    ...
    function r(a) {
      ...
      if(q.win && q.ie) {
        ...
        if(a = a.getElementsByTagName(N)[0]) {
          if(a = a.childNodes) {
    ...
    function h(a, b, c) {
      ...
      if(f) {
        if(typeof a.id == y && (a.id = c), q.ie && q.win) {
          ...
          for(g in b) {
            b[g] != Object.prototype[g] && "movie" != g.toLowerCase() && (a = p, d = g, k = b[g], c = s.createElement("param"), c.setAttribute("name", d), c.setAttribute("value", k), a.appendChild(c))
          }
    ...
    function n(a, b, c, e) {
      if(!q.ie || !q.mac) {
        ...
        if(f) {
          ...
          e && (K = O = null);
          if(!O || K != c) {
            e = s.createElement("style"), e.setAttribute("type", "text/css"), e.setAttribute("media", c), O = f.appendChild(e), q.ie && (q.win && typeof s.styleSheets != y && 0 < s.styleSheets.length) && (O = s.styleSheets[s.styleSheets.length - 1]), K = c
          }
          q.ie && q.win ? O && typeof O.addRule == N && O.addRule(a, b) : O && typeof s.createTextNode != y && O.appendChild(s.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function l(a, b) {
      if(M) {
        ...
        R && v(a) ? v(a).style.visibility = c : n("#" + a, "visibility:" + c)
      }
    }
    function u(a) {
      return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != y ? encodeURIComponent(a) : a
    }
    var y = "undefined", N = "object", t = "application/x-shockwave-flash", z = "SWFObjectExprInst", w = window, s = document, x = navigator, G = !1, C = [function() {
      G ? e() : g()
    }], A = [], D = [], B = [], E, H, J, L, R = !1, I = !1, O, K, M = !0, q = function() {
      var a = typeof s.getElementById != y && typeof s.getElementsByTagName != y && typeof s.createElement != y, b = x.userAgent.toLowerCase(), c = x.platform.toLowerCase(), e = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, f = !+"\v1", g = [0, 0, 0], d = null;
      if(typeof x.plugins != y && typeof x.plugins["Shockwave Flash"] == N) {
        if((d = x.plugins["Shockwave Flash"].description) && !(typeof x.mimeTypes != y && x.mimeTypes[t] && !x.mimeTypes[t].enabledPlugin)) {
          G = !0, f = !1, d = d.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), g[0] = parseInt(d.replace(/^(.*)\..*$/, "$1"), 10), g[1] = parseInt(d.replace(/^.*\.(.*)\s.*$/, "$1"), 10), g[2] = /[a-zA-Z]/.test(d) ? parseInt(d.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        }
      }else {
    ...
    (function() {
      q.w3 && ((typeof s.readyState != y && "complete" == s.readyState || typeof s.readyState == y && (s.getElementsByTagName("body")[0] || s.body)) && a(), R || (typeof s.addEventListener != y && s.addEventListener("DOMContentLoaded", a, !1), q.ie && q.win && (s.attachEvent("onreadystatechange", function() {
    ...
    (function() {
      q.ie && q.win && window.attachEvent("onunload", function() {
        for(var a = B.length, b = 0;b < a;b++) {
          B[b][0].detachEvent(B[b][1], B[b][2])
        }
        a = D.length;
        for(b = 0;b < a;b++) {
          F(D[b])
    ...
    return{registerObject:function(a, b, c, e) {
    ...
    }, embedSWF:function(a, b, e, f, g, p, r, F, v, Q) {
      var n = {success:!1, id:b};
      q.w3 && !(q.wk && 312 > q.wk) && a && b && e && f && g ? (l(b, !1), c(function() {
        e += "";
        f += "";
        var c = {};
        if(v && typeof v === N) {
        ...
        if(r && typeof r === N) {
          for(var s in r) {
            q.flashvars = typeof q.flashvars != y ? q.flashvars + ("\x26" + s + "\x3d" + r[s]) : s + "\x3d" + r[s]
          }
        }
        if(V(g)) {
          W = h(c, q, b), c.id == b && l(b, !0), n.success = !0, n.ref = W
        }else {
          if(p && d()) {
            c.data = p;
            m(c, q, b, Q);
      ...
      if(I) {
        var a = v(z);
        a && E && (a.parentNode.replaceChild(E, a), H && (l(H, !0), q.ie && q.win && (E.style.display = "block")), J && J(L));
        I = !1
      }
    }}
  }(), aa = function() {
    ...
    function b(a, c) {
      ...
      h.logAction(h.LOG_MICRO, "Realtime.ConnectionManager()", "requested transports \x3d [" + (c.transports || u.transports) + "]");
    ...
    var e = "undefined" !== typeof Cookie && Cookie.read, d = "undefined" !== typeof Cookie && Cookie.create, f = ("object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types")).TAction, k = function() {
    ...
    b.prototype.notifyState = function(a) {
      if(!(this.state.terminal || a.state == this.state.state)) {
        ...
        a = new ca(this.state.state, b.state, b.retryDelay, a.error || A[b.state]);
    ...
    b.prototype.requestState = function(a) {
      ...
      if(a.state != this.state.state) {
        ...
        if(a.state != this.state.state) {
          var b = m[a.state];
          a = new ca(this.state.state, b.state, b.retryIn, a.error || A[b.state]);
          this.enactStateChange(a)
        }
      }
    };
    ...
    b.prototype.queue = function(a, b) {
      ...
      f && ga.mergeTo(f.msg, a) ? (f.merged || (f.callback = new ba([f.callback]), f.merged = !0), f.callback.push(b)) : this.queuedMessages.push(new c(a, b))
    };
    ...
    function a(a, b, c) {
      c.binary = c.binary && d;
      B.call(this, a, b, c);
      this.wsHost = u.getHost(c.options, c.host, !0)
    }
    var c = "object" == typeof window, b = c ? t : require("../nodejs/lib/protocol/clientmessage_types"), e = c ? window.WebSocket || window.MozWebSocket : require("ws"), d = c ? !1 : !!w, f = function() {
    };
    n.inherits(a, B);
    a.isAvailable = function() {
      return!!e
    };
    a.isAvailable() && (G.transports.web_socket = a);
    ...
    a.prototype.connect = function() {
      ...
      var a = this, b = this.params, c = b.options, f = (c.encrypted ? "wss://" : "ws://") + this.wsHost + ":" + u.getPort(c) + "/";
    ...
    a.prototype.connect = function() {
      ...
      B.prototype.connect.call(this);
      var c = this, b = this.params, e = b.options, b = u.getHost(e, b.host), d = u.getPort(e);
      this.baseUri = (e.encrypted ? "https://" : "http://") + b + ":" + d + "/comet/";
    ...
    a.prototype.send = function(a, b) {
      if(this.sendRequest) {
        this.pendingItems = this.pendingItems || [], this.pendingItems.push(a), this.pendingCallback = this.pendingCallback || new ba, this.pendingCallback.push(b)
      }else {
  ...
  this.Data = function() {
    ...
    var c = "object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types"), b = "object" === typeof window, e = {"[object Null]":function(a, b) {
      a.type = c.TType.NONE;
      return!0
      ...
      !b && w.isBuffer(e) ? (a.type = c.TType.BUFFER, a.binaryData = e) : (a.type = c.TType.JSONOBJECT, a.stringData = JSON.stringify(e));
      return!0
    ...
    a.fromTData = function(a) {
      ...
      if(a) {
        if(a.cipherData) {
          return new C.CipherData(a.cipherData, a.type)
        }
        switch(a.type) {
          case 1:
            b = !0;
  ...
  var U = function() {
    ...
    a.encrypt = function(a, e) {
      ...
      d.cipherData = e.encrypt(C.Data.asPlaintext(f));
      d.type = f.type;
      a.data = d
    };
    a.decrypt = function(a, c) {
      var d = a.data;
      d.cipherData && (a.data = C.Data.fromPlaintext(c.decrypt(d.cipherData), d.type))
    };
    return a
  }(), ia = function() {
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, e = a.TMessage = {}, d = a.TPresence = {}, f = a.TProtocolMessage = {}, h = a.TMessageArray = {}, m = a.TMessageBundle = {}, p = c.TType.BUFFER;
    ...
    c.TMessage.prototype.toJSON = function() {
      ...
      (c = Data.isCipherData(a)) ? (b.encoding = "cipher+base64", c = C.Data.asBase64(c), b.type = a.type) : (c = Data.fromTData(a), a.type == p && (b.encoding = "base64", c = c.toString("base64")));
      b.data = c;
      return b
    };
    ...
    b.fromREST = function(a, b) {
      ...
      switch(a.encoding) {
        case "cipher+base64":
          e = new c.TData;
          e.type = a.type;
          e.cipherData = C.Data.fromBase64(b);
          break;
        case "base64":
          e = new c.TData;
          e.type = p;
          e.binaryData = new w(b, "base64");
          break;
        default:
          e = Data.toTData(b)
      }
    ...
    h.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          var f;
          if(d = ThriftUtil.decodeSync(f = new c.TMessageArray, a)) {
            throw d;
          }
          d = f.items
        }else {
          f = JSON.parse(a);
          for(var g = f.length, d = Array(g), h = 0;h < g;h++) {
            d[h] = e.fromJSON(f[h])
          }
        }
      }
  ...
  var X = function() {
    ...
    a.prototype.get = function(a) {
      var b = this;
      X.get(this.rest, this.path, this.headers, this.params, function(e, d, f) {
        if(e) {
    ...
    b.prototype.requestToken = function(b, e, d) {
      ...
      var l = e.id || b.keyId, g = this.rest, u = function(a) {
        return g.baseUri(a) + "/keys/" + l + "/requestToken"
      }, w = function(a, c) {
        var e;
        Http.post ? (e = n.defaultPostHeaders(), b.requestHeaders && n.mixin(e, b.requestHeaders), Http.post(g, u, e, a, null, c)) : (e = n.defaultGetHeaders(), b.requestHeaders && n.mixin(e, b.requestHeaders), Http.get(g, u, e, a, c))
      };
      f(e, function(a, b) {
        a ? (h.logAction(h.LOG_ERROR, "Auth.requestToken()", "token request signing call returned error; err \x3d " + a), "code" in a || (a.code = 40170), "statusCode" in a || (a.statusCode = 401), d(a)) : "issued_at" in b ? d(null, b) : w(b, function(a, b) {
    ...
    a.prototype.stats = function(a, c) {
      ...
      (new ka(this, "/stats", d, a, function(a) {
    ...
    c.prototype.get = function(a) {
      ...
      b || (this.attached[a] = b = new da(this.rest, a));
      return b
    };
    return a
  }(), J = function() {
    ...
    c.prototype.get = function(a) {
      a = String(a);
      var c = this.attached[a];
      c || (this.attached[a] = c = new ga(this.realtime, a, this.realtime.options));
      return c
    };
    return a
  }(), ca = function() {
    ...
    n.inherits(a, x);
    a.prototype.on = function(a, b) {
      x.prototype.on.apply(this, arguments);
      if(this.state == a && b) {
        try {
          b(new ca(void 0, a))
        }catch(d) {
    ...
    c.prototype.presence = function(b, c) {
      ...
      X.get(d, "/channels/" + this.name + "/presence", k, b, function(a, b) {
        a ? c(a) : f ? ia.decodeTPresenceArray(b, c) : c(null, b)
      })
    };
    c.prototype.history = function(b, c) {
      h.logAction(h.LOG_MICRO, "Channel.history()", "channel \x3d " + this.name);
      void 0 === c && ("function" == typeof b ? (c = b, b = null) : c = a);
      var d = this.rest, f = !d.options.useTextProtocol, k = n.copy(n.defaultGetHeaders(f)), m = this.cipher;
      d.options.headers && n.mixin(k, d.options.headers);
      X.get(d, "/channels/" + this.name + "/history", k, b, function(a, b) {
        if(a) {
          c(a)
        }else {
          try {
            for(var d = Serialize.TMessageArray.decode(b, f), g = 0;g < d.length;g++) {
              m && U.decrypt(d[g], m), d[g].data = Data.fromTData(d[g].data)
            }
            c(null, d)
          }catch(h) {
            c(h)
    ...
    a.prototype.attach = function(a) {
      ...
      G.activeState(b.state) ? "attached" == this.state ? a() : "failed" == this.state ? a(b.getStateError()) : (this.once(function(c) {
        switch(this.event) {
          case "attached":
            a();
            break;
    ...
    a.prototype.detach = function(b) {
      ...
      G.activeState(c.state) ? "detached" == this.state ? b() : (this.once(function(a) {
        switch(this.event) {
          case "detached":
            b();
            break;
          case "attached":
            b(A.unknownChannelErr);
            break;
          case "failed":
            b(a || c.getStateError())
        }
    ...
    a.prototype.onMessage = function(a) {
      switch(a.action) {
            ...
            for(var c = Array(a.length), d = this.cipher, e = 0;e < c.length;e++) {
              ...
              if(d) {
                try {
                  ...
                  var n = "Unexpected error decrypting message; err \x3d " + l;
                  h.logAction(h.LOG_ERROR, "RealtimeChannel.onMessage()", n);
                  this.emit("error", Error(n))
                }
              }
              c[e] = new U(g.channelSerial, g.timestamp, g.name, Data.fromTData(g.data))
            }
            this.onEvent(c)
          }
          break;
        case b.ERROR:
          ...
          break;
        default:
          h.logAction(h.LOG_ERROR, "RealtimeChannel.onMessage()", "Fatal protocol error: unrecognised action (" + a.action + ")"), this.connectionManager.abort(A.unknownChannelErr)
      }
    };
      ...
      if("attaching" == this.state) {
        ...
        try {
          if(this.pendingEvents.length) {
            var b = new c.TProtocolMessage({action:c.TAction.MESSAGE, channel:this.name, messages:[]}), d = new ba;
    ...
    var c = "object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types"), b = c.TPresenceState, d = ["enter", "leave", "update"];
    n.inherits(a, x);
    ...
    a.prototype.leaveClient = function(a, d) {
      ...
      var e = new c.TPresence({state:b.LEAVE, clientId:a}), m = this.channel;
      switch(m.state) {
        case "attached":
          m.sendPresence(e, d);
          break;
        ...
        case "initialized":
          ...
          break;
        default:
          this.pendingPresence = null, d(A.failed)
      }
    };
    a.prototype.get = function(a) {
    ...
    a.prototype.setPresence = function(a, c) {
      ...
      for(var k = 0;k < a.length;k++) {
        var m = a[k], p = m.clientId + ":" + m.memberId, r = new ia(m.clientId, Data.fromTData(m.clientData), m.memberId);
        switch(m.state) {
          case b.LEAVE:
            delete this.members[p];
            break;
          case b.UPDATE:
            m.inheritMemberId && delete this.members[m.clientId + ":" + m.inheritMemberId];
          case b.ENTER:
            clientData = this.members[p] = r
        }
        c && this.emit(d[m.state], r)
      }
    };
  ...
  (function() {
    ...
    G.httpTransports.jsonp = G.transports.jsonp = a;
    var g = null;
    a.checkConnectivity = function(b) {
      g ? g.push(b) : (g = [b], (new a.Request("isTheInternetUp")).send("http://live.cdn.ably-realtime.com/is-the-internet-up.js", null, null, null, !1, !1, function(a, b) {
    ...
    a.tryConnect = function(b, c, d, e) {
      var g = new a(b, c, d), l = function(a) {
        e(a)
      };
      g.on("error", l);
    ...
    a.Request.prototype.send = function(a, c, d, e, g, h, l) {
      this.callback = l;
      var n = this.requestId, w = this.timer = setTimeout(function() {
        x.abort()
      }, g ? u.cometRecvTimeout : u.cometSendTimeout);
      c = c || {};
      c.callback = "Ably._(" + n + ")";
      ...
      t.src = T.paramStr(c, a);
      var x = this, z = this._finish = function() {
        clearTimeout(w);
  ...
  (function() {
    ...
    a.checkConnectivity = function(b) {
      (new a.Request).send("http://live.cdn.ably-realtime.com/is-the-internet-up.txt", null, null, null, !1, function(a, c) {
        b(null, !a && "yes" == c)
      })
    };
    ...
    a.prototype.request = function(b, c, d, f, h) {
      var m = new a.Request;
      m.send(b, c, null, d, f, this.binary, h);
      return m
    };
    a.prototype.toString = function() {
    ...
    a.Request.prototype.send = function(a, d, g, f, h, m, l) {
      g = g || {};
      a = T.paramStr(d, a);
      var n, t, x;
      f ? (d = "POST", n = 201) : (d = "GET", n = 200);
      var v = this.xhr = c();
      m && (v.responseType = "arraybuffer", f = f.view);
      var z = setTimeout(function() {
        x = !0;
        v.abort()
      }, h ? u.cometRecvTimeout : u.cometSendTimeout);
      v.open(d, a, !0);
      f && (!m && "object" === typeof f) && (g["content-type"] || (g["content-type"] = "application/json"), f = JSON.stringify(f));
      g.accept || (g.accept = m ? "application/x-thrift" : "application/json");
      for(var A in g) {
        v.setRequestHeader(A, g[A])
      }
      ...
      v.onabort = function() {
        t = Error(x ? "Request timed out" : "Request cancelled");
        t.statusCode = 404;
        t.code = 8E4;
        l(t)
      };
      v.onreadystatechange = function() {
        if(4 == v.readyState) {
          if(clearTimeout(z), t) {
            ...
            if(v.status == n) {
              var a = null;
              m ? v.response && (a = new w, a.buf = v.response, a.view = new DataView(a.buf)) : a = v.responseText;
              for(var b = v.getAllResponseHeaders().trim().split("\n"), c = {}, d = 0;d < b.length;d++) {
                var e = b[d].split(":");
                c[e[0].trim()] = e[1].trim()
              }
              l(null, a, c)
            }else {
              0 != v.status && (t = Error("Unexpected response: statusCode \x3d " + v.status), t.statusCode = v.status, t.code = 8E4, t.statusText = v.statusText, l(t))
            }
          }
        }
      };
    ...
    a.isAvailable() && (G.httpTransports.xhr = G.transports.xhr = a, Http.supportsAuthHeaders = !0, Http.Request = function(b, c, d, f, h, l) {
  ...
  (function() {
    ...
    n.inherits(a, ha);
    a.isAvailable = function() {
      return c && S && 10 <= S.getFlashPlayerVersion().major && aa
    };
    a.isAvailable() && (G.transports.flash_socket = a);
    a.tryConnect = function(b, c, d, f) {
      aa.__initialize(b.options.flashTransport && b.options.flashTransport.swfLocation || u.flashTransport.swfLocation);
    ...
    a.prototype.createWebSocket = function(a, c) {
      ...
      return new aa(a, [], d.proxyHost, d.proxyPort)
    };
    a.prototype.toString = function() {
