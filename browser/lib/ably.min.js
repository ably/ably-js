(function() {
  for(var kb = ["web_socket", "flash_socket", "xhr", "jsonp"], ya = function(a, b, c) {
    function f() {
    }
    ...
    for(a.readStructBegin();;) {
      ...
      switch(b.fid) {
        ...
        case 2:
          ...
          break;
        case 3:
          c == d.Type.STRUCT ? (this.clientData = new Q, this.clientData.read(a)) : a.skip(c);
          break;
        default:
          a.skip(c)
      }
    ...
    for(a.readStructBegin();;) {
      ...
      switch(b.fid) {
        ...
        case 4:
          ...
          break;
        case 5:
          c == d.Type.STRUCT ? (this.payload = new Q, this.payload.read(a)) : a.skip(c);
          break;
        case 6:
          if(c == d.Type.LIST) {
            b = 0;
  ...
  var G = {TAction:TAction, TType:TType, TData:Q, TPresence:W, TMessage:X, TChannelMessage:Y, TMessageSet:da}, R, Z = function() {
    if(!S) {
      try {
    ...
    if(0 < a) {
      for(var b = 0;b < a;b++) {
        var c = M[b].id, f = M[b].callbackFn, d = {success:!1, id:c};
        if(0 < h.pv[0]) {
          var e = H(c);
          if(e) {
            if(la(M[b].swfVersion) && !(h.wk && 312 > h.wk)) {
              T(c, !0), f && (d.success = !0, d.ref = Ca(c), f(d))
            }else {
              if(M[b].expressInstall && Da()) {
                d = {};
                d.data = M[b].expressInstall;
                ...
                for(var m = {}, e = e.getElementsByTagName("param"), r = e.length, p = 0;p < r;p++) {
                  "movie" != e[p].getAttribute("name").toLowerCase() && (m[e[p].getAttribute("name")] = e[p].getAttribute("value"))
                }
                Ea(d, m, c, f)
              }else {
                nb(e), f && f(d)
    ...
    var d = H(c);
    if(d) {
      "OBJECT" == d.nodeName ? (ea = Ha(d), na = null) : (ea = d, na = c);
      a.id = Va;
    ...
    if(d) {
      if(typeof a.id == q && (a.id = c), h.ie && h.win) {
        var e = "", m;
        for(m in a) {
          a[m] != Object.prototype[m] && ("data" == m.toLowerCase() ? b.movie = a[m] : "styleclass" == m.toLowerCase() ? e += ' class="' + a[m] + '"' : "classid" != m.toLowerCase() && (e += " " + m + '="' + a[m] + '"'))
        }
        m = "";
        for(var r in b) {
          b[r] != Object.prototype[r] && (m += '<param name="' + r + '" value="' + b[r] + '" />')
        }
        d.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + e + ">" + m + "</object>";
        oa[oa.length] = a.id;
        f = H(a.id)
      }else {
        r = l.createElement(J);
        ...
        for(e in b) {
          b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = r, m = e, p = b[e], c = l.createElement("param"), c.setAttribute("name", m), c.setAttribute("value", p), a.appendChild(c))
        }
    ...
    if(!h.ie || !h.mac) {
      ...
      if(d) {
        ...
        f && (Ja = K = null);
        if(!K || Ja != c) {
          f = l.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), K = d.appendChild(f), h.ie && (h.win && typeof l.styleSheets != q && 0 < l.styleSheets.length) && (K = l.styleSheets[l.styleSheets.length - 1]), Ja = c
        }
  ...
  }, q = "undefined", J = "object", pa = "application/x-shockwave-flash", Va = "SWFObjectExprInst", D = window, l = document, N = navigator, $a = !1, ka = [function() {
    if($a) {
  ...
  }], M = [], oa = [], $ = [], ea, na, Ga, Ua, S = !1, ma = !1, K, Ja, Ya = !0, h, ob = typeof l.getElementById != q && typeof l.getElementsByTagName != q && typeof l.createElement != q, qa = N.userAgent.toLowerCase(), ra = N.platform.toLowerCase(), pb = ra ? /win/.test(ra) : /win/.test(qa), qb = ra ? /mac/.test(ra) : /mac/.test(qa), rb = /webkit/.test(qa) ? parseFloat(qa.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Ka = !+"\v1", fa = [0, 0, 0], A = null;
  if(typeof N.plugins != q && typeof N.plugins["Shockwave Flash"] == J) {
    if((A = N.plugins["Shockwave Flash"].description) && !(typeof N.mimeTypes != q && N.mimeTypes[pa] && !N.mimeTypes[pa].enabledPlugin)) {
      $a = !0, Ka = !1, A = A.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), fa[0] = parseInt(A.replace(/^(.*)\..*$/, "$1"), 10), fa[1] = parseInt(A.replace(/^.*\.(.*)\s.*$/, "$1"), 10), fa[2] = /[a-zA-Z]/.test(A) ? parseInt(A.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    }
  }else {
    if(typeof D.ActiveXObject != q) {
      try {
        ...
        if(ab && (A = ab.GetVariable("$version"))) {
          Ka = !0, A = A.split(" ")[1].split(","), fa = [parseInt(A[0], 10), parseInt(A[1], 10), parseInt(A[2], 10)]
        }
      }catch(Gb) {
      }
    }
  ...
  R = {registerObject:function(a, b, c, f) {
    if(h.w3 && a && b) {
      var d = {};
      d.id = a;
      d.swfVersion = b;
  ...
  }, embedSWF:function(a, b, c, f, d, e, m, r, p, j) {
    ...
    h.w3 && !(h.wk && 312 > h.wk) && a && b && c && f && d ? (T(b, !1), Sa(function() {
      ...
      if(m && typeof m === J) {
        for(var n in m) {
          i.flashvars = typeof i.flashvars != q ? i.flashvars + ("&" + n + "=" + m[n]) : n + "=" + m[n]
        }
      }
      if(la(d)) {
        l = Ia(h, i, b), h.id == b && T(b, !0), k.success = !0, k.ref = l
      }else {
        if(e && Da()) {
          h.data = e;
          Ea(h, i, b, j);
    ...
    if(ma) {
      var a = H(Va);
      a && ea && (a.parentNode.replaceChild(ea, a), na && (T(na, !0), h.ie && h.win && (ea.style.display = "block")), Ga && Ga(Ua));
      ma = !1
    }
  }};
  var sa, bb = window.location.protocol, cb = bb + "//rest.ably.io:" + ("https:" == bb ? 443 : 80) + "/static/0/WebSocketMainInsecure.swf";
  ...
  j.__initialize = function() {
    if(!j.__initialized) {
      ...
      R.embedSWF(cb, "webSocketFlash", "1", "1", "10.0.0", null, null, {hasPriority:!0, swliveconnect:!0, allowScriptAccess:"always"}, null, function(a) {
  ...
  s.prototype.chooseTransport = function(a) {
    if(this.transport) {
      ...
      var b = this, c = this.transports.slice(), f = function(a) {
        var d = c.shift();
        d ? (e.logAction(e.LOG_MICRO, "ConnectionManager.chooseTransport()", "trying " + d), s.availableTransports[d].tryConnect(b, b.realtime.auth, b.options, function(c, h) {
  ...
  s.prototype.requestState = function(a) {
    ...
    if(a.state != this.state.state) {
      ...
      var b = E[a.state], a = new ta(this.state.state, b.state, b.retryIn, a.reason || b.defaultMessage);
      this.enactStateChange(a)
    }
  };
  ...
  s.prototype.send = function(a, b, c) {
    c = c || ub;
    this.state.queueEvents && (b ? (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "queueing event"), (b = this.pendingMessages[this.pendingMessages.length - 1]) && La.mergeTo(b.msg, a) ? (b.isMerged || (b.callback = new ga([b.callback]), b.isMerged = !0), b.listener.push(c)) : this.pendingMessages.push({msg:a, callback:c})) : (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), c(this.state.defaultMessage)));
  ...
  var u = function(a, b, c) {
    ...
    t.call(this, a, b, c)
  }, Ma = "object" == typeof window, fb = Ma ? window.WebSocket || window.MozWebSocket : require("ws"), wb = Ma ? !1 : B, xb = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), ua = Ma ? d : require("thrift");
  k.inherits(u, t);
  ...
  u.prototype.connect = function() {
    ...
    this.auth.getAuthParams(function(c, d) {
      ...
      if(c) {
        ...
        try {
          var m = a.wsConnection = a.createWebSocket(b, d);
  ...
  u.prototype.onWsData = function(a, b) {
    var c = b ? new ua.TBinaryProtocol(new ua.TTransport(a)) : new ua.TJSONProtocol(new ua.TStringTransport(a)), d = new xb.TChannelMessage;
    try {
  ...
  C.Request = function(a, b, c, d, e, h) {
    ...
    var k = setTimeout(d ? 9E4 : 1E4, function() {
      i.abort()
    });
    i.open(b, a, !0);
  ...
  F.Request = function(a, b, c, d, e) {
    ...
    k.src = v.paramStr(b, a);
    var l = this;
    Ably._["_" + i] = function(a) {
      clearTimeout(j);
      delete h["_" + i];
      l.aborted || (k.parentNode.removeChild(k), e(null, a))
    };
  ...
  O.isAvailable = function() {
    return zb && R && 10 <= R.getFlashPlayerVersion().major && sa
  };
  O.isAvailable() && (L.availableTransports.flash_socket = O);
  O.tryConnect = function(a, b, c, d) {
    sa.__initialize();
    var g = new O(a, b, c);
    errorCb = function(a) {
      d(a)
  ...
  O.prototype.createWebSocket = function(a, b) {
    var c = 0;
    if(b) {
      for(var d in b) {
        a += (c++ ? "&" : "?") + d + "=" + b[d]
    ...
    this.uri = a;
    return new sa(a, [], this.options.proxyHost, this.options.proxyPort)
  };
  ...
  P.prototype.post = function(a, b, c) {
  ...
  }, Oa = "object" == typeof window, Bb = Oa ? null : require("crypto"), va = void 0;
  ...
  var Pa = function(a) {
    ...
    this.events = new P(this, "/events");
    this.stats = new P(this, "/stats");
  ...
  var ia = function(a, b) {
    ...
    this.rest = a;
    this.name = b;
    this.presence = new P(a, "/channels/" + b + "/presence");
    this.events = new P(a, "/channels/" + b + "/events");
    this.stats = new P(a, "/channels/" + b + "/stats")
  }, Cb = function() {
  };
  k.inherits(ia, w);
  ia.prototype.publish = function(a, b, c) {
    ...
    c = c || Cb;
    (this._publish = this._publish || new P(this.rest, "/channels/" + this.name + "/publish")).post({name:a, payload:b}, c)
  };
  var La, n = function(a, b, c) {
    ...
    this.pendingEvents = []
  }, z = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), ba = function() {
  }, Db = {queueEvents:!0};
  k.inherits(n, ia);
  n.prototype.publish = function(a, b, c) {
  ...
  n.prototype.attachImpl = function(a) {
    ...
    this.sendMessage(b, a || ba)
  };
  n.prototype.detach = function(a) {
    var b = this.connectionManager, c = b.state;
  ...
  n.prototype.detachImpl = function(a) {
  ...
  n.prototype.subscribeAttached = function(a, b, c) {
    if(a) {
  ...
  n.prototype.subscribeForEvent = function(a, b, c) {
  ...
  n.prototype.unsubscribeAttached = function(a, b, c) {
    if(a) {
      if(a.__proto__ !== Array.prototype) {
  ...
  n.prototype.unsubscribeForEvent = function(a, b, c) {
    var d = this.subscriptions;
    d.off(a, b);
    d.listeners("*" === a ? null : a) ? c() : (e.logAction(e.LOG_MICRO, "RealtimeChannel.unsubscribe()", "sending UNSUBSCRIBE message"), a = new z.TChannelMessage({action:z.TAction.UNSUBSCRIBE, channel:this.name, name:a}), this.sendMessage(a, ba))
  };
  n.prototype.sendMessage = function(a, b) {
    this.connectionManager.send(a, this.options.queueEvents, b)
  };
  n.prototype.sendPresence = function(a, b) {
    var c = new z.TChannelMessage({action:z.TAction.PRESENCE, name:name});
    this.sendMessage(c, b)
  };
  n.prototype.onMessage = function(a) {
    switch(a.action) {
      case 3:
  ...
  n.prototype.setAttached = function(a) {
    ...
    try {
      if(this.pendingEvents.length) {
        var b = new z.TChannelMessage({action:z.TAction.EVENT, name:this.name}), c = new ga;
  ...
  n.prototype.setSubscribed = function(a) {
    var b = a.name;
  ...
  n.prototype.setDetached = function(a) {
    var b = this.state;
    this.state = "detached";
    "pending" == b ? this.emit("failed", a) : this.emit("detached")
  };
  n.prototype.setUnsubscribed = function(a) {
  ...
  var jb, I = function(a, b) {
    ...
    this.clients = {}
  }, xa = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types");
  k.inherits(I, w);
