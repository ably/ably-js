...
export default function UsePresenceOnlyEnter() {
  return (
    <ChannelProvider channelName="my-presence-channel" options={{ modes: ['PRESENCE'] }}>
      <UsePresenceOnlyEnterChild></UsePresenceOnlyEnterChild>
    </ChannelProvider>
  );
}

function UsePresenceOnlyEnterChild() {
  const ably = useAbly();
