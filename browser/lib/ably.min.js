(function() {
      ...
      if(A.activeState(m.state)) {
        switch(m = new c.TMessage, m.name = a, m.data = Data.toTData(b), this.state) {
          ...
          default:
            this.attach();
          case "attaching":
            g.logAction(g.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:m, listener:h})
        }
      }else {
        h(m.getStateError())
      }
  ...
  (function() {
    ...
    a.Request.prototype.send = function(a, d, h, f, g, l) {
      a = M.paramStr(d, a);
      var m, n, v;
      h ? (d = "POST", m = 201) : (d = "GET", m = 200);
      var t = this.xhr = c();
      ...
      t.open(d, a, !0);
      t.setRequestHeader("Accept", g ? "application/x-thrift" : "application/json");
      ...
      t.onreadystatechange = function() {
        if(4 == t.readyState) {
          if(clearTimeout(z), n) {
            ...
            if(t.status == m) {
              var a = null;
              g ? t.response && (a = new u, a.buf = t.response, a.view = new DataView(a.buf)) : a = t.responseText;
              l(null, a)
            }else {
