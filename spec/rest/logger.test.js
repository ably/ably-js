...
define(['shared_helper'], function(helper) {
	...
	/*
	 * Check that the logger writes to console.log by default with no errors.
	 */
	exports.logger_writes_to_console = function(test) {
		test.expect(2);
	...
	exports.logger_rest_constructor = function(test) {
		...
		helper.setupApp(function() {
			...
			test.ok(rest, 'Rest client instantiated');
