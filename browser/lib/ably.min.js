(function() {
  ...
  this.Http = function() {
    ...
    a.post = function(b, g, e, f, d, m) {
      ...
      m = m || c;
      var q = "function" == typeof g ? g : function(a) {
        return b.baseUri(a) + g
      ...
      if("string" == typeof q) {
        ...
        1 == B.length ? l(q(B[0]), m) : l(B.shift(), function(a, b, c) {
          if(a) {
            var f = a.code;
            if("ENETUNREACH" == f || "EHOSTUNREACH" == f || "EHOSTDOWN" == f) {
              l(B, m);
  ...
  this.Base64 = function() {
    ...
    var g = {codex:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode:function(b) {
      ...
      for(b = new c(b);b.moveNext();) {
        ...
        var l = b.current;
        b.moveNext();
        var q = b.current, h = m >> 2, m = (m & 3) << 4 | l >> 4, B = (l & 15) << 2 | q >> 6, y = q & 63;
        isNaN(l) ? B = y = 64 : isNaN(q) && (y = 64);
  ...
  var S = function() {
      ...
      if(c) {
        ...
        (function() {
          if(typeof c.GetVariable != x) {
            ...
            g && (g = g.split(" ")[1].split(","), p.pv = [parseInt(g[0], 10), parseInt(g[1], 10), parseInt(g[2], 10)])
          }else {
            if(10 > f) {
              f++;
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          ...
          if(0 < p.pv[0]) {
            var q = y(c);
            if(q) {
              if(k(C[b].swfVersion) && !(p.wk && 312 > p.wk)) {
                ...
                if(C[b].expressInstall && d()) {
                  ...
                  for(var h = {}, q = q.getElementsByTagName("param"), B = q.length, T = 0;T < B;T++) {
                    "movie" != q[T].getAttribute("name").toLowerCase() && (h[q[T].getAttribute("name")] = q[T].getAttribute("value"))
                  }
                  m(g, h, c, e)
                }else {
                  l(q), e && e(g)
    ...
    function d() {
      return!J && k("6.0.65") && (p.win || p.mac) && !(p.wk && 312 > p.wk)
    }
    function m(a, b, c, f) {
      J = !0;
      K = f || null;
      ...
      var g = y(c);
      if(g) {
        "OBJECT" == g.nodeName ? (G = q(g), I = null) : (G = g, I = c);
        a.id = A;
        ...
        p.ie && (p.win && 4 != g.readyState) && (f = s.createElement("div"), c += "SWFObjectNew", f.setAttribute("id", c), g.parentNode.insertBefore(f, g), g.style.display = "none", function() {
    ...
    function h(a, b, c) {
      ...
      if(g) {
        if(typeof a.id == x && (a.id = c), p.ie && p.win) {
          ...
          for(var q in a) {
            a[q] != Object.prototype[q] && ("styleclass" == q.toLowerCase() ? l.setAttribute("class", a[q]) : "classid" != q.toLowerCase() && l.setAttribute(q, a[q]))
          }
          for(e in b) {
            b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = l, d = e, q = b[e], c = s.createElement("param"), c.setAttribute("name", d), c.setAttribute("value", q), a.appendChild(c))
          }
    ...
    function n(a, b, c, f) {
      if(!p.ie || !p.mac) {
        ...
        if(g) {
          ...
          f && (N = L = null);
          if(!L || N != c) {
            f = s.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), L = g.appendChild(f), p.ie && (p.win && typeof s.styleSheets != x && 0 < s.styleSheets.length) && (L = s.styleSheets[s.styleSheets.length - 1]), N = c
          }
          p.ie && p.win ? L && typeof L.addRule == r && L.addRule(a, b) : L && typeof s.createTextNode != x && L.appendChild(s.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function Q(a, b) {
    ...
    var x = "undefined", r = "object", w = "application/x-shockwave-flash", A = "SWFObjectExprInst", v = window, s = document, z = navigator, F = !1, E = [function() {
      F ? g() : e()
    }], C = [], H = [], D = [], G, I, K, M, P = !1, J = !1, L, N, R = !0, p = function() {
    ...
    (function() {
      p.w3 && ((typeof s.readyState != x && "complete" == s.readyState || typeof s.readyState == x && (s.getElementsByTagName("body")[0] || s.body)) && a(), P || (typeof s.addEventListener != x && s.addEventListener("DOMContentLoaded", a, !1), p.ie && p.win && (s.attachEvent("onreadystatechange", function() {
    ...
    return{registerObject:function(a, b, c, f) {
    ...
    }, embedSWF:function(a, b, f, g, e, l, q, B, y, O) {
      var n = {success:!1, id:b};
      p.w3 && !(p.wk && 312 > p.wk) && a && b && f && g && e ? (Q(b, !1), c(function() {
        f += "";
        g += "";
        var c = {};
        if(y && typeof y === r) {
        ...
        if(q && typeof q === r) {
          for(var t in q) {
            p.flashvars = typeof p.flashvars != x ? p.flashvars + ("\x26" + t + "\x3d" + q[t]) : t + "\x3d" + q[t]
          }
        }
        if(k(e)) {
          s = h(c, p, b), c.id == b && Q(b, !0), n.success = !0, n.ref = s
        }else {
          if(l && d()) {
            c.data = l;
            m(c, p, b, O);
      ...
      if(J) {
        var a = y(A);
        a && G && (a.parentNode.replaceChild(G, a), I && (Q(I, !0), p.ie && p.win && (G.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), R = function() {
    ...
    a.prototype.connect = function() {
      ...
      var a = this, b = this.params, c = b.options, f = (c.encrypted ? "wss://" : "ws://") + this.wsHost + ":" + t.getPort(c) + "/";
      ...
      this.auth.getAuthParams(function(c, e) {
        ...
        if(c) {
          ...
          try {
            var l = a.wsConnection = a.createWebSocket(f, d);
  ...
  var U = function() {
    ...
    a.post = function(a, b, d, e, f, h) {
      function m() {
        a.auth.getAuthHeaders(function(l, q) {
          l ? h(l) : Http.post(a, b, n.mixin(q, e), d, f, function(b, f, d) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? h(a) : m()
            }) : h(b, f, d)
          })
    ...
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        (function(c) {
          ...
          var c = e.nonce = a.nonce || ("000000" + Math.floor(1E16 * Math.random())).slice(-16), q = e.timestamp = a.timestamp, c = e.id + "\n" + u + "\n" + k + "\n" + g + "\n" + q + "\n" + c + "\n";
          e.mac = a.mac || f(c, d);
    ...
    a.prototype.publish = function(a, b, e) {
      ...
      if(z.activeState(l.state)) {
        var l = new c.TMessage, q = this.cipher;
        l.name = a;
    ...
    c.prototype.setPresence = function(b, c) {
      ...
      for(var m = 0;m < b.length;m++) {
        var l = b[m], q = a.call(l.clientId, l.memberId), k = new da(l.clientId, Data.fromTData(l.clientData), l.memberId);
        switch(l.state) {
          case d.LEAVE:
            delete this.members[q];
            break;
          case d.UPDATE:
            l.inheritMemberId && delete this.members[a.call(l.clientId, l.inheritMemberId)];
          case d.ENTER:
            clientData = this.members[q] = k
        }
  ...
  (function() {
    ...
    a.tryConnect = function(b, c, d, f) {
      ...
      R.__initialize(k);
      var l = new a(b, c, d);
      m && R.loadFlashPolicyFile("xmlsocket://" + l.wsHost + ":" + m);
      errorCb = function(a) {
        f(a)
      };
