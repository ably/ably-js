(function() {
  for(var jb = ["web_socket", "flash_socket", "xhr", "jsonp"], za = function(a, b, c) {
    function f() {
    }
  ...
  W.prototype = {_2scomp:function() {
    ...
    return!a && h >= W.MAX_INT ? f ? -Infinity : Infinity : f ? -h : h
  }, valueOf:function() {
  ...
  C.prototype = {getArray:function() {
    ...
    return Aa.decode(this.view, a, b)
    ...
    return Aa.encode(b, this.view, a)
  }, inspect:function() {
  ...
  var kb = d.CheckedBuffer = function(a) {
    C.call(this, a)
  };
  za(kb, C, {grow:function(a) {
  ...
  j.prototype.readMessageBegin = function() {
    ...
    if(0 > a) {
      b = a & -65536;
      if(-2147418112 != b) {
        throw console.log("BAD: " + b), Ba(4, "Bad version in readMessageBegin: " + a);
      }
      a &= 255;
      b = this.readString()
    }else {
      if(this.strictRead) {
        throw Ba(4, "No protocol version header");
      }
      b = this.trans.read(a);
      a = this.readByte()
    }
  ...
  var lb = new C(0), X = d.TTransport = function(a, b) {
    this.buf = a || lb;
    this.onFlush = b;
    this.reset()
  };
  ...
  X.prototype = {commitPosition:function() {
  ...
  var Ca = d.TFramedTransport = function(a, b) {
    X.call(this, a, b)
  };
  Ca.receiver = function(a) {
    ...
    return function(d) {
      ...
      for(;d.length;) {
        ...
        d.length >= b ? (d.copy(f, c, 0, b), d = d.slice(b, d.length), b = 0, a(new Ca(f))) : d.length && (d.copy(f, c, 0, d.length), b -= d.length, c += d.length, d = d.slice(d.length, d.length))
      }
    }
  };
  za(Ca, X, {flush:function() {
    var a = this;
    X.prototype.flush.call(this, function(b) {
      if(a.onFlush) {
      ...
      switch(b.fid) {
        ...
        case 14:
          if(c == d.Type.SET) {
            ...
            for(c = 0;c < b;++c) {
              f = null, f = new Y, f.read(a), this.presence.push(f)
            }
            a.readSetEnd()
          }else {
            a.skip(c)
  ...
  var G = {TAction:TAction, TType:TType, TData:S, TPresence:Y, TMessage:Z, TChannelMessage:$, TMessageSet:ea}, T, aa = function() {
    if(!U) {
      try {
    ...
    if(0 < a) {
      for(var b = 0;b < a;b++) {
        ...
        if(0 < g.pv[0]) {
          var e = H(c);
          if(e) {
            if(ma(M[b].swfVersion) && !(g.wk && 312 > g.wk)) {
              V(c, !0), f && (d.success = !0, d.ref = Da(c), f(d))
            }else {
          ...
          if(V(c, !0), f) {
            if((c = Da(c)) && typeof c.SetVariable != r) {
              d.success = !0, d.ref = c
            }
            f(d)
          }
    ...
    return!na && ma("6.0.65") && (g.win || g.mac) && !(g.wk && 312 > g.wk)
  }, Fa = function(a, b, c, f) {
    na = !0;
    Ha = f || null;
    Ua = {success:!1, id:c};
    var d = H(c);
    if(d) {
      "OBJECT" == d.nodeName ? (fa = Ia(d), oa = null) : (fa = d, oa = c);
      a.id = Va;
    ...
    if(g.ie && g.win && 4 != a.readyState) {
      ...
      b.parentNode.replaceChild(Ia(a), b);
      a.style.display = "none";
      (function() {
        4 == a.readyState ? a.parentNode.removeChild(a) : setTimeout(arguments.callee, 10)
      })()
    }else {
      a.parentNode.replaceChild(Ia(a), a)
    }
  }, Ia = function(a) {
    var b = l.createElement("div");
    if(g.win && g.ie) {
    ...
    if(!g.ie || !g.mac) {
      ...
      if(d) {
        ...
        f && (Ka = K = null);
        if(!K || Ka != c) {
          f = l.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), K = d.appendChild(f), g.ie && (g.win && typeof l.styleSheets != r && 0 < l.styleSheets.length) && (K = l.styleSheets[l.styleSheets.length - 1]), Ka = c
        }
    ...
    if(Ya) {
      ...
      U && H(a) ? H(a).style.visibility = c : Xa("#" + a, "visibility:" + c)
    }
  }, Za = function(a) {
    return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != r ? encodeURIComponent(a) : a
  }, r = "undefined", J = "object", qa = "application/x-shockwave-flash", Va = "SWFObjectExprInst", D = window, l = document, N = navigator, $a = !1, la = [function() {
    if($a) {
  ...
  }], M = [], pa = [], ba = [], fa, oa, Ha, Ua, U = !1, na = !1, K, Ka, Ya = !0, g, nb = typeof l.getElementById != r && typeof l.getElementsByTagName != r && typeof l.createElement != r, ra = N.userAgent.toLowerCase(), sa = N.platform.toLowerCase(), ob = sa ? /win/.test(sa) : /win/.test(ra), pb = sa ? /mac/.test(sa) : /mac/.test(ra), qb = /webkit/.test(ra) ? parseFloat(ra.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, La = !+"\v1", ga = [0, 0, 0], A = null;
  if(typeof N.plugins != r && typeof N.plugins["Shockwave Flash"] == J) {
    if((A = N.plugins["Shockwave Flash"].description) && !(typeof N.mimeTypes != r && N.mimeTypes[qa] && !N.mimeTypes[qa].enabledPlugin)) {
      $a = !0, La = !1, A = A.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), ga[0] = parseInt(A.replace(/^(.*)\..*$/, "$1"), 10), ga[1] = parseInt(A.replace(/^.*\.(.*)\s.*$/, "$1"), 10), ga[2] = /[a-zA-Z]/.test(A) ? parseInt(A.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    }
  }else {
    if(typeof D.ActiveXObject != r) {
      try {
        ...
        if(ab && (A = ab.GetVariable("$version"))) {
          La = !0, A = A.split(" ")[1].split(","), ga = [parseInt(A[0], 10), parseInt(A[1], 10), parseInt(A[2], 10)]
        }
      }catch(Fb) {
      }
    }
  }
  g = {w3:nb, pv:ga, wk:qb, ie:La, win:ob, mac:pb};
  g.w3 && ((typeof l.readyState != r && "complete" == l.readyState || typeof l.readyState == r && (l.getElementsByTagName("body")[0] || l.body)) && aa(), U || (typeof l.addEventListener != r && l.addEventListener("DOMContentLoaded", aa, !1), g.ie && g.win && (l.attachEvent("onreadystatechange", function() {
    "complete" == l.readyState && (l.detachEvent("onreadystatechange", arguments.callee), aa())
  }), D == top && function() {
    if(!U) {
      try {
    ...
    U || (/loaded|complete/.test(l.readyState) ? aa() : setTimeout(arguments.callee, 0))
  }(), Ta(aa)));
  g.ie && g.win && window.attachEvent("onunload", function() {
    for(var a = ba.length, b = 0;b < a;b++) {
      ba[b][0].detachEvent(ba[b][1], ba[b][2])
    }
    a = pa.length;
    for(b = 0;b < a;b++) {
      Wa(pa[b])
  ...
  T = {registerObject:function(a, b, c, f) {
    if(g.w3 && a && b) {
      var d = {};
      d.id = a;
      d.swfVersion = b;
    ...
    g.w3 && !(g.wk && 312 > g.wk) && a && b && c && f && d ? (V(b, !1), Sa(function() {
      c += "";
      f += "";
      var g = {};
      if(p && typeof p === J) {
      ...
      if(ma(d)) {
        l = Ja(g, k, b), g.id == b && V(b, !0), j.success = !0, j.ref = l
      }else {
        if(e && Ea()) {
          g.data = e;
          Fa(g, k, b, i);
    ...
    if(na) {
      var a = H(Va);
      a && fa && (a.parentNode.replaceChild(fa, a), oa && (V(oa, !0), g.ie && g.win && (fa.style.display = "block")), Ha && Ha(Ua));
      na = !1
    }
  }};
  var ta;
  ...
  i.__initialize = function() {
    if(!i.__initialized) {
      ...
      T.embedSWF("swf/WebSocketMainInsecure.swf", "webSocketFlash", "1", "1", "10.0.0", null, null, {hasPriority:!0, swliveconnect:!0, allowScriptAccess:"always"}, null, function(a) {
  ...
  k.nextTick = rb ? function(a) {
    setTimeout(a, 0)
  } : process.nextTick;
  var sb = {json:"application/json", jsonp:"application/javascript", xml:"application/xml", html:"text/html"};
  ...
  k.inherits(ha, Function);
  ha.prototype.push = function() {
  ...
  s.prototype.notifyState = function(a) {
    if(!(this.state.terminal || a.state == this.state.state)) {
      ...
      a = new ua(this.state.state, b.state, b.retryDelay, a.reason || b.defaultMessage);
  ...
  s.prototype.requestState = function(a) {
    ...
    if(a.state != this.state.state) {
      ...
      var b = E[a.state], a = new ua(this.state.state, b.state, b.retryIn, a.reason || b.defaultMessage);
      this.enactStateChange(a)
    }
  };
  ...
  s.prototype.send = function(a, b, c) {
    c = c || tb;
    this.state.queueEvents && (b ? (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "queueing event"), (b = this.pendingMessages[this.pendingMessages.length - 1]) && Ma.mergeTo(b.msg, a) ? (b.isMerged || (b.callback = new ha([b.callback]), b.isMerged = !0), b.listener.push(c)) : this.pendingMessages.push({msg:a, callback:c})) : (e.logAction(e.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), c(this.state.defaultMessage)));
  ...
  var t = function(a, b, c) {
    ...
    this.auth = b;
    this.options = c;
    c.useTextProtocol ? (this.thriftTransport = ia.TStringTransport, this.thriftProtocol = ia.TJSONProtocol) : (this.thriftTransport = ia.TTransport, this.thriftProtocol = ia.TBinaryProtocol, this.protocolBuffer = new ia.CheckedBuffer(ub));
    this.isConnected = !1
  }, ia = "object" == typeof window ? d : require("thrift"), ub = 1024;
  k.inherits(t, w);
  ...
  var u = function(a, b, c) {
    c.useTextProtocol = c.useTextProtocol || !vb;
    this.sendOptions = {binary:!c.useTextProtocol};
    t.call(this, a, b, c)
  }, Na = "object" == typeof window, db = Na ? window.WebSocket || window.MozWebSocket : require("ws"), vb = Na ? !1 : C, wb = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), va = Na ? d : require("thrift");
  k.inherits(u, t);
  ...
  u.prototype.onWsData = function(a, b) {
    var c = b ? new va.TBinaryProtocol(new va.TTransport(a)) : new va.TJSONProtocol(new va.TStringTransport(a)), f = new wb.TChannelMessage;
    try {
  ...
  }, Oa = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types");
  ...
  v.prototype.send = function(a, b) {
    if(this.sendRequest) {
      this.pendingMessage = this.pendingMessage || new Oa.TMessageSet({items:[]}), this.pendingMessage.items.push(a), this.pendingCallback = this.pendingCallback || new ha, this.pendingCallback.push(b)
    }else {
      var c = this.pendingMessage || new Oa.TMessageSet({items:[]});
      c.items.push(a);
  ...
  v.prototype.onResponseData = function(a) {
    var a = new this.thriftProtocol(new this.thriftTransport(a)), b = new Oa.TMessageSet;
    try {
      b.read(a);
      var c = b.items;
      if(c && c.length) {
  ...
  F.Request = function(a, b, c, d, e) {
    var g = Ably._;
    this.callback = e;
    var i = this.requestId = xb++, k = this.timer = setTimeout(d ? 9E4 : 1E4, function() {
      l.abort()
    });
  ...
  O.isAvailable = function() {
    return yb && T && 10 <= T.getFlashPlayerVersion().major && ta
  };
  ...
  O.prototype.createWebSocket = function(a, b) {
    ...
    this.uri = a;
    return new ta(a, [], this.options.proxyHost, this.options.proxyPort)
  };
  ...
  P.get = function(a, b, c, d) {
    4 > arguments.length && ("function" == typeof c ? (d = c, c = null) : d = fb);
    a.auth.getAuthHeaders(function(e, g) {
      e ? d(e) : Http.get(a.baseUri + b, k.mixin(g, a.headers), c, d)
    })
  };
  P.post = function(a, b, c, d, e) {
    5 > arguments.length && ("function" == typeof d ? (e = d, d = null) : e = fb);
    a.auth.getAuthHeaders(function(g, i) {
      g ? e(g) : Http.post(a.baseUri + b, k.mixin(i, a.headers), c, d, e)
    })
  };
  var zb = function() {
  }, Ab = function(a) {
  ...
  }, Pa = "object" == typeof window, Bb = Pa ? null : require("crypto"), wa = void 0;
  Pa && (window.CryptoJS && CryptoJS.HmacSHA1 && CryptoJS.enc.Base64) && (wa = function(a, b) {
    return CryptoJS.HmacSHA1(a, b).toString(CryptoJS.enc.Base64)
  });
  Pa || (wa = function(a, b) {
    var c = Bb.createHmac("SHA1", b);
    c.update(a);
    return c.digest("base64")
  });
  ca.prototype.authorise = function(a, b) {
    if(this.token) {
  ...
  ca.prototype.requestToken = function(a, b) {
    "function" == typeof a && !b && (b = a, a = {});
    var a = a || {}, b = b || zb, a = k.mixin(k.copy(this.tokenOptions), a), c;
    if(a.authCallback) {
      ...
      if(a.authUrl) {
        e.logAction(e.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), c = function(b, c) {
          Http.get(a.authUrl, a.authHeaders || {}, k.mixin(b, a.authParams), c)
        }
      }else {
        if(a.keyValue) {
          var d = this;
    ...
    "capability" in a && (h.capability = Ab(a.capability));
    d = this;
    c(h, function(a, c) {
      if(a) {
  ...
  ca.prototype.createTokenRequest = function(a, b) {
  ...
  ca.prototype.getAuthParams = function(a) {
  ...
  ca.prototype.getAuthHeaders = function(a) {
    "basic" == this.method ? a(null, {authorization:"Basic " + (new C(this.keyId + ":" + this.keyValue, "ascii")).toString("base64")}) : this.authorise({}, function(b, c) {
  ...
  var ja = function(a) {
    ...
    this.headers = b;
    this.auth = new ca(this, a);
    this.connection = new gb(this, a);
    this.channels = new hb(this);
    this.connection.connectionManager.start()
  }, hb = function(a) {
    this.realtime = a;
    this.attached = {}
  };
  ja.prototype.history = function(a, b) {
    P.get(this, "/events", a, b)
  };
  ja.prototype.stats = function(a, b) {
    P.get(this, "/stats", a, b)
  };
  ...
  k.inherits(Q, w);
  Q.prototype.presence = function(a, b) {
    P.get(this, "/channels/" + this.name + "/presence", a, b)
  };
  Q.prototype.history = function(a, b) {
    P.get(this, "/channels/" + this.name + "/events", a, b)
  };
  Q.prototype.stats = function(a, b) {
    P.get(this, "/channels/" + this.name + "/stats", a, b)
  };
  Q.prototype.publish = function(a, b, c) {
    e.logAction(e.LOG_MICRO, "Channel.publish()", "name = " + a);
    P.post(this.rest, "/channels/" + this.name + "/publish", {name:a, payload:b}, c)
  };
  var Ma, n = function(a, b, c) {
    e.logAction(e.LOG_MINOR, "RealtimeChannel()", "started; name = " + b);
    Q.call(this, a, b, c);
    this.presence = new ib(this, c);
    ...
    this.pendingEvents = []
  }, z = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), R = function() {
  }, Cb = {queueEvents:!0};
  k.inherits(n, Q);
  ...
  n.prototype.attach = function(a) {
    var a = a || R, b = this.connectionManager, c = b.state;
  ...
  n.prototype.unsubscribeForEvent = function(a, b, c) {
    ...
    d.off(a, b);
    d.listeners(a) ? c() : (e.logAction(e.LOG_MICRO, "RealtimeChannel.unsubscribe()", "sending UNSUBSCRIBE message"), a = new z.TChannelMessage({action:z.TAction.UNSUBSCRIBE, channel:this.name, name:a}), this.sendMessage(a, R))
  };
  ...
  n.prototype.setAttached = function(a) {
    ...
    try {
      if(this.pendingEvents.length) {
        var b = new z.TChannelMessage({action:z.TAction.EVENT, channel:this.name, messages:[]}), c = new ha;
  ...
  Ma = n;
  var ib, I = function(a, b) {
    w.call(this);
    this.channel = a;
    this.clientId = b.clientId;
    this.clients = {}
  }, ya = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types");
  k.inherits(I, w);
  ...
  I.prototype.enterClient = function(a, b, c) {
    ...
    this.clients[a] = b;
    a = new ya.TPresence({state:ya.TPresenceState.ENTER, clientId:this.clientId});
    a.clientData = Q.createPayload(b);
  ...
  I.prototype.leaveClient = function(a, b) {
    ...
    var c = new ya.TPresence({state:ya.TPresenceState.LEAVE, clientId:this.channel.ably.options.clientId});
  ...
  I.prototype.setPresence = function(a, b) {
    ...
    for(var c = 0;c < a.length;c++) {
      ...
      "leave" == d.state ? delete this.clients[g] : h = this.clients[g] = ka.getPayload(d.clientData);
