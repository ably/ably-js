...
export class SyncLiveObjectsDataPool {
  ...
  private _createLiveMapDataEntry(stateObject: StateObject): LiveCounterDataEntry {
  ...
  private _createLiveCounterDataEntry(stateObject: StateObject): LiveMapDataEntry {
