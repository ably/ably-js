(function() {
  window.Ably = {};
  for(var H = {disconnected:{statusCode:408, code:80003, reason:"Connection to server temporarily unavailable"}, suspended:{statusCode:408, code:80002, reason:"Connection to server unavailable"}, failed:{statusCode:408, code:8E4, reason:"Connection failed or disconnected by server"}}, A = function(a, c, b) {
    function g() {
    }
  ...
  K.prototype = {_2scomp:function() {
    ...
    for(var g = this.buffer, f = this.offset, e = 7;0 <= e;e--) {
      g[f + e] = c & 255, c = 4 == e ? a : c >>> 8
    }
    b && this._2scomp()
  }, toNumber:function(a) {
    for(var c = this.buffer, b = this.offset, g = c[0] & 128, f = 0, e = 1, d = 7, p = 1;0 <= d;d--, p *= 256) {
      var l = c[b + d];
      g && (l = (l ^ 255) + e, e = l >> 8, l &= 255);
      f += l * p
    }
    return!a && f >= K.MAX_INT ? g ? -Infinity : Infinity : g ? -f : f
  }, valueOf:function() {
    return this.toNumber(!1)
  }, toString:function(a) {
    return this.valueOf().toString(a || 10)
  }, toOctetString:function(a) {
    for(var c = Array(8), b = this.buffer, g = this.offset, f = 0;8 > f;f++) {
      c[f] = ba[b[g + f]]
    }
    return c.join(a || "")
  }, inspect:function() {
  ...
  d.TXHRTransport.prototype = {getXmlHttpRequestObject:function() {
    ...
    var f = jQuery.Deferred(), e = jQuery._Deferred(), d = f.promise();
    d.success = d.done;
    d.error = d.fail;
    d.complete = e.done;
  ...
  d.Protocol.prototype = {getTransport:function() {
    ...
    var a = this.tpos.pop(), c = this.tstack[a], b = "{", g = !0, f;
    for(f in c) {
      g ? g = !1 : b += ",", b += f + ":" + c[f]
    }
    this.tstack[a] = b + "}"
    ...
    if(a != this.tstack.length) {
      ...
      for(var c = "}", b = !0;this.tstack.length > a + 1;) {
        var g = this.tstack.pop(), f = this.tstack.pop();
        b ? b = !1 : c = "," + c;
        isNaN(f) || (f = '"' + f + '"');
        c = f + ":" + g + c
      }
  ...
  var W = {encode:function(a, c, b) {
    ...
    b += c;
    for(c = c1 = c2 = 0;f < b;) {
      c = a.getInt8(f++), 128 > c ? g += String.fromCharCode(c) : 191 < c && 224 > c ? (c2 = a.getInt8(f++), g += String.fromCharCode((c & 31) << 6 | c2 & 63)) : (c2 = a.getInt8(f++), c3 = a.getInt8(f++), g += String.fromCharCode((c & 15) << 12 | (c2 & 63) << 6 | c3 & 63))
    }
    return g
  }}, v = function(a) {
    this.offset = 0;
  ...
  v.prototype = {getArray:function() {
    ...
    a = a || 0;
    c = c || this.length;
    var b = new v, g = b.length = c - a, f = b.offset = this.offset + a, e = b.buf = this.buf;
    b.view = new DataView(e, f, g);
    return b
  }, getInt8:function(a) {
  ...
  var ga = new v(0), M = d.TTransport = function(a, c) {
    this.buf = a || ga;
    this.onFlush = c;
    this.reset()
  };
  ...
  Y.receiver = function(a) {
    var c = 0, b = 0, g = null, f = null;
    return function(e) {
      if(f) {
        var d = new v(e.length + f.length);
        f.copy(d, 0, 0);
        e.copy(d, f.length, 0);
        f = null
      }
      ...
      switch(c.fid) {
        ...
        case 13:
          if(b == d.Type.SET) {
            ...
            for(b = 0;b < c;++b) {
              g = void 0, g = new E, g.read(a), this.presence.push(g)
            }
            a.readSetEnd()
          }else {
            a.skip(b)
  ...
  var B = {TAction:TAction, TFlags:TFlags, TType:TType, TData:D, TPresence:E, TMessage:I, TChannelMessage:J, TMessageSet:A};
  this.Cookie = function() {
    function a() {
    }
    "object" == typeof window && (a.create = function(a, b, g) {
      var f = "";
      g && (f = new Date, f.setTime(f.getTime() + g), f = "; expires\x3d" + f.toGMTString());
      document.cookie = a + "\x3d" + b + f + "; path\x3d/"
    }, a.read = function(a) {
      a += "\x3d";
      for(var b = document.cookie.split(";"), g = 0;g < b.length;g++) {
        for(var f = b[g];" " == f.charAt(0);) {
  ...
  "https:") + "//cdn.ably.io/lib/swf/WebSocketMainInsecure-0.9.swf", policyPort:"80"}, getHost:function(a, c, b) {
    ...
    var c;
    a.host ? (c = [a.host], a.fallbackHosts && c.concat(a.fallbackHosts)) : c = [a.host].concat(t.FALLBACK_HOSTS);
    return c
  }};
  ...
  this.Http = function() {
    ...
    a.get = function(b, g, f, e, d) {
      ...
      if("string" == typeof l) {
        ...
        var h;
        h = (f = b.connection) && "connected" == f.state ? [f.connectionManager.host] : t.getHosts(b.options);
        1 == h.length ? p(l(h[0]), d) : p(h.shift(), function(a, b, c) {
          if(a) {
            var e = a.code;
    ...
    a.post = function(b, g, f, e, d, p) {
      function l(b, c) {
        a.Request(b, d, e, h, c)
      }
      p = p || c;
      var s = "function" == typeof g ? g : function(a) {
        return b.baseUri(a) + g
      }, h = f && "application/json" != f.accept;
      if("string" == typeof s) {
        tryGet(s, p)
      }else {
        var u;
        u = (f = b.connection) && "connected" == f.state ? [f.connectionManager.host] : t.getHosts(b.options);
        1 == u.length ? l(s(u[0]), p) : l(u.shift(), function(a, b, c) {
          if(a) {
            var e = a.code;
            if("ENETUNREACH" == e || "EHOSTUNREACH" == e || "EHOSTDOWN" == e) {
              l(u, p);
  ...
  this.ThriftUtil = function() {
    ...
    var b = new d.TTransport, g = new d.TBinaryProtocol(b), f = 16384, e = [];
    c.encode = function(a, b) {
      try {
        b(null, c.encodeSync(a))
      }catch(e) {
        var g = "Unexpected exception encoding Thrift; exception \x3d " + e;
        h.logAction(h.LOG_ERROR, "ThriftUtil.encode()", g, e);
        g = Error(g);
        g.statusCode = 400;
        b(g)
      }
    ...
    c.decodeSync = function(a, c) {
      try {
        ...
        h.logAction(h.LOG_ERROR, "ThriftUtil.decode()", f, e);
        f = Error(f);
        f.statusCode = 400;
        throw f;
      }
  ...
  var S = function() {
    ...
    function f() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          var c = O[b].id, g = O[b].callbackFn, f = {success:!1, id:c};
          if(0 < n.pv[0]) {
            var s = C(c);
            if(s) {
              if(k(O[b].swfVersion) && !(n.wk && 312 > n.wk)) {
                Q(c, !0), g && (f.success = !0, f.ref = e(c), g(f))
              }else {
                if(O[b].expressInstall && d()) {
                  f = {};
                  f.data = O[b].expressInstall;
                  ...
                  for(var u = {}, s = s.getElementsByTagName("param"), T = s.length, x = 0;x < T;x++) {
                    "movie" != s[x].getAttribute("name").toLowerCase() && (u[s[x].getAttribute("name")] = s[x].getAttribute("value"))
                  }
                  h(f, u, c, g)
                }else {
                  l(s), g && g(f)
    ...
    function e(a) {
      ...
      if((a = C(a)) && "OBJECT" == a.nodeName) {
        typeof a.SetVariable != y ? b = a : (a = a.getElementsByTagName(v)[0]) && (b = a)
      }
      return b
    }
    function d() {
    ...
    function h(a, b, c, e) {
      ...
      var g = C(c);
      if(g) {
        "OBJECT" == g.nodeName ? (E = s(g), I = null) : (E = g, I = c);
        a.id = B;
    ...
    function T(a, b, c) {
      ...
      if(g) {
        if(typeof a.id == y && (a.id = c), n.ie && n.win) {
          var f = "", d;
          for(d in a) {
          ...
          g.outerHTML = '\x3cobject classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + f + "\x3e" + d + "\x3c/object\x3e";
          H[H.length] = a.id;
          e = C(a.id)
        }else {
          l = q.createElement(v);
          l.setAttribute("type", z);
          for(var r in a) {
            a[r] != Object.prototype[r] && ("styleclass" == r.toLowerCase() ? l.setAttribute("class", a[r]) : "classid" != r.toLowerCase() && l.setAttribute(r, a[r]))
          }
          for(f in b) {
            b[f] != Object.prototype[f] && "movie" != f.toLowerCase() && (a = l, d = f, r = b[f], c = q.createElement("param"), c.setAttribute("name", d), c.setAttribute("value", r), a.appendChild(c))
          }
    ...
    function m(a, b, c, e) {
      if(!n.ie || !n.mac) {
        ...
        if(g) {
          ...
          e && (L = N = null);
          if(!N || L != c) {
            e = q.createElement("style"), e.setAttribute("type", "text/css"), e.setAttribute("media", c), N = g.appendChild(e), n.ie && (n.win && typeof q.styleSheets != y && 0 < q.styleSheets.length) && (N = q.styleSheets[q.styleSheets.length - 1]), L = c
          }
          n.ie && n.win ? N && typeof N.addRule == v && N.addRule(a, b) : N && typeof q.createTextNode != y && N.appendChild(q.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function Q(a, b) {
      if(R) {
        ...
        P && C(a) ? C(a).style.visibility = c : m("#" + a, "visibility:" + c)
      }
    }
    function t(a) {
      return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != y ? encodeURIComponent(a) : a
    }
    var y = "undefined", v = "object", z = "application/x-shockwave-flash", B = "SWFObjectExprInst", w = window, q = document, A = navigator, F = !1, G = [function() {
      F ? g() : f()
    }], O = [], H = [], D = [], E, I, K, M, P = !1, J = !1, N, L, R = !0, n = function() {
      var a = typeof q.getElementById != y && typeof q.getElementsByTagName != y && typeof q.createElement != y, b = A.userAgent.toLowerCase(), c = A.platform.toLowerCase(), e = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, g = !+"\v1", f = [0, 0, 0], d = null;
      if(typeof A.plugins != y && typeof A.plugins["Shockwave Flash"] == v) {
        if((d = A.plugins["Shockwave Flash"].description) && !(typeof A.mimeTypes != y && A.mimeTypes[z] && !A.mimeTypes[z].enabledPlugin)) {
          F = !0, g = !1, d = d.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), f[0] = parseInt(d.replace(/^(.*)\..*$/, "$1"), 10), f[1] = parseInt(d.replace(/^.*\.(.*)\s.*$/, "$1"), 10), f[2] = /[a-zA-Z]/.test(d) ? parseInt(d.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        }
      }else {
        if(typeof w.ActiveXObject != y) {
          try {
            ...
            if(l && (d = l.GetVariable("$version"))) {
              g = !0, d = d.split(" ")[1].split(","), f = [parseInt(d[0], 10), parseInt(d[1], 10), parseInt(d[2], 10)]
            }
          }catch(r) {
          }
        }
      }
      return{w3:a, pv:f, wk:b, ie:g, win:e, mac:c}
    }();
    (function() {
      n.w3 && ((typeof q.readyState != y && "complete" == q.readyState || typeof q.readyState == y && (q.getElementsByTagName("body")[0] || q.body)) && a(), P || (typeof q.addEventListener != y && q.addEventListener("DOMContentLoaded", a, !1), n.ie && n.win && (q.attachEvent("onreadystatechange", function() {
    ...
    return{registerObject:function(a, b, c, e) {
    ...
    }, embedSWF:function(a, b, e, g, f, l, s, u, C, x) {
      var m = {success:!1, id:b};
      n.w3 && !(n.wk && 312 > n.wk) && a && b && e && g && f ? (Q(b, !1), c(function() {
        e += "";
        g += "";
        var c = {};
        if(C && typeof C === v) {
        ...
        if(s && typeof s === v) {
          for(var q in s) {
            n.flashvars = typeof n.flashvars != y ? n.flashvars + ("\x26" + q + "\x3d" + s[q]) : q + "\x3d" + s[q]
          }
        }
        if(k(f)) {
          U = T(c, n, b), c.id == b && Q(b, !0), m.success = !0, m.ref = U
        }else {
          if(l && d()) {
            c.data = l;
            h(c, n, b, x);
      ...
      if(J) {
        var a = C(B);
        a && E && (a.parentNode.replaceChild(E, a), I && (Q(I, !0), n.ie && n.win && (E.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), R = function() {
    ...
    var a = function(c, b, g, f, e) {
      ...
      d.__createTask = setTimeout(function() {
        a.__addTask(function() {
          d.__createTask = null;
          a.__flash.create(d.__id, c, b, g || null, f || 0, e || null)
        })
      }, 0)
    };
    ...
    a.prototype.off = function(a, b) {
      if(0 == arguments.length) {
        ...
        if(null === a) {
          ...
          if(b) {
            f = -1;
            if(!(g = this.events[a]) || -1 == (f = g.indexOf(b))) {
    ...
    function b(a, c) {
      ...
      this.httpTransports = m.intersect(c.transports || t.httpTransports, b.httpTransports);
      this.transports = m.intersect(c.transports || t.transports, b.transports);
      this.upgradeTransports = m.arrSubtract(this.transports, this.httpTransports);
      this.hosts = t.getHosts(c);
      ...
      h.logAction(h.LOG_MICRO, "Realtime.ConnectionManager()", "http hosts \x3d [" + this.hosts + "]");
    ...
    var d = "undefined" !== typeof Cookie && Cookie.read, f = "undefined" !== typeof Cookie && Cookie.create, e = ("object" == typeof B ? B : require("../nodejs/lib/protocol/clientmessage_types")).TAction, r = function() {
    }, p = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:t.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:t.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
      ...
      if(this.transport) {
        ...
        this.httpTransports.length ? this.chooseHttpTransport(e, function(c, d) {
          if(c) {
            ...
            if(h.logAction(h.LOG_MINOR, "ConnectionManager.chooseTransport()", "Establishing http transport: " + d), b(null, d), f.upgradeTransports.length) {
              d.on("connected", function(b, c) {
                ...
                f.chooseTransportForHost(e, f.upgradeTransports.slice(), r)
              })
            }
          }
        }) : (e.host = this.hosts[0], h.logAction(h.LOG_MINOR, "ConnectionManager.chooseTransport()", "No http transports available; ignoring fallback hosts"), this.chooseTransportForHost(e, f.transports.slice(), b))
      }
    };
    b.prototype.chooseTransportForHost = function(a, c, e) {
      ...
      if(f) {
        var d = this;
        h.logAction(h.LOG_MICRO, "ConnectionManager.chooseTransportForHost()", "trying " + f);
        b.transports[f].tryConnect(this, this.realtime.auth, a, function(b, g) {
          b ? d.chooseTransportForHost(a, c, e) : (h.logAction(h.LOG_MICRO, "ConnectionManager.chooseTransport()", "transport " + f + " connecting"), d.setTransportPending(g), e(null, g))
        })
      }else {
      ...
      function e() {
        if(f.length) {
          b.httpTransports[g.httpTransports[0]].checkConnectivity(function(b, d) {
            b ? c(b) : d ? (a.host = m.arrRandomElement(f), g.chooseTransportForHost(a, g.httpTransports.slice(), function(a, b) {
              a ? e() : c(null, b)
      ...
      if(this.state == p.closed) {
        ...
        for(var b = this, c = function(c) {
          return function(e, d) {
            ...
            e && e.reason && h.logAction(h.LOG_MICRO, "ConnectionManager.setTransportPending", "reason \x3d  " + e.reason);
            d && h.logAction(h.LOG_MICRO, "ConnectionManager.setTransportPending", "connectionId \x3d  " + d);
            var f;
            "connected" == c ? (b.activateTransport(a, d), f = !0) : f = b.deactivateTransport(a);
            f && b.notifyState({state:c, error:e})
          }
        }, e = ["connected", "disconnected", "closed", "failed"], d = 0;d < e.length;d++) {
          var f = e[d];
          a.on(f, c(f))
        }
    ...
    b.prototype.startConnectTimer = function() {
      ...
      this.connectTimer = setTimeout(function() {
        a.connectTimer && (h.logAction(h.LOG_MINOR, "ConnectionManager connect timer expired", "requesting new state: " + p.connecting.failState), a.notifyState({state:p.connecting.failState}))
      }, t.connectTimeout)
    };
    ...
    b.prototype.startSuspendTimer = function() {
      ...
      this.suspendTimer || (this.suspendTimer = setTimeout(function() {
        a.suspendTimer && (h.logAction(h.LOG_MINOR, "ConnectionManager suspend timer expired", "requesting new state: suspended"), p.connecting.failState = "suspended", p.connecting.queueEvents = !1, a.notifyState({state:"suspended"}))
      }, t.suspendedTimeout))
    };
    ...
    b.prototype.notifyState = function(a) {
      if(!(this.state.terminal || a.state == this.state.state)) {
        ...
        a = new $(this.state.state, b.state, b.retryDelay, a.error || H[b.state]);
    ...
    b.prototype.requestState = function(a) {
      ...
      if(a.state != this.state.state) {
        ...
        if(a.state != this.state.state) {
          var b = p[a.state];
          a = new $(this.state.state, b.state, b.retryIn, a.error || H[b.state]);
          this.enactStateChange(a)
        }
      }
    };
    b.prototype.connectImpl = function() {
      ...
      var a = this, b = this.realtime.auth, c = function(e) {
        h.logAction(h.LOG_ERROR, "ConnectionManager.connectImpl()", e);
    ...
    b.prototype.send = function(a, b, e) {
      e = e || r;
      this.state.queueEvents && (b ? this.queue(a, e) : (h.logAction(h.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), e(this.error)));
      this.state.sendEvents && (h.logAction(h.LOG_MICRO, "ConnectionManager.send()", "sending event"), this.sendImpl(new c(a, e)))
    };
    ...
    b.prototype.ackMessage = function(a, b, c) {
      ...
      c = c || null;
      var e = this.pendingMessages, d = e[0];
      if(d && (d = d.msg.msgSerial, a += b, a > d)) {
        e = e.splice(0, a - d);
    ...
    b.prototype.onChannelMessage = function(a, b) {
      b === this.transport || b.connectionId == this.connectionId ? (this.connectionSerial = a.connectionSerial, this.realtime.channels.onChannelMessage(a)) : this.realtime.channels.retryChannelMessage(a)
    };
    return b
  }(), G = function() {
    function a(a, b, c) {
    ...
    var c = "object" == typeof window ? B : require("../nodejs/lib/protocol/clientmessage_types"), b = c.TAction, d = c.TFlags, f = function() {
    };
    m.inherits(a, w);
    ...
    a.prototype.sendDisconnect = function() {
      this.send(new c.TChannelMessage({action:b.DISCONNECT}), f)
    };
    ...
    a.prototype.onConnect = function(a) {
      ...
      this.isConnected = !0;
      if(a.flags && a.flags & 1 << d.SYNC_TIME) {
        var b = this;
        m.nextTick(function() {
          b.connectionManager.realtime.time({connection_id:a.connectionId})
        })
      }
    };
    ...
    a.tryConnect = function(b, c, d, g) {
      var l = new a(b, c, d), s = function(a) {
        g(a)
      };
      l.on("wserror", s);
      l.on("wsopen", function() {
        h.logAction(h.LOG_MINOR, "WebSocketTransport.tryConnect()", "viable transport " + l);
        l.off("wserror", s);
        g(null, l)
      });
      l.connect()
    ...
    a.prototype.connect = function() {
      ...
      var a = this, b = this.params, c = b.options, d = t.getHost(c, b.host, !0), g = t.getPort(c), s = (c.encrypted ? "wss://" : "ws://") + d + ":" + g + "/";
      h.logAction(h.LOG_MINOR, "WebSocketTransport.connect()", "uri: " + s);
      this.auth.getAuthParams(function(c, d) {
        ...
        if(c) {
          ...
          g = b.getConnectParams(d);
          try {
            var p = a.wsConnection = a.createWebSocket(s, g);
    ...
    a.prototype.send = function(a, b) {
      try {
        ...
        h.logAction(h.LOG_ERROR, "WebSocketTransport.send()", d);
        b(Error(d))
      }
    };
    ...
    a.prototype.onWsClose = function(a, b) {
      ...
      h.logAction(h.LOG_MINOR, "WebSocketTransport.onWsClose()", "closed WebSocket; wasClean \x3d " + c + "; code \x3d " + d);
      delete this.wsConnection;
      G.prototype.onClose.call(this, c, g)
    };
    ...
    a.prototype.connect = function() {
      ...
      G.prototype.connect.call(this);
      var c = this, b = this.params, d = b.options, b = t.getHost(d, b.host), f = t.getPort(d);
      this.baseUri = (d.encrypted ? "https://" : "http://") + b + ":" + f + "/comet/";
      var e = this.baseUri + "connect";
      h.logAction(h.LOG_MINOR, "CometTransport.connect()", "uri: " + e);
    ...
    a.prototype.onConnect = function(a) {
      ...
      b = this.baseUri + b;
      h.logAction(h.LOG_MICRO, "CometTransport.onConnect()", "baseUri \x3d " + b + "; connectionId \x3d " + a.connectionId);
      this.sendUri = b + "/send";
      this.recvUri = b + "/recv";
    ...
    a.prototype.sendItems = function(a, b) {
      ...
      try {
        ...
        h.logAction(h.LOG_ERROR, "CometTransport.sendItems()", e);
        b(Error(e))
      }
    };
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof B ? B : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, d = a.TMessage = {}, f = a.TPresence = {}, e = a.TChannelMessage = {}, h = a.TMessageArray = {}, p = a.TMessageSet = {}, l = c.TType.BUFFER;
    b.fromREST = function(a) {
      var c, d = a.data, e = a.encoding;
      e ? (c = new b, c.type = l, c.binaryData = new v(d, e)) : Data.toTData(d);
      a.data = d
    };
    ...
    b.fromREST = function(a, c) {
      var d, e = a.encoding;
      e ? (d = new b, d.type = l, d.binaryData = new v(c, e)) : d = Data.toTData(c);
      return d
    };
    ...
    e.fromJSON = function(a) {
      var b;
      if(b = a.messages) {
        for(var e = b.length, h = a.messages = Array(e), r = 0;r < e;r++) {
          h[r] = d.fromJSON(b[r])
        }
      }
      if(b = a.presence) {
    ...
    e.decode = function(a, b) {
      var d, g;
      if(b) {
        if(g = ThriftUtil.decodeSync(d = new c.TChannelMessage, a)) {
          throw g;
        }
      }else {
    ...
    p.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          var g;
          if(d = ThriftUtil.decodeSync(g = new c.TMessageSet, a)) {
            throw d;
          }
          d = g.items
        }else {
          g = JSON.parse(a);
          for(var f = g.length, d = Array(f), h = 0;h < f;h++) {
            d[h] = e.fromJSON(g[h])
          }
        }
      }
    ...
    h.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          ...
          f = JSON.parse(a);
          for(var h = f.length, e = Array(h), r = 0;r < h;r++) {
            e[r] = d.fromJSON(f[r])
          }
        }
      }
  ...
  var V = function() {
    ...
    a.get = function(a, b, d, f, e) {
      function h() {
        a.auth.getAuthHeaders(function(p, l) {
          p ? e(p) : Http.get(a, b, m.mixin(l, d), f, function(b, d) {
    ...
    a.post = function(a, b, d, f, e, h) {
      function p() {
        a.auth.getAuthHeaders(function(l, s) {
          l ? h(l) : Http.post(a, b, m.mixin(s, f), d, e, function(b, d) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? h(a) : p()
            }) : h(b, d)
          })
    ...
    b.prototype.requestToken = function(b, d) {
      ...
      var e, g = this.rest;
      if(b.authCallback) {
        h.logAction(h.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_callback"), e = b.authCallback
      }else {
        if(b.authUrl) {
          h.logAction(h.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), e = function(a, c) {
          ...
          if(b.keyValue) {
            ...
            e = function(a, c) {
              f.createTokenRequest(m.mixin(m.copy(b), a), c)
            }
          }else {
      ...
      var g = this.rest, x = function(a) {
        return g.baseUri(a) + "/keys/" + b.keyId + "/authorise"
      }, v = function(a, b) {
        Http.post ? Http.post(g, x, m.defaultPostHeaders(), a, null, b) : Http.get(g, x, m.defaultGetHeaders(), a, b)
      };
      e(k, function(a, b) {
        a ? (h.logAction(h.LOG_ERROR, "Auth.requestToken()", "token request signing call returned error; err \x3d " + a), d(a)) : v(b, function(a, b) {
    ...
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        var g = {id:c}, f = a.clientId || "";
        f && (g.client_id = a.clientId);
        var k = a.ttl || "";
        k && (g.ttl = k);
        var m = a.capability || "";
        m && (g.capability = m);
        var t = this.rest, v = this;
        (function(c) {
          a.timestamp ? c() : a.queryTime ? t.time(function(d, e) {
            d ? b(d) : (a.timestamp = Math.floor(e / 1E3), c())
          }) : (a.timestamp = v.getTimestamp(), c())
        })(function() {
    ...
    c.prototype.retryChannelMessage = function(a) {
      ...
      if(c) {
        var d = this.attached[c];
        d ? d.retryMessage(a) : h.logAction(h.LOG_ERROR, "ConnectionManager on(channelmessage)", "received event for non-existent channel: " + c)
      }else {
        h.logAction(h.LOG_ERROR, "ConnectionManager on(channelmessage)", "received event unspecified channel: " + c)
      }
    };
    ...
    c.prototype.presence = function(b, c) {
      ...
      var d = this.rest, e = !d.options.useTextProtocol, r = m.copy(m.defaultGetHeaders(e));
    ...
    c.prototype.publish = function(b, c, d) {
      ...
      d = d || a;
      var e = this.rest, r = !e.options.useTextProtocol;
      b = Serialize.TMessageArray.encode([{name:b, data:c}], r);
      r = m.copy(m.defaultPostHeaders(r));
      e.options.headers && m.mixin(r, e.options.headers);
      V.post(e, "/channels/" + this.name + "/publish", b, r, null, d)
    };
    return c
  }(), ca = function() {
    function a(a, b, c) {
      ...
      this.options = m.prototypicalClone(f, c);
    ...
    a.prototype.publish = function(a, b, f) {
      ...
      F.activeState(l.state) ? (l = new c.TMessage, l.name = a, l.data = Data.toTData(b), "attached" == this.state ? (h.logAction(h.LOG_MICRO, "RealtimeChannel.publish()", "sending message"), a = new c.TChannelMessage, a.action = c.TAction.MESSAGE, a.channel = this.name, a.messages = [l], this.sendMessage(a, f)) : ("pending" != this.state && this.attach(), h.logAction(h.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:l, listener:f}))) : f(l.getStateError())
    };
        ...
        case b.MESSAGE:
          if(a = a.messages) {
            for(var c = Array(a.length), d = 0;d < c.length;d++) {
              var f = a[d];
              c[d] = new ha(f.channelSerial, f.timestamp, f.name, Data.fromTData(f.data))
            }
            this.onEvent(c)
          }
          break;
        default:
          h.logAction(h.LOG_ERROR, "RealtimeChannel.onMessage()", "Fatal protocol error: unrecognised action (" + a.action + ")"), this.connectionManager.abort(UIMessages.FAIL_REASON_FAILED)
      }
    };
    ...
    a.prototype.setAttached = function(a) {
      ...
      try {
        ...
        h.logAction(h.LOG_ERROR, "RealtimeChannel.setSubscribed()", "Unexpected exception sending pending messages: " + g.stack)
      }
    };
    ...
    a.prototype.retryMessage = function(a) {
      switch(a.action) {
        ...
        case b.DETACHED:
          ...
          break;
        default:
          h.logAction(h.LOG_ERROR, "RealtimeChannel.retryMessage()", "Unable to retry action (" + a.action + "); ignoring")
      }
    };
    return a
  }(), ka = function() {
    ...
    var b = "object" == typeof B ? B : require("../nodejs/lib/protocol/clientmessage_types"), d = b.TPresenceState, f = ["enter", "leave", "update"];
    m.inherits(c, w);
    ...
    c.prototype.leaveClient = function(a, c) {
      ...
      var f = new b.TPresence({state:d.LEAVE, clientId:a}), l = this.channel;
      switch(l.state) {
        case "attached":
          l.sendPresence(f, c);
          break;
        ...
        case "initialized":
          ...
          break;
        default:
          this.pendingPresence = null, c(H.failed)
      }
    };
    c.prototype.get = function(a) {
      return a ? this.members[a] : m.valuesArray(this.members, !0)
    };
    c.prototype.setPresence = function(b, c) {
      ...
      for(var p = 0;p < b.length;p++) {
        var l = b[p], s = a.call(l.clientId, l.memberId), k = new ea(l.clientId, Data.fromTData(l.clientData), l.memberId);
        switch(l.state) {
          case d.LEAVE:
          ...
          case d.ENTER:
            clientData = this.members[s] = k
        }
        c && this.emit(f[l.state], k)
      }
    };
    ...
    c.prototype.setSuspended = function(a) {
      this.pendingPresence && (this.pendingPresence.callback(H[a.state]), this.pendingPresence = null)
    };
    return c
  }();
  (function() {
    ...
    a.Request.prototype.send = function(a, c, d, f, g, h) {
      this.callback = h;
      var k = this.requestId, m = this.timer = setTimeout(f ? t.cometRecvTimeout : t.cometSendTimeout, function() {
        w.abort()
      });
      c = c || {};
      c.callback = "Ably._(" + k + ")";
  ...
  (function() {
    ...
    a.prototype.request = function(b, c, d, e, h) {
      (new a.Request).send(b, c, d, e, this.binary, h)
    };
    a.prototype.toString = function() {
    ...
    a.Request.prototype.send = function(a, d, f, e, h, k) {
      a = L.paramStr(d, a);
      var l, m, w;
      f ? (d = "POST", l = 201) : (d = "GET", l = 200);
      var u = this.xhr = c();
      h && (u.responseType = "arraybuffer");
      var z = setTimeout(e ? t.cometRecvTimeout : t.cometSendTimeout, function() {
        w = !0;
        u.abort()
      });
      u.open(d, a, !0);
      u.setRequestHeader("Accept", h ? "application/x-thrift" : "application/json");
      ...
      u.onreadystatechange = function() {
        if(4 == u.readyState) {
          if(clearTimeout(z), m) {
            ...
            if(u.status == l) {
              var a = null;
              h ? u.response && (a = new v, a.buf = u.response, a.view = new DataView(a.buf)) : a = u.responseText;
              k(null, a)
            }else {
              0 != u.status && (m = Error("Unexpected response: statusCode \x3d " + u.status), m.statusCode = u.status, m.code = 8E4, m.statusText = u.statusText, k(m))
            }
          }
        }
      };
    ...
    a.isAvailable() && (F.httpTransports.xhr = F.transports.xhr = a, Http.Request = function(b, c, d, e, h) {
