...
export class LiveMap {
   ...
   * (such as {@link LiveMapOperations.set}) to create a new LiveMap object
   * in the object tree on a channel.
   *
...
export class LiveCounter {
   ...
   * (such as {@link LiveMapOperations.set}) to create a new LiveCounter object
   * in the object tree on a channel.
   *
