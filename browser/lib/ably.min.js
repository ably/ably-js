(function() {
  ...
  K.prototype = {_2scomp:function() {
    ...
    for(var c = this.buffer, b = this.offset, e = c[0] & 128, g = 0, f = 1, r = 7, d = 1;0 <= r;r--, d *= 256) {
      var m = c[b + r];
  ...
  d.TXHRTransport.prototype = {getXmlHttpRequestObject:function() {
    ...
    var g = jQuery.Deferred(), f = jQuery._Deferred(), r = g.promise();
    r.success = r.done;
    r.error = r.fail;
    r.complete = f.done;
  ...
  this.Http = function() {
    ...
    a.get = function(b, e, g, f, r) {
      ...
      1 == m.length ? a.getUri(b, d(m[0]), g, f, r) : a.getUri(b, d(m.shift()), g, f, function(c) {
        if(c) {
          var e = c.code;
          if("ENETUNREACH" == e || "EHOSTUNREACH" == e || "EHOSTDOWN" == e) {
            a.getUri(b, d(m.shift()), g, f, r);
            return
          }
        }
    ...
    a.getUri = function(b, e, g, f, r) {
      r = r || c;
      a.Request(e, f, g, null, g && "application/json" != g.accept, r)
    };
    a.post = function(b, e, g, f, r, d) {
      d = d || c;
      var m = "function" == typeof e ? e : function(a) {
        return b.baseUri(a) + e
      }, q, P = b.connection;
      q = P && "connected" == P.state ? [P.connectionManager.host] : v.getHosts(b.options);
      1 == q.length ? a.postUri(b, m(q[0]), g, f, r, d) : a.postUri(b, m(q.shift()), g, f, r, function(c) {
        if(c) {
          var e = c.code;
          if("ENETUNREACH" == e || "EHOSTUNREACH" == e || "EHOSTDOWN" == e) {
            a.postUri(b, m(q.shift()), g, f, r, d);
            return
          }
        }
    ...
    a.postUri = function(b, e, g, f, r, d) {
      d = d || c;
      a.Request(e, r, g, f, g && "application/json" != g.accept, d)
    };
  ...
  this.Base64 = function() {
    ...
    var e = {codex:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode:function(b) {
      ...
      for(b = new c(b);b.moveNext();) {
        ...
        var m = b.current;
        b.moveNext();
        var q = b.current, P = p >> 2, p = (p & 3) << 4 | m >> 4, h = (m & 15) << 2 | q >> 6, u = q & 63;
        isNaN(m) ? h = u = 64 : isNaN(q) && (u = 64);
        f.append(d.charAt(P) + d.charAt(p) + d.charAt(h) + d.charAt(u))
      }
      return f.toString()
    }, decode:function(c) {
      var f = new a;
  ...
  var H = Ably.Crypto = window.CryptoJS && function() {
    ...
    b.prototype.getIv = function() {
      if(!this.iv) {
        return this.encryptCipher.process(p)
      }
      var a = this.iv;
      this.iv = null;
      return a
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          ...
          if(0 < n.pv[0]) {
            var q = u(c);
            if(q) {
              if(V(B[b].swfVersion) && !(n.wk && 312 > n.wk)) {
    ...
    function d() {
      return!J && V("6.0.65") && (n.win || n.mac) && !(n.wk && 312 > n.wk)
    }
    function p(a, b, c, e) {
      J = !0;
      K = e || null;
      ...
      if(f) {
        ...
        n.ie && (n.win && 4 != f.readyState) && (e = t.createElement("div"), c += "SWFObjectNew", e.setAttribute("id", c), f.parentNode.insertBefore(e, f), f.style.display = "none", function() {
    ...
    function h(a, b, c) {
      ...
      if(f) {
        if(typeof a.id == z && (a.id = c), n.ie && n.win) {
          ...
          for(g in b) {
            b[g] != Object.prototype[g] && "movie" != g.toLowerCase() && (a = m, d = g, r = b[g], c = t.createElement("param"), c.setAttribute("name", d), c.setAttribute("value", r), a.appendChild(c))
          }
    ...
    function k(a, b, c, e) {
      if(!n.ie || !n.mac) {
        ...
        if(f) {
          ...
          e && (L = N = null);
          if(!N || L != c) {
            e = t.createElement("style"), e.setAttribute("type", "text/css"), e.setAttribute("media", c), N = f.appendChild(e), n.ie && (n.win && typeof t.styleSheets != z && 0 < t.styleSheets.length) && (N = t.styleSheets[t.styleSheets.length - 1]), L = c
          }
          n.ie && n.win ? N && typeof N.addRule == w && N.addRule(a, b) : N && typeof t.createTextNode != z && N.appendChild(t.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function l(a, b) {
    ...
    var z = "undefined", w = "object", x = "application/x-shockwave-flash", A = "SWFObjectExprInst", s = window, t = document, y = navigator, H = !1, D = [function() {
      H ? e() : g()
    }], B = [], G = [], C = [], E, I, K, M, R = !1, J = !1, N, L, O = !0, n = function() {
    ...
    (function() {
      n.w3 && ((typeof t.readyState != z && "complete" == t.readyState || typeof t.readyState == z && (t.getElementsByTagName("body")[0] || t.body)) && a(), R || (typeof t.addEventListener != z && t.addEventListener("DOMContentLoaded", a, !1), n.ie && n.win && (t.attachEvent("onreadystatechange", function() {
    ...
    return{registerObject:function(a, b, c, e) {
      ...
      n.w3 && !(n.wk && 312 > n.wk) && a && b && e && f && g ? (l(b, !1), c(function() {
        e += "";
        f += "";
        var c = {};
        if(u && typeof u === w) {
        ...
        if(q && typeof q === w) {
          for(var t in q) {
            n.flashvars = typeof n.flashvars != z ? n.flashvars + ("\x26" + t + "\x3d" + q[t]) : t + "\x3d" + q[t]
          }
        }
        if(V(g)) {
          W = h(c, n, b), c.id == b && l(b, !0), k.success = !0, k.ref = W
        }else {
          if(m && d()) {
            c.data = m;
            p(c, n, b, Q);
      ...
      if(J) {
        var a = u(A);
        a && E && (a.parentNode.replaceChild(E, a), I && (l(I, !0), n.ie && n.win && (E.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), $ = function() {
    ...
    }, p = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:v.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:v.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
  ...
  var U = function() {
    ...
    c.prototype.history = function(b, c) {
      ...
      var f = this.rest, d = !f.options.useTextProtocol, p = k.copy(k.defaultGetHeaders(d)), m = this.cipher;
      f.options.headers && k.mixin(p, f.options.headers);
      U.get(f, "/channels/" + this.name + "/messages", p, b, function(a, b) {
        if(a) {
          c(a)
        }else {
          try {
    ...
    c.prototype.publish = function(b, c, f) {
      ...
      f = f || a;
      var d = this.rest, p = !d.options.useTextProtocol;
      b = {name:b, data:c};
      (c = this.cipher) && T.encrypt(b, c);
      b = Serialize.TMessageArray.encode([b], p);
      p = k.copy(k.defaultPostHeaders(p));
      d.options.headers && k.mixin(p, d.options.headers);
      U.post(d, "/channels/" + this.name + "/messages", b, p, null, f)
    };
    b.prototype.get = function(b, c) {
      h.logAction(h.LOG_MICRO, "Channel.presence.get()", "channel \x3d " + this.name);
      void 0 === c && ("function" == typeof b ? (c = b, b = null) : c = a);
      var f = this.channel, d = f.rest, p = !d.options.useTextProtocol, m = k.copy(k.defaultGetHeaders(p));
      d.options.headers && k.mixin(m, d.options.headers);
      U.get(d, "/channels/" + f.name + "/presence", m, b, function(a, b) {
        a ? c(a) : p ? ha.decodeTPresenceArray(b, c) : c(null, b)
      })
    };
    b.prototype.history = function(b, c) {
      h.logAction(h.LOG_MICRO, "Channel.presence.history()", "channel \x3d " + this.name);
      void 0 === c && ("function" == typeof b ? (c = b, b = null) : c = a);
      var f = this.channel, d = f.rest, p = !d.options.useTextProtocol, m = k.copy(k.defaultGetHeaders(p));
      d.options.headers && k.mixin(m, d.options.headers);
      U.get(d, "/channels/" + f.name + "/presence/history", m, b, function(a, b) {
        if(a) {
          c(a)
        }else {
          try {
            for(var f = Serialize.TMessageArray.decode(b, p), e = 0;e < f.length;e++) {
    ...
    a.prototype.leaveClient = function(a, e) {
      ...
      var d = new c.TPresence({state:b.LEAVE, clientId:a}), p = this.channel;
      switch(p.state) {
        case "attached":
          p.sendPresence(d, e);
          break;
    ...
    a.prototype.setPresence = function(a, c) {
      ...
      for(var d = 0;d < a.length;d++) {
        var p = a[d], m = p.clientId + ":" + p.memberId, q = new ha(p.clientId, Data.fromTData(p.clientData), p.memberId);
        switch(p.state) {
          case b.LEAVE:
            delete this.members[m];
            break;
          case b.UPDATE:
            p.inheritMemberId && delete this.members[p.clientId + ":" + p.inheritMemberId];
          case b.ENTER:
            clientData = this.members[m] = q
        }
        c && this.emit(e[p.state], q)
      }
    };
  ...
  (function() {
    ...
    a.Request.prototype.send = function(a, e, d, f, h, k, m) {
      d = d || {};
      a = O.paramStr(e, a);
      var l, s, w;
      f ? (e = "POST", l = 201) : (e = "GET", l = 200);
      var u = this.xhr = c();
