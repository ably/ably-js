(function() {
  ...
  (function() {
    ...
    a.tryConnect = function(b, c, d, f) {
      R.__initialize(y.flashTransport.swfLocation);
      y.flashTransport.policyPort && R.loadFlashPolicyFile("xmlsocket://" + d.host + ":" + y.flashTransport.policyPort);
      var k = new a(b, c, d);
      errorCb = function(a) {
        f(a)
      };
      ...
      k.on("wsopen", function() {
        g.logAction(g.LOG_MINOR, "FlashTransport.tryConnect()", "viable transport " + k);
