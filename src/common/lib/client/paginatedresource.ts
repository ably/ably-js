...
class PaginatedResource {
  ...
  post<T1, T2>(params: Record<string, T2>, body: HttpRequestBody, callback: PaginatedResultCallback<T1>): void {
    Resource.post(
      this.client,
      this.path,
      body,
  ...
  put<T1, T2>(params: Record<string, T2>, body: HttpRequestBody, callback: PaginatedResultCallback<T1>): void {
    Resource.put(
      this.client,
      this.path,
      body,
  ...
  patch<T1, T2>(params: Record<string, T2>, body: HttpRequestBody, callback: PaginatedResultCallback<T1>): void {
    Resource.patch(
      this.client,
      this.path,
      body,
