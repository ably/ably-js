...
*/
(function(){function la(b){if("string"!==typeof b)throw new q("host must be a string; was a "+typeof b,4E4,400);if(!b.length)throw new q("host must not be zero-length",4E4,400);}var u="object"===typeof window&&window||"object"===typeof self&&self,aa=u.Ably=this,B=B||function(b,d){var f={},a=f.lib={},c=a.Base=function(){function g(){}return{extend:function(a){g.prototype=this;var c=new g;a&&c.mixIn(a);c.hasOwnProperty("init")||(c.init=function(){c.$super.init.apply(this,arguments)});c.init.prototype=
...
1),this.offset+=3,this.map(a);case 223:return a=this.view.getUint32(this.offset+1),this.offset+=5,this.map(a)}throw Error("Unknown type 0x"+a.toString(16));};return m}();"undefined"===typeof Window&&"undefined"===typeof WorkerGlobalScope&&console.log("Warning: this distribution of Ably is intended for browsers. On nodejs, please use the 'ably' package on npm");var v={libver:"js-web-",logTimestamps:!0,noUpgrade:navigator&&navigator.userAgent.toString().match(/MSIE\s8\.0/),binaryType:"arraybuffer",
...
stringByteSize:function(b){return u.TextDecoder&&(new u.TextEncoder).encode(b).length||b.length},Promise:u.Promise,getRandomValues:function(b){if(void 0!==b)return function(d,f){b.getRandomValues(d);f&&f(null)}}(u.crypto||u.msCrypto)},U=function(){function b(){}function l(){this.key=this.mode=this.keyLength=this.algorithm=null}function f(a,e,c){this.algorithm=a.algorithm+"-"+String(a.keyLength)+"-"+a.mode;this.cjsAlgorithm=a.algorithm.toUpperCase().replace(/-\d+$/,"");this.key=y.toWordArray(a.key);
c&&(this.iv=y.toWordArray(c).clone());this.blockLengthWords=e}var a=B.lib.WordArray;if(v.getRandomWordArray)var c=v.getRandomWordArray;else if("undefined"!==typeof Uint32Array&&v.getRandomValues){var n=new Uint32Array(4);c=function(a,e){var c=a/4,g=4==c?n:new Uint32Array(c);v.getRandomValues(g,function(a){e(a,y.toWordArray(g))})}}else c=function(e,c){d.logAction(d.LOG_MAJOR,"Ably.Crypto.generateRandom()","Warning: the browser you are using does not support secure cryptographically secure randomness generation; falling back to insecure Math.random()");
...
"Error"==a.constructor.name||a instanceof Error)?a.toString():b.inspect(a)};b.inspectBody=function(a){return y.isBuffer(a)?a.toString():"string"===typeof a?a:v.inspect(a)};b.dataSizeBytes=function(a){if(y.isBuffer(a))return y.byteLength(a);if("string"===typeof a)return v.stringByteSize(a);throw Error("Expected input of Utils.dataSizeBytes to be a buffer or string, but was: "+typeof a);};b.cheapRandStr=function(){return String(Math.random()).substr(2)};b.randomString=v.getRandomValues&&"undefined"!==
typeof Uint8Array?function(a){a=new Uint8Array(a);v.getRandomValues(a);return y.base64Encode(a.buffer)}:function(a){var c=y.base64CharSet;a=Math.round(4*a/3);for(var b="",e=0;e<a;e++)b+=c[Math.floor(Math.random()*c.length)];return b};b.arrChooseN=function(a,c){for(var f=Math.min(c,a.length),e=a.slice(),d=[],t=0;t<f;t++)d.push(b.arrPopRandomElement(e));return d};b.trim=String.prototype.trim?function(a){return a.trim()}:function(a){return a.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")};b.promisify=
...
suspendedRetryTimeout:3E4,httpRequestTimeout:15E3,channelRetryTimeout:15E3,fallbackRetryTimeout:6E5,connectionStateTtl:12E4,realtimeRequestTimeout:1E4,recvTimeout:9E4,preferenceConnectTimeout:6E3,parallelUpgradeDelay:6E3};r.httpMaxRetryCount=3;r.maxMessageSize=65536;r.version="1.1.16";r.libstring=v.libver+r.version;r.apiVersion="1.1";r.getHost=function(b,d,f){return d=f?d==b.restHost&&b.realtimeHost||d||b.realtimeHost:d||b.restHost};r.getPort=function(b,d){return d||b.tls?b.tlsPort:b.port};r.getHttpScheme=
...
f),delete this.eventsOnce[a]);(f=this.events[a])&&Array.prototype.push.apply(e,f);h.arrForEach(e,function(a){l(b,a,c)})};b.prototype.once=function(a,c){var b=arguments.length,e=this;if((0===b||1===b&&"function"!==typeof a)&&v.Promise)return new v.Promise(function(c){e.once(a,c)});if(1==arguments.length&&"function"==typeof a)this.anyOnce.push(a);else if(h.isEmptyArg(a))this.anyOnce.push(c);else{if(h.isArray(a))throw"Arrays of events can only be used with on(), not once()";(this.eventsOnce[a]||(this.eventsOnce[a]=
[])).push(c)}};b.prototype.whenState=function(a,c,b){var e={event:a},f=this,d=Array.prototype.slice.call(arguments,3);if("string"!==typeof a||"string"!==typeof c)throw"whenState requires a valid event String argument";if("function"!==typeof b&&v.Promise)return new v.Promise(function(e){f.whenState.bind(f,a,c,e).apply(f,d)});if(a===c)l(e,b,d);else this.once(a,b)};return b}(),d=function(){function b(a,c){return("000"+a).slice(-2-(c||0))}function d(a){return v.logTimestamps?function(c){var g=new Date;
...
return e+"]"};b.isDuplicate=function(a,c){return a&&c&&(a.action===f.MESSAGE||a.action===f.PRESENCE)&&a.action===c.action&&a.channel===c.channel&&a.id===c.id};return b}(),pa=function(){function b(a){this.count=a&&a.count||0;this.data=a&&a.data||0;this.uncompressedData=a&&a.uncompressedData||0;this.failed=a&&a.failed||0;this.refused=a&&a.refused||0}function d(a){this.peak=a&&a.peak||0;this.min=a&&a.min||0;this.mean=a&&a.mean||0;this.opened=a&&a.opened||0;this.refused=a&&a.refused||0}function f(a){this.succeeded=
...
code:80017,message:"Connection closing"}),closed:q.fromValues({statusCode:400,code:80017,message:"Connection closed"}),unknownConnectionErr:q.fromValues({statusCode:500,code:50002,message:"Internal connection error"}),unknownChannelErr:q.fromValues({statusCode:500,code:50001,message:"Internal channel error"})},ia=function(){function b(){A.call(this);this.messages=[]}h.inherits(b,A);b.prototype.count=function(){return this.messages.length};b.prototype.push=function(b){this.messages.push(b)};b.prototype.shift=
...
"Last known activity from realtime was "+a+"ms ago; discarding connection state"),this.clearConnection(),this.states.connecting.failState="suspended",this.states.connecting.queueEvents=!1)}};a.prototype.persistConnection=function(){if(n){var a=this.realtime.connection.recoveryKey;a&&(a={recoveryKey:a,disconnectedAt:h.now(),location:u.location,clientId:this.realtime.auth.clientId},n&&M.setSession("ably-connection-recovery",a))}};a.prototype.unpersistConnection=function(){n&&M.removeSession("ably-connection-recovery")};
...
b.promises=!0;return new F(b)};F.Callbacks=F;var H=function(){function b(f){if(!(this instanceof b))return new b(f);d.logAction(d.LOG_MINOR,"Realtime()","");F.call(this,f);this.connection=new ra(this,this.options);this.channels=new l(this);!1!==f.autoConnect&&this.connect()}function l(b){A.call(this);this.realtime=b;this.all={};this.inProgress={};var a=this;b.connection.connectionManager.on("transport.active",function(){a.onTransportActive()})}h.inherits(b,F);b.prototype.connect=function(){d.logAction(d.LOG_MINOR,
...
b+" bytes)",40009,400)):e._publish(C.serialize(m,g),p,l,d)}})};l.prototype._publish=function(a,b,d,e){L.post(this.rest,this.basePath+"/messages",a,b,d,!1,e)};return l}(),V=function(){function b(){}function l(a,b,f){d.logAction(d.LOG_MINOR,"RealtimeChannel()","started; name = "+b);Z.call(this,a,b,f);this.realtime=a;this.presence=new sa(this,a.options);this.connectionManager=a.connection.connectionManager;this.state="initialized";this.subscriptions=new A;this.syncChannelSerial=void 0;this.properties=
...
a,c)};l.prototype.whenState=function(a,b){A.prototype.whenState.call(this,a,this.state,b)};return l}(),sa=function(){function b(){}function l(a){a=a.channel.realtime;var b=a.auth.clientId;return(!b||"*"===b)&&"connected"===a.connection.state}function f(a,b,c){switch(a.state){case "attached":case "suspended":c();break;case "initialized":case "detached":case "detaching":case "attaching":a.attach(function(a){a?b(a):c()});break;default:b(q.fromValues(V.invalidStateError(a.state)))}}function a(a){Y.call(this,
...
!1}var a=u._ablyjs_jsonp={};a._=function(c){return a["_"+c]||b};var c=1,n=null;h.inherits(l,O);l.isAvailable=function(){return v.jsonpSupported&&v.allowComet};l.isAvailable()&&(Q.supportedTransports.jsonp=l);v.jsonpSupported&&(n=document.getElementsByTagName("head")[0]);var e=null;u.JSONPTransport=l;l.tryConnect=function(a,b,c,e){function g(a){e({event:this.event,error:a})}var f=new l(a,b,c);f.on(["failed","disconnected"],g);f.on("preconnect",function(){d.logAction(d.LOG_MINOR,"JSONPTransport.tryConnect()",
