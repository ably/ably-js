(function() {
  ...
  C.prototype = {getArray:function() {
    ...
    var a = a || 0, b = b || this.length, c = new C, f = c.length = b - a, g = c.offset = this.offset + a, d = c.buf = this.buf;
  ...
  var kb = new C(0), W = d.TTransport = function(a, b) {
    this.buf = a || kb;
    this.onFlush = b;
    this.reset()
  };
  ...
  var G = {TAction:TAction, TType:TType, TData:R, TPresence:X, TMessage:Y, TChannelMessage:Z, TMessageSet:da}, S, $ = function() {
    if(!T) {
      try {
    ...
    if(typeof D.addEventListener != p) {
      D.addEventListener("load", a, !1)
    }else {
      if(typeof l.addEventListener != p) {
        l.addEventListener("load", a, !1)
      }else {
        if(typeof D.attachEvent != p) {
          var b = D;
    ...
    if(0 < a) {
      for(var b = 0;b < a;b++) {
        var c = M[b].id, f = M[b].callbackFn, g = {success:!1, id:c};
        if(0 < h.pv[0]) {
          var d = H(c);
          if(d) {
            if(la(M[b].swfVersion) && !(h.wk && 312 > h.wk)) {
              U(c, !0), f && (g.success = !0, g.ref = Ca(c), f(g))
            }else {
              if(M[b].expressInstall && Da()) {
                g = {};
                g.data = M[b].expressInstall;
                ...
                for(var e = {}, d = d.getElementsByTagName("param"), r = d.length, m = 0;m < r;m++) {
                  "movie" != d[m].getAttribute("name").toLowerCase() && (e[d[m].getAttribute("name")] = d[m].getAttribute("value"))
                }
                Ea(g, e, c, f)
              }else {
                lb(d), f && f(g)
          ...
          if(U(c, !0), f) {
            if((c = Ca(c)) && typeof c.SetVariable != p) {
              g.success = !0, g.ref = c
            }
            f(g)
          }
    ...
    if((a = H(a)) && "OBJECT" == a.nodeName) {
      typeof a.SetVariable != p ? b = a : (a = a.getElementsByTagName(J)[0]) && (b = a)
    }
    return b
  }, Da = function() {
    ...
    if(d) {
      ...
      b.flashvars = typeof b.flashvars != p ? b.flashvars + ("&" + f) : f;
    ...
    if(d) {
      if(typeof a.id == p && (a.id = c), h.ie && h.win) {
        var e = "", q;
        for(q in a) {
          a[q] != Object.prototype[q] && ("data" == q.toLowerCase() ? b.movie = a[q] : "styleclass" == q.toLowerCase() ? e += ' class="' + a[q] + '"' : "classid" != q.toLowerCase() && (e += " " + q + '="' + a[q] + '"'))
        }
        q = "";
        for(var r in b) {
          b[r] != Object.prototype[r] && (q += '<param name="' + r + '" value="' + b[r] + '" />')
        }
        d.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + e + ">" + q + "</object>";
        oa[oa.length] = a.id;
        f = H(a.id)
      }else {
        r = l.createElement(J);
        ...
        for(e in b) {
          b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = r, q = e, m = b[e], c = l.createElement("param"), c.setAttribute("name", q), c.setAttribute("value", m), a.appendChild(c))
        }
    ...
    if(!h.ie || !h.mac) {
      ...
      if(d) {
        ...
        f && (Ja = K = null);
        if(!K || Ja != c) {
          f = l.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), K = d.appendChild(f), h.ie && (h.win && typeof l.styleSheets != p && 0 < l.styleSheets.length) && (K = l.styleSheets[l.styleSheets.length - 1]), Ja = c
        }
        h.ie && h.win ? K && typeof K.addRule == J && K.addRule(a, b) : K && typeof l.createTextNode != p && K.appendChild(l.createTextNode(a + " {" + b + "}"))
      }
    }
  }, U = function(a, b) {
    if(Ya) {
      var c = b ? "visible" : "hidden";
      T && H(a) ? H(a).style.visibility = c : Xa("#" + a, "visibility:" + c)
    }
  }, Za = function(a) {
    return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != p ? encodeURIComponent(a) : a
  }, p = "undefined", J = "object", pa = "application/x-shockwave-flash", Va = "SWFObjectExprInst", D = window, l = document, N = navigator, $a = !1, ka = [function() {
    if($a) {
  ...
  }], M = [], oa = [], aa = [], ea, na, Ga, Ua, T = !1, ma = !1, K, Ja, Ya = !0, h, mb = typeof l.getElementById != p && typeof l.getElementsByTagName != p && typeof l.createElement != p, qa = N.userAgent.toLowerCase(), ra = N.platform.toLowerCase(), nb = ra ? /win/.test(ra) : /win/.test(qa), ob = ra ? /mac/.test(ra) : /mac/.test(qa), pb = /webkit/.test(qa) ? parseFloat(qa.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Ka = !+"\v1", fa = [0, 0, 0], A = null;
  if(typeof N.plugins != p && typeof N.plugins["Shockwave Flash"] == J) {
    if((A = N.plugins["Shockwave Flash"].description) && !(typeof N.mimeTypes != p && N.mimeTypes[pa] && !N.mimeTypes[pa].enabledPlugin)) {
  ...
  h.w3 && ((typeof l.readyState != p && "complete" == l.readyState || typeof l.readyState == p && (l.getElementsByTagName("body")[0] || l.body)) && $(), T || (typeof l.addEventListener != p && l.addEventListener("DOMContentLoaded", $, !1), h.ie && h.win && (l.attachEvent("onreadystatechange", function() {
  ...
  S = {registerObject:function(a, b, c, f) {
    if(h.w3 && a && b) {
      var d = {};
      d.id = a;
      d.swfVersion = b;
  ...
  }, embedSWF:function(a, b, c, f, d, e, q, r, m, j) {
    ...
    h.w3 && !(h.wk && 312 > h.wk) && a && b && c && f && d ? (U(b, !1), Sa(function() {
      ...
      if(q && typeof q === J) {
        for(var n in q) {
          i.flashvars = typeof i.flashvars != p ? i.flashvars + ("&" + n + "=" + q[n]) : n + "=" + q[n]
        }
      }
      if(la(d)) {
    ...
    if(ma) {
      var a = H(Va);
      a && ea && (a.parentNode.replaceChild(ea, a), na && (U(na, !0), h.ie && h.win && (ea.style.display = "block")), Ga && Ga(Ua));
      ma = !1
    }
  }};
  var sa;
  ...
  j.__initialize = function() {
    if(!j.__initialized) {
      ...
      S.embedSWF("swf/WebSocketMainInsecure.swf", "webSocketFlash", "1", "1", "10.0.0", null, null, {hasPriority:!0, swliveconnect:!0, allowScriptAccess:"always"}, null, function(a) {
  ...
  k.copyFile = function(a, b, c) {
    ...
    c = path.dirname(b);
    k.mkdirs(c);
    for(var c = new C(1024), a = fs.openSync(a, "r"), b = fs.openSync(b, "w"), f;0 < (f = fs.readSync(a, c, 0, 1024));) {
  ...
  s.prototype.setupTransport = function(a) {
    ...
    for(var c = function(c) {
      return function(f, d) {
        e.logAction(e.LOG_MICRO, "ConnectionManager.setupTransport; on state = " + c, "reason =  " + f + "; connectionId = " + d);
        b.transport === a && (d && (b.realtime.connection.id = d), b.notifyState({state:c, reason:f}))
      }
  ...
  var u = function(a, b, c) {
    ...
    t.call(this, a, b, c)
  }, Ma = "object" == typeof window, db = Ma ? window.WebSocket || window.MozWebSocket : require("ws"), ub = Ma ? !1 : C, vb = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), ua = Ma ? d : require("thrift");
  k.inherits(u, t);
  ...
  u.prototype.connect = function() {
    ...
    this.auth.getAuthParams(function(c, f) {
      ...
      if(c) {
        ...
        try {
          var j = a.wsConnection = a.createWebSocket(b, f);
          j.binaryType = "arraybuffer";
          j.onopen = function() {
            a.onWsOpen()
          };
          j.onclose = function(b, c) {
            a.onWsClose(b, c)
          };
  ...
  v.prototype.send = function(a, b) {
    if(this.sendRequest) {
      this.pendingMessage = this.pendingMessage || new Na.TMessageSet({items:[]}), this.pendingMessage.items.push(a), this.pendingCallback = this.pendingCallback || new ga, this.pendingCallback.push(b)
    }else {
  ...
  var B = function(a, b, c) {
    c.useTextProtocol = c.useTextProtocol || !B.binary;
    v.call(this, a, b, c)
  }, eb = function() {
  ...
  B.isAvailable() && (L.availableTransports.xhr = B);
  B.tryConnect = function(a, b, c, d) {
    var g = new B(a, b, c), h = function(a) {
      d(a)
    };
    g.on("error", h);
  ...
  B.prototype.request = function(a, b, c, d, e) {
    return new B.Request(a, b, c, d, this.binary, e)
  };
  B.prototype.toString = function() {
    return"XHRTransport; uri=" + this.baseUri + "; isConnected=" + this.isConnected
  };
  B.Request = function(a, b, c, d, e, h) {
    ...
    i.onreadystatechange = function() {
      if(4 == i.readyState) {
        clearTimeout(m);
        var a = null;
        i.status != j ? (a = Error("Unexpected response: statusCode = " + i.status), a.statusCode = i.status, a.statusText = i.statusText, h(a)) : (a = null, e ? i.response && (a = new C, a.buf = i.response, a.view = new DataView(a.buf)) : a = i.responseText, h(null, a))
      }
    };
    i.send(c)
  };
  ...
  O.isAvailable = function() {
    return xb && S && 10 <= S.getFlashPlayerVersion().major && sa
  };
  ...
  ba.prototype.getAuthHeaders = function(a) {
    "basic" == this.method ? a(null, {authorization:"Basic " + (new C(this.key || this.key_id + ":" + this.key_value, "ascii")).toString("base64")}) : this.authorise({}, function(b, c) {
  ...
  var La, n = function(a, b, c) {
    ...
    this.pendingEvents = []
  }, z = "object" == typeof G ? G : require("../nodejs/lib/protocol/clientmessage_types"), Q = function() {
  }, Bb = {queueEvents:!0};
  k.inherits(n, ia);
  ...
  n.prototype.subscribeForEvent = function(a, b, c) {
    if(this.subscriptions.listeners(a)) {
      ...
      var d = null === a ? ":" : a, g = this.pendingSubscriptions[d];
      g || (g = [], this.pendingSubscriptions[d] = g);
      g.push({listener:b, callback:c});
  ...
  n.prototype.setAttached = function(a) {
    ...
    try {
      if(this.pendingEvents.length) {
        var b = new z.TChannelMessage({action:z.TAction.EVENT, name:this.name, events:[]}), c = new ga;
  ...
  n.prototype.setUnsubscribed = function(a) {
    ...
    d && (k.nextTick(function() {
      for(var b in d) {
        d[b].callback(a.reason || "Connection refused by the server")
      }
