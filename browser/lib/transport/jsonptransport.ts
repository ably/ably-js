...
/* express strips out parantheses from the callback!
	...
	*/
_._ = function(id: string) { return _['_' + id] || noop; };
let idCounter = 1;
...
export function createRequest(uri: string, headers: Record<string, string> | null, params?: RequestParams, body?: unknown, requestMode?: number, timeouts?: Record<string, number> | null, method?: HttpMethods) {
	...
	return new Request(undefined, uri, headers, Utils.copy<RequestParams>(params), body, requestMode as number, timeouts as Record<string, number>, method);
}
...
class JSONPTransport extends CometTransport {
	...
	createRequest(uri: string, headers: Record<string, string> | null, params?: Record<string, string>, body?: unknown, requestMode?: number, timeouts?: Record<string, number>, method?: HttpMethods) {
		/* JSONP requests are used either with the context being a realtime
		 * transport, or with timeouts passed in (for when used by a rest client),
		 * or completely standalone.  Use the appropriate timeouts in each case */
...
export class Request extends EventEmitter {
	...
	constructor(id: string | number | undefined, uri: string, headers: Record<string, string> | null, params: Record<string, string> | null, body: unknown | null, requestMode: number, timeouts: Record<string, number>, method?: HttpMethods) {
		super();
