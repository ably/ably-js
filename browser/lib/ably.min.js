(function() {
  ...
  G.prototype = {_2scomp:function() {
    ...
    for(var c = this.buffer, b = this.offset, g = c[0] & 128, d = 0, e = 1, k = 7, q = 1;0 <= k;k--, q *= 256) {
      var l = c[b + k];
      g && (l = (l ^ 255) + e, e = l >> 8, l &= 255);
      d += l * q
    }
    return!a && d >= G.MAX_INT ? g ? -Infinity : Infinity : g ? -d : d
  }, valueOf:function() {
  ...
  d.TXHRTransport.prototype = {getXmlHttpRequestObject:function() {
    ...
    c = jQuery.ajax({url:this.url, data:c, type:"POST", cache:!1, dataType:"text", context:this, success:this.jqResponse, error:function(b, c, e) {
      d.rejectWith(a, jQuery.merge([e], b.tArgs))
  ...
  w.prototype = {getArray:function() {
    ...
    a = a || 0;
    c = c || this.length;
    var b = new w, g = b.length = c - a, d = b.offset = this.offset + a, e = b.buf = this.buf;
  ...
  var ga = new w(0), I = d.TTransport = function(a, c) {
    this.buf = a || ga;
    this.onFlush = c;
    this.reset()
  };
  ...
  Y.receiver = function(a) {
    ...
    return function(e) {
      ...
      for(;e.length;) {
        ...
        e.length >= c ? (e.copy(g, b, 0, c), e = e.slice(c, e.length), c = 0, a(new Y(g))) : e.length && (e.copy(g, b, 0, e.length), c -= e.length, b += e.length, e = e.slice(e.length, e.length))
      }
    }
  };
  J(Y, I, {flush:function() {
    var a = this;
    I.prototype.flush.call(this, function(c) {
      if(a.onFlush) {
        var b = new w(c.length + 4);
    ...
    for(a.readStructBegin();;) {
      ...
      switch(c.fid) {
        ...
        case 2:
          ...
          break;
        case 3:
          b == d.Type.STRUCT ? (this.clientData = new D, this.clientData.read(a)) : a.skip(b);
          break;
        case 4:
    ...
    for(a.readStructBegin();;) {
      ...
      switch(c.fid) {
        ...
        case 3:
          ...
          break;
        case 4:
          b == d.Type.STRUCT ? (this.data = new D, this.data.read(a)) : a.skip(b);
          break;
        case 5:
          if(b == d.Type.LIST) {
            c = 0;
      ...
      switch(c.fid) {
        ...
        case 13:
          if(b == d.Type.LIST) {
            ...
            c = a.readListBegin().size;
            for(b = 0;b < c;++b) {
              g = void 0, g = new H, g.read(a), this.presence.push(g)
            }
            a.readListEnd()
          }else {
            a.skip(b)
      ...
      switch(c.fid) {
        case 1:
          if(b == d.Type.LIST) {
            ...
            c = a.readListBegin().size;
            for(b = 0;b < c;++b) {
              var g = void 0, g = new WWebhookMessage;
              g.read(a);
              this.items.push(g)
            }
            a.readListEnd()
  ...
  var t = {TAction:TAction, TFlags:TFlags, TType:TType, TData:D, TPresence:H, TMessage:C, TChannelMessage:void 0, TProtocolMessage:K};
  this.Cookie = function() {
    function a() {
    }
    "object" == typeof window && (a.create = function(a, b, d) {
      var h = "";
      d && (h = new Date, h.setTime(h.getTime() + d), h = "; expires\x3d" + h.toGMTString());
      document.cookie = a + "\x3d" + b + h + "; path\x3d/"
    }, a.read = function(a) {
      a += "\x3d";
      for(var b = document.cookie.split(";"), d = 0;d < b.length;d++) {
        for(var h = b[d];" " == h.charAt(0);) {
  ...
  "https:") + "//cdn.ably.io/lib/swf/WebSocketMainInsecure-0.9.swf", policyPort:"80"}, getHost:function(a, c, b) {
    ...
    var c;
    a.host ? (c = [a.host], a.fallbackHosts && c.concat(a.fallbackHosts)) : c = [u.HOST].concat(u.FALLBACK_HOSTS);
    return c
  }};
  ...
  this.Http = function() {
    ...
    a.get = function(b, d, h, e, k) {
      ...
      }, v = h && "application/json" != h.accept;
      if("string" == typeof l) {
        q(l, k)
      }else {
        var E;
        E = (h = b.connection) && "connected" == h.state ? [h.connectionManager.host] : u.getHosts(b.options);
        1 == E.length ? q(l(E[0]), k) : q(E.shift(), function(a, b, c) {
          if(a) {
            var e = a.code;
    ...
    a.post = function(b, d, h, e, k, q) {
      ...
      var v = "function" == typeof d ? d : function(a) {
        return b.baseUri(a) + d
      }, E = h && "application/json" != h.accept;
      if("string" == typeof v) {
        tryGet(v, q)
      }else {
        var f;
        f = (h = b.connection) && "connected" == h.state ? [h.connectionManager.host] : u.getHosts(b.options);
        1 == f.length ? l(v(f[0]), q) : l(f.shift(), function(a, b, c) {
          if(a) {
            var e = a.code;
            if("ENETUNREACH" == e || "EHOSTUNREACH" == e || "EHOSTDOWN" == e) {
              l(f, q);
  ...
  this.ThriftUtil = function() {
    ...
    var b = new d.TTransport, g = new d.TBinaryProtocol(b), h = 16384, e = [];
    c.encode = function(a, b) {
      try {
        b(null, c.encodeSync(a))
      }catch(e) {
        var d = "Unexpected exception encoding Thrift; exception \x3d " + e;
        f.logAction(f.LOG_ERROR, "ThriftUtil.encode()", d, e);
        d = Error(d);
        d.statusCode = 400;
        b(d)
      }
    ...
    c.decodeSync = function(a, c) {
      try {
        ...
        var d = "Unexpected exception decoding thrift message; exception \x3d " + e;
        f.logAction(f.LOG_ERROR, "ThriftUtil.decode()", d, e);
        d = Error(d);
        d.statusCode = 400;
        throw d;
      }
  ...
  var L = function() {
    ...
    function b(a) {
      var b = this.algorithm = a.algorithm.toUpperCase(), c = this.key = a.key;
      a = this.iv = a.iv;
      this.encryptCipher = CryptoJS.algo[b].createEncryptor(c, {iv:a});
      this.blockLengthWords = a.length
    }
    var d = t.TData, h = t.TType, e;
    if(window.Uint32Array && window.crypto && window.crypto.getRandomValues) {
      var k = new Uint32Array(4);
      e = function(a, b) {
        var c = a / 4, c = 4 == c ? k : new Uint32Array(c);
        window.crypto.getRandomValues(c);
        b(null, CryptoJS.lib.WordArray.create(c))
      }
    }else {
      k = Array(4), e = function(a, b) {
        for(var c = a / 4, e = 4 == c ? k : Array(c), d = 0;d < c;d++) {
          e[d] = Math.floor(4294967296 * Math.random())
        }
        b(null, CryptoJS.lib.WordArray.create(e))
      }
    }
    var q = CryptoJS.lib.WordArray.create(0.5), l = [CryptoJS.lib.WordArray.create([269488144, 269488144, 269488144, 269488144], 16), CryptoJS.lib.WordArray.create([16777216], 1), CryptoJS.lib.WordArray.create([33685504], 2), CryptoJS.lib.WordArray.create([50529024], 3), CryptoJS.lib.WordArray.create([67372036], 4), CryptoJS.lib.WordArray.create([84215045, 83886080], 5), CryptoJS.lib.WordArray.create([101058054, 101056512], 6), CryptoJS.lib.WordArray.create([117901063, 117901056], 7), CryptoJS.lib.WordArray.create([134744072, 
    ...
    a.getCipher = function(e, d) {
      var g = e && e.cipherParams;
      g ? g instanceof c ? d(null, new b(g)) : d(Error("ChannelOptions not supported")) : a.getDefaultParams(function(a, c) {
        a ? d(a) : d(null, new b(c))
      })
    };
    b.prototype.encrypt = function(a) {
      f.logAction(f.LOG_MICRO, "CBCCipher.encrypt()", "");
      console.log("encrypt: plaintext:");
      console.log(CryptoJS.enc.Hex.stringify(a));
      var b = a.length, c = b + 16 & -16, e = this.getIv();
      a = this.encryptCipher.process(a.concat(l[c - b]));
      e = e.clone().concat(a.ciphertext);
      console.log("encrypt: ciphertext:");
      console.log(CryptoJS.enc.Hex.stringify(e));
      return e
    };
    b.prototype.decrypt = function(a) {
      console.log("decrypt: ciphertext:");
      console.log(CryptoJS.enc.Hex.stringify(a));
      var b = this.blockLengthWords;
      a = CryptoJS.lib.CipherParams.create({ciphertext:a.slice(b), iv:a.slice(0, b)});
      a = CryptoJS[this.algorithm].decrypt(a, this.key);
    ...
    b.prototype.getIv = function() {
      if(!this.iv) {
        return this.encryptCipher.process(q).ciphertext
      }
      var a = this.iv;
      this.iv = null;
      return a
    ...
    v.asPlaintext = function(a) {
      ...
      switch(a.type) {
        ...
        case h.JSONARRAY:
          ...
          break;
        case h.INT32:
          b = CryptoJS.lib.WordArray.create(1);
          b[0] = a.i32Data;
          break;
        case h.INT64:
          b = CryptoJS.lib.WordArray.create(2);
          b[0] = a.i64Data / 4294967296;
          b[1] = a.i64Data % 4294967296;
          break;
        case h.DOUBLE:
          a = a.doubleData;
          b = new ArrayBuffer(8);
    ...
    function b(a) {
      if(typeof s.addEventListener != x) {
        ...
        if(typeof r.addEventListener != x) {
          r.addEventListener("load", a, !1)
        }else {
          if(typeof s.attachEvent != x) {
            S(s, "onload", a)
          }else {
    ...
    function d() {
      var a = r.getElementsByTagName("body")[0], b = r.createElement(t);
    ...
    function h() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          var c = A[b].id, d = A[b].callbackFn, g = {success:!1, id:c};
          if(0 < p.pv[0]) {
            var h = B(c);
            if(h) {
              if(m(A[b].swfVersion) && !(p.wk && 312 > p.wk)) {
                R(c, !0), d && (g.success = !0, g.ref = e(c), d(g))
              }else {
                if(A[b].expressInstall && k()) {
                  g = {};
                  g.data = A[b].expressInstall;
                  ...
                  for(var v = {}, h = h.getElementsByTagName("param"), f = h.length, E = 0;E < f;E++) {
                    "movie" != h[E].getAttribute("name").toLowerCase() && (v[h[E].getAttribute("name")] = h[E].getAttribute("value"))
                  }
                  q(g, v, c, d)
                }else {
                  l(h), d && d(g)
    ...
    function q(a, b, c, e) {
      ...
      var d = B(c);
      if(d) {
        "OBJECT" == d.nodeName ? (G = v(d), I = null) : (G = d, I = c);
        a.id = z;
        ...
        e = "MMredirectURL\x3d" + s.location.toString().replace(/&/g, "%26") + "\x26MMplayerType\x3d" + e + "\x26MMdoctitle\x3d" + r.title;
        b.flashvars = typeof b.flashvars != x ? b.flashvars + ("\x26" + e) : e;
        p.ie && (p.win && 4 != d.readyState) && (e = r.createElement("div"), c += "SWFObjectNew", e.setAttribute("id", c), d.parentNode.insertBefore(e, d), d.style.display = "none", function() {
    ...
    function f(a, b, c) {
      ...
      if(d) {
        if(typeof a.id == x && (a.id = c), p.ie && p.win) {
          var g = "", l;
          for(l in a) {
            a[l] != Object.prototype[l] && ("data" == l.toLowerCase() ? b.movie = a[l] : "styleclass" == l.toLowerCase() ? g += ' class\x3d"' + a[l] + '"' : "classid" != l.toLowerCase() && (g += " " + l + '\x3d"' + a[l] + '"'))
          }
          l = "";
          for(var k in b) {
            b[k] != Object.prototype[k] && (l += '\x3cparam name\x3d"' + k + '" value\x3d"' + b[k] + '" /\x3e')
          }
          d.outerHTML = '\x3cobject classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + g + "\x3e" + l + "\x3c/object\x3e";
          H[H.length] = a.id;
          e = B(a.id)
        }else {
          k = r.createElement(t);
          ...
          for(var h in a) {
            a[h] != Object.prototype[h] && ("styleclass" == h.toLowerCase() ? k.setAttribute("class", a[h]) : "classid" != h.toLowerCase() && k.setAttribute(h, a[h]))
          }
          for(g in b) {
            b[g] != Object.prototype[g] && "movie" != g.toLowerCase() && (a = k, l = g, h = b[g], c = r.createElement("param"), c.setAttribute("name", l), c.setAttribute("value", h), a.appendChild(c))
          }
    ...
    function n(a, b, c, e) {
      if(!p.ie || !p.mac) {
        ...
        if(d) {
          ...
          e && (L = M = null);
          if(!M || L != c) {
            e = r.createElement("style"), e.setAttribute("type", "text/css"), e.setAttribute("media", c), M = d.appendChild(e), p.ie && (p.win && typeof r.styleSheets != x && 0 < r.styleSheets.length) && (M = r.styleSheets[r.styleSheets.length - 1]), L = c
          }
          p.ie && p.win ? M && typeof M.addRule == t && M.addRule(a, b) : M && typeof r.createTextNode != x && M.appendChild(r.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function R(a, b) {
      if(O) {
        ...
        Q && B(a) ? B(a).style.visibility = c : n("#" + a, "visibility:" + c)
      }
    }
    function u(a) {
      return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != x ? encodeURIComponent(a) : a
    }
    var x = "undefined", t = "object", w = "application/x-shockwave-flash", z = "SWFObjectExprInst", s = window, r = document, y = navigator, F = !1, D = [function() {
      F ? d() : h()
    }], A = [], H = [], C = [], G, I, K, N, Q = !1, J = !1, M, L, O = !0, p = function() {
      var a = typeof r.getElementById != x && typeof r.getElementsByTagName != x && typeof r.createElement != x, b = y.userAgent.toLowerCase(), c = y.platform.toLowerCase(), e = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, d = !+"\v1", g = [0, 0, 0], l = null;
      if(typeof y.plugins != x && typeof y.plugins["Shockwave Flash"] == t) {
        if((l = y.plugins["Shockwave Flash"].description) && !(typeof y.mimeTypes != x && y.mimeTypes[w] && !y.mimeTypes[w].enabledPlugin)) {
          F = !0, d = !1, l = l.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), g[0] = parseInt(l.replace(/^(.*)\..*$/, "$1"), 10), g[1] = parseInt(l.replace(/^.*\.(.*)\s.*$/, "$1"), 10), g[2] = /[a-zA-Z]/.test(l) ? parseInt(l.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        }
      }else {
        if(typeof s.ActiveXObject != x) {
          try {
            var k = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
            if(k && (l = k.GetVariable("$version"))) {
              d = !0, l = l.split(" ")[1].split(","), g = [parseInt(l[0], 10), parseInt(l[1], 10), parseInt(l[2], 10)]
            }
          }catch(h) {
          }
        }
      }
      return{w3:a, pv:g, wk:b, ie:d, win:e, mac:c}
    }();
    (function() {
      p.w3 && ((typeof r.readyState != x && "complete" == r.readyState || typeof r.readyState == x && (r.getElementsByTagName("body")[0] || r.body)) && a(), Q || (typeof r.addEventListener != x && r.addEventListener("DOMContentLoaded", a, !1), p.ie && p.win && (r.attachEvent("onreadystatechange", function() {
        "complete" == r.readyState && (r.detachEvent("onreadystatechange", arguments.callee), a())
      }), s == top && function() {
        if(!Q) {
          try {
        ...
        Q || (/loaded|complete/.test(r.readyState) ? a() : setTimeout(arguments.callee, 0))
      }(), b(a)))
    })();
    (function() {
    ...
    return{registerObject:function(a, b, c, e) {
    ...
    }, embedSWF:function(a, b, e, d, g, l, h, v, P, B) {
      var S = {success:!1, id:b};
      p.w3 && !(p.wk && 312 > p.wk) && a && b && e && d && g ? (R(b, !1), c(function() {
        e += "";
        d += "";
        var c = {};
        if(P && typeof P === t) {
        ...
        if(h && typeof h === t) {
          for(var r in h) {
            p.flashvars = typeof p.flashvars != x ? p.flashvars + ("\x26" + r + "\x3d" + h[r]) : r + "\x3d" + h[r]
          }
        }
        if(m(g)) {
          n = f(c, p, b), c.id == b && R(b, !0), S.success = !0, S.ref = n
        }else {
          if(l && k()) {
            c.data = l;
            q(c, p, b, B);
      ...
      if(J) {
        var a = B(z);
        a && G && (a.parentNode.replaceChild(G, a), I && (R(I, !0), p.ie && p.win && (G.style.display = "block")), K && K(N));
        J = !1
      }
    }}
  }(), U = function() {
    ...
    var d = "undefined" !== typeof Cookie && Cookie.read, h = "undefined" !== typeof Cookie && Cookie.create, e = ("object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types")).TAction, k = function() {
    ...
    b.prototype.chooseTransport = function(b) {
      ...
      if(this.transport) {
        ...
        }) : (d.host = this.httpHosts[0], f.logAction(f.LOG_MINOR, "ConnectionManager.chooseTransport()", "No http transports available; ignoring fallback hosts"), this.chooseTransportForHost(d, e.transports.slice(), b))
      }
    };
    b.prototype.chooseTransportForHost = function(a, c, d) {
      ...
      if(e) {
        ...
        b.transports[e].tryConnect(this, this.realtime.auth, a, function(b, k) {
          b ? g.chooseTransportForHost(a, c, d) : (f.logAction(f.LOG_MICRO, "ConnectionManager.chooseTransport()", "transport " + e + " connecting"), g.setTransportPending(k), d(null, k))
        })
      }else {
    ...
    b.prototype.chooseHttpTransport = function(a, c) {
      function d() {
        if(e.length) {
          b.httpTransports[k.httpTransports[0]].checkConnectivity(function(b, g) {
            b ? c(b) : g ? (a.host = n.arrRandomElement(e), k.chooseTransportForHost(a, k.httpTransports.slice(), function(a, b) {
              a ? d() : c(null, b)
    ...
    b.prototype.startConnectTimer = function() {
      ...
      this.connectTimer = setTimeout(function() {
        a.connectTimer && (f.logAction(f.LOG_MINOR, "ConnectionManager connect timer expired", "requesting new state: " + q.connecting.failState), a.notifyState({state:q.connecting.failState}))
      }, u.connectTimeout)
    };
    ...
    b.prototype.startSuspendTimer = function() {
      ...
      this.suspendTimer || (this.suspendTimer = setTimeout(function() {
        a.suspendTimer && (f.logAction(f.LOG_MINOR, "ConnectionManager suspend timer expired", "requesting new state: suspended"), q.connecting.failState = "suspended", q.connecting.queueEvents = !1, a.notifyState({state:"suspended"}))
      }, u.suspendedTimeout))
    };
    ...
    var c = ("object" == typeof window ? t : require("../nodejs/lib/protocol/clientmessage_types")).TAction;
    n.inherits(a, s);
    ...
    var c = "object" == typeof window, b = c ? t : require("../nodejs/lib/protocol/clientmessage_types"), d = c ? window.WebSocket || window.MozWebSocket : require("ws"), h = c ? !1 : !!w, e = function() {
    };
    n.inherits(a, A);
    ...
    a.tryConnect = function(b, c, d, e) {
      var g = new a(b, c, d), h = function(a) {
        e(a)
      };
      g.on("wserror", h);
    ...
    a.prototype.connect = function() {
      ...
      this.auth.getAuthParams(function(c, d) {
        ...
        if(c) {
          ...
          try {
            var l = a.wsConnection = a.createWebSocket(g, e);
            l.binaryType = "arraybuffer";
            l.onopen = function() {
              a.onWsOpen()
            };
            l.onclose = function(b, c) {
              a.onWsClose(b, c)
            };
    ...
    a.prototype.onWsClose = function(a, b) {
      ...
      A.prototype.onClose.call(this, c, e)
    };
    ...
    "object" == typeof t || require("../nodejs/lib/protocol/clientmessage_types");
    (n || require("util")).inherits(a, A);
    ...
    a.prototype.onConnect = function(a) {
      ...
      A.prototype.onConnect.call(this, a);
  ...
  this.Data = function() {
    ...
    var c = "object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types"), b = L.CipherData, d = {"[object Null]":function(a, b) {
      a.type = c.TType.NONE;
      return!0
      ...
      "undefined" !== typeof w && w.isBuffer(b) ? (a.type = c.TType.BUFFER, a.binaryData = b) : (a.type = c.TType.JSONOBJECT, a.stringData = JSON.stringify(b));
      return!0
      ...
      var c = d[Object.prototype.toString.call(b)];
      return c && c(a, b)
    }};
    ...
    a.fromTData = function(a) {
      ...
      if(a) {
        if(a.cipherData) {
          return new b(a.cipherData, a.type)
        }
        switch(a.type) {
          case 1:
            c = !0;
  ...
  var O = function() {
    ...
    var c = ("object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types")).TData;
    a.encrypt = function(a, d) {
      var h = new c, e = a.data;
      h.cipherData = d.encrypt(L.Data.asPlaintext(e));
      h.type = e.type;
      a.data = h
    };
    a.decrypt = function(a, c) {
      var d = a.data;
      d.cipherData && (a.data = L.Data.fromPlaintext(c.decrypt(d.cipherData), d.type))
    };
    return a
  }(), ea = function() {
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, d = a.TMessage = {}, h = a.TPresence = {}, e = a.TProtocolMessage = {}, k = a.TMessageArray = {}, f = a.TMessageBundle = {}, l = c.TType.BUFFER;
    ...
    b.fromREST = function(a, b) {
      ...
      switch(a.encoding) {
        case "cipher+base64":
          d = new c.TData;
          d.type = a.type;
          d.cipherData = new w(b, "base64");
          break;
        case "base64":
          d = new c.TData;
          d.type = l;
          d.binaryData = new w(b, "base64");
          break;
        default:
          d = Data.toTData(b)
      }
    ...
    e.fromJSON = function(a) {
      var b;
      if(b = a.messages) {
        for(var e = b.length, k = a.messages = Array(e), f = 0;f < e;f++) {
          k[f] = d.fromJSON(b[f])
        }
      }
      if(b = a.presence) {
    ...
    f.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          ...
          g = JSON.parse(a);
          for(var h = g.length, d = Array(h), k = 0;k < h;k++) {
            d[k] = e.fromJSON(g[k])
          }
        }
      }
    ...
    k.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          ...
          h = JSON.parse(a);
          for(var k = h.length, e = Array(k), f = 0;f < k;f++) {
            e[f] = d.fromJSON(h[f])
          }
        }
      }
  ...
  var V = function() {
    ...
    a.get = function(a, b, d, h, e) {
      function k() {
        a.auth.getAuthHeaders(function(f, l) {
          f ? e(f) : Http.get(a, b, n.mixin(l, d), h, function(b, d, g) {
    ...
    a.post = function(a, b, d, h, e, k) {
      function f() {
        a.auth.getAuthHeaders(function(l, v) {
          l ? k(l) : Http.post(a, b, n.mixin(v, h), d, e, function(b, d, e) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? k(a) : f()
            }) : k(b, d, e)
          })
    ...
    a.prototype.get = function(a) {
      var b = this;
      V.get(this.rest, this.path, this.headers, this.params, function(d, h, e) {
        if(d) {
    ...
    a.prototype.parseRelLinks = function(a) {
      for(var b = {}, d = 0;d < a.length;d++) {
        var h = a[d].match(/^\s*<(.+)>;\s*rel="(\w+)"$/);
        if(h) {
          var e = this.getRel(h[1]);
          e && (b[h[2]] = e)
        }
      }
      return b
    ...
    var d = "object" == typeof window, h = d ? null : require("crypto"), e, k = void 0;
    ...
    }, k = CryptoJS.enc.Base64.stringify);
    d || (e = function(a, b) {
      var c = h.createHmac("SHA256", b);
      c.update(a);
      return c.digest("base64")
    }, k = function(a) {
      return(new w(a, "ascii")).toString("base64")
    });
    ...
    b.prototype.requestToken = function(b, d) {
      ...
      if(b.authCallback) {
        ...
        if(b.authUrl) {
          f.logAction(f.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), e = function(a, c) {
            Http.get(g, b.authUrl, b.authHeaders || {}, n.mixin(a, b.authParams), c)
          }
        }else {
          if(b.keyValue) {
            var h = this;
      ...
      var k = {}, m = b.clientId || this.rest.clientId;
      m && (k.client_id = m);
      m = b.ttl || "";
      "ttl" in b && (k.ttl = m);
      ...
      var g = this.rest, u = function(a) {
        ...
        Http.post ? Http.post(g, u, n.defaultPostHeaders(), a, null, b) : Http.get(g, u, n.defaultGetHeaders(), a, b)
      };
      e(k, function(a, b) {
        a ? (f.logAction(f.LOG_ERROR, "Auth.requestToken()", "token request signing call returned error; err \x3d " + a), d(a)) : t(b, function(a, b) {
    ...
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        var g = {id:c}, h = a.clientId || "";
        h && (g.client_id = a.clientId);
        var k = a.ttl || "";
        k && (g.ttl = k);
        var m = a.capability || "";
        m && (g.capability = m);
        var n = this.rest, u = this;
        (function(c) {
          a.timestamp ? c() : a.queryTime ? n.time(function(d, e) {
            d ? b(d) : (a.timestamp = Math.floor(e / 1E3), c())
          }) : (a.timestamp = u.getTimestamp(), c())
        })(function() {
          var c = g.nonce = a.nonce || ("000000" + Math.floor(1E16 * Math.random())).slice(-16), v = g.timestamp = a.timestamp, c = g.id + "\n" + k + "\n" + m + "\n" + h + "\n" + v + "\n" + c + "\n";
          g.mac = a.mac || e(c, d);
    ...
    a.prototype.stats = function(a, c) {
      ...
      var k = n.copy(n.defaultGetHeaders());
      this.options.headers && n.mixin(k, this.options.headers);
      (new ha(this, "/stats", k, a, d)).get(c)
    };
    ...
    c.prototype.setOptions = function(a, c) {
      a && a.encrypted ? this.cipher = L.getCipher(a, c) : c(null, this.cipher = null)
    };
    c.prototype.presence = function(b, c) {
      ...
      V.get(d, "/channels/" + this.name + "/presence", k, b, function(a, b) {
    ...
    c.prototype.history = function(b, c) {
      ...
      d.options.headers && n.mixin(k, d.options.headers);
      V.get(d, "/channels/" + this.name + "/history", k, b, function(a, b) {
        if(a) {
          c(a)
        }else {
          try {
    ...
    var c = "object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types"), b = c.TAction, d = function() {
    }, h = {queueEvents:!0};
    n.inherits(a, aa);
    ...
    a.prototype.publish = function(a, b, h) {
      ...
      if(y.activeState(l.state)) {
        var l = new c.TMessage, v = this.cipher;
        l.name = a;
        ...
        switch(this.state) {
          ...
          default:
            this.attach();
          case "attaching":
            f.logAction(f.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:l, listener:h})
        }
      }else {
        h(l.getStateError())
      }
    ...
    a.prototype.detach = function(a) {
      a = a || d;
      var b = this.connectionManager;
      y.activeState(b.state) ? "detached" == this.state ? a() : (this.once(function(c) {
        switch(this.event) {
          case "detached":
            a();
            break;
            ...
            for(var c = Array(a.length), d = this.cipher, g = 0;g < c.length;g++) {
              ...
              if(d) {
                try {
                  ...
                  f.logAction(f.LOG_ERROR, "RealtimeChannel.onMessage()", n);
                  this.emit("error", Error(n))
                }
              }
              c[g] = new O(h.channelSerial, h.timestamp, h.name, Data.fromTData(h.data))
            }
            this.onEvent(c)
          }
          break;
    ...
    a.prototype.setAttached = function(a) {
      ...
      if("attaching" == this.state) {
        ...
        try {
          ...
          f.logAction(f.LOG_ERROR, "RealtimeChannel.setAttached()", "Unexpected exception sending pending messages: " + h.stack)
        }
      }
    };
    ...
    var b = "object" == typeof t ? t : require("../nodejs/lib/protocol/clientmessage_types"), d = b.TPresenceState, h = ["enter", "leave", "update"];
    n.inherits(c, s);
  ...
  (function() {
    ...
    a.tryConnect = function(b, c, d, g) {
      ...
      h.on("preconnect", function() {
        f.logAction(f.LOG_MINOR, "JSONPTransport.tryConnect()", "viable transport " + h);
        h.off("error", m);
        g(null, h)
      });
      h.connect()
    ...
    a.Request.prototype.send = function(a, c, d, g, f, h) {
      this.callback = h;
      var m = this.requestId, n = this.timer = setTimeout(g ? u.cometRecvTimeout : u.cometSendTimeout, function() {
        w.abort()
      });
      c = c || {};
      c.callback = "Ably._(" + m + ")";
      ...
      t.src = N.paramStr(c, a);
      var s = this._finish = function() {
        clearTimeout(n);
  ...
  (function() {
    ...
    a.Request.prototype.send = function(a, d, f, e, k, m) {
      a = N.paramStr(d, a);
      var l, n, t;
      f ? (d = "POST", l = 201) : (d = "GET", l = 200);
      var s = this.xhr = c();
      k && (s.responseType = "arraybuffer");
      var y = setTimeout(e ? u.cometRecvTimeout : u.cometSendTimeout, function() {
        t = !0;
        s.abort()
      });
      s.open(d, a, !0);
      ...
      s.onabort = function() {
        n = Error(t ? "Request timed out" : "Request cancelled");
        n.statusCode = 404;
        n.code = 8E4;
        m(n)
      };
      s.onreadystatechange = function() {
        if(4 == s.readyState) {
          if(clearTimeout(y), n) {
            ...
            if(s.status == l) {
              var a = null;
              k ? s.response && (a = new w, a.buf = s.response, a.view = new DataView(a.buf)) : a = s.responseText;
              m(null, a)
            }else {
    ...
    a.isAvailable() && (y.httpTransports.xhr = y.transports.xhr = a, Http.Request = function(b, c, d, e, f) {
  ...
  (function() {
    ...
    n.inherits(a, da);
    a.isAvailable = function() {
      return c && T && 10 <= T.getFlashPlayerVersion().major && U
    };
    ...
    a.tryConnect = function(b, c, d, e) {
      ...
      U.__initialize(k);
      m && U.loadFlashPolicyFile("xmlsocket://" + d.host + ":" + m);
      var l = new a(b, c, d);
      errorCb = function(a) {
        e(a)
      };
    ...
    a.prototype.createWebSocket = function(a, c) {
      ...
      return new U(a, [], d.proxyHost, d.proxyPort)
    };
    a.prototype.toString = function() {
