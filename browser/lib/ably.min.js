(function() {
  ...
  H.prototype = {_2scomp:function() {
    for(var a = this.buffer, c = this.offset, b = 1, g = c + 7;g >= c;g--) {
      b = (a[g] ^ 255) + b, a[g] = b & 255, b >>= 8
    }
    ...
    for(var g = this.buffer, d = this.offset, e = 7;0 <= e;e--) {
      g[d + e] = c & 255, c = 4 == e ? a : c >>> 8
    }
    b && this._2scomp()
  }, toNumber:function(a) {
    for(var c = this.buffer, b = this.offset, g = c[0] & 128, d = 0, e = 1, h = 7, m = 1;0 <= h;h--, m *= 256) {
      var l = c[b + h];
      g && (l = (l ^ 255) + e, e = l >> 8, l &= 255);
      d += l * m
    }
    return!a && d >= H.MAX_INT ? g ? -Infinity : Infinity : g ? -d : d
  }, valueOf:function() {
    return this.toNumber(!1)
  }, toString:function(a) {
    return this.valueOf().toString(a || 10)
  }, toOctetString:function(a) {
    for(var c = Array(8), b = this.buffer, g = this.offset, d = 0;8 > d;d++) {
      c[d] = aa[b[g + d]]
    }
    return c.join(a || "")
  }, inspect:function() {
  ...
  d.TXHRTransport.prototype = {getXmlHttpRequestObject:function() {
    ...
    this.rpos = 0
  }, jqRequest:function(a, c, b, g) {
    if("undefined" === typeof jQuery || "undefined" === typeof jQuery.Deferred) {
      throw"Thrift.js requires jQuery 1.5+ to use asynchronous requests";
    }
    var d = jQuery.Deferred(), e = jQuery._Deferred(), h = d.promise();
    h.success = h.done;
    h.error = h.fail;
    h.complete = e.done;
    c = jQuery.ajax({url:this.url, data:c, type:"POST", cache:!1, dataType:"text", context:this, success:this.jqResponse, error:function(b, c, g) {
      d.rejectWith(a, jQuery.merge([g], b.tArgs))
    }, complete:function(b, c) {
      e.resolveWith(a, [b, c])
    }});
    d.done(jQuery.makeArray(b).pop());
    c.tArgs = b;
    c.tClient = a;
    c.tRecvFn = g;
    c.tDfd = d;
    ...
    try {
      var g = b.tRecvFn.call(b.tClient);
      b.tDfd.resolveWith(b, jQuery.merge([g], b.tArgs))
    }catch(d) {
  ...
  d.Protocol.prototype = {getTransport:function() {
    ...
    var a = this.tpos.pop(), c = this.tstack[a], b = "{", g = !0, d;
    for(d in c) {
      g ? g = !1 : b += ",", b += d + ":" + c[d]
    }
    this.tstack[a] = b + "}"
    ...
    if(a != this.tstack.length) {
      ...
      for(var c = "}", b = !0;this.tstack.length > a + 1;) {
        var g = this.tstack.pop(), d = this.tstack.pop();
        b ? b = !1 : c = "," + c;
        isNaN(d) || (d = '"' + d + '"');
        c = d + ":" + g + c
      }
    ...
    if(null === a) {
      ...
      for(var c = "", b = 0;b < a.length;b++) {
        var g = a.charAt(b), c = '"' === g ? c + '\\"' : "\\" === g ? c + "\\\\" : "\b" === g ? c + "\\b" : "\f" === g ? c + "\\f" : "\n" === g ? c + "\\n" : "\r" === g ? c + "\\r" : "\t" === g ? c + "\\t" : c + g
      }
      this.tstack.push('"' + c + '"')
    }
    ...
    var a = {}, c = -1, b = d.Type.STOP, g;
    for(g in this.rstack[this.rstack.length - 1]) {
      if(null !== g) {
        c = parseInt(g, 10);
        this.rpos.push(this.rstack.length);
        g = this.rstack[this.rstack.length - 1][c];
    ...
    if(-1 != c) {
      for(var k in this.rstack[this.rstack.length - 1]) {
        null !== d.Protocol.RType[k] && (b = d.Protocol.RType[k], this.rstack[this.rstack.length - 1] = this.rstack[this.rstack.length - 1][k])
      }
    }
    a.fname = "";
    a.ftype = b;
    ...
    var b = this.rstack[this.rstack.length - 1], g = {};
    g.etype = d.Protocol.RType[b.shift()];
    g.size = b.shift();
    this.rpos.push(this.rstack.length);
    this.rstack.push(b);
    return g
  ...
  d.TJSONProtocol.prototype = {reset:function() {
    ...
    var b = d.TJSONProtocol.getValueFromScope(this.elementStack[0]), g = {etype:d.Protocol.RType[b.shift()], size:b.shift()};
  ...
  var V = {encode:function(a, c, b) {
    for(var g = b, d = 0;d < a.length;d++) {
      var e = a.charCodeAt(d);
      128 > e ? c.setInt8(g++, e) : (127 < e && 2048 > e ? c.setInt8(g++, e >> 6 | 192) : (c.setInt8(g++, e >> 12 | 224), c.setInt8(g++, e >> 6 & 63 | 128)), c.setInt8(g++, e & 63 | 128))
    }
    return g - b
    ...
    b += c;
    for(c = c1 = c2 = 0;d < b;) {
      c = a.getInt8(d++), 128 > c ? g += String.fromCharCode(c) : 191 < c && 224 > c ? (c2 = a.getInt8(d++), g += String.fromCharCode((c & 31) << 6 | c2 & 63)) : (c2 = a.getInt8(d++), c3 = a.getInt8(d++), g += String.fromCharCode((c & 15) << 12 | (c2 & 63) << 6 | c3 & 63))
    }
    return g
  }}, r = function(a) {
    this.offset = 0;
  ...
  r.prototype = {getArray:function() {
    ...
    a = a || 0;
    c = c || this.length;
    var b = new r, g = b.length = c - a, d = b.offset = this.offset + a, e = b.buf = this.buf;
    b.view = new DataView(e, d, g);
    return b
  }, getInt8:function(a) {
  ...
  n = d.CheckedBuffer = function(a) {
    r.call(this, a)
  };
  I(n, r, {grow:function(a) {
  ...
  var x = d.Type, W = function(a, c) {
    Error.call(this, c);
    this.name = "TProtocolException";
    this.type = a
  };
  I(W, Error);
  n = d.TBinaryProtocol = function(a, c, b) {
    this.trans = a;
  ...
  n.prototype.writeMessageBegin = function(a, c, b) {
    this.strictWrite ? (this.writeI32(-2147418112 | c), this.writeString(a)) : (this.writeString(a), this.writeByte(c));
    this.writeI32(b)
  };
  n.prototype.writeMessageEnd = function() {
  };
  n.prototype.writeStructBegin = function(a) {
  };
  n.prototype.writeStructEnd = function() {
  };
  n.prototype.writeFieldBegin = function(a, c, b) {
    this.writeByte(c);
    this.writeI16(b)
  };
  n.prototype.writeFieldEnd = function() {
  };
  n.prototype.writeFieldStop = function() {
    this.writeByte(x.STOP)
  };
  n.prototype.writeMapBegin = function(a, c, b) {
    this.writeByte(a);
    this.writeByte(c);
    this.writeI32(b)
  };
  n.prototype.writeMapEnd = function() {
  };
  n.prototype.writeListBegin = function(a, c) {
    this.writeByte(a);
    this.writeI32(c)
  };
  n.prototype.writeListEnd = function() {
  };
  n.prototype.writeSetBegin = function(a, c) {
    this.writeByte(a);
    this.writeI32(c)
  };
  n.prototype.writeSetEnd = function() {
  };
  n.prototype.writeBool = function(a) {
    this.writeByte(a ? 1 : 0)
  };
  n.prototype.writeByte = function(a) {
    this.trans.writeByte(a)
  };
  n.prototype.writeI16 = function(a) {
    this.trans.writeI16(a)
  };
  n.prototype.writeI32 = function(a) {
    this.trans.writeI32(a)
  };
  n.prototype.writeI64 = function(a) {
    a.buffer ? this.trans.writeI64(a) : this.trans.writeI64(new H(a))
  };
  n.prototype.writeDouble = function(a) {
    this.trans.writeDouble(a)
  };
  n.prototype.writeString = function(a) {
    this.trans.writeWithLength(a)
  };
  n.prototype.writeBinary = function(a) {
    this.trans.writeWithLength(a)
  };
  n.prototype.readMessageBegin = function() {
  ...
  n.prototype.readMessageEnd = function() {
  };
  n.prototype.readStructBegin = function() {
    return{fname:""}
  };
  n.prototype.readStructEnd = function() {
  };
  n.prototype.readFieldBegin = function() {
    var a = this.readByte();
    if(a == x.STOP) {
  ...
  n.prototype.readFieldEnd = function() {
  };
  n.prototype.readMapBegin = function() {
    var a = this.readByte(), c = this.readByte(), b = this.readI32();
    return{ktype:a, vtype:c, size:b}
  };
  n.prototype.readMapEnd = function() {
  };
  n.prototype.readListBegin = function() {
    var a = this.readByte(), c = this.readI32();
    return{etype:a, size:c}
  };
  n.prototype.readListEnd = function() {
  };
  n.prototype.readSetBegin = function() {
    var a = this.readByte(), c = this.readI32();
    return{etype:a, size:c}
  };
  n.prototype.readSetEnd = function() {
  };
  n.prototype.readBool = function() {
  ...
  n.prototype.readBinary = function() {
    var a = this.readI32();
  ...
  var fa = new r(0), J = d.TTransport = function(a, c) {
    this.buf = a || fa;
    this.onFlush = c;
    this.reset()
  };
  J.receiver = function(a) {
    return function(c) {
      a(new J(c))
    }
  };
  J.prototype = {commitPosition:function() {
  ...
  X.receiver = function(a) {
    var c = 0, b = 0, g = null, d = null;
    return function(e) {
      if(d) {
        var h = new r(e.length + d.length);
        d.copy(h, 0, 0);
        e.copy(h, d.length, 0);
        d = null
      }
      for(;e.length;) {
        ...
        e.length >= c ? (e.copy(g, b, 0, c), e = e.slice(c, e.length), c = 0, a(new X(g))) : e.length && (e.copy(g, b, 0, e.length), c -= e.length, b += e.length, e = e.slice(e.length, e.length))
      }
    }
  };
  I(X, J, {flush:function() {
    var a = this;
    J.prototype.flush.call(this, function(c) {
      if(a.onFlush) {
      ...
      switch(c.fid) {
        ...
        case 13:
          if(b == d.Type.LIST) {
            ...
            c = a.readListBegin().size;
            for(b = 0;b < c;++b) {
              g = void 0, g = new C, g.read(a), this.presence.push(g)
            }
            a.readListEnd()
          }else {
            a.skip(b)
      ...
      switch(c.fid) {
        case 1:
          if(b == d.Type.LIST) {
            ...
            c = a.readListBegin().size;
            for(b = 0;b < c;++b) {
              var g = void 0, g = new TProtocolMessage;
              g.read(a);
              this.items.push(g)
            }
            a.readListEnd()
  ...
  var A = {TAction:TAction, TFlags:TFlags, TType:TType, TData:G, TPresence:C, TMessage:D, TChannelMessage:void 0, TMessageSet:void 0};
  this.Cookie = function() {
    function a() {
    }
    "object" == typeof window && (a.create = function(a, b, g) {
      var d = "";
      g && (d = new Date, d.setTime(d.getTime() + g), d = "; expires\x3d" + d.toGMTString());
      document.cookie = a + "\x3d" + b + d + "; path\x3d/"
    }, a.read = function(a) {
      a += "\x3d";
      for(var b = document.cookie.split(";"), g = 0;g < b.length;g++) {
        for(var d = b[g];" " == d.charAt(0);) {
  ...
  this.Http = function() {
    ...
    a.get = function(b, d, k, e, h) {
      function m(b, c) {
        a.Request(b, e, null, v, c)
      }
      h = h || c;
      var l = "function" == typeof d ? d : function(a) {
        return b.baseUri(a) + d
      }, v = k && "application/json" != k.accept;
      if("string" == typeof l) {
        m(l, h)
      }else {
        var f;
        f = (k = b.connection) && "connected" == k.state ? [k.connectionManager.host] : u.getHosts(b.options);
        1 == f.length ? m(l(f[0]), h) : m(f.shift(), function(a, b, c) {
          if(a) {
            var d = a.code;
    ...
    a.post = function(b, d, k, e, h, m) {
      function l(b, c) {
        a.Request(b, h, e, f, c)
      }
      m = m || c;
      var v = "function" == typeof d ? d : function(a) {
        return b.baseUri(a) + d
      }, f = k && "application/json" != k.accept;
      if("string" == typeof v) {
        tryGet(v, m)
      }else {
        var s;
        s = (k = b.connection) && "connected" == k.state ? [k.connectionManager.host] : u.getHosts(b.options);
        1 == s.length ? l(v(s[0]), m) : l(s.shift(), function(a, b, c) {
          if(a) {
            var d = a.code;
            if("ENETUNREACH" == d || "EHOSTUNREACH" == d || "EHOSTDOWN" == d) {
              l(s, m);
  ...
  this.ThriftUtil = function() {
    ...
    var b = new d.TTransport, g = new d.TBinaryProtocol(b), k = 16384, e = [];
    c.encode = function(a, b) {
      try {
        b(null, c.encodeSync(a))
      }catch(d) {
        var g = "Unexpected exception encoding Thrift; exception \x3d " + d;
        f.logAction(f.LOG_ERROR, "ThriftUtil.encode()", g, d);
        g = Error(g);
        g.statusCode = 400;
        b(g)
      }
    ...
    c.decodeSync = function(a, c) {
      try {
        return b.reset(c), a.read(g), a
      }catch(d) {
        var e = "Unexpected exception decoding thrift message; exception \x3d " + d;
        f.logAction(f.LOG_ERROR, "ThriftUtil.decode()", e, d);
        e = Error(e);
        e.statusCode = 400;
        throw e;
      }
  ...
  var S = function() {
      ...
      if(c) {
        ...
        (function() {
          if(typeof c.GetVariable != y) {
            ...
            d && (d = d.split(" ")[1].split(","), q.pv = [parseInt(d[0], 10), parseInt(d[1], 10), parseInt(d[2], 10)])
          }else {
            if(10 > g) {
              g++;
    ...
    function k() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          var c = N[b].id, d = N[b].callbackFn, g = {success:!1, id:c};
          if(0 < q.pv[0]) {
            var v = B(c);
            if(v) {
              if(n(N[b].swfVersion) && !(q.wk && 312 > q.wk)) {
                P(c, !0), d && (g.success = !0, g.ref = e(c), d(g))
              }else {
                if(N[b].expressInstall && h()) {
                  g = {};
                  g.data = N[b].expressInstall;
                  g.width = v.getAttribute("width") || "0";
                  g.height = v.getAttribute("height") || "0";
                  v.getAttribute("class") && (g.styleclass = v.getAttribute("class"));
                  v.getAttribute("align") && (g.align = v.getAttribute("align"));
                  for(var k = {}, v = v.getElementsByTagName("param"), f = v.length, s = 0;s < f;s++) {
                    "movie" != v[s].getAttribute("name").toLowerCase() && (k[v[s].getAttribute("name")] = v[s].getAttribute("value"))
                  }
                  m(g, k, c, d)
                }else {
                  l(v), d && d(g)
    ...
    function e(a) {
      var b = null;
      if((a = B(a)) && "OBJECT" == a.nodeName) {
        typeof a.SetVariable != y ? b = a : (a = a.getElementsByTagName(r)[0]) && (b = a)
      }
      return b
    }
    function h() {
      return!I && n("6.0.65") && (q.win || q.mac) && !(q.wk && 312 > q.wk)
    }
    function m(a, b, c, d) {
      I = !0;
      J = d || null;
      ...
      var g = B(c);
      if(g) {
        "OBJECT" == g.nodeName ? (D = v(g), H = null) : (D = g, H = c);
        a.id = A;
        ...
        d = q.ie && q.win ? "ActiveX" : "PlugIn";
        d = "MMredirectURL\x3d" + w.location.toString().replace(/&/g, "%26") + "\x26MMplayerType\x3d" + d + "\x26MMdoctitle\x3d" + t.title;
        b.flashvars = typeof b.flashvars != y ? b.flashvars + ("\x26" + d) : d;
        q.ie && (q.win && 4 != g.readyState) && (d = t.createElement("div"), c += "SWFObjectNew", d.setAttribute("id", c), g.parentNode.insertBefore(d, g), g.style.display = "none", function() {
    ...
    function f(a, b, c) {
      ...
      if(g) {
        if(typeof a.id == y && (a.id = c), q.ie && q.win) {
          var e = "", l;
          for(l in a) {
          ...
          l = "";
          for(var h in b) {
            b[h] != Object.prototype[h] && (l += '\x3cparam name\x3d"' + h + '" value\x3d"' + b[h] + '" /\x3e')
          }
          g.outerHTML = '\x3cobject classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + e + "\x3e" + l + "\x3c/object\x3e";
          G[G.length] = a.id;
          d = B(a.id)
        }else {
          h = t.createElement(r);
          h.setAttribute("type", x);
          for(var m in a) {
            a[m] != Object.prototype[m] && ("styleclass" == m.toLowerCase() ? h.setAttribute("class", a[m]) : "classid" != m.toLowerCase() && h.setAttribute(m, a[m]))
          }
          for(e in b) {
            b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = h, l = e, m = b[e], c = t.createElement("param"), c.setAttribute("name", l), c.setAttribute("value", m), a.appendChild(c))
          }
    ...
    function p(a, b, c, d) {
      if(!q.ie || !q.mac) {
        var g = t.getElementsByTagName("head")[0];
        if(g) {
          c = c && "string" == typeof c ? c : "screen";
          d && (M = K = null);
          if(!K || M != c) {
            d = t.createElement("style"), d.setAttribute("type", "text/css"), d.setAttribute("media", c), K = g.appendChild(d), q.ie && (q.win && typeof t.styleSheets != y && 0 < t.styleSheets.length) && (K = t.styleSheets[t.styleSheets.length - 1]), M = c
          }
          q.ie && q.win ? K && typeof K.addRule == r && K.addRule(a, b) : K && typeof t.createTextNode != y && K.appendChild(t.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function P(a, b) {
      if(Q) {
        ...
        O && B(a) ? B(a).style.visibility = c : p("#" + a, "visibility:" + c)
      }
    }
    function u(a) {
      return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != y ? encodeURIComponent(a) : a
    }
    var y = "undefined", r = "object", x = "application/x-shockwave-flash", A = "SWFObjectExprInst", w = window, t = document, z = navigator, F = !1, E = [function() {
      F ? d() : k()
    }], N = [], G = [], C = [], D, H, J, L, O = !1, I = !1, K, M, Q = !0, q = function() {
      var a = typeof t.getElementById != y && typeof t.getElementsByTagName != y && typeof t.createElement != y, b = z.userAgent.toLowerCase(), c = z.platform.toLowerCase(), d = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, g = !+"\v1", e = [0, 0, 0], l = null;
      if(typeof z.plugins != y && typeof z.plugins["Shockwave Flash"] == r) {
        if((l = z.plugins["Shockwave Flash"].description) && !(typeof z.mimeTypes != y && z.mimeTypes[x] && !z.mimeTypes[x].enabledPlugin)) {
          F = !0, g = !1, l = l.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), e[0] = parseInt(l.replace(/^(.*)\..*$/, "$1"), 10), e[1] = parseInt(l.replace(/^.*\.(.*)\s.*$/, "$1"), 10), e[2] = /[a-zA-Z]/.test(l) ? parseInt(l.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        }
      }else {
        if(typeof w.ActiveXObject != y) {
          try {
            var h = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
            if(h && (l = h.GetVariable("$version"))) {
              g = !0, l = l.split(" ")[1].split(","), e = [parseInt(l[0], 10), parseInt(l[1], 10), parseInt(l[2], 10)]
            }
          }catch(m) {
          }
        }
      }
      return{w3:a, pv:e, wk:b, ie:g, win:d, mac:c}
    }();
    (function() {
      q.w3 && ((typeof t.readyState != y && "complete" == t.readyState || typeof t.readyState == y && (t.getElementsByTagName("body")[0] || t.body)) && a(), O || (typeof t.addEventListener != y && t.addEventListener("DOMContentLoaded", a, !1), q.ie && q.win && (t.attachEvent("onreadystatechange", function() {
    ...
    return{registerObject:function(a, b, c, d) {
    ...
    }, embedSWF:function(a, b, d, g, l, e, v, k, s, B) {
      var R = {success:!1, id:b};
      q.w3 && !(q.wk && 312 > q.wk) && a && b && d && g && l ? (P(b, !1), c(function() {
        d += "";
        g += "";
        var c = {};
        if(s && typeof s === r) {
        ...
        if(v && typeof v === r) {
          for(var T in v) {
            q.flashvars = typeof q.flashvars != y ? q.flashvars + ("\x26" + T + "\x3d" + v[T]) : T + "\x3d" + v[T]
          }
        }
        if(n(l)) {
          p = f(c, q, b), c.id == b && P(b, !0), R.success = !0, R.ref = p
        }else {
          if(e && h()) {
            c.data = e;
            m(c, q, b, B);
    ...
    }, hasFlashPlayerVersion:n, createSWF:function(a, b, c) {
      if(q.w3) {
        return f(a, b, c)
      }
      ...
      if(I) {
        var a = B(A);
        a && D && (a.parentNode.replaceChild(D, a), H && (P(H, !0), q.ie && q.win && (D.style.display = "block")), J && J(L));
        I = !1
      }
    }}
  }(), Q = function() {
    ...
    var a = function(c, b, d, k, e) {
      var h = this;
      h.__id = a.__nextId++;
      a.__instances[h.__id] = h;
      h.readyState = a.CONNECTING;
      h.bufferedAmount = 0;
      h.__events = {};
      ...
      h.__createTask = setTimeout(function() {
        a.__addTask(function() {
          h.__createTask = null;
          a.__flash.create(h.__id, c, b, d || null, k || 0, e || null)
        })
      }, 0)
    };
    ...
    a.prototype.off = function(a, b) {
      if(0 == arguments.length) {
        ...
        if(null === a) {
          ...
          if(b) {
            k = -1;
            if(!(d = this.events[a]) || -1 == (k = d.indexOf(b))) {
    ...
    function b(a, c) {
      ...
      this.realtime = a;
      this.options = c;
      this.state = m.initialized;
      this.error = null;
      this.queuedMessages = [];
      this.pendingMessages = [];
      this.msgSerial = 0;
      this.connectionSerial = this.connectionId = void 0;
      this.httpTransports = p.intersect(c.transports || u.httpTransports, b.httpTransports);
      this.transports = p.intersect(c.transports || u.transports, b.transports);
      this.upgradeTransports = p.arrSubtract(this.transports, this.httpTransports);
      ...
      f.logAction(f.LOG_MICRO, "Realtime.ConnectionManager()", "requested transports \x3d [" + (c.transports || u.transports) + "]");
      ...
      f.logAction(f.LOG_MICRO, "Realtime.ConnectionManager()", "http hosts \x3d [" + this.hosts + "]");
      ...
      k && c.recover && window.addEventListener("beforeunload", function() {
        self.persistConnection()
      })
    }
    var d = "undefined" !== typeof Cookie && Cookie.read, k = "undefined" !== typeof Cookie && Cookie.create, e = ("object" == typeof A ? A : require("../nodejs/lib/protocol/clientmessage_types")).TAction, h = function() {
    }, m = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:u.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:u.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
    ...
    b.prototype.chooseTransport = function(b) {
      ...
      if(this.transport) {
        ...
        f.logAction(f.LOG_MINOR, "ConnectionManager.chooseTransport()", "Transport recovery mode \x3d " + c + ("clean" == c ? "" : "; connectionId \x3d " + this.connectionId + "; connectionSerial \x3d " + this.connectionSerial));
        var e = this;
        this.httpTransports.length ? this.chooseHttpTransport(d, function(c, g) {
          if(c) {
            f.logAction(f.LOG_ERROR, "ConnectionManager.chooseTransport()", "Unexpected error establishing transport; err \x3d " + c), b(c)
          }else {
            if(f.logAction(f.LOG_MINOR, "ConnectionManager.chooseTransport()", "Establishing http transport: " + g), b(null, g), e.upgradeTransports.length) {
              g.on("connected", function(b, c) {
                ...
                e.chooseTransportForHost(d, e.upgradeTransports.slice(), h)
              })
            }
          }
        }) : (d.host = this.hosts[0], f.logAction(f.LOG_MINOR, "ConnectionManager.chooseTransport()", "No http transports available; ignoring fallback hosts"), this.chooseTransportForHost(d, e.transports.slice(), b))
      }
    };
    b.prototype.chooseTransportForHost = function(a, c, d) {
      ...
      if(e) {
        var g = this;
        f.logAction(f.LOG_MICRO, "ConnectionManager.chooseTransportForHost()", "trying " + e);
        b.transports[e].tryConnect(this, this.realtime.auth, a, function(b, h) {
          b ? g.chooseTransportForHost(a, c, d) : (f.logAction(f.LOG_MICRO, "ConnectionManager.chooseTransport()", "transport " + e + " connecting"), g.setTransportPending(h), d(null, h))
        })
      }else {
    ...
    b.prototype.chooseHttpTransport = function(a, c) {
      function d() {
        if(e.length) {
          b.httpTransports[h.httpTransports[0]].checkConnectivity(function(b, g) {
            b ? c(b) : g ? (a.host = p.arrRandomElement(e), h.chooseTransportForHost(a, h.httpTransports.slice(), function(a, b) {
              a ? d() : c(null, b)
      ...
      var e = this.hosts.slice(), g = e.shift();
      if(g) {
        a.host = g;
        var h = this;
      ...
      if(this.state == m.closed) {
        ...
        for(var b = this, c = function(c) {
          return function(d, e) {
            ...
            d && d.reason && f.logAction(f.LOG_MICRO, "ConnectionManager.setTransportPending", "reason \x3d  " + d.reason);
            e && f.logAction(f.LOG_MICRO, "ConnectionManager.setTransportPending", "connectionId \x3d  " + e);
            var g;
            "connected" == c ? (b.activateTransport(a, e), g = !0) : g = b.deactivateTransport(a);
            g && b.notifyState({state:c, error:d})
          }
    ...
    b.prototype.persistConnection = function() {
      k && (this.connectionId && k("ably-connection-id", this.connectionId), this.connectionSerial && k("ably-connection-serial", this.connectionSerial))
    };
    ...
    b.prototype.startConnectTimer = function() {
      ...
      this.connectTimer = setTimeout(function() {
        a.connectTimer && (f.logAction(f.LOG_MINOR, "ConnectionManager connect timer expired", "requesting new state: " + m.connecting.failState), a.notifyState({state:m.connecting.failState}))
      }, u.connectTimeout)
    };
    ...
    b.prototype.startSuspendTimer = function() {
      ...
      this.suspendTimer || (this.suspendTimer = setTimeout(function() {
        a.suspendTimer && (f.logAction(f.LOG_MINOR, "ConnectionManager suspend timer expired", "requesting new state: suspended"), m.connecting.failState = "suspended", m.connecting.queueEvents = !1, a.notifyState({state:"suspended"}))
      }, u.suspendedTimeout))
    };
    b.prototype.cancelSuspendTimer = function() {
      m.connecting.failState = "disconnected";
      m.connecting.queueEvents = !0;
    ...
    b.prototype.connectImpl = function() {
      ...
      var a = this, b = this.realtime.auth, c = function(d) {
        f.logAction(f.LOG_ERROR, "ConnectionManager.connectImpl()", d);
        401 == d.statusCode && (-1 != d.message.indexOf("expire") && "token" == b.method) && b.getToken(!0, function(b) {
          b ? c(b) : a.connectImpl()
        });
        a.notifyState({state:m.connecting.failState, error:d})
      }, d = function() {
    ...
    b.prototype.send = function(a, b, d) {
      d = d || h;
      var e = this.state;
      e.sendEvents ? (f.logAction(f.LOG_MICRO, "ConnectionManager.send()", "sending event"), this.sendImpl(new c(a, d))) : e.queueEvents && (b ? this.queue(a, d) : (f.logAction(f.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), d(this.error)))
    };
    ...
    var c = "object" == typeof window, b = c ? A : require("../nodejs/lib/protocol/clientmessage_types"), d = c ? window.WebSocket || window.MozWebSocket : require("ws"), k = c ? !1 : !!r, e = function() {
    };
    p.inherits(a, E);
    ...
    a.tryConnect = function(b, c, d, e) {
      var g = new a(b, c, d), k = function(a) {
        e(a)
      };
      g.on("wserror", k);
      g.on("wsopen", function() {
        f.logAction(f.LOG_MINOR, "WebSocketTransport.tryConnect()", "viable transport " + g);
        g.off("wserror", k);
        e(null, g)
      });
      g.connect()
    ...
    a.prototype.connect = function() {
      ...
      var a = this, b = this.params, c = b.options, d = u.getHost(c, b.host, !0), e = u.getPort(c), g = (c.encrypted ? "wss://" : "ws://") + d + ":" + e + "/";
      f.logAction(f.LOG_MINOR, "WebSocketTransport.connect()", "uri: " + g);
      this.auth.getAuthParams(function(c, d) {
        var e = "", l;
        for(l in d) {
          e += " " + l + ": " + d[l] + ";"
        }
        f.logAction(f.LOG_MINOR, "WebSocketTransport.connect()", "authParams:" + e);
        if(c) {
          a.abort(UIMessages.FAIL_REASON_REFUSED)
        }else {
          e = b.getConnectParams(d);
          try {
            var k = a.wsConnection = a.createWebSocket(g, e);
            k.binaryType = "arraybuffer";
            k.onopen = function() {
              a.onWsOpen()
            };
            k.onclose = function(b, c) {
              a.onWsClose(b, c)
            };
    ...
    a.prototype.onWsClose = function(a, b) {
      ...
      E.prototype.onClose.call(this, c, e)
    };
    ...
    a.prototype.connect = function() {
      ...
      E.prototype.connect.call(this);
      var c = this, b = this.params, d = b.options, b = u.getHost(d, b.host), k = u.getPort(d);
      this.baseUri = (d.encrypted ? "https://" : "http://") + b + ":" + k + "/comet/";
      ...
      this.auth.getAuthParams(function(b, d) {
        if(b) {
          ...
          c.authParams = d;
          var g = c.params.getConnectParams(d);
          f.logAction(f.LOG_MINOR, "CometTransport.connect()", "connectParams:" + a.paramStr(g));
          try {
            c.request(e, g, null, !1, function(a, b) {
    ...
    a.prototype.onConnect = function(a) {
      ...
      E.prototype.onConnect.call(this, a);
      var d = this.baseUri + b;
      f.logAction(f.LOG_MICRO, "CometTransport.onConnect()", "baseUri \x3d " + d + "; connectionId \x3d " + a.connectionId);
      this.sendUri = d + "/send";
      this.recvUri = d + "/recv";
    ...
    a.prototype.sendItems = function(a, b) {
      ...
      try {
        ...
        var e = "Unexpected send exception: " + k;
        f.logAction(f.LOG_ERROR, "CometTransport.sendItems()", e);
        b(Error(e))
      }
    };
  ...
  this.Data = function() {
    ...
    var c = "object" == typeof A ? A : require("../nodejs/lib/protocol/clientmessage_types"), b = c.TData, d = c.TType, f = Crypto.CipherData, e = {"[object Null]":function(a, b) {
      a.type = c.TType.NONE;
      return!0
    ...
    a.fromTData = function(a) {
      ...
      if(a) {
        if(a.cipherData) {
          return new f(a.cipherData, a.type)
        }
        switch(a.type) {
          case 1:
            b = !0;
    ...
    a.toTData = function(a) {
      var b = new c.TData, d = h[typeof a];
      if(d && d(b, a)) {
        return b
      }
  ...
  var M = function() {
    ...
    a.encrypt = function(a, d) {
      var f = new c, e = a.data;
      f.cipherData = d.encrypt(Data.asPlaintext(e));
      f.type = e.type;
      a.data = f
    };
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof A ? A : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, d = a.TMessage = {}, f = a.TPresence = {}, e = a.TProtocolMessage = {}, h = a.TMessageArray = {}, m = a.TMessageBundle = {}, l = c.TType.BUFFER;
    ...
    e.fromJSON = function(a) {
      var b;
      if(b = a.messages) {
        for(var e = b.length, h = a.messages = Array(e), m = 0;m < e;m++) {
          h[m] = d.fromJSON(b[m])
        }
      }
      if(b = a.presence) {
        e = b.length;
        h = a.presence = Array(e);
        for(m = 0;m < e;m++) {
          h[m] = f.fromJSON(b[m])
        }
      }
    ...
    e.decode = function(a, b) {
      var d, g;
      if(b) {
        if(g = ThriftUtil.decodeSync(d = new c.TProtocolMessage, a)) {
          throw g;
        }
      }else {
    ...
    m.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          var g;
          if(d = ThriftUtil.decodeSync(g = new c.TMessageBundle, a)) {
            throw d;
          }
          d = g.items
        }else {
          g = JSON.parse(a);
          for(var h = g.length, d = Array(h), f = 0;f < h;f++) {
            d[f] = e.fromJSON(g[f])
          }
        }
      }
    ...
    h.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          var h;
          if(e = ThriftUtil.decodeSync(h = new c.TMessageArray, a)) {
            throw e;
          }
          e = h.items
        }else {
          h = JSON.parse(a);
          for(var f = h.length, e = Array(f), m = 0;m < f;m++) {
            e[m] = d.fromJSON(h[m])
          }
        }
      }
  ...
  var U = function() {
    ...
    a.get = function(a, b, d, f, e) {
      function h() {
        a.auth.getAuthHeaders(function(m, l) {
          m ? e(m) : Http.get(a, b, p.mixin(l, d), f, function(b, d, g) {
    ...
    a.post = function(a, b, d, f, e, h) {
      function m() {
        a.auth.getAuthHeaders(function(l, v) {
          l ? h(l) : Http.post(a, b, p.mixin(v, f), d, e, function(b, d, e) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? h(a) : m()
            }) : h(b, d, e)
          })
    ...
    a.prototype.get = function(a) {
      var c = this;
      U.get(this.rest, this.path, this.headers, this.params, function(d, e, h) {
        if(d) {
          f.logAction(f.LOG_ERROR, "PaginatedResource.get()", "Unexpected error getting resource: err \x3d " + d)
        }else {
          d = c.current = c.bodyHandler(e);
          var m, l;
          if(h && (m = h.Link || h.link)) {
            l = c.parseRelLinks(m.split(","))
          }
          a(null, d, l)
        }
      })
    ...
    var d = "object" == typeof window, k = d ? null : require("crypto"), e = void 0;
    ...
    b.prototype.requestToken = function(b, d) {
      ...
      b = b || {};
      d = d || a;
      b = p.mixin(p.copy(this.tokenOptions), b);
      var e, g = this.rest;
      if(b.authCallback) {
        ...
        if(b.authUrl) {
          f.logAction(f.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), e = function(a, c) {
            Http.get(g, b.authUrl, b.authHeaders || {}, p.mixin(a, b.authParams), c)
          }
        }else {
          if(b.keyValue) {
            var k = this;
            ...
            e = function(a, c) {
              k.createTokenRequest(p.mixin(p.copy(b), a), c)
            }
          }else {
      ...
      var s = {}, n = b.clientId || this.rest.clientId;
      n && (s.client_id = n);
      n = b.ttl || "";
      "ttl" in b && (s.ttl = n);
      "capability" in b && (s.capability = c(b.capability));
      var g = this.rest, u = function(a) {
        return g.baseUri(a) + "/keys/" + b.keyId + "/requestToken"
      }, r = function(a, b) {
        Http.post ? Http.post(g, u, p.defaultPostHeaders(), a, null, b) : Http.get(g, u, p.defaultGetHeaders(), a, b)
      };
      e(s, function(a, b) {
        a ? (f.logAction(f.LOG_ERROR, "Auth.requestToken()", "token request signing call returned error; err \x3d " + a), d(a)) : r(b, function(a, b) {
    ...
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        var g = {id:c}, k = a.clientId || "";
        k && (g.client_id = a.clientId);
        var n = a.ttl || "";
        n && (g.ttl = n);
        var p = a.capability || "";
        p && (g.capability = p);
        var u = this.rest, r = this;
        (function(c) {
          a.timestamp ? c() : a.queryTime ? u.time(function(d, e) {
            d ? b(d) : (a.timestamp = Math.floor(e / 1E3), c())
          }) : (a.timestamp = r.getTimestamp(), c())
        })(function() {
          var c = g.nonce = a.nonce || ("000000" + Math.floor(1E16 * Math.random())).slice(-16), l = g.timestamp = a.timestamp, c = g.id + "\n" + n + "\n" + p + "\n" + k + "\n" + l + "\n" + c + "\n";
          g.mac = a.mac || e(c, d);
    ...
    a.prototype.stats = function(a, c) {
      ...
      var f = p.copy(p.defaultGetHeaders());
      this.options.headers && p.mixin(f, this.options.headers);
      (new ga(this, "/stats", f, a, d)).get(c)
    };
    a.prototype.time = function(a, c) {
      void 0 === c && ("function" == typeof a ? (c = a, a = null) : c = b);
      var d = p.copy(p.defaultGetHeaders());
      this.options.headers && p.mixin(d, this.options.headers);
      var g = this;
    ...
    c.prototype.setOptions = function(a, c) {
      a && a.encrypted ? this.cipher = Crypto.getCipher(a, c) : c(null, this.cipher = null)
    };
    c.prototype.presence = function(b, c) {
      ...
      var d = this.rest, e = !d.options.useTextProtocol, h = p.copy(p.defaultGetHeaders(e));
      d.options.headers && p.mixin(h, d.options.headers);
      U.get(d, "/channels/" + this.name + "/presence", h, b, function(a, b) {
    ...
    c.prototype.history = function(b, c) {
      ...
      void 0 === c && ("function" == typeof b ? (c = b, b = null) : c = a);
      var d = this.rest, e = !d.options.useTextProtocol, h = p.copy(p.defaultGetHeaders(e)), m = this.cipher;
      d.options.headers && p.mixin(h, d.options.headers);
      U.get(d, "/channels/" + this.name + "/history", h, b, function(a, b) {
        if(a) {
          c(a)
        }else {
          try {
    ...
    c.prototype.publish = function(b, c, d) {
      ...
      d = d || a;
      var e = this.rest, h = !e.options.useTextProtocol;
      b = {name:b, data:c};
      (c = this.cipher) && M.encrypt(b, c);
      b = Serialize.TMessageArray.encode([b], h);
      h = p.copy(p.defaultPostHeaders(h));
      e.options.headers && p.mixin(h, e.options.headers);
      U.post(e, "/channels/" + this.name + "/publish", b, h, null, d)
    };
    return c
  }(), ba = function() {
    function a(a, b, c) {
      ...
      this.options = p.prototypicalClone(k, c);
    ...
    a.prototype.setOptions = function(a, b) {
      ...
      if(a && a.encrypted) {
        var c = this;
        Crypto.getCipher(a, function(a, d) {
          c.cipher = d;
          b(null)
        })
      }else {
    ...
    a.prototype.publish = function(a, b, m) {
      f.logAction(f.LOG_MICRO, "RealtimeChannel.publish()", "name \x3d " + a);
      m = m || d;
      var l = this.connectionManager;
      if(z.activeState(l.state)) {
        var l = new c.TMessage, k = this.cipher;
        l.name = a;
        l.data = Data.toTData(b);
        k && M.encrypt(l, k);
        switch(this.state) {
          case "attached":
            f.logAction(f.LOG_MICRO, "RealtimeChannel.publish()", "sending message");
            a = new c.TProtocolMessage;
            a.action = c.TAction.MESSAGE;
            a.channel = this.name;
            a.messages = [l];
            this.sendMessage(a, m);
            break;
          default:
            this.attach();
          case "attaching":
            f.logAction(f.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:l, listener:m})
        }
      }else {
        m(l.getStateError())
      }
    ...
    a.prototype.onMessage = function(a) {
      switch(a.action) {
        ...
        case b.MESSAGE:
          if(a = a.messages) {
            for(var c = Array(a.length), d = this.cipher, g = 0;g < c.length;g++) {
              var k = a[g];
              if(d) {
                try {
                  M.decrypt(k, d)
                }catch(n) {
                  var p = "Unexpected error decrypting message; err \x3d " + n;
                  f.logAction(f.LOG_ERROR, "RealtimeChannel.onMessage()", p);
                  this.emit("error", Error(p))
                }
              }
              c[g] = new M(k.channelSerial, k.timestamp, k.name, Data.fromTData(k.data))
            }
            this.onEvent(c)
          }
          break;
        default:
          f.logAction(f.LOG_ERROR, "RealtimeChannel.onMessage()", "Fatal protocol error: unrecognised action (" + a.action + ")"), this.connectionManager.abort(F.unknownChannelErr)
      }
    };
    a.mergeTo = function(a, c) {
      var d = !1, g;
      if(a.channel == c.channel && (g = a.action) == c.action) {
        switch(g) {
          case b.MESSAGE:
        ...
        try {
          if(this.pendingEvents.length) {
            ...
            for(a = 0;a < this.pendingEvents.length;a++) {
              var g = this.pendingEvents[a];
              b.messages.push(g.message);
              d.push(g.callback)
            }
          ...
          f.logAction(f.LOG_ERROR, "RealtimeChannel.setAttached()", "Unexpected exception sending pending messages: " + k.stack)
        }
      }
    };
    ...
    var b = "object" == typeof A ? A : require("../nodejs/lib/protocol/clientmessage_types"), d = b.TPresenceState, k = ["enter", "leave", "update"];
    p.inherits(c, w);
    ...
    c.prototype.enterClient = function(a, c, k) {
      ...
      switch(c.state) {
        ...
        case "initialized":
          c.attach();
        case "attaching":
          this.pendingPresence = {presence:a, callback:k};
          break;
        default:
          a = Error("Unable to enter presence channel (incompatible state)"), a.code = 90001, k(a)
      }
    };
    ...
    c.prototype.leaveClient = function(a, c) {
      ...
      var k = new b.TPresence({state:d.LEAVE, clientId:a}), l = this.channel;
      switch(l.state) {
        case "attached":
          l.sendPresence(k, c);
          break;
        case "attaching":
          this.pendingPresence = {presence:k, callback:c};
          break;
        case "initialized":
          this.pendingPresence = null;
          k = Error("Unable to enter presence channel (incompatible state)");
          k.code = 90001;
          c(k);
          break;
        default:
    ...
    c.prototype.get = function(a) {
      return a ? this.members[a] : p.valuesArray(this.members, !0)
    };
    c.prototype.setPresence = function(b, c) {
      f.logAction(f.LOG_MICRO, "Presence.setPresence()", "received presence for " + b.length + " participants");
      for(var m = 0;m < b.length;m++) {
        var l = b[m], n = a.call(l.clientId, l.memberId), p = new da(l.clientId, Data.fromTData(l.clientData), l.memberId);
        switch(l.state) {
          case d.LEAVE:
            delete this.members[n];
            break;
          case d.UPDATE:
            l.inheritMemberId && delete this.members[a.call(l.clientId, l.inheritMemberId)];
          case d.ENTER:
            clientData = this.members[n] = p
        }
        c && this.emit(k[l.state], p)
      }
    };
  ...
  (function() {
    ...
    a.checkConnectivity = function(b) {
      k ? k.push(b) : (k = [b], (new a.Request("isTheInternetUp")).send("http://live.cdn.ably-realtime.com/is-the-internet-up.js", null, null, !1, !1, function(a, b) {
        for(var c = !a && b, d = 0;d < k.length;d++) {
          k[d](null, c)
        }
        k = null
      }))
    ...
    a.tryConnect = function(b, c, d, g) {
      ...
      k.on("preconnect", function() {
        f.logAction(f.LOG_MINOR, "JSONPTransport.tryConnect()", "viable transport " + k);
        k.off("error", n);
        g(null, k)
      });
      k.connect()
    ...
    a.prototype.request = function(b, c, d, g, f) {
      return(new a.Request).send(b, c, d, g, !1, f)
    };
    a.Request = function(a) {
      this.requestId = a || d++
    };
    a.Request.prototype.send = function(a, c, d, g, f, k) {
      this.callback = k;
      var n = this.requestId, p = this.timer = setTimeout(g ? u.cometRecvTimeout : u.cometSendTimeout, function() {
        x.abort()
      });
      c = c || {};
      c.callback = "Ably._(" + n + ")";
      ...
      r.src = L.paramStr(c, a);
      var w = this._finish = function() {
        clearTimeout(p);
    ...
    Http.Request = function(b, c, d, g, f) {
      (new a.Request).send(b, c, d, !1, g, f)
    };
    return a
  })();
  (function() {
    ...
    a.tryConnect = function(b, c, d, e) {
      ...
      h.on("preconnect", function() {
        f.logAction(f.LOG_MINOR, "XHRTransport.tryConnect()", "viable transport " + h);
        h.off("error", m);
        e(null, h)
      });
      h.connect()
    };
    a.prototype.request = function(b, c, d, e, f) {
      (new a.Request).send(b, c, d, e, this.binary, f)
    };
    a.prototype.toString = function() {
    ...
    a.Request.prototype.send = function(a, d, f, e, h, m) {
      a = L.paramStr(d, a);
      var l, n, p;
      f ? (d = "POST", l = 201) : (d = "GET", l = 200);
      var s = this.xhr = c();
      ...
      s.open(d, a, !0);
      s.setRequestHeader("Accept", h ? "application/x-thrift" : "application/json");
      s.onerror = function(a) {
        a.code = 8E4;
        m(a)
      };
      s.onabort = function() {
        n = Error(p ? "Request timed out" : "Request cancelled");
        n.statusCode = 404;
        n.code = 8E4;
        m(n)
      };
      s.onreadystatechange = function() {
        if(4 == s.readyState) {
          if(clearTimeout(w), n) {
            ...
            if(s.status == l) {
              var a = null;
              h ? s.response && (a = new r, a.buf = s.response, a.view = new DataView(a.buf)) : a = s.responseText;
              m(null, a)
            }else {
    ...
    a.isAvailable() && (z.httpTransports.xhr = z.transports.xhr = a, Http.Request = function(b, c, d, e, f) {
      (new a.Request).send(b, c, d, !1, e, f)
    });
    return a
  })();
  (function() {
    ...
    a.tryConnect = function(b, c, d, e) {
      var h = u.flashTransport.swfLocation, m = u.flashTransport.policyPort;
      b.options.flashTransport && (b.options.flashTransport.swfLocation && (h = b.options.flashTransport.swfLocation), b.options.flashTransport.policyPort && (h = b.options.flashTransport.swfLocation));
      Q.__initialize(h);
      ...
      l.on("wsopen", function() {
        f.logAction(f.LOG_MINOR, "FlashTransport.tryConnect()", "viable transport " + l);
