(function() {
  ...
  G.prototype = {_2scomp:function() {
    ...
    for(var c = this.buffer, b = this.offset, g = c[0] & 128, e = 0, f = 1, d = 7, l = 1;0 <= d;d--, l *= 256) {
      var n = c[b + d];
      g && (n = (n ^ 255) + f, f = n >> 8, n &= 255);
      e += n * l
    }
  ...
  x.prototype = {getArray:function() {
    this.array || (this.array = new Uint8Array(this.buf, this.offset, this.length));
    return this.array
  }, slice:function(a, c) {
    a = a || 0;
    c = c || this.length;
    var b = new x, g = b.length = c - a, e = b.offset = this.offset + a, f = b.buf = this.buf;
  ...
  var ga = new x(0), I = d.TTransport = function(a, c) {
    this.buf = a || ga;
    this.onFlush = c;
    this.reset()
  };
  ...
  L(X, I, {flush:function() {
    var a = this;
    I.prototype.flush.call(this, function(c) {
      if(a.onFlush) {
        var b = new x(c.length + 4);
  ...
  this.Http = function() {
    ...
    a.get = function(b, g, e, f, d) {
      function l(b, c) {
        a.Request(b, f, null, m, c)
      }
      d = d || c;
      var n = "function" == typeof g ? g : function(a) {
        return b.baseUri(a) + g
      }, m = e && "application/json" != e.accept;
      if("string" == typeof n) {
        l(n, d)
      }else {
        var N;
        N = (e = b.connection) && "connected" == e.state ? [e.connectionManager.host] : t.getHosts(b.options);
        1 == N.length ? l(n(N[0]), d) : l(N.shift(), function(a, b, c) {
          if(a) {
            var f = a.code;
    ...
    a.post = function(b, g, e, f, d, l) {
      function n(b, c) {
        a.Request(b, d, f, N, c)
      }
      l = l || c;
      var m = "function" == typeof g ? g : function(a) {
        return b.baseUri(a) + g
      }, N = e && "application/json" != e.accept;
      if("string" == typeof m) {
        tryGet(m, l)
      }else {
        var h;
        h = (e = b.connection) && "connected" == e.state ? [e.connectionManager.host] : t.getHosts(b.options);
        1 == h.length ? n(m(h[0]), l) : n(h.shift(), function(a, b, c) {
          if(a) {
            var f = a.code;
            if("ENETUNREACH" == f || "EHOSTUNREACH" == f || "EHOSTDOWN" == f) {
              n(h, l);
  ...
  this.Base64 = function() {
    ...
    var g = {codex:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode:function(b) {
      ...
      for(b = new c(b);b.moveNext();) {
        ...
        var n = b.current;
        b.moveNext();
        var m = b.current, h = l >> 2, l = (l & 3) << 4 | n >> 4, C = (n & 15) << 2 | m >> 6, y = m & 63;
        isNaN(n) ? C = y = 64 : isNaN(m) && (y = 64);
        f.append(d.charAt(h) + d.charAt(l) + d.charAt(C) + d.charAt(y))
      }
      return f.toString()
    }, decode:function(c) {
      var f = new a;
    ...
    b.prototype = {current:64, moveNext:function() {
      ...
      var a = g.codex.indexOf(this._input.charAt(++this._index)), b = g.codex.indexOf(this._input.charAt(++this._index)), c = g.codex.indexOf(this._input.charAt(++this._index)), d = g.codex.indexOf(this._input.charAt(++this._index)), n = (c & 3) << 6 | d;
      this.current = a << 2 | b >> 4;
      64 != c && this._buffer.push((b & 15) << 4 | c >> 2);
      64 != d && this._buffer.push(n);
      return!0
    }};
    return g
  }();
  Ably.Crypto = window.CryptoJS && function() {
    ...
    b.prototype.encrypt = function(a) {
      ...
      a = this.encryptCipher.process(a.concat(n[c - b]));
      return f.concat(a)
    };
  ...
  var T = function() {
    ...
    function b(a) {
      if(typeof v.addEventListener != w) {
        v.addEventListener("load", a, !1)
      }else {
        if(typeof s.addEventListener != w) {
          s.addEventListener("load", a, !1)
        }else {
          if(typeof v.attachEvent != w) {
            Q(v, "onload", a)
          }else {
          ...
          if(0 < q.pv[0]) {
            ...
            if(m) {
              if(k(B[b].swfVersion) && !(q.wk && 312 > q.wk)) {
                S(c, !0), e && (g.success = !0, g.ref = f(c), e(g))
              }else {
                if(B[b].expressInstall && d()) {
                  g = {};
                  g.data = B[b].expressInstall;
                  g.width = m.getAttribute("width") || "0";
                  g.height = m.getAttribute("height") || "0";
                  m.getAttribute("class") && (g.styleclass = m.getAttribute("class"));
                  m.getAttribute("align") && (g.align = m.getAttribute("align"));
                  for(var h = {}, m = m.getElementsByTagName("param"), N = m.length, C = 0;C < N;C++) {
                    "movie" != m[C].getAttribute("name").toLowerCase() && (h[m[C].getAttribute("name")] = m[C].getAttribute("value"))
                  }
                  l(g, h, c, e)
                }else {
                  n(m), e && e(g)
            ...
            if(S(c, !0), e) {
              if((c = f(c)) && typeof c.SetVariable != w) {
                g.success = !0, g.ref = c
              }
              e(g)
            }
    ...
    function f(a) {
      ...
      if((a = y(a)) && "OBJECT" == a.nodeName) {
        typeof a.SetVariable != w ? b = a : (a = a.getElementsByTagName(r)[0]) && (b = a)
      }
      return b
    }
    function d() {
    ...
    function l(a, b, c, f) {
      ...
      var g = y(c);
      if(g) {
        "OBJECT" == g.nodeName ? (G = m(g), I = null) : (G = g, I = c);
        a.id = A;
        if(typeof a.width == w || !/%$/.test(a.width) && 310 > parseInt(a.width, 10)) {
          a.width = "310"
        }
        if(typeof a.height == w || !/%$/.test(a.height) && 137 > parseInt(a.height, 10)) {
          a.height = "137"
        }
        ...
        b.flashvars = typeof b.flashvars != w ? b.flashvars + ("\x26" + f) : f;
    ...
    function h(a, b, c) {
      ...
      if(g) {
        if(typeof a.id == w && (a.id = c), q.ie && q.win) {
          var e = "", d;
          for(d in a) {
          ...
          d = "";
          for(var n in b) {
            b[n] != Object.prototype[n] && (d += '\x3cparam name\x3d"' + n + '" value\x3d"' + b[n] + '" /\x3e')
          }
          ...
          n = s.createElement(r);
          n.setAttribute("type", x);
          for(var m in a) {
            a[m] != Object.prototype[m] && ("styleclass" == m.toLowerCase() ? n.setAttribute("class", a[m]) : "classid" != m.toLowerCase() && n.setAttribute(m, a[m]))
          }
          for(e in b) {
            b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = n, d = e, m = b[e], c = s.createElement("param"), c.setAttribute("name", d), c.setAttribute("value", m), a.appendChild(c))
          }
    ...
    function p(a, b, c, f) {
      if(!q.ie || !q.mac) {
        ...
        if(g) {
          ...
          f && (L = O = null);
          if(!O || L != c) {
            f = s.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), O = g.appendChild(f), q.ie && (q.win && typeof s.styleSheets != w && 0 < s.styleSheets.length) && (O = s.styleSheets[s.styleSheets.length - 1]), L = c
          }
          q.ie && q.win ? O && typeof O.addRule == r && O.addRule(a, b) : O && typeof s.createTextNode != w && O.appendChild(s.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function S(a, b) {
      if(P) {
        ...
        R && y(a) ? y(a).style.visibility = c : p("#" + a, "visibility:" + c)
      }
    }
    function t(a) {
      return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != w ? encodeURIComponent(a) : a
    }
    var w = "undefined", r = "object", x = "application/x-shockwave-flash", A = "SWFObjectExprInst", v = window, s = document, z = navigator, F = !1, E = [function() {
      F ? g() : e()
    }], B = [], H = [], D = [], G, I, K, M, R = !1, J = !1, O, L, P = !0, q = function() {
      var a = typeof s.getElementById != w && typeof s.getElementsByTagName != w && typeof s.createElement != w, b = z.userAgent.toLowerCase(), c = z.platform.toLowerCase(), f = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, g = !+"\v1", e = [0, 0, 0], d = null;
      if(typeof z.plugins != w && typeof z.plugins["Shockwave Flash"] == r) {
        if((d = z.plugins["Shockwave Flash"].description) && !(typeof z.mimeTypes != w && z.mimeTypes[x] && !z.mimeTypes[x].enabledPlugin)) {
        ...
        if(typeof v.ActiveXObject != w) {
          try {
            var n = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
            if(n && (d = n.GetVariable("$version"))) {
    ...
    (function() {
      q.w3 && ((typeof s.readyState != w && "complete" == s.readyState || typeof s.readyState == w && (s.getElementsByTagName("body")[0] || s.body)) && a(), R || (typeof s.addEventListener != w && s.addEventListener("DOMContentLoaded", a, !1), q.ie && q.win && (s.attachEvent("onreadystatechange", function() {
    ...
    return{registerObject:function(a, b, c, f) {
    ...
    }, embedSWF:function(a, b, f, g, e, n, m, C, y, Q) {
      var p = {success:!1, id:b};
      q.w3 && !(q.wk && 312 > q.wk) && a && b && f && g && e ? (S(b, !1), c(function() {
        f += "";
        g += "";
        var c = {};
        if(y && typeof y === r) {
        ...
        if(m && typeof m === r) {
          for(var t in m) {
            q.flashvars = typeof q.flashvars != w ? q.flashvars + ("\x26" + t + "\x3d" + m[t]) : t + "\x3d" + m[t]
          }
        }
        if(k(e)) {
          s = h(c, q, b), c.id == b && S(b, !0), p.success = !0, p.ref = s
        }else {
          if(n && d()) {
            c.data = n;
            l(c, q, b, Q);
      ...
      if(J) {
        var a = y(A);
        a && G && (a.parentNode.replaceChild(G, a), I && (S(I, !0), q.ie && q.win && (G.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), Y = function() {
    ...
    function b(a, c) {
      ...
      this.httpTransports = p.intersect(c.transports || t.httpTransports, b.httpTransports);
      this.transports = p.intersect(c.transports || t.transports, b.transports);
    ...
    }, l = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:t.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:t.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
      ...
      function f() {
        if(e.length) {
          b.httpTransports[g.httpTransports[0]].checkConnectivity(function(b, d) {
            b ? c(b) : d ? (a.host = p.arrRandomElement(e), g.chooseTransportForHost(a, g.httpTransports.slice(), function(a, b) {
              a ? f() : c(null, b)
    ...
    b.prototype.queue = function(a, b) {
      ...
      f && ca.mergeTo(f.msg, a) ? (f.merged || (f.callback = new Z([f.callback]), f.merged = !0), f.callback.push(b)) : this.queuedMessages.push(new c(a, b))
    };
    ...
    var c = "object" == typeof window, b = c ? r : require("../nodejs/lib/protocol/clientmessage_types"), d = c ? window.WebSocket || window.MozWebSocket : require("ws"), e = c ? !1 : !!x, f = function() {
    };
    p.inherits(a, B);
    ...
    a.prototype.connect = function() {
      ...
      this.auth.getAuthParams(function(c, e) {
        ...
        if(c) {
          ...
          try {
            var n = a.wsConnection = a.createWebSocket(f, d);
  ...
  this.Data = function() {
    ...
    var c = "object" == typeof r ? r : require("../nodejs/lib/protocol/clientmessage_types"), b = {"[object Null]":function(a, b) {
      ...
      "undefined" !== typeof x && x.isBuffer(b) ? (a.type = c.TType.BUFFER, a.binaryData = b) : (a.type = c.TType.JSONOBJECT, a.stringData = JSON.stringify(b));
      return!0
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof r ? r : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, d = a.TMessage = {}, e = a.TPresence = {}, f = a.TProtocolMessage = {}, h = a.TMessageArray = {}, l = a.TMessageBundle = {}, n = c.TType.BUFFER;
    ...
    c.TMessage.prototype.toJSON = function() {
      ...
      (c = Data.isCipherData(a)) ? (b.encoding = "cipher+base64", c = Crypto.Data.asBase64(c), b.type = a.type) : (c = Data.fromTData(a), a.type == n && (b.encoding = "base64", c = c.toString("base64")));
      b.data = c;
      return b
    };
    c.TPresence.prototype.toJSON = function() {
      ...
      a.type == n && (b.encoding = "base64", c = c.toString("base64"));
      b.clientData = c;
      return b
    };
    ...
    h.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          ...
          e = JSON.parse(a);
          for(var h = e.length, f = Array(h), l = 0;l < h;l++) {
            f[l] = d.fromJSON(e[l])
          }
        }
      }
  ...
  var U = function() {
    ...
    a.get = function(a, b, d, e, f) {
      function h() {
        a.auth.getAuthHeaders(function(l, n) {
          l ? f(l) : Http.get(a, b, p.mixin(n, d), e, function(b, d, e) {
    ...
    a.post = function(a, b, d, e, f, h) {
      function l() {
        a.auth.getAuthHeaders(function(n, m) {
          n ? h(n) : Http.post(a, b, p.mixin(m, e), d, f, function(b, f, d) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? h(a) : l()
            }) : h(b, f, d)
          })
    ...
    a.prototype.getRel = function(c) {
      ...
      var d = this;
      return function(c) {
        (new a(d.rest, d.basePath + b[1], d.headers, p.parseQueryString(b[2]), d.bodyHandler)).get(c)
      }
    };
    return a
  }(), ia = function() {
    ...
    d ? (u = Base64.encode, window.CryptoJS && (CryptoJS.HmacSHA256 && CryptoJS.enc.Base64) && (f = function(a, b) {
      ...
      return(new x(a, "ascii")).toString("base64")
    }, f = function(a, b) {
    ...
    b.prototype.requestToken = function(b, f) {
      ...
      if(b.authCallback) {
        ...
        if(b.authUrl) {
          h.logAction(h.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), d = function(a, c) {
            Http.get(e, b.authUrl, b.authHeaders || {}, p.mixin(a, b.authParams), c)
          }
        }else {
          if(b.keyValue) {
            var g = this;
            ...
            d = function(a, c) {
              g.createTokenRequest(p.mixin(p.copy(b), a), c)
            }
          }else {
      ...
      var e = this.rest, t = function(a) {
        ...
        Http.post ? Http.post(e, t, p.defaultPostHeaders(), a, null, b) : Http.get(e, t, p.defaultGetHeaders(), a, b)
      };
      d(u, function(a, b) {
    ...
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        var k = a.capability || "";
        k && (e.capability = k);
        var p = this.rest, t = this;
        (function(c) {
          a.timestamp ? c() : a.queryTime ? p.time(function(f, d) {
    ...
    a.prototype.stats = function(a, c) {
      ...
      var h = p.copy(p.defaultGetHeaders());
      this.options.headers && p.mixin(h, this.options.headers);
    ...
    c.prototype.setOptions = function(b, c) {
      ...
      if(b && b.encrypted) {
        var d = this;
        Crypto.getCipher(b, function(a, b) {
          d.cipher = b;
          c(null)
        })
      }else {
    ...
    c.prototype.presence = function(b, c) {
      ...
      var d = this.rest, f = !d.options.useTextProtocol, u = p.copy(p.defaultGetHeaders(f));
      d.options.headers && p.mixin(u, d.options.headers);
    ...
    c.prototype.history = function(b, c) {
      ...
      void 0 === c && ("function" == typeof b ? (c = b, b = null) : c = a);
      var d = this.rest, f = !d.options.useTextProtocol, u = p.copy(p.defaultGetHeaders(f)), l = this.cipher;
      d.options.headers && p.mixin(u, d.options.headers);
      U.get(d, "/channels/" + this.name + "/history", u, b, function(a, b) {
        if(a) {
          ...
          try {
            for(var d = Serialize.TMessageArray.decode(b, f), e = 0;e < d.length;e++) {
              l && P.decrypt(d[e], l), d[e].data = Data.fromTData(d[e].data)
            }
            c(null, d)
          }catch(h) {
            c(h)
    ...
    c.prototype.publish = function(b, c, d) {
      ...
      b = {name:b, data:c};
      (c = this.cipher) && P.encrypt(b, c);
      b = Serialize.TMessageArray.encode([b], u);
      u = p.copy(p.defaultPostHeaders(u));
      f.options.headers && p.mixin(u, f.options.headers);
    ...
    function a(a, b, c) {
      ...
      this.options = p.prototypicalClone(e, c);
      ...
      if(z.activeState(a.state)) {
        ...
        if(2 == b) {
          ...
          for(var h = Array(a.length), b = 0;b < a.length;b++) {
            var m = a[b], k = h[b] = new c.TMessage;
            k.name = m.name;
            k.data = Data.toTData(m.data)
          }
          a = h
        }else {
          m = new c.TMessage, m.name = arguments[0], m.data = Data.toTData(arguments[1]), a = [m]
        }
        if(h = this.cipher) {
            ...
            for(var c = Array(a.length), d = this.cipher, e = 0;e < c.length;e++) {
              ...
              if(d) {
                try {
                  ...
                  var p = "Unexpected error decrypting message; err \x3d " + k;
                  h.logAction(h.LOG_ERROR, "RealtimeChannel.onMessage()", p);
                  this.emit("error", Error(p))
                }
              }
              c[e] = new P(g.channelSerial, g.timestamp, g.name, Data.fromTData(g.data))
            }
            this.onEvent(c)
          }
          break;
    ...
    a.prototype.setDetached = function(a) {
      (a = a.error) ? (this.state = "failed", this.emit("failed", {statusCode:a.statusCode, code:a.code, reason:a.reason})) : (this.state = "detached", this.emit("detached"))
    };
    ...
    c.prototype.leaveClient = function(a, c) {
      ...
      var e = new b.TPresence({state:d.LEAVE, clientId:a}), n = this.channel;
      switch(n.state) {
        case "attached":
          n.sendPresence(e, c);
          break;
    ...
    c.prototype.setPresence = function(b, c) {
      ...
      for(var l = 0;l < b.length;l++) {
        var n = b[l], m = a.call(n.clientId, n.memberId), k = new ea(n.clientId, Data.fromTData(n.clientData), n.memberId);
        switch(n.state) {
          case d.LEAVE:
            delete this.members[m];
            break;
          case d.UPDATE:
            n.inheritMemberId && delete this.members[a.call(n.clientId, n.inheritMemberId)];
          case d.ENTER:
            clientData = this.members[m] = k
        }
        c && this.emit(e[n.state], k)
      }
    };
  ...
  (function() {
    ...
    a.Request.prototype.send = function(a, c, d, e, g, h) {
      this.callback = h;
      var k = this.requestId, p = this.timer = setTimeout(function() {
        v.abort()
      ...
      var v = this, x = this._finish = function() {
        clearTimeout(p);
  ...
  (function() {
    ...
    a.Request.prototype.send = function(a, d, e, f, h, k) {
      ...
      r.onabort = function() {
        m = Error(p ? "Request timed out" : "Request cancelled");
        m.statusCode = 404;
        m.code = 8E4;
        k(m)
      };
      r.onreadystatechange = function() {
        if(4 == r.readyState) {
          if(clearTimeout(v), m) {
            ...
            if(r.status == n) {
              var a = null;
              h ? r.response && (a = new x, a.buf = r.response, a.view = new DataView(a.buf)) : a = r.responseText;
              k(null, a)
            }else {
              0 != r.status && (m = Error("Unexpected response: statusCode \x3d " + r.status), m.statusCode = r.status, m.code = 8E4, m.statusText = r.statusText, k(m))
            }
          }
        }
      };
  ...
  (function() {
    ...
    p.inherits(a, da);
    a.isAvailable = function() {
      return c && T && 10 <= T.getFlashPlayerVersion().major && Y
    };
    a.isAvailable() && (z.transports.flash_socket = a);
    a.tryConnect = function(b, c, d, f) {
      Y.__initialize(b.options.flashTransport && b.options.flashTransport.swfLocation || t.flashTransport.swfLocation);
      var k = new a(b, c, d), l = function(a) {
        f(a)
      };
      k.on("wserror", l);
    ...
    a.prototype.createWebSocket = function(a, c) {
      ...
      return new Y(a, [], d.proxyHost, d.proxyPort)
    };
    a.prototype.toString = function() {
