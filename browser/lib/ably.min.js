(function() {
  window.Ably = {};
  for(var G = {disconnected:{statusCode:408, code:80003, reason:"Connection to server temporarily unavailable"}, suspended:{statusCode:408, code:80002, reason:"Connection to server unavailable"}, failed:{statusCode:408, code:8E4, reason:"Connection failed or disconnected by server"}, unknownConnectionErr:{statusCode:500, code:50002, reason:"Internal connection error"}, unknownChannelErr:{statusCode:500, code:50001, reason:"Internal channel error"}}, J = function(a, c, b) {
    function h() {
    }
  ...
  I.MAX_INT = Math.pow(2, 53);
  I.MIN_INT = -Math.pow(2, 53);
  I.prototype = {_2scomp:function() {
    ...
    for(var h = this.buffer, f = this.offset, e = 7;0 <= e;e--) {
      h[f + e] = c & 255, c = 4 == e ? a : c >>> 8
    }
    b && this._2scomp()
  }, toNumber:function(a) {
    for(var c = this.buffer, b = this.offset, h = c[0] & 128, f = 0, e = 1, k = 7, d = 1;0 <= k;k--, d *= 256) {
      var m = c[b + k];
      h && (m = (m ^ 255) + e, e = m >> 8, m &= 255);
      f += m * d
    }
    return!a && f >= I.MAX_INT ? h ? -Infinity : Infinity : h ? -f : f
  }, valueOf:function() {
    return this.toNumber(!1)
  }, toString:function(a) {
    return this.valueOf().toString(a || 10)
  }, toOctetString:function(a) {
    for(var c = Array(8), b = this.buffer, h = this.offset, f = 0;8 > f;f++) {
      c[f] = aa[b[h + f]]
    }
    return c.join(a || "")
  }, inspect:function() {
  ...
  d.TXHRTransport.prototype = {getXmlHttpRequestObject:function() {
    ...
    var f = jQuery.Deferred(), e = jQuery._Deferred(), k = f.promise();
    k.success = k.done;
    k.error = k.fail;
    k.complete = e.done;
    c = jQuery.ajax({url:this.url, data:c, type:"POST", cache:!1, dataType:"text", context:this, success:this.jqResponse, error:function(b, c, e) {
      f.rejectWith(a, jQuery.merge([e], b.tArgs))
    }, complete:function(b, c) {
      e.resolveWith(a, [b, c])
    }});
    f.done(jQuery.makeArray(b).pop());
    c.tArgs = b;
    c.tClient = a;
    c.tRecvFn = h;
    c.tDfd = f;
    ...
    try {
      ...
      b.tDfd.rejectWith(b, jQuery.merge([f], b.tArgs))
    }
  ...
  d.Protocol.prototype = {getTransport:function() {
    ...
    var a = this.tpos.pop(), c = this.tstack[a], b = "{", h = !0, f;
    for(f in c) {
      h ? h = !1 : b += ",", b += f + ":" + c[f]
    }
    this.tstack[a] = b + "}"
    ...
    if(a != this.tstack.length) {
      ...
      for(var c = "}", b = !0;this.tstack.length > a + 1;) {
        var h = this.tstack.pop(), f = this.tstack.pop();
        b ? b = !1 : c = "," + c;
        isNaN(f) || (f = '"' + f + '"');
        c = f + ":" + h + c
      }
    ...
    if(-1 != c) {
      for(var f in this.rstack[this.rstack.length - 1]) {
        null !== d.Protocol.RType[f] && (b = d.Protocol.RType[f], this.rstack[this.rstack.length - 1] = this.rstack[this.rstack.length - 1][f])
      }
    }
    a.fname = "";
    a.ftype = b;
  ...
  var V = {encode:function(a, c, b) {
    for(var h = b, f = 0;f < a.length;f++) {
      var e = a.charCodeAt(f);
      128 > e ? c.setInt8(h++, e) : (127 < e && 2048 > e ? c.setInt8(h++, e >> 6 | 192) : (c.setInt8(h++, e >> 12 | 224), c.setInt8(h++, e >> 6 & 63 | 128)), c.setInt8(h++, e & 63 | 128))
    }
    return h - b
    ...
    b += c;
    for(c = c1 = c2 = 0;f < b;) {
      c = a.getInt8(f++), 128 > c ? h += String.fromCharCode(c) : 191 < c && 224 > c ? (c2 = a.getInt8(f++), h += String.fromCharCode((c & 31) << 6 | c2 & 63)) : (c2 = a.getInt8(f++), c3 = a.getInt8(f++), h += String.fromCharCode((c & 15) << 12 | (c2 & 63) << 6 | c3 & 63))
    }
    return h
  }}, t = function(a) {
    this.offset = 0;
  ...
  t.prototype = {getArray:function() {
    ...
    a = a || 0;
    c = c || this.length;
    var b = new t, h = b.length = c - a, f = b.offset = this.offset + a, e = b.buf = this.buf;
    b.view = new DataView(e, f, h);
    return b
  }, getInt8:function(a) {
  ...
  l.prototype.writeI64 = function(a) {
    a.buffer ? this.trans.writeI64(a) : this.trans.writeI64(new I(a))
  };
  ...
  var fa = new t(0), K = d.TTransport = function(a, c) {
    this.buf = a || fa;
    this.onFlush = c;
    this.reset()
  };
  K.receiver = function(a) {
    return function(c) {
      a(new K(c))
    }
  };
  K.prototype = {commitPosition:function() {
  ...
  X.receiver = function(a) {
    var c = 0, b = 0, h = null, f = null;
    return function(e) {
      if(f) {
        var k = new t(e.length + f.length);
        f.copy(k, 0, 0);
        e.copy(k, f.length, 0);
        f = null
      }
      for(;e.length;) {
        ...
        e.length >= c ? (e.copy(h, b, 0, c), e = e.slice(c, e.length), c = 0, a(new X(h))) : e.length && (e.copy(h, b, 0, e.length), c -= e.length, b += e.length, e = e.slice(e.length, e.length))
      }
    }
  };
  J(X, K, {flush:function() {
    var a = this;
    K.prototype.flush.call(this, function(c) {
      if(a.onFlush) {
        var b = new t(c.length + 4);
    ...
    for(a.readStructBegin();;) {
      ...
      switch(c.fid) {
        ...
        case 2:
          ...
          break;
        case 3:
          b == d.Type.STRUCT ? (this.clientData = new H, this.clientData.read(a)) : a.skip(b);
          break;
        case 4:
    ...
    for(a.readStructBegin();;) {
      ...
      switch(c.fid) {
        ...
        case 3:
          ...
          break;
        case 4:
          b == d.Type.STRUCT ? (this.data = new H, this.data.read(a)) : a.skip(b);
          break;
        case 5:
          if(b == d.Type.LIST) {
            c = 0;
  ...
  TProtocolMessage.prototype.read = function(a) {
    for(a.readStructBegin();;) {
      var c = a.readFieldBegin(), b = c.ftype;
      if(b == d.Type.STOP) {
        break
  ...
  TProtocolMessage.prototype.write = function(a) {
      ...
      switch(c.fid) {
        case 1:
          if(b == d.Type.LIST) {
            ...
            c = a.readListBegin().size;
            for(b = 0;b < c;++b) {
              var h = void 0, h = new TProtocolMessage;
              h.read(a);
              this.items.push(h)
            }
            a.readListEnd()
  ...
  SStats = function(a) {
    this.inProgress = this.tokenRequests = this.apiRequests = this.channels = this.connections = this.persisted = this.outbound = this.inbound = this.all = void 0;
  ...
  var A = {TAction:TAction, TFlags:TFlags, TType:TType, TData:H, TPresence:D, TMessage:E, TChannelMessage:void 0, TMessageSet:void 0};
  this.Cookie = function() {
    function a() {
    }
    "object" == typeof window && (a.create = function(a, b, h) {
      var f = "";
      h && (f = new Date, f.setTime(f.getTime() + h), f = "; expires\x3d" + f.toGMTString());
      document.cookie = a + "\x3d" + b + f + "; path\x3d/"
    }, a.read = function(a) {
      a += "\x3d";
      for(var b = document.cookie.split(";"), h = 0;h < b.length;h++) {
        for(var f = b[h];" " == f.charAt(0);) {
  ...
  var r = {protocolVersion:1, HOST:"rest.ably.io", WS_HOST:"realtime.ably.io", FALLBACK_HOSTS:["A.ably-realtime.com", "B.ably-realtime.com", "C.ably-realtime.com", "D.ably-realtime.com", "E.ably-realtime.com"], PORT:80, TLS_PORT:443, connectTimeout:15E3, disconnectTimeout:3E4, suspendedTimeout:12E4, cometRecvTimeout:9E4, cometSendTimeout:1E4, httpTransports:["xhr", "jsonp"], transports:["web_socket", "flash_socket", "xhr", "jsonp"], flashTransport:{swfLocation:("undefined" !== typeof window ? window.location.protocol : 
  "https:") + "//cdn.ably.io/lib/swf/WebSocketMainInsecure-0.9.swf", policyPort:"80"}, getHost:function(a, c, b) {
    c = c || a.host || r.HOST;
    b && (c = c == a.host && (a.wsHost || c) || c == r.HOST && (r.WS_HOST || c) || c);
    return c
  }, getPort:function(a) {
    return a.encrypted ? a.tlsPort || r.TLS_PORT : a.port || r.PORT
  }, getHosts:function(a) {
    var c;
    a.host ? (c = [a.host], a.fallbackHosts && c.concat(a.fallbackHosts)) : c = [a.host].concat(r.FALLBACK_HOSTS);
    return c
  }};
  "undefined" !== typeof exports && this.exports !== exports && (exports.defaults = r);
  this.Http = function() {
    function a() {
    }
    var c = function() {
    };
    a.get = function(b, h, f, e, k) {
      function d(b, c) {
        a.Request(b, e, null, s, c)
      }
      k = k || c;
      var m = "function" == typeof h ? h : function(a) {
        return b.baseUri(a) + h
      }, s = f && "application/json" != f.accept;
      if("string" == typeof m) {
        d(m, k)
      }else {
        var g;
        g = (f = b.connection) && "connected" == f.state ? [f.connectionManager.host] : r.getHosts(b.options);
        1 == g.length ? d(m(g[0]), k) : d(g.shift(), function(a, b, c) {
          if(a) {
            var e = a.code;
    ...
    a.post = function(b, h, f, e, k, d) {
      function m(b, c) {
        a.Request(b, k, e, g, c)
      }
      d = d || c;
      var s = "function" == typeof h ? h : function(a) {
        return b.baseUri(a) + h
      }, g = f && "application/json" != f.accept;
      if("string" == typeof s) {
        tryGet(s, d)
      }else {
        var u;
        u = (f = b.connection) && "connected" == f.state ? [f.connectionManager.host] : r.getHosts(b.options);
        1 == u.length ? m(s(u[0]), d) : m(u.shift(), function(a, b, c) {
          if(a) {
            var e = a.code;
            if("ENETUNREACH" == e || "EHOSTUNREACH" == e || "EHOSTDOWN" == e) {
              m(u, d);
  ...
  this.ThriftUtil = function() {
    ...
    var b = new d.TTransport, h = new d.TBinaryProtocol(b), f = 16384, e = [];
    c.encode = function(a, b) {
      try {
        b(null, c.encodeSync(a))
      }catch(e) {
        var h = "Unexpected exception encoding Thrift; exception \x3d " + e;
        g.logAction(g.LOG_ERROR, "ThriftUtil.encode()", h, e);
        h = Error(h);
        h.statusCode = 400;
        b(h)
      }
    ...
    c.decodeSync = function(a, c) {
      try {
        ...
        var f = "Unexpected exception decoding thrift message; exception \x3d " + e;
        g.logAction(g.LOG_ERROR, "ThriftUtil.decode()", f, e);
        f = Error(f);
        f.statusCode = 400;
        throw f;
      }
  ...
  var T = function() {
    ...
    function b(a) {
      if(typeof v.addEventListener != x) {
        v.addEventListener("load", a, !1)
      }else {
        if(typeof q.addEventListener != x) {
          q.addEventListener("load", a, !1)
        }else {
          if(typeof v.attachEvent != x) {
            w(v, "onload", a)
          }else {
    ...
    function h() {
      var a = q.getElementsByTagName("body")[0], b = q.createElement(t);
      ...
      if(c) {
        ...
        (function() {
          if(typeof c.GetVariable != x) {
            ...
            h && (h = h.split(" ")[1].split(","), p.pv = [parseInt(h[0], 10), parseInt(h[1], 10), parseInt(h[2], 10)])
          }else {
            if(10 > e) {
              e++;
    ...
    function f() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          var c = N[b].id, h = N[b].callbackFn, f = {success:!1, id:c};
          if(0 < p.pv[0]) {
            var s = C(c);
            if(s) {
              if(l(N[b].swfVersion) && !(p.wk && 312 > p.wk)) {
                Q(c, !0), h && (f.success = !0, f.ref = e(c), h(f))
              }else {
                if(N[b].expressInstall && d()) {
                  f = {};
                  f.data = N[b].expressInstall;
                  f.width = s.getAttribute("width") || "0";
                  f.height = s.getAttribute("height") || "0";
                  s.getAttribute("class") && (f.styleclass = s.getAttribute("class"));
                  s.getAttribute("align") && (f.align = s.getAttribute("align"));
                  for(var S = {}, s = s.getElementsByTagName("param"), u = s.length, w = 0;w < u;w++) {
                    "movie" != s[w].getAttribute("name").toLowerCase() && (S[s[w].getAttribute("name")] = s[w].getAttribute("value"))
                  }
                  g(f, S, c, h)
                }else {
                  m(s), h && h(f)
            ...
            if(Q(c, !0), h) {
              if((c = e(c)) && typeof c.SetVariable != x) {
                f.success = !0, f.ref = c
              }
              h(f)
            }
    ...
    function e(a) {
      ...
      if((a = C(a)) && "OBJECT" == a.nodeName) {
        typeof a.SetVariable != x ? b = a : (a = a.getElementsByTagName(t)[0]) && (b = a)
      }
      return b
    }
    function d() {
      return!J && l("6.0.65") && (p.win || p.mac) && !(p.wk && 312 > p.wk)
    }
    function g(a, b, c, e) {
      J = !0;
      K = e || null;
      ...
      var h = C(c);
      if(h) {
        "OBJECT" == h.nodeName ? (E = s(h), I = null) : (E = h, I = c);
        a.id = A;
        if(typeof a.width == x || !/%$/.test(a.width) && 310 > parseInt(a.width, 10)) {
          a.width = "310"
        }
        if(typeof a.height == x || !/%$/.test(a.height) && 137 > parseInt(a.height, 10)) {
          a.height = "137"
        }
        q.title = q.title.slice(0, 47) + " - Flash Player Installation";
        e = p.ie && p.win ? "ActiveX" : "PlugIn";
        e = "MMredirectURL\x3d" + v.location.toString().replace(/&/g, "%26") + "\x26MMplayerType\x3d" + e + "\x26MMdoctitle\x3d" + q.title;
        b.flashvars = typeof b.flashvars != x ? b.flashvars + ("\x26" + e) : e;
        p.ie && (p.win && 4 != h.readyState) && (e = q.createElement("div"), c += "SWFObjectNew", e.setAttribute("id", c), h.parentNode.insertBefore(e, h), h.style.display = "none", function() {
    ...
    function m(a) {
      if(p.ie && p.win && 4 != a.readyState) {
        ...
        b.parentNode.replaceChild(s(a), b);
        a.style.display = "none";
        (function() {
          4 == a.readyState ? a.parentNode.removeChild(a) : setTimeout(arguments.callee, 10)
        })()
      }else {
        a.parentNode.replaceChild(s(a), a)
      }
    }
    function s(a) {
      var b = q.createElement("div");
      if(p.win && p.ie) {
        ...
        if(a = a.getElementsByTagName(t)[0]) {
          if(a = a.childNodes) {
    ...
    function S(a, b, c) {
      ...
      if(h) {
        if(typeof a.id == x && (a.id = c), p.ie && p.win) {
          var f = "", d;
          for(d in a) {
            a[d] != Object.prototype[d] && ("data" == d.toLowerCase() ? b.movie = a[d] : "styleclass" == d.toLowerCase() ? f += ' class\x3d"' + a[d] + '"' : "classid" != d.toLowerCase() && (f += " " + d + '\x3d"' + a[d] + '"'))
          }
          d = "";
          for(var k in b) {
            b[k] != Object.prototype[k] && (d += '\x3cparam name\x3d"' + k + '" value\x3d"' + b[k] + '" /\x3e')
          }
          h.outerHTML = '\x3cobject classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + f + "\x3e" + d + "\x3c/object\x3e";
          H[H.length] = a.id;
          e = C(a.id)
        }else {
          k = q.createElement(t);
          k.setAttribute("type", y);
          for(var m in a) {
            a[m] != Object.prototype[m] && ("styleclass" == m.toLowerCase() ? k.setAttribute("class", a[m]) : "classid" != m.toLowerCase() && k.setAttribute(m, a[m]))
          }
          for(f in b) {
            b[f] != Object.prototype[f] && "movie" != f.toLowerCase() && (a = k, d = f, m = b[f], c = q.createElement("param"), c.setAttribute("name", d), c.setAttribute("value", m), a.appendChild(c))
          }
    ...
    function n(a, b, c, e) {
      if(!p.ie || !p.mac) {
        var h = q.getElementsByTagName("head")[0];
        if(h) {
          c = c && "string" == typeof c ? c : "screen";
          e && (O = L = null);
          if(!L || O != c) {
            e = q.createElement("style"), e.setAttribute("type", "text/css"), e.setAttribute("media", c), L = h.appendChild(e), p.ie && (p.win && typeof q.styleSheets != x && 0 < q.styleSheets.length) && (L = q.styleSheets[q.styleSheets.length - 1]), O = c
          }
          p.ie && p.win ? L && typeof L.addRule == t && L.addRule(a, b) : L && typeof q.createTextNode != x && L.appendChild(q.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function Q(a, b) {
      if(R) {
        ...
        P && C(a) ? C(a).style.visibility = c : n("#" + a, "visibility:" + c)
      }
    }
    function r(a) {
      return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != x ? encodeURIComponent(a) : a
    }
    var x = "undefined", t = "object", y = "application/x-shockwave-flash", A = "SWFObjectExprInst", v = window, q = document, z = navigator, G = !1, F = [function() {
      G ? h() : f()
    }], N = [], H = [], D = [], E, I, K, M, P = !1, J = !1, L, O, R = !0, p = function() {
      var a = typeof q.getElementById != x && typeof q.getElementsByTagName != x && typeof q.createElement != x, b = z.userAgent.toLowerCase(), c = z.platform.toLowerCase(), e = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, h = !+"\v1", f = [0, 0, 0], d = null;
      if(typeof z.plugins != x && typeof z.plugins["Shockwave Flash"] == t) {
        if((d = z.plugins["Shockwave Flash"].description) && !(typeof z.mimeTypes != x && z.mimeTypes[y] && !z.mimeTypes[y].enabledPlugin)) {
          G = !0, h = !1, d = d.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), f[0] = parseInt(d.replace(/^(.*)\..*$/, "$1"), 10), f[1] = parseInt(d.replace(/^.*\.(.*)\s.*$/, "$1"), 10), f[2] = /[a-zA-Z]/.test(d) ? parseInt(d.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        }
      }else {
        if(typeof v.ActiveXObject != x) {
          try {
            var k = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
            if(k && (d = k.GetVariable("$version"))) {
              h = !0, d = d.split(" ")[1].split(","), f = [parseInt(d[0], 10), parseInt(d[1], 10), parseInt(d[2], 10)]
            }
          }catch(m) {
          }
        }
      }
      return{w3:a, pv:f, wk:b, ie:h, win:e, mac:c}
    }();
    (function() {
      p.w3 && ((typeof q.readyState != x && "complete" == q.readyState || typeof q.readyState == x && (q.getElementsByTagName("body")[0] || q.body)) && a(), P || (typeof q.addEventListener != x && q.addEventListener("DOMContentLoaded", a, !1), p.ie && p.win && (q.attachEvent("onreadystatechange", function() {
        ...
        P || (/loaded|complete/.test(q.readyState) ? a() : setTimeout(arguments.callee, 0))
      }(), b(a)))
    })();
    (function() {
    ...
    return{registerObject:function(a, b, c, e) {
    ...
    }, embedSWF:function(a, b, e, h, f, m, s, u, C, w) {
      var n = {success:!1, id:b};
      p.w3 && !(p.wk && 312 > p.wk) && a && b && e && h && f ? (Q(b, !1), c(function() {
        e += "";
        h += "";
        var c = {};
        if(C && typeof C === t) {
        ...
        if(s && typeof s === t) {
          for(var q in s) {
            p.flashvars = typeof p.flashvars != x ? p.flashvars + ("\x26" + q + "\x3d" + s[q]) : q + "\x3d" + s[q]
          }
        }
        if(l(f)) {
          U = S(c, p, b), c.id == b && Q(b, !0), n.success = !0, n.ref = U
        }else {
          if(m && d()) {
            c.data = m;
            g(c, p, b, w);
    ...
    }, hasFlashPlayerVersion:l, createSWF:function(a, b, c) {
      if(p.w3) {
        return S(a, b, c)
      }
      ...
      if(J) {
        var a = C(A);
        a && E && (a.parentNode.replaceChild(E, a), I && (Q(I, !0), p.ie && p.win && (E.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), O = function() {
    ...
    var a = function(c, b, h, f, e) {
      ...
      d.__createTask = setTimeout(function() {
        a.__addTask(function() {
          d.__createTask = null;
          a.__flash.create(d.__id, c, b, h || null, f || 0, e || null)
        })
      }, 0)
    };
    ...
    a.prototype.off = function(a, b) {
      if(0 == arguments.length) {
        ...
        if(null === a) {
          ...
          if(b) {
            f = -1;
            if(!(h = this.events[a]) || -1 == (f = h.indexOf(b))) {
    ...
    a.LOG_DEFAULT = 3;
    a.LOG_DEBUG = 4;
    a.logAction = function(a, f, e) {
      a <= c && b("Ably: " + f + ": " + e)
    };
    a.setLog = function(a, f) {
      c = a || 3;
      b = f || console.log.bind(console)
    };
    return a
  }(), n = function() {
    function a() {
    ...
    a.valuesArray = function(a, c) {
      var f = [], e;
      for(e in a) {
        (!c || a.hasOwnProperty(e)) && f.push(a[e])
      }
      return f.length ? f : void 0
    };
    ...
    function b(a, c) {
      ...
      this.httpTransports = n.intersect(c.transports || r.httpTransports, b.httpTransports);
      this.transports = n.intersect(c.transports || r.transports, b.transports);
      this.upgradeTransports = n.arrSubtract(this.transports, this.httpTransports);
      this.hosts = r.getHosts(c);
      this.host = this.pendingTransport = this.transport = null;
      g.logAction(g.LOG_MINOR, "Realtime.ConnectionManager()", "started");
      g.logAction(g.LOG_MICRO, "Realtime.ConnectionManager()", "requested transports \x3d [" + (c.transports || r.transports) + "]");
      ...
      f && c.recover && window.addEventListener("beforeunload", function() {
        self.persistConnection()
      })
    }
    var d = "undefined" !== typeof Cookie && Cookie.read, f = "undefined" !== typeof Cookie && Cookie.create, e = ("object" == typeof A ? A : require("../nodejs/lib/protocol/clientmessage_types")).TAction, k = function() {
    }, B = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:r.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:r.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
    retryDelay:r.suspendedTimeout}, closed:{state:"closed", terminal:!1, queueEvents:!1, sendEvents:!1}, failed:{state:"failed", terminal:!0, queueEvents:!1, sendEvents:!1}};
      ...
      if(this.transport) {
        ...
        this.httpTransports.length ? this.chooseHttpTransport(e, function(c, d) {
          if(c) {
            ...
            if(g.logAction(g.LOG_MINOR, "ConnectionManager.chooseTransport()", "Establishing http transport: " + d), b(null, d), f.upgradeTransports.length) {
              d.on("connected", function(b, c) {
                g.logAction(g.LOG_MAJOR, "ConnectionManager.chooseTransport()", "upgrading ... connectionId \x3d " + c);
                e = new a(f.options, e.host, "resume", c, f.connectionSerial);
                f.chooseTransportForHost(e, f.upgradeTransports.slice(), k)
              })
            }
          }
        }) : (e.host = this.hosts[0], g.logAction(g.LOG_MINOR, "ConnectionManager.chooseTransport()", "No http transports available; ignoring fallback hosts"), this.chooseTransportForHost(e, f.transports.slice(), b))
      }
    };
    b.prototype.chooseTransportForHost = function(a, c, e) {
      ...
      if(f) {
        var d = this;
        g.logAction(g.LOG_MICRO, "ConnectionManager.chooseTransportForHost()", "trying " + f);
        b.transports[f].tryConnect(this, this.realtime.auth, a, function(b, h) {
          b ? d.chooseTransportForHost(a, c, e) : (g.logAction(g.LOG_MICRO, "ConnectionManager.chooseTransport()", "transport " + f + " connecting"), d.setTransportPending(h), e(null, h))
        })
      }else {
    ...
    b.prototype.chooseHttpTransport = function(a, c) {
      function e() {
        if(f.length) {
          b.httpTransports[h.httpTransports[0]].checkConnectivity(function(b, d) {
            b ? c(b) : d ? (a.host = n.arrRandomElement(f), h.chooseTransportForHost(a, h.httpTransports.slice(), function(a, b) {
              a ? e() : c(null, b)
      ...
      var f = this.hosts.slice(), d = f.shift();
      if(d) {
        a.host = d;
        var h = this;
      ...
      if(this.state == B.closed) {
        ...
        for(var b = this, c = function(c) {
          return function(e, f) {
            ...
            e && e.reason && g.logAction(g.LOG_MICRO, "ConnectionManager.setTransportPending", "reason \x3d  " + e.reason);
            f && g.logAction(g.LOG_MICRO, "ConnectionManager.setTransportPending", "connectionId \x3d  " + f);
            var d;
            "connected" == c ? (b.activateTransport(a, f), d = !0) : d = b.deactivateTransport(a);
            d && b.notifyState({state:c, error:e})
          }
        }, e = ["connected", "disconnected", "closed", "failed"], f = 0;f < e.length;f++) {
          var d = e[f];
          a.on(d, c(d))
        }
    ...
    b.prototype.persistConnection = function() {
      f && (this.connectionId && f("ably-connection-id", this.connectionId), this.connectionSerial && f("ably-connection-serial", this.connectionSerial))
    };
    b.prototype.getStateError = function() {
      return G[this.state.state]
    };
    ...
    b.prototype.startConnectTimer = function() {
      ...
      this.connectTimer = setTimeout(function() {
        a.connectTimer && (g.logAction(g.LOG_MINOR, "ConnectionManager connect timer expired", "requesting new state: " + B.connecting.failState), a.notifyState({state:B.connecting.failState}))
      }, r.connectTimeout)
    };
    ...
    b.prototype.startSuspendTimer = function() {
      ...
      this.suspendTimer || (this.suspendTimer = setTimeout(function() {
        a.suspendTimer && (g.logAction(g.LOG_MINOR, "ConnectionManager suspend timer expired", "requesting new state: suspended"), B.connecting.failState = "suspended", B.connecting.queueEvents = !1, a.notifyState({state:"suspended"}))
      }, r.suspendedTimeout))
    };
    b.prototype.cancelSuspendTimer = function() {
      B.connecting.failState = "disconnected";
      B.connecting.queueEvents = !0;
    ...
    b.prototype.notifyState = function(a) {
      if(!(this.state.terminal || a.state == this.state.state)) {
        ...
        a = new Z(this.state.state, b.state, b.retryDelay, a.error || G[b.state]);
    ...
    b.prototype.requestState = function(a) {
      ...
      if(a.state != this.state.state) {
        ...
        if(a.state != this.state.state) {
          var b = B[a.state];
          a = new Z(this.state.state, b.state, b.retryIn, a.error || G[b.state]);
          this.enactStateChange(a)
        }
      }
    };
    b.prototype.connectImpl = function() {
      ...
      var a = this, b = this.realtime.auth, c = function(e) {
        g.logAction(g.LOG_ERROR, "ConnectionManager.connectImpl()", e);
        401 == e.statusCode && (-1 != e.message.indexOf("expire") && "token" == b.method) && b.getToken(!0, function(b) {
          b ? c(b) : a.connectImpl()
        });
        a.notifyState({state:B.connecting.failState, error:e})
      }, e = function() {
    ...
    b.prototype.send = function(a, b, e) {
      e = e || k;
      var f = this.state;
      f.sendEvents ? (g.logAction(g.LOG_MICRO, "ConnectionManager.send()", "sending event"), this.sendImpl(new c(a, e))) : f.queueEvents && (b ? this.queue(a, e) : (g.logAction(g.LOG_MICRO, "ConnectionManager.send()", "rejecting event"), e(this.error)))
    };
    ...
    b.prototype.ackMessage = function(a, b, c) {
      ...
      c = c || null;
      var e = this.pendingMessages, f = e[0];
      if(f && (f = f.msg.msgSerial, a += b, a > f)) {
        e = e.splice(0, a - f);
    ...
    b.prototype.queue = function(a, b) {
      ...
      e && ba.mergeTo(e.msg, a) ? (e.merged || (e.callback = new Y([e.callback]), e.merged = !0), e.listener.push(b)) : this.queuedMessages.push(new c(a, b))
    };
    ...
    var c = "object" == typeof window, b = c ? A : require("../nodejs/lib/protocol/clientmessage_types"), d = c ? window.WebSocket || window.MozWebSocket : require("ws"), f = c ? !1 : !!t, e = function() {
    };
    n.inherits(a, F);
    ...
    a.tryConnect = function(b, c, e, f) {
      var d = new a(b, c, e), h = function(a) {
        f(a)
      };
      d.on("wserror", h);
      d.on("wsopen", function() {
        g.logAction(g.LOG_MINOR, "WebSocketTransport.tryConnect()", "viable transport " + d);
        d.off("wserror", h);
        f(null, d)
      });
      d.connect()
    ...
    a.prototype.connect = function() {
      ...
      F.prototype.connect.call(this);
      var a = this, b = this.params, c = b.options, e = r.getHost(c, b.host, !0), f = r.getPort(c), d = (c.encrypted ? "wss://" : "ws://") + e + ":" + f + "/";
      g.logAction(g.LOG_MINOR, "WebSocketTransport.connect()", "uri: " + d);
      this.auth.getAuthParams(function(c, e) {
        var f = "", h;
        for(h in e) {
          f += " " + h + ": " + e[h] + ";"
        }
        g.logAction(g.LOG_MINOR, "WebSocketTransport.connect()", "authParams:" + f);
        if(c) {
          a.abort(UIMessages.FAIL_REASON_REFUSED)
        }else {
          f = b.getConnectParams(e);
          try {
            var m = a.wsConnection = a.createWebSocket(d, f);
    ...
    a.prototype.send = function(a, b) {
      try {
        ...
        var e = "Unexpected send exception: " + c;
        g.logAction(g.LOG_ERROR, "WebSocketTransport.send()", e);
        b(Error(e))
      }
    };
    ...
    a.prototype.onWsClose = function(a, b) {
      var c, e, f;
      "object" == typeof a ? (c = a.wasClean, e = a.code, f = a.reason) : (e = a, f = b || "", c = 1E3 == e);
      g.logAction(g.LOG_MINOR, "WebSocketTransport.onWsClose()", "closed WebSocket; wasClean \x3d " + c + "; code \x3d " + e);
      delete this.wsConnection;
      F.prototype.onClose.call(this, c, f)
    };
    ...
    a.prototype.connect = function() {
      ...
      F.prototype.connect.call(this);
      var c = this, b = this.params, d = b.options, b = r.getHost(d, b.host), f = r.getPort(d);
      this.baseUri = (d.encrypted ? "https://" : "http://") + b + ":" + f + "/comet/";
      var e = this.baseUri + "connect";
      g.logAction(g.LOG_MINOR, "CometTransport.connect()", "uri: " + e);
      this.auth.getAuthParams(function(b, f) {
        if(b) {
          c.abort(UIMessages.FAIL_REASON_REFUSED)
        }else {
          c.authParams = f;
          var d = c.params.getConnectParams(f);
          g.logAction(g.LOG_MINOR, "CometTransport.connect()", "connectParams:" + a.paramStr(d));
          try {
            c.request(e, d, null, !1, function(a, b) {
    ...
    a.prototype.onConnect = function(a) {
      ...
      F.prototype.onConnect.call(this, a);
    ...
    a.prototype.send = function(a, b) {
      if(this.sendRequest) {
        this.pendingItems = this.pendingItems || [], this.pendingItems.push(a), this.pendingCallback = this.pendingCallback || new Y, this.pendingCallback.push(b)
      }else {
        var d = this.pendingItems || [];
        d.push(a);
        this.pendingItems = null;
        var f = this.pendingCallback;
        f && (f.push(b), b = f, this.pendingCallback = null);
        this.sendItems(d, b)
      }
    };
    a.prototype.sendItems = function(a, b) {
      ...
      try {
        ...
        var e = "Unexpected send exception: " + f;
  ...
  this.Data = function() {
    ...
    var c = "object" == typeof A ? A : require("../nodejs/lib/protocol/clientmessage_types"), b = {"[object Null]":function(a, b) {
      a.type = c.TType.NONE;
      return!0
      ...
      "undefined" !== typeof t && t.isBuffer(b) ? (a.type = c.TType.BUFFER, a.binaryData = b) : (a.type = c.TType.JSONOBJECT, a.stringData = JSON.stringify(b));
      return!0
    ...
    a.toTData = function(a) {
      var b = new c.TData, k = d[typeof a];
      if(k && k(b, a)) {
        return b
      }
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof A ? A : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, d = a.TMessage = {}, f = a.TPresence = {}, e = a.TProtocolMessage = {}, k = a.TMessageArray = {}, g = a.TMessageBundle = {}, m = c.TType.BUFFER;
    b.fromREST = function(a) {
      var c, e = a.data, d = a.encoding;
      d ? (c = new b, c.type = m, c.binaryData = new t(e, d)) : Data.toTData(e);
      a.data = e
    };
    c.TMessage.prototype.toJSON = function() {
      ...
      a.type == m && (b.encoding = "base64", c = c.toString("base64"));
      b.data = c;
      return b
    };
    ...
    b.fromREST = function(a, c) {
      var e, d = a.encoding;
      d ? (e = new b, e.type = m, e.binaryData = new t(c, d)) : e = Data.toTData(c);
      return e
    };
    ...
    g.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          ...
          f = JSON.parse(a);
          for(var h = f.length, d = Array(h), k = 0;k < h;k++) {
            d[k] = e.fromJSON(f[k])
          }
        }
      }
    ...
    k.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          var f;
          if(e = ThriftUtil.decodeSync(f = new c.TMessageArray, a)) {
            throw e;
          }
          e = f.items
        }else {
          f = JSON.parse(a);
          for(var k = f.length, e = Array(k), g = 0;g < k;g++) {
            e[g] = d.fromJSON(f[g])
          }
        }
      }
  ...
  var R = function() {
    ...
    a.get = function(a, b, d, f, e) {
      function k() {
        a.auth.getAuthHeaders(function(g, m) {
          g ? e(g) : Http.get(a, b, n.mixin(m, d), f, function(b, d, f) {
    ...
    a.post = function(a, b, d, f, e, k) {
      function g() {
        a.auth.getAuthHeaders(function(m, s) {
          m ? k(m) : Http.post(a, b, n.mixin(s, f), d, e, function(b, e, d) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? k(a) : g()
            }) : k(b, e, d)
          })
    ...
    a.prototype.get = function(a) {
      var c = this;
      R.get(this.rest, this.path, this.headers, this.params, function(d, e, k) {
        if(d) {
          g.logAction(g.LOG_ERROR, "PaginatedResource.get()", "Unexpected error getting resource: err \x3d " + d)
        }else {
          d = c.current = c.bodyHandler(e);
          var B, m;
          if(k && (B = k.Link || k.link)) {
            m = c.parseRelLinks(B.split(","))
          }
          a(null, d, m)
        }
      })
    ...
    a.prototype.parseRelLinks = function(a) {
      for(var c = {}, d = 0;d < a.length;d++) {
        var e = a[d].match(/^\s*<(.+)>;\s*rel="(\w+)"$/);
        e && (c[e[2]] = this.getRel(e[1]))
      }
      return c
    };
    a.prototype.getRel = function(b) {
      var d = c.parse(b, !0), f = c.resolve(this.path, d.path), e = this;
      return function(b) {
        (new a(e.rest, f, e.headers, d.query, e.bodyHandler)).get(b)
      }
    };
    return a
  }(), ia = function() {
    ...
    function b(a, b) {
      ...
      if(b.keyValue) {
        if(!b.clientId) {
          ...
          this.method = "basic";
          this.basicKey = (new t(b.key || b.keyId + ":" + b.keyValue, "ascii")).toString("base64");
          this.keyId = b.keyId;
    ...
    var d = "object" == typeof window, f = d ? null : require("crypto"), e = void 0;
    ...
    b.prototype.authorise = function(a, b) {
      ...
      this.requestToken(a, function(a, c) {
        a ? b(a) : b(null, e.token = c.access_token)
      })
    };
    b.prototype.requestToken = function(b, e) {
      "function" == typeof b && !e && (e = b, b = {});
      b = b || {};
      e = e || a;
      b = n.mixin(n.copy(this.tokenOptions), b);
      var d, f = this.rest;
      if(b.authCallback) {
        g.logAction(g.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_callback"), d = b.authCallback
      }else {
        if(b.authUrl) {
          g.logAction(g.LOG_MINOR, "Auth.requestToken()", "using token auth with auth_url"), d = function(a, c) {
      ...
      var l = {}, r = b.clientId || this.rest.clientId;
      r && (l.client_id = r);
      r = b.ttl || "";
      "ttl" in b && (l.ttl = r);
      "capability" in b && (l.capability = c(b.capability));
      var f = this.rest, w = function(a) {
        return f.baseUri(a) + "/keys/" + b.keyId + "/authorise"
      }, t = function(a, b) {
        Http.post ? Http.post(f, w, n.defaultPostHeaders(), a, null, b) : Http.get(f, w, n.defaultGetHeaders(), a, b)
      };
      d(l, function(a, b) {
        a ? (g.logAction(g.LOG_ERROR, "Auth.requestToken()", "token request signing call returned error; err \x3d " + a), e(a)) : t(b, function(a, b) {
          a ? (g.logAction(g.LOG_ERROR, "Auth.requestToken()", "token request API call returned error; err \x3d " + a), e(a)) : (g.logAction(g.LOG_MINOR, "Auth.getToken()", "token received"), e(null, b.access_token))
        })
      })
    };
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        var n = a.capability || "";
        n && (f.capability = n);
        var r = this.rest, t = this;
        (function(c) {
          a.timestamp ? c() : a.queryTime ? r.time(function(e, d) {
            e ? b(e) : (a.timestamp = Math.floor(d / 1E3), c())
          }) : (a.timestamp = t.getTimestamp(), c())
        })(function() {
          var c = f.nonce = a.nonce || ("000000" + Math.floor(1E16 * Math.random())).slice(-16), m = f.timestamp = a.timestamp, c = f.id + "\n" + l + "\n" + n + "\n" + h + "\n" + m + "\n" + c + "\n";
          f.mac = a.mac || e(c, d);
    ...
    b.prototype.getAuthHeaders = function(a) {
      "basic" == this.method ? a(null, {authorization:"Basic " + this.basicKey}) : this.authorise({}, function(b, c) {
        b ? a(b) : a(null, {authorization:"Bearer " + (new t(c.id, "ascii")).toString("base64")})
      })
    };
    ...
    function a(a) {
      ...
      this.baseUri = this.authority = function(b) {
        return"https://" + b + ":" + (a.tlsPort || r.TLS_PORT)
      };
    ...
    c.prototype.get = function(a) {
      ...
      b || (this.attached[a] = b = new $(this.rest, a));
      return b
    };
    return a
  }(), J = function() {
    ...
    c.prototype.get = function(a) {
      a = String(a);
      var c = this.attached[a];
      c || (this.attached[a] = c = new ba(this.realtime, a, this.realtime.options));
      return c
    };
    return a
  }(), Z = function() {
    ...
    c.prototype.presence = function(b, c) {
      ...
      R.get(d, "/channels/" + this.name + "/presence", k, b, function(a, b) {
        a ? c(a) : e ? da.decodeTPresenceArray(b, c) : c(null, b)
      })
    };
    c.prototype.history = function(b, c) {
      ...
      var d = this.rest, e = !d.options.useTextProtocol, k = n.copy(n.defaultGetHeaders(e));
      d.options.headers && n.mixin(k, d.options.headers);
      R.get(d, "/channels/" + this.name + "/history", k, b, function(a, b) {
        if(a) {
          c(a)
        }else {
          try {
            c(null, Serialize.TMessageArray.decode(b, e))
          }catch(d) {
            c(d)
          }
        }
    ...
    c.prototype.publish = function(b, c, d) {
      ...
      b = Serialize.TMessageArray.encode([{name:b, data:c}], k);
      k = n.copy(n.defaultPostHeaders(k));
      e.options.headers && n.mixin(k, e.options.headers);
      R.post(e, "/channels/" + this.name + "/publish", b, k, null, d)
    };
    return c
  }(), ba = function() {
    function a(a, b, c) {
      ...
      this.options = n.prototypicalClone(f, c);
    ...
    a.prototype.publish = function(a, b, f) {
      g.logAction(g.LOG_MICRO, "RealtimeChannel.publish()", "name \x3d " + a);
      f = f || d;
      var m = this.connectionManager;
      if(z.activeState(m.state)) {
        switch(m = new c.TMessage, m.name = a, m.data = Data.toTData(b), this.state) {
          case "attached":
          ...
          default:
            this.attach();
          case "attaching":
            g.logAction(g.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:m, listener:f})
        }
      }else {
        f(m.getStateError())
      }
    ...
    a.prototype.subscribe = function() {
      ...
      var b = a[0], c = a[1], a = a[2] = a[2] || d, f = this.subscriptions;
        ...
        case b.MESSAGE:
          if(a = a.messages) {
            for(var c = Array(a.length), d = 0;d < c.length;d++) {
              var f = a[d];
              c[d] = new ga(f.channelSerial, f.timestamp, f.name, Data.fromTData(f.data))
            }
            this.onEvent(c)
          }
          break;
        default:
          g.logAction(g.LOG_ERROR, "RealtimeChannel.onMessage()", "Fatal protocol error: unrecognised action (" + a.action + ")"), this.connectionManager.abort(G.unknownChannelErr)
      }
    };
      ...
      if("attaching" == this.state) {
        ...
        try {
          if(this.pendingEvents.length) {
            var b = new c.TProtocolMessage({action:c.TAction.MESSAGE, channel:this.name, messages:[]}), d = new Y;
    ...
    var b = "object" == typeof A ? A : require("../nodejs/lib/protocol/clientmessage_types"), d = b.TPresenceState, f = ["enter", "leave", "update"];
    n.inherits(c, v);
    ...
    c.prototype.enterClient = function(a, c, f) {
      ...
      switch(c.state) {
        ...
        case "initialized":
          c.attach();
        case "attaching":
          this.pendingPresence = {presence:a, callback:f};
          break;
        default:
          a = Error("Unable to enter presence channel (incompatible state)"), a.code = 90001, f(a)
      }
    };
    ...
    c.prototype.leaveClient = function(a, c) {
      ...
      var f = new b.TPresence({state:d.LEAVE, clientId:a}), m = this.channel;
      switch(m.state) {
        case "attached":
          m.sendPresence(f, c);
          break;
        case "attaching":
          this.pendingPresence = {presence:f, callback:c};
          break;
        case "initialized":
          this.pendingPresence = null;
          f = Error("Unable to enter presence channel (incompatible state)");
          f.code = 90001;
          c(f);
          break;
        default:
          this.pendingPresence = null, c(G.failed)
      }
    };
    c.prototype.get = function(a) {
    ...
    c.prototype.setPresence = function(b, c) {
      ...
      for(var l = 0;l < b.length;l++) {
        var m = b[l], s = a.call(m.clientId, m.memberId), n = new da(m.clientId, Data.fromTData(m.clientData), m.memberId);
        switch(m.state) {
          case d.LEAVE:
            delete this.members[s];
            break;
          case d.UPDATE:
            m.inheritMemberId && delete this.members[a.call(m.clientId, m.inheritMemberId)];
          case d.ENTER:
            clientData = this.members[s] = n
        }
        c && this.emit(f[m.state], n)
      }
    };
    ...
    c.prototype.setSuspended = function(a) {
      this.pendingPresence && (this.pendingPresence.callback(G[a.state]), this.pendingPresence = null)
    };
    return c
  }();
  (function() {
    ...
    a.checkConnectivity = function(b) {
      f ? f.push(b) : (f = [b], (new a.Request("isTheInternetUp")).send("http://live.cdn.ably-realtime.com/is-the-internet-up.js", null, null, !1, !1, function(a, b) {
        for(var c = !a && b, d = 0;d < f.length;d++) {
          f[d](null, c)
        }
        f = null
      }))
    ...
    a.tryConnect = function(b, c, d, f) {
      var h = new a(b, c, d), l = function(a) {
        f(a)
      };
      h.on("error", l);
    ...
    a.prototype.request = function(b, c, d, f, h) {
      return(new a.Request).send(b, c, d, f, !1, h)
    };
    a.Request = function(a) {
      this.requestId = a || d++
    };
    a.Request.prototype.send = function(a, c, d, f, h, g) {
      this.callback = g;
      var l = this.requestId, n = this.timer = setTimeout(f ? r.cometRecvTimeout : r.cometSendTimeout, function() {
        v.abort()
      });
      c = c || {};
      c.callback = "Ably._(" + l + ")";
      ...
      w.src = M.paramStr(c, a);
      var t = this._finish = function() {
        clearTimeout(n);
    ...
    Http.Request = function(b, c, d, f, h) {
      (new a.Request).send(b, c, d, !1, f, h)
    };
    return a
  })();
  (function() {
    ...
    a.Request.prototype.send = function(a, d, f, e, g, l) {
      a = M.paramStr(d, a);
      var m, n, v;
      f ? (d = "POST", m = 201) : (d = "GET", m = 200);
      var u = this.xhr = c();
      g && (u.responseType = "arraybuffer");
      var y = setTimeout(e ? r.cometRecvTimeout : r.cometSendTimeout, function() {
        v = !0;
        u.abort()
      });
      u.open(d, a, !0);
      u.setRequestHeader("Accept", g ? "application/x-thrift" : "application/json");
      ...
      u.onreadystatechange = function() {
        if(4 == u.readyState) {
          if(clearTimeout(y), n) {
            ...
            if(u.status == m) {
              var a = null;
              g ? u.response && (a = new t, a.buf = u.response, a.view = new DataView(a.buf)) : a = u.responseText;
              l(null, a)
            }else {
              0 != u.status && (n = Error("Unexpected response: statusCode \x3d " + u.status), n.statusCode = u.status, n.code = 8E4, n.statusText = u.statusText, l(n))
            }
          }
        }
      };
  ...
  (function() {
    ...
    n.inherits(a, ca);
    a.isAvailable = function() {
      return c && T && 10 <= T.getFlashPlayerVersion().major && O
    };
    a.isAvailable() && (z.transports.flash_socket = a);
    a.tryConnect = function(b, c, d, e) {
      var k = r.flashTransport.swfLocation, l = r.flashTransport.policyPort;
      ...
      O.__initialize(k);
      l && O.loadFlashPolicyFile("xmlsocket://" + d.host + ":" + l);
      var m = new a(b, c, d);
      errorCb = function(a) {
        e(a)
      };
      m.on("wserror", errorCb);
      m.on("wsopen", function() {
        g.logAction(g.LOG_MINOR, "FlashTransport.tryConnect()", "viable transport " + m);
        m.off("wserror", errorCb);
        e(null, m)
      });
      m.connect()
    };
    a.prototype.createWebSocket = function(a, c) {
      ...
      return new O(a, [], d.proxyHost, d.proxyPort)
    };
    a.prototype.toString = function() {
