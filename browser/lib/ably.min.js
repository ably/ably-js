(function() {
  ...
  G.prototype = {_2scomp:function() {
    ...
    for(var g = this.buffer, e = this.offset, f = 7;0 <= f;f--) {
      g[e + f] = c & 255, c = 4 == f ? a : c >>> 8
    }
    b && this._2scomp()
  }, toNumber:function(a) {
    for(var c = this.buffer, b = this.offset, g = c[0] & 128, e = 0, f = 1, d = 7, m = 1;0 <= d;d--, m *= 256) {
      var l = c[b + d];
      g && (l = (l ^ 255) + f, f = l >> 8, l &= 255);
      e += l * m
    }
    return!a && e >= G.MAX_INT ? g ? -Infinity : Infinity : g ? -e : e
  }, valueOf:function() {
    return this.toNumber(!1)
  }, toString:function(a) {
    return this.valueOf().toString(a || 10)
  }, toOctetString:function(a) {
    for(var c = Array(8), b = this.buffer, g = this.offset, e = 0;8 > e;e++) {
      c[e] = aa[b[g + e]]
    }
    return c.join(a || "")
  }, inspect:function() {
  ...
  d.Protocol.prototype = {getTransport:function() {
    ...
    var a = this.tpos.pop(), c = this.tstack[a], b = "{", g = !0, e;
    for(e in c) {
      g ? g = !1 : b += ",", b += e + ":" + c[e]
    }
    this.tstack[a] = b + "}"
  ...
  var V = {encode:function(a, c, b) {
    for(var g = b, e = 0;e < a.length;e++) {
      var f = a.charCodeAt(e);
      128 > f ? c.setInt8(g++, f) : (127 < f && 2048 > f ? c.setInt8(g++, f >> 6 | 192) : (c.setInt8(g++, f >> 12 | 224), c.setInt8(g++, f >> 6 & 63 | 128)), c.setInt8(g++, f & 63 | 128))
    }
    return g - b
    ...
    b += c;
    for(c = c1 = c2 = 0;e < b;) {
      c = a.getInt8(e++), 128 > c ? g += String.fromCharCode(c) : 191 < c && 224 > c ? (c2 = a.getInt8(e++), g += String.fromCharCode((c & 31) << 6 | c2 & 63)) : (c2 = a.getInt8(e++), c3 = a.getInt8(e++), g += String.fromCharCode((c & 15) << 12 | (c2 & 63) << 6 | c3 & 63))
    }
    return g
  }}, w = function(a) {
    this.offset = 0;
  ...
  w.prototype = {getArray:function() {
    ...
    a = a || 0;
    c = c || this.length;
    var b = new w, g = b.length = c - a, e = b.offset = this.offset + a, f = b.buf = this.buf;
    b.view = new DataView(f, e, g);
    return b
  }, getInt8:function(a) {
  ...
  var fa = new w(0), I = d.TTransport = function(a, c) {
    this.buf = a || fa;
    this.onFlush = c;
    this.reset()
  };
  ...
  X.receiver = function(a) {
    var c = 0, b = 0, g = null, e = null;
    return function(f) {
      if(e) {
        var d = new w(f.length + e.length);
        e.copy(d, 0, 0);
        f.copy(d, e.length, 0);
        e = null
      }
      for(;f.length;) {
        ...
        f.length >= c ? (f.copy(g, b, 0, c), f = f.slice(c, f.length), c = 0, a(new X(g))) : f.length && (f.copy(g, b, 0, f.length), c -= f.length, b += f.length, f = f.slice(f.length, f.length))
      }
    }
  };
  ...
  var r = {TAction:TAction, TFlags:TFlags, TType:TType, TData:E, TPresence:H, TMessage:D, TChannelMessage:void 0, TProtocolMessage:K};
  this.Cookie = function() {
    function a() {
    }
    "object" == typeof window && (a.create = function(a, b, g) {
      var e = "";
      g && (e = new Date, e.setTime(e.getTime() + g), e = "; expires\x3d" + e.toGMTString());
      document.cookie = a + "\x3d" + b + e + "; path\x3d/"
    }, a.read = function(a) {
      a += "\x3d";
      for(var b = document.cookie.split(";"), g = 0;g < b.length;g++) {
        for(var e = b[g];" " == e.charAt(0);) {
  ...
  var t = {protocolVersion:1, HOST:"rest.ably.io", WS_HOST:"realtime.ably.io", FALLBACK_HOSTS:["A.ably-realtime.com", "B.ably-realtime.com", "C.ably-realtime.com", "D.ably-realtime.com", "E.ably-realtime.com"], PORT:80, TLS_PORT:443, connectTimeout:15E3, disconnectTimeout:3E4, suspendedTimeout:12E4, cometRecvTimeout:9E4, cometSendTimeout:1E4, httpTransports:["xhr", "jsonp"], transports:["web_socket", "flash_socket", "xhr", "jsonp"], flashTransport:{swfLocation:("undefined" !== typeof window ? window.location.protocol : 
  "https:") + "//cdn.ably.io/lib/swf/WebSocketMainInsecure-0.9.swf", policyPort:"80"}, getHost:function(a, c, b) {
    c = c || a.host || t.HOST;
    b && (c = c == a.host && (a.wsHost || c) || c == t.HOST && (t.WS_HOST || c) || c);
    return c
  }, getPort:function(a) {
    return a.encrypted ? a.tlsPort || t.TLS_PORT : a.port || t.PORT
  }, getHosts:function(a) {
    var c;
    a.host ? (c = [a.host], a.fallbackHosts && c.concat(a.fallbackHosts)) : c = [t.HOST].concat(t.FALLBACK_HOSTS);
    return c
  }};
  "undefined" !== typeof exports && this.exports !== exports && (exports.defaults = t);
  this.Http = function() {
    function a() {
    }
    var c = function() {
    };
    a.get = function(b, g, e, f, d) {
      function m(b, c) {
        a.Request(b, f, null, p, c)
      }
      d = d || c;
      var l = "function" == typeof g ? g : function(a) {
        return b.baseUri(a) + g
      }, p = e && "application/json" != e.accept;
      if("string" == typeof l) {
        m(l, d)
      }else {
        var h;
        h = (e = b.connection) && "connected" == e.state ? [e.connectionManager.host] : t.getHosts(b.options);
        1 == h.length ? m(l(h[0]), d) : m(h.shift(), function(a, b, c) {
          if(a) {
            var f = a.code;
    ...
    a.post = function(b, g, e, f, d, m) {
      function l(b, c) {
        a.Request(b, d, f, h, c)
      }
      m = m || c;
      var p = "function" == typeof g ? g : function(a) {
        return b.baseUri(a) + g
      }, h = e && "application/json" != e.accept;
      if("string" == typeof p) {
        tryGet(p, m)
      }else {
        var B;
        B = (e = b.connection) && "connected" == e.state ? [e.connectionManager.host] : t.getHosts(b.options);
        1 == B.length ? l(p(B[0]), m) : l(B.shift(), function(a, b, c) {
          if(a) {
            var f = a.code;
            if("ENETUNREACH" == f || "EHOSTUNREACH" == f || "EHOSTDOWN" == f) {
              l(B, m);
  ...
  this.ThriftUtil = function() {
    ...
    var b = new d.TTransport, g = new d.TBinaryProtocol(b), e = 16384, f = [];
    ...
    c.decodeSync = function(a, c) {
      try {
        ...
        h.logAction(h.LOG_ERROR, "ThriftUtil.decode()", e, f);
        e = Error(e);
        e.statusCode = 400;
        throw e;
      }
  ...
  this.Base64 = function() {
    ...
    var g = {codex:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode:function(b) {
      var f = new a, d = g.codex;
      for(b = new c(b);b.moveNext();) {
        var m = b.current;
        b.moveNext();
        var l = b.current;
        b.moveNext();
        var p = b.current, h = m >> 2, m = (m & 3) << 4 | l >> 4, B = (l & 15) << 2 | p >> 6, y = p & 63;
        isNaN(l) ? B = y = 64 : isNaN(p) && (y = 64);
        f.append(d.charAt(h) + d.charAt(m) + d.charAt(B) + d.charAt(y))
      }
      return f.toString()
    }, decode:function(c) {
      var f = new a;
      for(c = new b(c);c.moveNext();) {
        var g = c.current;
        if(128 > g) {
          f.append(String.fromCharCode(g))
        }else {
          if(191 < g && 224 > g) {
            c.moveNext();
            var d = c.current;
            f.append(String.fromCharCode((g & 31) << 6 | d & 63))
          }else {
            c.moveNext(), d = c.current, c.moveNext(), f.append(String.fromCharCode((g & 15) << 12 | (d & 63) << 6 | c.current & 63))
          }
        }
      }
      return f.toString()
    ...
    b.prototype = {current:64, moveNext:function() {
      ...
      var a = g.codex.indexOf(this._input.charAt(++this._index)), b = g.codex.indexOf(this._input.charAt(++this._index)), c = g.codex.indexOf(this._input.charAt(++this._index)), d = g.codex.indexOf(this._input.charAt(++this._index)), l = (c & 3) << 6 | d;
      this.current = a << 2 | b >> 4;
      64 != c && this._buffer.push((b & 15) << 4 | c >> 2);
      64 != d && this._buffer.push(l);
      return!0
    }};
    return g
  }();
  Ably.Crypto = window.CryptoJS && function() {
    ...
    a.getCipher = function(f, e) {
      var g = f && f.cipherParams;
      g ? g instanceof c ? e(null, new b(g)) : e(Error("ChannelOptions not supported")) : a.getDefaultParams(function(a, c) {
        a ? e(a) : e(null, new b(c))
      })
    };
    b.prototype.encrypt = function(a) {
      h.logAction(h.LOG_MICRO, "CBCCipher.encrypt()", "");
      var b = a.sigBytes, c = b + 16 & -16, f = this.getIv().clone();
    ...
    b.prototype.getIv = function() {
      if(!this.iv) {
        return this.encryptCipher.process(m)
      }
      var a = this.iv;
      this.iv = null;
      return a
    ...
    p.asBase64 = function(a) {
      return CryptoJS.enc.Base64.stringify(a)
    };
    p.fromBase64 = function(a) {
  ...
  var S = function() {
    ...
    function g() {
      var a = s.getElementsByTagName("body")[0], b = s.createElement(r);
      ...
      if(c) {
        ...
        (function() {
          if(typeof c.GetVariable != x) {
            ...
            g && (g = g.split(" ")[1].split(","), q.pv = [parseInt(g[0], 10), parseInt(g[1], 10), parseInt(g[2], 10)])
          }else {
            if(10 > f) {
              f++;
    ...
    function e() {
      ...
      if(0 < a) {
        for(var b = 0;b < a;b++) {
          var c = C[b].id, e = C[b].callbackFn, g = {success:!1, id:c};
          if(0 < q.pv[0]) {
            var p = y(c);
            if(p) {
              if(k(C[b].swfVersion) && !(q.wk && 312 > q.wk)) {
                Q(c, !0), e && (g.success = !0, g.ref = f(c), e(g))
              }else {
                if(C[b].expressInstall && d()) {
                  g = {};
                  g.data = C[b].expressInstall;
                  g.width = p.getAttribute("width") || "0";
                  g.height = p.getAttribute("height") || "0";
                  p.getAttribute("class") && (g.styleclass = p.getAttribute("class"));
                  p.getAttribute("align") && (g.align = p.getAttribute("align"));
                  for(var h = {}, p = p.getElementsByTagName("param"), B = p.length, T = 0;T < B;T++) {
                    "movie" != p[T].getAttribute("name").toLowerCase() && (h[p[T].getAttribute("name")] = p[T].getAttribute("value"))
                  }
                  m(g, h, c, e)
                }else {
                  l(p), e && e(g)
            ...
            if(Q(c, !0), e) {
              if((c = f(c)) && typeof c.SetVariable != x) {
                g.success = !0, g.ref = c
              }
              e(g)
            }
    ...
    function f(a) {
      var b = null;
      if((a = y(a)) && "OBJECT" == a.nodeName) {
        typeof a.SetVariable != x ? b = a : (a = a.getElementsByTagName(r)[0]) && (b = a)
      }
      return b
    }
    function d() {
      return!J && k("6.0.65") && (q.win || q.mac) && !(q.wk && 312 > q.wk)
    }
    function m(a, b, c, f) {
      J = !0;
      K = f || null;
      ...
      var g = y(c);
      if(g) {
        "OBJECT" == g.nodeName ? (G = p(g), I = null) : (G = g, I = c);
        a.id = A;
        ...
        f = q.ie && q.win ? "ActiveX" : "PlugIn";
        f = "MMredirectURL\x3d" + v.location.toString().replace(/&/g, "%26") + "\x26MMplayerType\x3d" + f + "\x26MMdoctitle\x3d" + s.title;
        b.flashvars = typeof b.flashvars != x ? b.flashvars + ("\x26" + f) : f;
        q.ie && (q.win && 4 != g.readyState) && (f = s.createElement("div"), c += "SWFObjectNew", f.setAttribute("id", c), g.parentNode.insertBefore(f, g), g.style.display = "none", function() {
    ...
    function h(a, b, c) {
      ...
      if(g) {
        if(typeof a.id == x && (a.id = c), q.ie && q.win) {
          var e = "", d;
          for(d in a) {
            a[d] != Object.prototype[d] && ("data" == d.toLowerCase() ? b.movie = a[d] : "styleclass" == d.toLowerCase() ? e += ' class\x3d"' + a[d] + '"' : "classid" != d.toLowerCase() && (e += " " + d + '\x3d"' + a[d] + '"'))
          }
          d = "";
          for(var l in b) {
            b[l] != Object.prototype[l] && (d += '\x3cparam name\x3d"' + l + '" value\x3d"' + b[l] + '" /\x3e')
          }
          g.outerHTML = '\x3cobject classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + e + "\x3e" + d + "\x3c/object\x3e";
          H[H.length] = a.id;
          f = y(a.id)
        }else {
          l = s.createElement(r);
          l.setAttribute("type", w);
          for(var p in a) {
            a[p] != Object.prototype[p] && ("styleclass" == p.toLowerCase() ? l.setAttribute("class", a[p]) : "classid" != p.toLowerCase() && l.setAttribute(p, a[p]))
          }
          for(e in b) {
            b[e] != Object.prototype[e] && "movie" != e.toLowerCase() && (a = l, d = e, p = b[e], c = s.createElement("param"), c.setAttribute("name", d), c.setAttribute("value", p), a.appendChild(c))
          }
    ...
    function n(a, b, c, f) {
      if(!q.ie || !q.mac) {
        var g = s.getElementsByTagName("head")[0];
        if(g) {
          c = c && "string" == typeof c ? c : "screen";
          f && (N = L = null);
          if(!L || N != c) {
            f = s.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), L = g.appendChild(f), q.ie && (q.win && typeof s.styleSheets != x && 0 < s.styleSheets.length) && (L = s.styleSheets[s.styleSheets.length - 1]), N = c
          }
          q.ie && q.win ? L && typeof L.addRule == r && L.addRule(a, b) : L && typeof s.createTextNode != x && L.appendChild(s.createTextNode(a + " {" + b + "}"))
        }
      }
    }
    function Q(a, b) {
      if(R) {
        ...
        P && y(a) ? y(a).style.visibility = c : n("#" + a, "visibility:" + c)
      }
    }
    function t(a) {
      return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != x ? encodeURIComponent(a) : a
    }
    var x = "undefined", r = "object", w = "application/x-shockwave-flash", A = "SWFObjectExprInst", v = window, s = document, z = navigator, F = !1, E = [function() {
      F ? g() : e()
    }], C = [], H = [], D = [], G, I, K, M, P = !1, J = !1, L, N, R = !0, q = function() {
      var a = typeof s.getElementById != x && typeof s.getElementsByTagName != x && typeof s.createElement != x, b = z.userAgent.toLowerCase(), c = z.platform.toLowerCase(), f = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, g = !+"\v1", e = [0, 0, 0], d = null;
      if(typeof z.plugins != x && typeof z.plugins["Shockwave Flash"] == r) {
        if((d = z.plugins["Shockwave Flash"].description) && !(typeof z.mimeTypes != x && z.mimeTypes[w] && !z.mimeTypes[w].enabledPlugin)) {
          F = !0, g = !1, d = d.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), e[0] = parseInt(d.replace(/^(.*)\..*$/, "$1"), 10), e[1] = parseInt(d.replace(/^.*\.(.*)\s.*$/, "$1"), 10), e[2] = /[a-zA-Z]/.test(d) ? parseInt(d.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        }
      }else {
        if(typeof v.ActiveXObject != x) {
          try {
            ...
            if(l && (d = l.GetVariable("$version"))) {
              g = !0, d = d.split(" ")[1].split(","), e = [parseInt(d[0], 10), parseInt(d[1], 10), parseInt(d[2], 10)]
            }
          }catch(p) {
          }
        }
    ...
    (function() {
      q.w3 && ((typeof s.readyState != x && "complete" == s.readyState || typeof s.readyState == x && (s.getElementsByTagName("body")[0] || s.body)) && a(), P || (typeof s.addEventListener != x && s.addEventListener("DOMContentLoaded", a, !1), q.ie && q.win && (s.attachEvent("onreadystatechange", function() {
        ...
        P || (/loaded|complete/.test(s.readyState) ? a() : setTimeout(arguments.callee, 0))
      }(), b(a)))
    })();
    (function() {
    ...
    return{registerObject:function(a, b, c, f) {
    ...
    }, embedSWF:function(a, b, f, g, e, l, p, B, y, O) {
      var n = {success:!1, id:b};
      q.w3 && !(q.wk && 312 > q.wk) && a && b && f && g && e ? (Q(b, !1), c(function() {
        f += "";
        g += "";
        var c = {};
        if(y && typeof y === r) {
        ...
        if(p && typeof p === r) {
          for(var t in p) {
            q.flashvars = typeof q.flashvars != x ? q.flashvars + ("\x26" + t + "\x3d" + p[t]) : t + "\x3d" + p[t]
          }
        }
        if(k(e)) {
          s = h(c, q, b), c.id == b && Q(b, !0), n.success = !0, n.ref = s
        }else {
          if(l && d()) {
            c.data = l;
            m(c, q, b, O);
      ...
      if(b) {
        ...
        for(var b = b.split("\x26"), c = 0;c < b.length;c++) {
          if(b[c].substring(0, b[c].indexOf("\x3d")) == a) {
            return t(b[c].substring(b[c].indexOf("\x3d") + 1))
          }
        }
      }
      return""
      ...
      if(J) {
        var a = y(A);
        a && G && (a.parentNode.replaceChild(G, a), I && (Q(I, !0), q.ie && q.win && (G.style.display = "block")), K && K(M));
        J = !1
      }
    }}
  }(), R = function() {
    ...
    var a = function(c, b, g, e, f) {
      ...
      d.__createTask = setTimeout(function() {
        a.__addTask(function() {
          d.__createTask = null;
          a.__flash.create(d.__id, c, b, g || null, e || 0, f || null)
        })
      }, 0)
    };
    ...
    a.prototype.addEventListener = function(a, b, g) {
      a in this.__events || (this.__events[a] = []);
      this.__events[a].push(b)
    };
    a.prototype.removeEventListener = function(a, b, g) {
    ...
    a.prototype.dispatchEvent = function(a) {
      for(var b = this.__events[a.type] || [], g = 0;g < b.length;++g) {
        b[g](a)
      }
    ...
    a.prototype.__createMessageEvent = function(a, b) {
      if(document.createEvent && window.MessageEvent && !window.opera) {
        var g = document.createEvent("MessageEvent");
        g.initMessageEvent("message", !1, !1, b, null, null, window, null);
        return g
      }
    ...
    a.prototype.off = function(a, b) {
      if(0 == arguments.length) {
        ...
        if(null === a) {
          ...
          if(b) {
            e = -1;
            if(!(g = this.events[a]) || -1 == (e = g.indexOf(b))) {
    ...
    a.prototype.emit = function(a) {
      var b = Array.prototype.slice.call(arguments, 1), g = {event:a};
    ...
    function b(a, c) {
      ...
      this.httpTransports = n.intersect(c.transports || t.httpTransports, b.httpTransports);
      this.transports = n.intersect(c.transports || t.transports, b.transports);
      this.upgradeTransports = n.arrSubtract(this.transports, this.httpTransports);
      this.httpHosts = t.getHosts(c);
      this.host = this.pendingTransport = this.transport = null;
      h.logAction(h.LOG_MINOR, "Realtime.ConnectionManager()", "started");
      h.logAction(h.LOG_MICRO, "Realtime.ConnectionManager()", "requested transports \x3d [" + (c.transports || t.transports) + "]");
    ...
    var d = "undefined" !== typeof Cookie && Cookie.read, e = "undefined" !== typeof Cookie && Cookie.create, f = ("object" == typeof r ? r : require("../nodejs/lib/protocol/clientmessage_types")).TAction, u = function() {
    }, m = {initialized:{state:"initialized", terminal:!1, queueEvents:!0, sendEvents:!1}, connecting:{state:"connecting", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:t.connectTimeout, failState:"disconnected"}, connected:{state:"connected", terminal:!1, queueEvents:!1, sendEvents:!0, failState:"disconnected"}, disconnected:{state:"disconnected", terminal:!1, queueEvents:!0, sendEvents:!1, retryDelay:t.disconnectTimeout}, suspended:{state:"suspended", terminal:!1, queueEvents:!1, sendEvents:!1, 
    retryDelay:t.suspendedTimeout}, closed:{state:"closed", terminal:!1, queueEvents:!1, sendEvents:!1}, failed:{state:"failed", terminal:!0, queueEvents:!1, sendEvents:!1}};
          ...
          if(c) {
            ...
            if(h.logAction(h.LOG_MINOR, "ConnectionManager.chooseTransport()", "Establishing http transport: " + d), b(null, d), e.upgradeTransports.length) {
              d.on("connected", function(b, c) {
                ...
                e.chooseTransportForHost(f, e.upgradeTransports.slice(), u)
              })
            }
          }
    ...
    b.prototype.startConnectTimer = function() {
      ...
      this.connectTimer = setTimeout(function() {
        a.connectTimer && (h.logAction(h.LOG_MINOR, "ConnectionManager connect timer expired", "requesting new state: " + m.connecting.failState), a.notifyState({state:m.connecting.failState}))
      }, t.connectTimeout)
    };
    ...
    b.prototype.startSuspendTimer = function() {
      ...
      this.suspendTimer || (this.suspendTimer = setTimeout(function() {
        a.suspendTimer && (h.logAction(h.LOG_MINOR, "ConnectionManager suspend timer expired", "requesting new state: suspended"), m.connecting.failState = "suspended", m.connecting.queueEvents = !1, a.notifyState({state:"suspended"}))
      }, t.suspendedTimeout))
    };
    ...
    b.prototype.connectImpl = function() {
      ...
      var a = this, b = this.realtime.auth, c = function(f) {
        ...
        a.notifyState({state:m.connecting.failState, error:f})
      }, f = function() {
    ...
    b.prototype.queue = function(a, b) {
      ...
      f && ba.mergeTo(f.msg, a) ? (f.merged || (f.callback = new Y([f.callback]), f.merged = !0), f.listener.push(b)) : this.queuedMessages.push(new c(a, b))
    };
    ...
    var c = ("object" == typeof window ? r : require("../nodejs/lib/protocol/clientmessage_types")).TAction;
    n.inherits(a, v);
    ...
    var c = "object" == typeof window, b = c ? r : require("../nodejs/lib/protocol/clientmessage_types"), d = c ? window.WebSocket || window.MozWebSocket : require("ws"), e = c ? !1 : !!w, f = function() {
    };
    n.inherits(a, C);
    ...
    a.prototype.connect = function() {
      ...
      C.prototype.connect.call(this);
      var a = this, b = this.params, c = b.options, f = t.getHost(c, b.host, !0), e = t.getPort(c), d = (c.encrypted ? "wss://" : "ws://") + f + ":" + e + "/";
      h.logAction(h.LOG_MINOR, "WebSocketTransport.connect()", "uri: " + d);
      this.auth.getAuthParams(function(c, f) {
        var e = "", g;
        for(g in f) {
          e += " " + g + ": " + f[g] + ";"
        }
        h.logAction(h.LOG_MINOR, "WebSocketTransport.connect()", "authParams:" + e);
        if(c) {
          a.abort(UIMessages.FAIL_REASON_REFUSED)
        }else {
          e = b.getConnectParams(f);
          try {
            var p = a.wsConnection = a.createWebSocket(d, e);
    ...
    a.prototype.onWsClose = function(a, b) {
      ...
      C.prototype.onClose.call(this, c, e)
    };
    ...
    "object" == typeof r || require("../nodejs/lib/protocol/clientmessage_types");
    (n || require("util")).inherits(a, C);
    ...
    a.prototype.connect = function() {
      ...
      C.prototype.connect.call(this);
      var c = this, b = this.params, d = b.options, b = t.getHost(d, b.host), e = t.getPort(d);
      this.baseUri = (d.encrypted ? "https://" : "http://") + b + ":" + e + "/comet/";
    ...
    a.prototype.onConnect = function(a) {
      ...
      C.prototype.onConnect.call(this, a);
      var d = this.baseUri + b;
      h.logAction(h.LOG_MICRO, "CometTransport.onConnect()", "baseUri \x3d " + d + "; connectionId \x3d " + a.connectionId);
      this.sendUri = d + "/send";
      this.recvUri = d + "/recv";
    ...
    a.prototype.onResponseData = function(a) {
      try {
        ...
        h.logAction(h.LOG_ERROR, "CometTransport.onResponseData()", "Unexpected exception handing channel event: " + d.stack)
      }
    };
  ...
  this.Data = function() {
    ...
    var c = "object" == typeof r ? r : require("../nodejs/lib/protocol/clientmessage_types"), b = {"[object Null]":function(a, b) {
      a.type = c.TType.NONE;
      return!0
    ...
    a.fromTData = function(a) {
      ...
      if(a) {
        if(a.cipherData) {
          return new Crypto.CipherData(a.cipherData, a.type)
        }
        switch(a.type) {
          case 1:
            b = !0;
    ...
    a.toTData = function(a) {
      var b = new c.TData, h = d[typeof a];
      if(h && h(b, a)) {
        return b
      }
  ...
  var N = function() {
    ...
    var c = ("object" == typeof r ? r : require("../nodejs/lib/protocol/clientmessage_types")).TData;
    a.encrypt = function(a, d) {
      var e = new c, f = a.data;
      e.cipherData = d.encrypt(Crypto.Data.asPlaintext(f));
      e.type = f.type;
      a.data = e
    };
    a.decrypt = function(a, c) {
      var d = a.data;
      d.cipherData && (a.data = Crypto.Data.fromPlaintext(c.decrypt(d.cipherData), d.type))
    };
    return a
  }(), da = function() {
  ...
  this.Serialize = function() {
    ...
    var c = "object" == typeof r ? r : require("../nodejs/lib/protocol/clientmessage_types"), b = a.TData = {}, d = a.TMessage = {}, e = a.TPresence = {}, f = a.TProtocolMessage = {}, h = a.TMessageArray = {}, m = a.TMessageBundle = {}, l = c.TType.BUFFER;
    c.TMessage.prototype.toJSON = function() {
      ...
      (c = Data.isCipherData(a)) ? (b.encoding = "cipher+base64", c = Crypto.Data.asBase64(c), b.type = a.type) : (c = Data.fromTData(a), a.type == l && (b.encoding = "base64", c = c.toString("base64")));
      b.data = c;
      return b
    };
    ...
    b.fromREST = function(a, b) {
      ...
      switch(a.encoding) {
        case "cipher+base64":
          f = new c.TData;
          f.type = a.type;
          f.cipherData = Crypto.Data.fromBase64(b);
          break;
        case "base64":
          f = new c.TData;
          f.type = l;
          f.binaryData = new w(b, "base64");
          break;
        default:
          f = Data.toTData(b)
      }
    ...
    f.fromJSON = function(a) {
      var b;
      if(b = a.messages) {
        for(var f = b.length, h = a.messages = Array(f), m = 0;m < f;m++) {
          h[m] = d.fromJSON(b[m])
        }
      }
      if(b = a.presence) {
    ...
    m.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          ...
          e = JSON.parse(a);
          for(var g = e.length, d = Array(g), h = 0;h < g;h++) {
            d[h] = f.fromJSON(e[h])
          }
        }
      }
    ...
    h.decode = function(a, b) {
      ...
      if(a) {
        if(b) {
          ...
          e = JSON.parse(a);
          for(var h = e.length, f = Array(h), m = 0;m < h;m++) {
            f[m] = d.fromJSON(e[m])
          }
        }
      }
  ...
  var U = function() {
    ...
    a.get = function(a, b, d, e, f) {
      function h() {
        a.auth.getAuthHeaders(function(m, l) {
          m ? f(m) : Http.get(a, b, n.mixin(l, d), e, function(b, d, e) {
    ...
    a.post = function(a, b, d, e, f, h) {
      function m() {
        a.auth.getAuthHeaders(function(l, p) {
          l ? h(l) : Http.post(a, b, n.mixin(p, e), d, f, function(b, f, d) {
            b && 40140 == b.code ? a.auth.authorise({force:!0}, function(a) {
              a ? h(a) : m()
            }) : h(b, f, d)
          })
    ...
    a.prototype.get = function(a) {
      var b = this;
      U.get(this.rest, this.path, this.headers, this.params, function(d, e, f) {
        if(d) {
          h.logAction(h.LOG_ERROR, "PaginatedResource.get()", "Unexpected error getting resource: err \x3d " + d)
        }else {
          d = b.current = b.bodyHandler(e);
          var u, m;
          if(f && (u = f.Link || f.link)) {
            m = b.parseRelLinks(u.split(","))
          }
          a(null, d, m)
        }
      })
    ...
    function b(a, b) {
      ...
      if(b.keyValue) {
        if(!b.clientId) {
          ...
          this.method = "basic";
          this.basicKey = u(b.key || b.keyId + ":" + b.keyValue);
          this.keyId = b.keyId;
          this.keyValue = b.keyValue;
          return
        }
        if(!f) {
          throw c = "client-side token request signing not supported", h.logAction(h.LOG_ERROR, "Auth()", c), Error(c);
        }
      }
      this.method = "token";
      b.authToken && (this.token = {id:b.authToken});
      if(b.authCallback) {
        h.logAction(h.LOG_MINOR, "Auth()", "using token auth with authCallback"), c.authCallback = b.authCallback
      }else {
        if(b.authUrl) {
          h.logAction(h.LOG_MINOR, "Auth()", "using token auth with authUrl"), c.authUrl = b.authUrl
        }else {
          if(b.keyValue) {
    ...
    var d = "object" == typeof window, e = d ? null : require("crypto"), f, u = void 0;
    d ? (u = Base64.encode, window.CryptoJS && (CryptoJS.HmacSHA256 && CryptoJS.enc.Base64) && (f = function(a, b) {
    ...
    b.prototype.authorise = function(a, b) {
      ...
      if(c) {
        if(void 0 === c.expires || c.expires > this.getTimestamp()) {
          if(!a.force) {
            h.logAction(h.LOG_MINOR, "Auth.getToken()", "using cached token; expires \x3d " + c.expires);
            b(null, c);
            return
          }
        }else {
    ...
    b.prototype.requestToken = function(b, d) {
      ...
      if(b.authCallback) {
        ...
        if(b.authUrl) {
          ...
          if(b.keyValue) {
            ...
            f = function(a, c) {
              g.createTokenRequest(n.mixin(n.copy(b), a), c)
            }
          }else {
      ...
      var u = {}, k = b.clientId || this.rest.clientId;
      k && (u.client_id = k);
      k = b.ttl || "";
      "ttl" in b && (u.ttl = k);
      "capability" in b && (u.capability = c(b.capability));
      var e = this.rest, t = function(a) {
        return e.baseUri(a) + "/keys/" + b.keyId + "/requestToken"
      }, r = function(a, b) {
        Http.post ? Http.post(e, t, n.defaultPostHeaders(), a, null, b) : Http.get(e, t, n.defaultGetHeaders(), a, b)
      };
      f(u, function(a, b) {
        a ? (h.logAction(h.LOG_ERROR, "Auth.requestToken()", "token request signing call returned error; err \x3d " + a), d(a)) : r(b, function(a, b) {
          a ? (h.logAction(h.LOG_ERROR, "Auth.requestToken()", "token request API call returned error; err \x3d " + a), d(a)) : (h.logAction(h.LOG_MINOR, "Auth.getToken()", "token received"), d(null, b.access_token))
        })
      })
    };
    b.prototype.createTokenRequest = function(a, b) {
      ...
      if(!c || !d) {
        ...
        var e = {id:c}, g = a.clientId || "";
        g && (e.client_id = a.clientId);
        var u = a.ttl || "";
        u && (e.ttl = u);
        var k = a.capability || "";
        k && (e.capability = k);
        var n = this.rest, t = this;
        (function(c) {
          a.timestamp ? c() : a.queryTime ? n.time(function(d, f) {
            d ? b(d) : (a.timestamp = Math.floor(f / 1E3), c())
          }) : (a.timestamp = t.getTimestamp(), c())
        })(function() {
          var c = e.nonce = a.nonce || ("000000" + Math.floor(1E16 * Math.random())).slice(-16), p = e.timestamp = a.timestamp, c = e.id + "\n" + u + "\n" + k + "\n" + g + "\n" + p + "\n" + c + "\n";
          e.mac = a.mac || f(c, d);
    ...
    b.prototype.getAuthHeaders = function(a) {
      "basic" == this.method ? a(null, {authorization:"Basic " + this.basicKey}) : this.authorise({}, function(b, c) {
        b ? a(b) : a(null, {authorization:"Bearer " + u(c.id)})
      })
    };
    ...
    function a(a) {
      ...
      this.baseUri = this.authority = function(b) {
        return"https://" + b + ":" + (a.tlsPort || t.TLS_PORT)
      };
    ...
    a.prototype.stats = function(a, c) {
      ...
      var h = n.copy(n.defaultGetHeaders());
      this.options.headers && n.mixin(h, this.options.headers);
      (new ga(this, "/stats", h, a, d)).get(c)
    };
    ...
    c.prototype.presence = function(b, c) {
      ...
      var d = this.rest, f = !d.options.useTextProtocol, u = n.copy(n.defaultGetHeaders(f));
      d.options.headers && n.mixin(u, d.options.headers);
      U.get(d, "/channels/" + this.name + "/presence", u, b, function(a, b) {
    ...
    c.prototype.history = function(b, c) {
      ...
      void 0 === c && ("function" == typeof b ? (c = b, b = null) : c = a);
      var d = this.rest, f = !d.options.useTextProtocol, u = n.copy(n.defaultGetHeaders(f)), m = this.cipher;
      d.options.headers && n.mixin(u, d.options.headers);
      U.get(d, "/channels/" + this.name + "/history", u, b, function(a, b) {
        if(a) {
          c(a)
        }else {
          try {
            var d = Serialize.TMessageArray.decode(b, f);
            if(m) {
    ...
    c.prototype.publish = function(b, c, d) {
      ...
      d = d || a;
      var f = this.rest, u = !f.options.useTextProtocol;
      b = {name:b, data:c};
      (c = this.cipher) && N.encrypt(b, c);
      b = Serialize.TMessageArray.encode([b], u);
      u = n.copy(n.defaultPostHeaders(u));
      f.options.headers && n.mixin(u, f.options.headers);
      U.post(f, "/channels/" + this.name + "/publish", b, u, null, d)
    };
    return c
  }(), ba = function() {
    function a(a, b, c) {
      ...
      this.options = n.prototypicalClone(e, c);
      this.state = "initialized";
      this.subscriptions = new v;
      this.pendingEvents = []
    }
    var c = "object" == typeof r ? r : require("../nodejs/lib/protocol/clientmessage_types"), b = c.TAction, d = function() {
    }, e = {queueEvents:!0};
    n.inherits(a, $);
    ...
    a.prototype.publish = function(a, b, e) {
      h.logAction(h.LOG_MICRO, "RealtimeChannel.publish()", "name \x3d " + a);
      e = e || d;
      var l = this.connectionManager;
      if(z.activeState(l.state)) {
        var l = new c.TMessage, p = this.cipher;
        l.name = a;
        ...
        switch(this.state) {
          case "attached":
            ...
            a.channel = this.name;
            a.messages = [l];
            this.sendMessage(a, e);
            break;
          default:
            this.attach();
          case "attaching":
            h.logAction(h.LOG_MICRO, "RealtimeChannel.publish()", "queueing message"), this.pendingEvents.push({message:l, listener:e})
        }
      }else {
        e(l.getStateError())
      }
    ...
    a.prototype.detachImpl = function(a) {
      h.logAction(h.LOG_MICRO, "RealtimeChannel.attach()", "sending DETACH message");
            ...
            for(var c = Array(a.length), d = this.cipher, e = 0;e < c.length;e++) {
              ...
              if(d) {
                try {
                  ...
                  var n = "Unexpected error decrypting message; err \x3d " + k;
                  h.logAction(h.LOG_ERROR, "RealtimeChannel.onMessage()", n);
                  this.emit("error", Error(n))
                }
              }
              c[e] = new N(g.channelSerial, g.timestamp, g.name, Data.fromTData(g.data))
            }
            this.onEvent(c)
          }
          break;
        default:
          h.logAction(h.LOG_ERROR, "RealtimeChannel.onMessage()", "Fatal protocol error: unrecognised action (" + a.action + ")"), this.connectionManager.abort(F.unknownChannelErr)
      }
    };
    ...
    a.prototype.setSuspended = function(a) {
      h.logAction(h.LOG_MINOR, "RealtimeChannel.setSuspended", "deactivating channel; name \x3d " + this.name);
      this.state = "detached";
    ...
    var b = "object" == typeof r ? r : require("../nodejs/lib/protocol/clientmessage_types"), d = b.TPresenceState, e = ["enter", "leave", "update"];
    n.inherits(c, v);
    ...
    c.prototype.enterClient = function(a, c, e) {
    ...
    c.prototype.leaveClient = function(a, c) {
      ...
      var e = new b.TPresence({state:d.LEAVE, clientId:a}), l = this.channel;
      switch(l.state) {
        case "attached":
          l.sendPresence(e, c);
          break;
        case "attaching":
          this.pendingPresence = {presence:e, callback:c};
          break;
        case "initialized":
    ...
    c.prototype.setPresence = function(b, c) {
      h.logAction(h.LOG_MICRO, "Presence.setPresence()", "received presence for " + b.length + " participants");
      for(var m = 0;m < b.length;m++) {
        var l = b[m], p = a.call(l.clientId, l.memberId), k = new da(l.clientId, Data.fromTData(l.clientData), l.memberId);
        switch(l.state) {
          case d.LEAVE:
          ...
          case d.ENTER:
            clientData = this.members[p] = k
        }
        c && this.emit(e[l.state], k)
      }
    };
  ...
  (function() {
    ...
    a.prototype.request = function(b, c, d, e, g) {
      return(new a.Request).send(b, c, d, e, !1, g)
    };
    a.Request = function(a) {
      this.requestId = a || d++
    };
    a.Request.prototype.send = function(a, c, d, e, g, h) {
      this.callback = h;
      var k = this.requestId, n = this.timer = setTimeout(e ? t.cometRecvTimeout : t.cometSendTimeout, function() {
        w.abort()
      });
      c = c || {};
      c.callback = "Ably._(" + k + ")";
    ...
    Http.Request = function(b, c, d, e, g) {
  ...
  (function() {
    ...
    a.prototype.request = function(b, c, d, f, h) {
      (new a.Request).send(b, c, d, f, this.binary, h)
    };
    a.prototype.toString = function() {
    ...
    a.Request.prototype.send = function(a, d, e, f, h, m) {
      a = M.paramStr(d, a);
      var l, k, n;
      e ? (d = "POST", l = 201) : (d = "GET", l = 200);
      var r = this.xhr = c();
      h && (r.responseType = "arraybuffer");
      var v = setTimeout(f ? t.cometRecvTimeout : t.cometSendTimeout, function() {
        n = !0;
        r.abort()
      });
      r.open(d, a, !0);
      r.setRequestHeader("Accept", h ? "application/x-thrift" : "application/json");
      r.onerror = function(a) {
        a.code = 8E4;
        m(a)
      };
      r.onabort = function() {
        k = Error(n ? "Request timed out" : "Request cancelled");
        k.statusCode = 404;
        k.code = 8E4;
        m(k)
      };
      r.onreadystatechange = function() {
        if(4 == r.readyState) {
          if(clearTimeout(v), k) {
            ...
            if(r.status == l) {
              var a = null;
              h ? r.response && (a = new w, a.buf = r.response, a.view = new DataView(a.buf)) : a = r.responseText;
              m(null, a)
            }else {
              0 != r.status && (k = Error("Unexpected response: statusCode \x3d " + r.status), k.statusCode = r.status, k.code = 8E4, k.statusText = r.statusText, m(k))
            }
          }
        }
      };
    ...
    a.isAvailable() && (z.httpTransports.xhr = z.transports.xhr = a, Http.Request = function(b, c, d, f, h) {
  ...
  (function() {
    ...
    a.tryConnect = function(b, c, d, f) {
      var k = t.flashTransport.swfLocation, m = t.flashTransport.policyPort;
      ...
      R.__initialize(k);
      m && R.loadFlashPolicyFile("xmlsocket://" + d.host + ":" + m);
      var l = new a(b, c, d);
      errorCb = function(a) {
        f(a)
      };
      ...
      l.on("wsopen", function() {
        h.logAction(h.LOG_MINOR, "FlashTransport.tryConnect()", "viable transport " + l);
